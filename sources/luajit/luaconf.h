...
#	endif // #ifndef LUA_BUILD_AS_DLL
#endif // #ifndef CS_STATIC_LIBRARIES

#if defined(LUA_BUILD_AS_DLL)

#if defined(LUA_CORE) || defined(LUA_LIB) || defined(CS_SINGLE_DLL)
#	define LUA_API	__declspec(dllexport)
#else
#	if defined(CS_STATIC_LIBRARIES)
#		define LUA_API	__declspec(dllimport)
#	else // #if defined(CS_STATIC_LIBRARIES) || defined(CS_SINGLE_DLL)
#		define LUA_API	extern
#	endif // #if defined(CS_STATIC_LIBRARIES) || defined(CS_SINGLE_DLL)
#endif
