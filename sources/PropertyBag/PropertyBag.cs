...
namespace Flobbster.Windows.Forms
{
	...
	public class PropertySpec
	{
		...
		/// </summary>
		/// <param name="name">The name of the property displayed in the property grid.</param>
		/// <param name="typeId">The fully qualified name of the type of the property.</param>
		/// <param name="category">The category under which the property is displayed in the
		/// property grid.</param>
		/// <param name="description">A string that is displayed in the help area of the
		/// property grid.</param>
		...
		public PropertySpec(string name, Type typeId, string category, string description, object defaultValue):
			this(name, typeId, category, description, defaultValue ,null) { }
		...
		/// <param name="tag"> Additional data for property</param>
		public PropertySpec(string name, Type typeId, string category, string description, object defaultValue, object tag)
		{
			this.name = name;
			this.type = typeId;
			this.type_str = typeId.AssemblyQualifiedName;
		...
		public PropertySpec(string name, Type type, string category, string description, object defaultValue,
			...
			this(name, type, category, description, defaultValue, editor,
		...
		/// <summary>
		/// Gets s Type of contained Property
		/// </summary>
        public Type TypeId
        {
            get { return type; }
		...
		/// <summary>
		/// Gets or Sets additional datat for this PropertySpec
		/// </summary>
		public Object Tag
		{
			get { return tag; }
	...
	public class PropertyBag : ICustomTypeDescriptor
	{
		...
		public class PropertySpecDescriptor : PropertyDescriptor
		{
			...
			/// <summary>
			/// PropertySpec that contained by this descriptor
			/// </summary>
			public PropertySpec Item
			{
				get { return item; }
