...
#ifndef GL_NVX_instanced_arrays
#define GL_NVX_instanced_arrays 1
#ifdef GL_GLEXT_PROTOTYPES
extern void APIENTRY glVertexAttribDivisorNVX (GLuint attrib, GLuint divisor);
extern void APIENTRY glDrawArraysInstancedNVX (GLenum mode, GLint start, GLsizei count, GLsizei primCount);
extern void APIENTRY glMultiDrawArraysInstancedNVX (GLenum mode, const GLint *starts, const GLsizei *counts, GLsizei primCount);
extern void APIENTRY glDrawElementsInstancedNVX (GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei primCount);
extern void APIENTRY glMultiDrawElementsInstancedNVX (GLenum mode, const GLsizei *counts, GLenum type, const GLvoid* *indices, GLsizei primCount);
#endif /* GL_GLEXT_PROTOTYPES */
...
typedef void (APIENTRY * PFNGLMULTIDRAWARRAYSINSTANCEDNVXPROC) (GLenum mode, const GLint *starts, const GLsizei *counts, GLsizei primCount);
...
typedef void (APIENTRY * PFNGLMULTIDRAWELEMENTSINSTANCEDNVXPROC) (GLenum mode, const GLsizei *counts, GLenum type, const GLvoid* *indices, GLsizei primCount);
#endif
