 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BaseModel::BaseModel( allocator_type* const allocator ) : mIMesh(null), mModelCode(0), mSource(null), mTree(null), m_allocator( allocator )
{
}
...
bool BaseModel::CreateTree(bool no_leaf, bool quantized)
{
	...
	{
		if(mModelCode & OPC_QUANTIZED)	mTree = NEW ( AABBQuantizedNoLeafTree )( m_allocator );
		else							mTree = NEW ( AABBNoLeafTree )( m_allocator );
	}
	else
	{
		if(mModelCode & OPC_QUANTIZED)	mTree = NEW ( AABBQuantizedTree )( m_allocator );
		else							mTree = NEW ( AABBCollisionTree )( m_allocator );
	}
	CHECKALLOC(mTree);
