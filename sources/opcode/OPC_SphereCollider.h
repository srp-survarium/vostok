...
#define __OPC_SPHERECOLLIDER_H__
	...
	{
					SphereCache(Opcode::allocator_type* allocator) : VolumeCache(allocator), Center(0.0f,0.0f,0.0f), FatRadius2(0.0f), FatCoeff(1.1f)	{}
					~SphereCache()																{}
	...
	class OPCODE_API HybridSphereCollider : public SphereCollider
	{
		public:
		// Constructor / Destructor
											HybridSphereCollider(Opcode::allocator_type* allocator);
