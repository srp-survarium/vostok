...
#define __OPC_PLANESCOLLIDER_H__
	...
	{
					PlanesCache(Opcode::allocator_type* allocator) : VolumeCache(allocator)
					{
					}
	};
	...
	class OPCODE_API PlanesCollider : public VolumeCollider
	{
		...
		// Constructor / Destructor
											PlanesCollider(Opcode::allocator_type* allocator);
	...
	class OPCODE_API HybridPlanesCollider : public PlanesCollider
	{
		public:
		// Constructor / Destructor
											HybridPlanesCollider(allocator_type* allocator);
