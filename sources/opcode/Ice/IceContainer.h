...
//#include "api.h"
	...
	class ICECORE_API Container
	{
		...
		// Constructor / Destructor
								Container(Opcode::allocator_type* allocator);
								Container(const Container& object);
								Container(Opcode::allocator_type* allocator, udword size, float growth_factor);
								~Container();
		// Management
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/**
		...
		inline_	udword			operator[](udword i)			const	{ ASSERT(int(i)>=0 && i<mCurNbEntries); return mEntries[i];	}
		//! Write-access as an array
		inline_	udword&			operator[](udword i)					{ ASSERT(int(i)>=0 && i<mCurNbEntries); return mEntries[i];	}
		...
		// Data
	Opcode::allocator_type* m_allocator;
