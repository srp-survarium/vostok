 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Container::Container(Opcode::allocator_type* allocator) : mMaxNbEntries(0), mCurNbEntries(0), mEntries(null), mGrowthFactor(2.0f), m_allocator(allocator)
{
#ifdef CONTAINER_STATS
	mNbContainers++;
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Container::Container(Opcode::allocator_type* allocator, udword size, float growth_factor) : mMaxNbEntries(0), mCurNbEntries(0), mEntries(null), mGrowthFactor(growth_factor), m_allocator(allocator)
{
#ifdef CONTAINER_STATS
	mNbContainers++;
	mUsedRam+=sizeof(Container);
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Container::Container(const Container& object) : mMaxNbEntries(0), mCurNbEntries(0), mEntries(null), mGrowthFactor(2.0f), m_allocator( object.m_allocator )
{
#ifdef CONTAINER_STATS
	mNbContainers++;
	mUsedRam+=sizeof(Container);
...
bool Container::Resize(udword needed)
{
	...
	udword*	NewEntries = NEW_A ( udword, mMaxNbEntries );
...
bool Container::SetSize(udword nb)
{
	...
	// Get some bytes for new entries
	mEntries = NEW_A ( udword, mMaxNbEntries );
	CHECKALLOC(mEntries);
