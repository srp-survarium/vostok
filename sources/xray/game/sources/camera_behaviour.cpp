...
//}
//
//bool camera_free_fly_behaviour::on_keyboard_action( xray::input::world* input_world, 
...
//}
//
//bool camera_free_fly_behaviour::on_gamepad_action( xray::input::world* input_world, 
...
//}
//
//bool camera_free_fly_behaviour::on_mouse_key_action(	xray::input::world* input_world, 
...
//}
//
//bool camera_free_fly_behaviour::on_mouse_move( xray::input::world* input_world, int x, int y, int z )
//{
//	XRAY_UNREFERENCED_PARAMETERS	( input_world );
//
//	m_mouse_move.x += x;
...
//}
//
//void camera_free_fly_behaviour::build_view_matrix( xray::math::float2 const& raw_angles, float const shift_forward, float const shift_right, float const shift_up )
//{
