...
static xray::uninitialized_reference<xray::resources_performance_test::application>	s_application;
...
struct guard {
	inline	guard				( )
	{
		XRAY_CONSTRUCT_REFERENCE( s_application, xray::resources_performance_test::application );
