...
void
s1712 (SISLCurve * pc, sisl_double abeg, sisl_double aend, SISLCurve ** rcnew, int *jstat)
#else
void
...
**********************************************************************/
{
  ...
  sisl_double tbeg, tend;		/* The less and greater point.      */
  ...
  {
      sisl_double delta = pc->et[pc->in] - pc->et[pc->ik - 1];
