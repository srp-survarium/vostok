...
using xray::sound_editor::composite_sound_add_items_command;
using xray::sound_editor::composite_sound_remove_items_command;
using xray::sound_editor::composite_sound_change_objects_property_command;
using xray::sound_editor::composite_sound_create_collection_command;
...
void composite_sound_remove_items_command::save_childs(tree_node^ n, xray::configs::lua_config_value& root)
{
...
void composite_sound_remove_items_command::remove_childs(xray::configs::lua_config_value& root)
{
...
void composite_sound_remove_items_command::add_childs(xray::configs::lua_config_value& root)
{
	composite_sound_item^ item = gcnew composite_sound_item();
	item->load(root);
	String^ full_path = gcnew String((pcstr)root["full_path"]);
