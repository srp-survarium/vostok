...
m_editor(ed)
{
	...
	m_tree_view->selected_items_changed += gcnew EventHandler<xray::editor::controls::tree_view_selection_event_args^>(this, &sound_collection_document::on_selection_changed);
...
void sound_collection_document::on_selection_changed(Object^, xray::editor::controls::tree_view_selection_event_args^)
{
