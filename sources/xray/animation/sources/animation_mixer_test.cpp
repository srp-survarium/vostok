...
#include "pch.h"
#include <xray/animation/animation_mixer.h>
...
using xray::animation::animation_mixer;
...
void xray::animation::test_animation_mixer		(
		skeleton_animation_ptr skeleton_animation0,
		skeleton_animation_ptr skeleton_animation1,
		skeleton const& skeleton
	)
