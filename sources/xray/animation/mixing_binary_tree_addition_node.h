...
class XRAY_ANIMATION_API binary_tree_addition_node : public binary_tree_binary_operation_node {
public:
...
#include <xray/animation/mixing_binary_tree_addition_node_inline.h>
