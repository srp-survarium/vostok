...
class XRAY_ANIMATION_API binary_tree_subtraction_node : public binary_tree_binary_operation_node {
public:
...
#include <xray/animation/mixing_binary_tree_subtraction_node_inline.h>
