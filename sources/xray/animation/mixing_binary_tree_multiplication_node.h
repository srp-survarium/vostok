...
#include <xray/animation/mixing_binary_tree_binary_operation_node.h>

namespace xray {
namespace animation {
namespace mixing {

class XRAY_ANIMATION_API binary_tree_multiplication_node : public binary_tree_binary_operation_node {
public:
...
#include <xray/animation/mixing_binary_tree_multiplication_node_inline.h>
