...
#include <xray/fs/fs_physical_path_info_data.h>
...
public:
	...
	file_size_type					get_file_size		() const { return data.file_size; }
	...
	physical_path_info const *		get_parent			() const { return parent; }
private:
