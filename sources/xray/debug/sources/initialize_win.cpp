...
void xray::debug::platform::setup_storage_access_handler	( error_mode error_mode, 
...
void xray::debug::platform::change_storage_access_handler	( error_mode error_mode, 
																  void (*storage_access_handler) ( int ) )
{
	XRAY_UNREFERENCED_PARAMETER			( storage_access_handler );
