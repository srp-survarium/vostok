...
void xray::debug::platform::on_error	( bool* do_debug_break, char* const message, u32 const message_size, bool* ignore_always, _EXCEPTION_POINTERS* const exception_information, error_type_enum error_type )
{
	...
	xray::debug::call_stack::iterate( NULL, NULL, boost::bind( & call_stack_size_calculator::predicate, &calculator, _1, _2, _3, _4, _5, _6, _7), false );
	...
	xray::debug::call_stack::iterate( exception_information, NULL, boost::bind( &error_helper::predicate, &helper, _1, _2, _3, _4, _5, _6, _7), false );
...
void xray::debug::platform::on_error_message_box	( bool* do_debug_break, char* const message, u32 const message_size, bool* ignore_always, _EXCEPTION_POINTERS* const exception_information, error_type_enum error_type )
{
