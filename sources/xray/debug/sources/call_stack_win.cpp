...
static void GetStackTrace(HANDLE hThread, /**DWORD64 ranOffsets[][2],/**/ _EXCEPTION_POINTERS* pointers, xray::debug::call_stack::Callback const& callback, bool invert_order )
{
...
static void WriteStackTrace ( DWORD64 ranOffsets[][2], u32 num_call_stack_lines, xray::debug::call_stack::Callback const& callback, bool invert_order )
{
	TCHAR module_name[256] = _T("?");
	TCHAR file_name[2*260] = _T("?");
	TCHAR function[s_buffer_size] = _T("?");
...
void xray::debug::call_stack::get_stack_trace (void* stacktrace[], u32 const stacktrace_max, u32 const num_to_capture, u32* out_hash)
{
	::initialize						();
