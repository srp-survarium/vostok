...
#	define XRAY_ANALYSIS_ASSUME				__analysis_assume
#	define DEBUG_BREAK						__debugbreak
#	define XRAY_INIT_PRIORITY( priority )
#elif XRAY_PLATFORM_XBOX_360	// #if XRAY_PLATFORM_WINDOWS
#	define XRAY_ANALYSIS_ASSUME				__analysis_assume
#	define DEBUG_BREAK						__debugbreak
#	define XRAY_INIT_PRIORITY( priority )
#elif XRAY_PLATFORM_PS3			// #elif XRAY_PLATFORM_XBOX_360
#	define XRAY_ANALYSIS_ASSUME( ... )		(void)0
#	define DEBUG_BREAK						__builtin_trap
#	define XRAY_INIT_PRIORITY( priority )	__attribute__( (init_priority(101 + priority)) )
...
#include <xray/debug/macros_inline.h>
