...
#ifndef VOSTOK_MATH_QUATERNION_H_INCLUDED
#define VOSTOK_MATH_QUATERNION_H_INCLUDED
...
class VOSTOK_CORE_API quaternion {
public:
#if defined(_MSC_VER)
#	pragma warning(push)
...
#endif // #ifndef VOSTOK_MATH_QUATERNION_H_INCLUDED