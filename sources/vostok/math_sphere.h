...
#ifndef VOSTOK_MATH_SPHERE_H_INCLUDED
#define VOSTOK_MATH_SPHERE_H_INCLUDED

namespace vostok {
namespace math {

class VOSTOK_CORE_API sphere {
public:
	typedef float			type;
...
#include <vostok/math_sphere_inline.h>

#endif // #ifndef VOSTOK_MATH_SPHERE_H_INCLUDED