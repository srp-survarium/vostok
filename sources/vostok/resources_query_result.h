...
#ifndef VOSTOK_RESOURCES_QUERY_RESULT_H_INCLUDED
#define VOSTOK_RESOURCES_QUERY_RESULT_H_INCLUDED
...
#include <vostok/resources_save_generated_data.h>
...
class VOSTOK_CORE_API query_result_for_user : public resource_base
{
public:
...
template class VOSTOK_CORE_API boost::function< void ( ) >;

class VOSTOK_CORE_API query_result_for_cook : public query_result_for_user
{
public:
...
class query_result;
class VOSTOK_CORE_API query_result_debug
{
public:
...
class VOSTOK_CORE_API query_result :	
...
#endif // #ifndef VOSTOK_RESOURCES_QUERY_RESULT_H_INCLUDED
