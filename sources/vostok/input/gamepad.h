...
#ifndef VOSTOK_INPUT_CONTROLLER_H_INCLUDED
#define VOSTOK_INPUT_CONTROLLER_H_INCLUDED
...
struct VOSTOK_NOVTABLE gamepad {
public:
	struct state {
...
protected:
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR( gamepad )
}; // class handler

} // namespace input
} // namespace vostok

#endif // #ifndef VOSTOK_INPUT_CONTROLLER_H_INCLUDED