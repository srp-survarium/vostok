...
#ifndef VOSTOK_INTRUSIVE_LIST_H_INCLUDED
#define VOSTOK_INTRUSIVE_LIST_H_INCLUDED
...
inline	void			swap			(vostok::no_size_policy & left, vostok::no_size_policy & right);

#include <vostok/intrusive_list_inline.h>

#endif // #ifndef VOSTOK_INTRUSIVE_LIST_H_INCLUDED