...
#ifndef VOSTOK_TYPE_VARIANT_INLINE_H_INCLUDED
#define VOSTOK_TYPE_VARIANT_INLINE_H_INCLUDED
...
void   variant<MaxSize>::set (T const & value)
{
	...
	m_type_id		=	::vostok::detail::type_to_int<T>::get();

	new (m_storage)		T(value);
	COMPILE_ASSERT		(sizeof(m_helper_storage) >= sizeof(::vostok::detail::concrete_type_helper<T>), increase_sizeof_m_destroyer_storage);
	m_helper		=	new (m_helper_storage) ::vostok::detail::concrete_type_helper<T>();
}
...
#endif // #ifndef VOSTOK_TYPE_VARIANT_INLINE_H_INCLUDED