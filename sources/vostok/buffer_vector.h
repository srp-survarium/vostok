...
#ifndef VOSTOK_BUFFER_VECTOR_H_INCLUDED
#define VOSTOK_BUFFER_VECTOR_H_INCLUDED
...
private:
	...
	template < typename T >
	inline	void					swap			( ::vostok::buffer_vector< T >& left, ::vostok::buffer_vector< T >& right );

#include <vostok/buffer_vector_inline.h>

#endif // #ifndef VOSTOK_BUFFER_VECTOR_H_INCLUDED