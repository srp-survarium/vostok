...
void bt_static_rigid_body::apply_impulse( float3 const& impulse, float3 const& point_in_world ) {
	m_bt_body->setActivationState( ACTIVE_TAG );										// <0x584079>|0x000|0x000:'85'
	btVector3 rel_pos = from_vostok( point_in_world ) - m_bt_body->getWorldTransform().getOrigin();	// <0x584097>|0x01e|0x01e:'86'
