...
#ifndef VOSTOK_PHYSICS_2_STATIC_RIGID_BODY_H_INCLUDED
#define VOSTOK_PHYSICS_2_STATIC_RIGID_BODY_H_INCLUDED

#include <vostok/physics_2/rigid_body_base.h>
#include <vostok/physics_2/collision_shapes.h> // for typedef
...
VOSTOK_PHYSICS_2_API bt_static_rigid_body*	create_static_rigid_body	( bt_rigid_body_construction_info const& construction_info );
VOSTOK_PHYSICS_2_API void					destroy_static_rigid_body	(  bt_static_rigid_body* body );

} // namespace physics
} // namespace vostok

#endif // #ifndef VOSTOK_PHYSICS_2_STATIC_RIGID_BODY_H_INCLUDED