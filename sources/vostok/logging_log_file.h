...
class VOSTOK_CORE_API log_file : private detail::noncopyable {
public:		
...
private:
	typedef vostok::mt::vector< int >				line_groups_type;
...
extern vostok::fs::path_string	g_log_file_name;

VOSTOK_CORE_API log_file* get_log_file			( );
