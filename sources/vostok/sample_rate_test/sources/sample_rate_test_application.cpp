...
#include <vostok/os_preinclude.h>		// for GetCommandLine
#undef NOUSER
#undef NOMSG
#undef NOWINMESSAGES
#undef NOCTLMGR
...
using vostok::sample_rate_test::application;

vostok::memory::doug_lea_allocator_type	vostok::sample_rate_test::g_allocator;
