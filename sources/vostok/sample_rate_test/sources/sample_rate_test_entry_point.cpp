...
static vostok::uninitialized_reference<vostok::sample_rate_test::application>	s_application;
...
struct guard {
	inline	guard				( )
	{
		VOSTOK_CONSTRUCT_REFERENCE( s_application, vostok::sample_rate_test::application );
