...
static vostok::uninitialized_reference<vostok::sound_system_usage_example::application>	s_application;
...
struct guard {
	inline	guard				( )
	{
		VOSTOK_CONSTRUCT_REFERENCE( s_application, vostok::sound_system_usage_example::application );
