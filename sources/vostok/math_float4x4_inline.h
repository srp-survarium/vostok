...
#ifndef VOSTOK_MATH_FLOAT4X4_INLINE_H_INCLUDED
#define VOSTOK_MATH_FLOAT4X4_INLINE_H_INCLUDED
...
inline DISABLE_LINKER_GL float4x4& float4x4::identity			( )
{
...
inline float4x4 create_rotation ( float3 const& angles, vostok::math::axis_rotation_order const order )
{
...
#endif // #ifndef VOSTOK_MATH_FLOAT4X4_INLINE_H_INCLUDED
