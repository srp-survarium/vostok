...
#ifndef VOSTOK_STRINGS_DETAIL_TUPLES_INLINE_H_INLUDED
#define VOSTOK_STRINGS_DETAIL_TUPLES_INLINE_H_INLUDED

template < typename T0 >
inline vostok::strings::detail::tuples::tuples		( T0 p0 ) :
		m_count				(1)
{
...
inline vostok::strings::detail::tuples::tuples		( T0 p0, T1 p1 ) :
	m_count					(2)
{
	helper<0>::add_string	(*this, p0);
...
inline vostok::strings::detail::tuples::tuples		( T0 p0, T1 p1, T2 p2 ) :
	m_count					(3)
{
	helper<0>::add_string	(*this, p0);
	helper<1>::add_string	(*this, p1);
...
inline vostok::strings::detail::tuples::tuples		( T0 p0, T1 p1, T2 p2, T3 p3 ) :
	m_count					(4)
{
	helper<0>::add_string	(*this, p0);
	helper<1>::add_string	(*this, p1);
...
inline vostok::strings::detail::tuples::tuples		( T0 p0, T1 p1, T2 p2, T3 p3, T4 p4 ) :
	m_count					(5)
{
	helper<0>::add_string	(*this, p0);
	helper<1>::add_string	(*this, p1);
...
inline vostok::strings::detail::tuples::tuples		( T0 p0, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5 ) :
	m_count					(6)
{
	helper<0>::add_string	(*this, p0);
	helper<1>::add_string	(*this, p1);
...
inline u32 vostok::strings::detail::tuples::size		( ) const
{
	ASSERT			(m_count > 0);
...
inline void vostok::strings::detail::tuples::concat	( pcstr const result ) const
{
	ASSERT			(m_count > 0);
...
#define HELPER				vostok::strings::detail::tuples::helper< index >
...
TEMPLATE_SIGNATURE
template <typename T>
inline void HELPER::add_string								( vostok::strings::detail::tuples& self, T p )
{
...
#endif // #ifndef VOSTOK_STRINGS_DETAIL_TUPLES_INLINE_H_INLUDED