...
void client::on_lobby_connected		( vostok::lobby_client_message_types_enum const message_type )
{
	switch ( message_type ) {
...
void client::on_signed_in			(
		vostok::connection_error_types_enum const connection_error,
		vostok::handshaking_error_types_enum const handshaking_error,
		vostok::socket_error_types_enum const socket_error,
		vostok::login_client_message_types_enum const message_type,
		vostok::connection_info const& connection_info
	)
{
...
void client::on_signed_out			(
		...
		vostok::login_client_message_types_enum message_type
	)
{
	switch ( connection_error ) {
		case successfully_connected : {
...
void client::on_signed_up			(
		...
		vostok::socket_error_types_enum const socket_error,
		vostok::login_client_message_types_enum const message_type,
		vostok::sign_up_info const& sign_up_info,
		bool& finished
	)
{
	(void)&sign_up_info;
...
void client::sign_up				( vostok::sign_up_info const& sign_up_info, bool& finished )
{
	ASSERT							( !m_is_signed_in );
