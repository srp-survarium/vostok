...
void login_client::on_sign_out_handshaked( sign_out_callback_type const& callback, vostok::handshaking_error_types_enum const error )
{
...
void login_client::sign_out_on_connected	( vostok::connection_error_types_enum const connection_result, sign_out_callback_type const& callback )
{
	...
	*buffer++						= vostok::sign_out_message_type;
