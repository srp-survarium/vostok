...
void login_client::sign_up_on_handshaked	(
		sign_up_callback_type const& callback,
		vostok::sign_up_info const& sign_up_info,
		vostok::handshaking_error_types_enum const handshaking_result
	)
{
...
void login_client::sign_up_on_connected	(
		vostok::connection_error_types_enum const connection_result,
		sign_up_callback_type const& callback,
		vostok::sign_up_info const& sign_up_info
	)
{
	...
	*buffer++						= vostok::sign_up_message_type;
...
void login_client::sign_up			( vostok::sign_up_info const& sign_up_info, sign_up_callback_type const& callback )
{
