...
#define VOSTOK_ENGINE_VERSION		0
#define VOSTOK_ENGINE_SUBVERSION	1
#define VOSTOK_ENGINE_ID			"Vostok Engine v" VOSTOK_MAKE_STRING(VOSTOK_ENGINE_VERSION) "." VOSTOK_MAKE_STRING(VOSTOK_ENGINE_SUBVERSION)
