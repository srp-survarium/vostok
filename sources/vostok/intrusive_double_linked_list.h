...
#ifndef VOSTOK_INTRUSIVE_DOUBLE_LINKED_LIST_H_INCLUDED
#define VOSTOK_INTRUSIVE_DOUBLE_LINKED_LIST_H_INCLUDED

#include <vostok/threading_policies.h>
#include <vostok/size_policies.h>
#include <vostok/debug_policies.h>
...
template <	typename BaseWithMember,
		 ...
		 >
class VOSTOK_CORE_API intrusive_double_linked_list : public SizePolicy, public DebugPolicy {
public:
...
inline	void	swap	(vostok::intrusive_double_linked_list<BaseWithMember, PointerType, MemberPrev, MemberNext, ThreadingPolicy, SizePolicy>& left, 
						 vostok::intrusive_double_linked_list<BaseWithMember, PointerType, MemberPrev, MemberNext, ThreadingPolicy, SizePolicy>& right);

#include <vostok/intrusive_double_linked_list_inline.h>

#endif // #ifndef VOSTOK_INTRUSIVE_DOUBLE_LINKED_LIST_H_INCLUDED