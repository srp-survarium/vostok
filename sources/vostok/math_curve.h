...
template struct VOSTOK_CORE_API curve_line_points<float, float_curve_line>;
template struct VOSTOK_CORE_API curve_line_points<float3_pod, float_curve_line>;
template struct VOSTOK_CORE_API curve_line_points<float4_pod, float_curve_line>;
template struct VOSTOK_CORE_API curve_line_points<float4_pod, color_curve_line>;
...
struct VOSTOK_CORE_API curve_line_ranged_base
{
private:
...
struct VOSTOK_CORE_API curve_line_ranged_float
{
...
struct VOSTOK_CORE_API curve_line_ranged_xyz_float
{
