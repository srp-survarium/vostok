...
#ifndef VOSTOK_LIMITED_INTRUSIVE_LIST_H_INCLUDED
#define VOSTOK_LIMITED_INTRUSIVE_LIST_H_INCLUDED
...
template < typename T, typename BaseWithMember, T* BaseWithMember::*MemberNext >
inline	void			swap			( vostok::limited_intrusive_list< T, BaseWithMember, MemberNext >& left, 
										  vostok::limited_intrusive_list< T, BaseWithMember, MemberNext >& right );

#include <vostok/limited_intrusive_list_inline.h>

#endif // #ifndef VOSTOK_LIMITED_INTRUSIVE_LIST_H_INCLUDED