...
#ifndef VOSTOK_FIXED_VECTOR_INLINE_H_INCLUDED
#define VOSTOK_FIXED_VECTOR_INLINE_H_INCLUDED

#include <vostok/debug/pointer_cast.h>

#define TEMPLATE_SIGNATURE	template < typename T, int max_count >
#define FIXED_VECTOR		vostok::fixed_vector< T, max_count >
...
#endif // #ifndef VOSTOK_FIXED_VECTOR_INLINE_H_INCLUDED