...
#ifndef VOSTOK_MATH_FLOAT3_H_INCLUDED
#define VOSTOK_MATH_FLOAT3_H_INCLUDED
...
class VOSTOK_CORE_API float3 : public float3_pod {
public:
	inline				float3			( );
...
VOSTOK_CORE_API void	generate_orthonormal_basis	( float3 const& direction, float3& up, float3& right );
VOSTOK_CORE_API float3 normalize_precise			( float3 const& object );

} // namespace math
} // namespace vostok

#include <vostok/math_float3_inline.h>

#endif // #ifndef VOSTOK_MATH_FLOAT2_H_INCLUDED