...
using vostok::rtp::grasping_tree_space_params;
using vostok::rtp::grasping_space_params;
using vostok::rtp::test_grasping_world_params;
using vostok::float2;
using vostok::float3;
...
void	grasping_tree_space_params::render( const grasping_tree_space_params& to, vostok::render::scene_ptr const& scene,  vostok::render::debug::renderer& renderer, vostok::math::color const& color/* = math::color_xrgb(  255,  255, 255 ) */ )const
{
...
#ifndef	MASTER_GOLD
void	grasping_tree_space_params::save				( vostok::configs::lua_config_value cfg )const
{
...
void	grasping_tree_space_params::load				( const vostok::configs::binary_config_value &cfg )
{
...
void	grasping_space_params::render		( const grasping_space_params& to, vostok::render::scene_ptr const& scene,  vostok::render::debug::renderer& renderer, vostok::math::color const& clr )const
{
...
#ifndef	MASTER_GOLD
void	grasping_space_params::save				( vostok::configs::lua_config_value cfg )const
{
	super::save( cfg );
}
#endif

void	grasping_space_params::load				( const vostok::configs::binary_config_value &cfg )
{
	super::load( cfg );
}
...
#ifndef	MASTER_GOLD
void	test_grasping_world_params::save( vostok::configs::lua_config_value cfg )const
{
	cfg["dir"]	=	dir;
	cfg["pos"]	=	pos;
}
...
void	test_grasping_world_params::load( const vostok::configs::binary_config_value &cfg )
{
	dir = cfg["dir"];
	pos = cfg["pos"];
}
