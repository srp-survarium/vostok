...
#include <vostok/animation/i_animation_action.h>
...
public:
						navigation_controller	( pcstr name, vostok::animation::i_animation_controller_set *set );
						navigation_controller	( pcstr name, animation::world &w, pcstr animation_set_path );
						navigation_controller	( pcstr name, animation::world &w, pcstr animation_set_path, const vostok::configs::binary_config_ptr &cfg );
						navigation_controller	( pcstr name, animation::world &w, const vostok::configs::binary_config_ptr &cfg );
...
public:
	...
	virtual		void	dbg_move_control		( float4x4 &view_inverted,  vostok::input::world& input_world  );
...
#ifndef MASTER_GOLD
	void				save_settings			( vostok::configs::lua_config_value cfg )const;
#endif // MASTER_GOLD

	void				load_settings			( const vostok::configs::binary_config_value &cfg );
