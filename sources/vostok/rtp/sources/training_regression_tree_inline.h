...
#ifndef MASTER_GOLD
template< class training_node >
void	training_regression_tree< training_node >::save		( vostok::configs::lua_config_value cfg, const node_save_load_data< space_param_type >& data  )const
{
	...
	vostok::configs::lua_config_value lcfg = cfg["sample_idx"];
...
template< class training_node >
void training_regression_tree< training_node >::load		( const vostok::configs::binary_config_value &cfg, node_save_load_data< space_param_type >& data )
{
	super::load( cfg, data );
	if( !data.get_training_save_load_data() )
		return;
	vostok::configs::binary_config_value lcfg = cfg["sample_idx"];
...
//template< class training_node >	
//void	training_regression_tree< training_node >::render( vostok::render::debug::renderer& r, const iaction<space_param_type> &a ) const
//{
//	m_root.render( r, a );
//}
...
/*
template< class space_param_type >	
void	training_node<space_param_type>::render( vostok::render::debug::renderer& r, const iaction_type &a ) const
{
	if( is_leaf( ) )
	{
...
#ifndef MASTER_GOLD
template< class space_param_type >	
void	training_node<space_param_type>::save( vostok::configs::lua_config_value cfg, const node_save_load_data<space_param_type>& data  )const
{
...
template< class space_param_type >	
void	training_node< space_param_type >::load( const vostok::configs::binary_config_value &cfg, node_save_load_data< space_param_type >& data  )
{
	super::load( cfg, data );
	if(!data.get_training_save_load_data())
		return;
