...
navigation_controller< base_type >::navigation_controller	( pcstr name, vostok::animation::i_animation_controller_set *set ):
super( name, set ),
...
template< class base_type >
navigation_controller< base_type >::navigation_controller	( pcstr name, animation::world &w, pcstr animation_set_path, const vostok::configs::binary_config_ptr &cfg ):
...
template< class base_type >
navigation_controller< base_type >::navigation_controller	( pcstr name, animation::world &w, const vostok::configs::binary_config_ptr &config_ptr ):
...
{
	VOSTOK_UNREFERENCED_PARAMETERS( &torso_direction );
...
#ifndef MASTER_GOLD
template< class base_type >
void	navigation_controller< base_type >::save( vostok::configs::lua_config_value cfg, bool training_trees )const
{
...
#endif // MASTER_GOLD
template< class base_type >
void	navigation_controller< base_type >::load( const vostok::configs::binary_config_value &cfg )
{
	super::load( cfg );
	load_settings( cfg );
}
...
#ifndef MASTER_GOLD
template< class base_type >
void	navigation_controller< base_type >::save_settings	( vostok::configs::lua_config_value config )const
{

 vostok::configs::lua_config_value cfg = config["action_settings"];
...
template< class base_type >
void	navigation_controller< base_type >::load_settings	( const vostok::configs::binary_config_value &config )
{

if(!config.value_exists("action_settings"))
		return;

vostok::configs::binary_config_value cfg = config["action_settings"];
...
base_controller* create_navigation_learning_controller( pcstr name, animation::world &w, const vostok::configs::binary_config_ptr &cfg )
{
...
base_controller* create_navigation_walking_controller( pcstr name, animation::world &w, const vostok::configs::binary_config_ptr &cfg )
{
...
base_controller* create_navigation_controller( pcstr name, animation::world &w, pcstr animation_set_path, const vostok::configs::binary_config_ptr &cfg )
{
	return NEW( navigation_controller_type )( name, w, animation_set_path, cfg );
}

base_controller* create_navigation_controller( pcstr name, animation::world &w, const vostok::configs::binary_config_ptr &cfg )
{
