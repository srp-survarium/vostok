...
#ifndef MASTER_GOLD
	virtual	void						save_training_sets			( vostok::configs::lua_config_value  )const{};
#endif // MASTER_GOLD

	virtual	void						load_training_sets			( const vostok::configs::binary_config_value & ){};
...
public:
	virtual	void						render_value				( vostok::render::scene_ptr const& scene, vostok::render::debug::renderer& renderer ) const;
...
base_controller*	create_controller( pcstr name,  const vostok::configs::binary_config_ptr &cfg , animation::world &w );
