...
public:
	...
	virtual		void	render					( const world_space_params&,  vostok::render::debug::renderer&  ) const{}
	virtual		void	render					( const space_params& ,  vostok::render::debug::renderer& ) const{};
