...
//		void	render		( vostok::render::debug::renderer& renderer, const iaction_type &a ) const;
...
public:
#ifndef MASTER_GOLD
virtual		void	save		( vostok::configs::lua_config_value cfg, const node_save_load_data< space_param_type >& data )const;
#endif // MASTER_GOLD

virtual		void	load		( const vostok::configs::binary_config_value &cfg, node_save_load_data< space_param_type >& data );
...
public:
//		void							render		( vostok::render::debug::renderer& renderer, space_param_type const &to ) const;
