	...
	public tree_space_param< 2, navigation_tree_params >
{
	...
	typedef	navigation_action	action_type;
			...
			void	render					( const navigation_tree_params&, vostok::render::scene_ptr const&, vostok::render::debug::renderer& , math::color&   )const;
		...
		public space_param< 1, 1,  navigation_tree_params, navigation_params >
{
	...
	void	render				( const navigation_params&,  vostok::render::debug::renderer& , u32   )const;
	...
	public tree_space_param< 1, navigation_tree_theta_params >
{
	...
	typedef	navigation_theta_action								action_type;
			...
			void	render					( const navigation_theta_params&, vostok::render::scene_ptr const&, vostok::render::debug::renderer&, math::color const&   )const{};
