...
public:
	virtual	void				debug_render		( vostok::render::debug::renderer& renderer ) const ;
	virtual	void				render				( vostok::render::game::renderer &, vostok::render::skeleton_model_ptr& )const {};
	virtual	void				render				( vostok::render::editor::renderer &, vostok::render::skeleton_model_ptr&  )const {};
