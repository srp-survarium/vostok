...
public:
	...
	virtual	void				load_training_sets	( const vostok::configs::lua_config_value &cfg )=0;
	virtual	void				save				( vostok::configs::lua_config_value cfg, bool training_tries )const = 0;
	virtual	void				load				( const vostok::configs::lua_config_value &cfg )=0;
	virtual	pcstr				type				( )const = 0;

	virtual	void				render				( vostok::render::debug::renderer& renderer ) const=0;
