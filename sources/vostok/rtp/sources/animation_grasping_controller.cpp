...
animation_grasping_controller::animation_grasping_controller ( pcstr name, vostok::animation::i_animation_controller_set *set ):
super( name, set )
{
...
animation_grasping_controller::animation_grasping_controller( pcstr name, animation::world &w, vostok::configs::binary_config_ptr const& cfg ) :
	super					( name, w, cfg )
{
	dbg_set_random_target	( );
}
...
{
	VOSTOK_UNREFERENCED_PARAMETERS( &w, &p );	
