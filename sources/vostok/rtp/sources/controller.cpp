...
base_controller* create_controller( pcstr name, const vostok::configs::binary_config_ptr &config_ptr, animation::world &w )
{
	const vostok::configs::binary_config_value cfg = config_ptr->get_root(); 
