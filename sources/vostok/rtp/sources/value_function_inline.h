...
template< class regression_tree, class action >
inline void	value_function< regression_tree, action >::render(  vostok::render::scene_ptr const&, vostok::render::debug::renderer&  ) const
{

	//VOSTOK_UNREFERENCED_PARAMETERS( r );
...
#ifndef MASTER_GOLD
template< class regression_tree, class action >
void	value_function< regression_tree, action >::save( vostok::configs::lua_config_value cfg, bool )const
{
...
template< class regression_tree, class action >
void	value_function< regression_tree, action >::load( const vostok::configs::binary_config_value &cfg )
{
	clear();
	init_trees();
