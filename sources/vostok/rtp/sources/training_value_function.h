...
#ifndef MASTER_GOLD
	void		save				( vostok::configs::lua_config_value cfg, bool training )const;
#endif // MASTER_GOLD

	void		load				( const vostok::configs::binary_config_value &cfg );

#ifndef MASTER_GOLD
	void		save_training_sets	( vostok::configs::lua_config_value cfg )const;
#endif // MASTER_GOLD

	void		load_training_sets	( const vostok::configs::binary_config_value &cfg );
