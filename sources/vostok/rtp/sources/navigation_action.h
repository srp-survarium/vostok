...
{
		global_actions_params< navigation_action >( vostok::animation::i_animation_controller_set *set ):
...
struct global_actions_params< navigation_theta_action >:
	public animation_global_actions_params
{
		global_actions_params< navigation_theta_action >( vostok::animation::i_animation_controller_set *set ):
			animation_global_actions_params(set){}
} ;
