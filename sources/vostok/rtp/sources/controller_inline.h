...
{
	VOSTOK_UNREFERENCED_PARAMETERS( &w, &params );
}
...
template < class action, class value_function_type >
inline void		controller< action, value_function_type >::render_value			( vostok::render::scene_ptr const& scene, vostok::render::debug::renderer& renderer ) const
{
...
#ifndef MASTER_GOLD
template < class action, class value_function_type >
inline void	controller< action, value_function_type >::save( vostok::configs::lua_config_value config, bool training_trees )const
{


		vostok::configs::lua_config_value cfg = config["controller"];
		cfg["type"]					= type ();
...
template < class action, class value_function_type >
inline void	controller< action, value_function_type >::load( const vostok::configs::binary_config_value &config )
{
		const vostok::configs::binary_config_value cfg = config["controller"];
...
#ifndef MASTER_GOLD
template < class action >
inline void	learning_controller< action >::save_training_sets	( vostok::configs::lua_config_value cfg )const
{
...
template < class action >
inline void	learning_controller< action >::load_training_sets	( const vostok::configs::binary_config_value &cfg )
{
