...
#ifndef MASTER_GOLD
template< class  space_param >
inline void	action_value < training_node< typename space_param::tree_space_param_type >, space_param >::save		( vostok::configs::lua_config_value cfg,  const action_value_save_load_data< space_param_type, training_sample_type >& data )const
{
...
#ifndef MASTER_GOLD
template< class regression_tree, class space_param >
inline void	action_value_base<regression_tree, space_param>::save		( vostok::configs::lua_config_value cfg, const action_value_save_load_data< space_param_type, training_sample_type >& data  )const
{
	VOSTOK_UNREFERENCED_PARAMETERS( &data );
...
template< class  space_param >
inline void	action_value < training_node< typename space_param::tree_space_param_type >, space_param >::load		( const vostok::configs::binary_config_value &cfg, action_value_save_load_data< space_param_type, training_sample_type >& data )
{
...
template< class regression_tree, class space_param  >
void	action_value_base< regression_tree, space_param >::load		( const vostok::configs::binary_config_value &cfg , action_value_save_load_data< space_param_type, training_sample_type >& data  )
{
	VOSTOK_UNREFERENCED_PARAMETERS( &data );
	for( u32 i = 0; i < space_param::separate_dimensions_count; ++i )
		for( u32 j = 0; j < discrete_dimension_size; ++j )
...
template< class regression_tree, class space_param  >
inline void	action_value_base< regression_tree, space_param >::render	( vostok::render::debug::renderer& renderer, const iaction< space_param_type > &a ) const
{
	VOSTOK_UNREFERENCED_PARAMETERS( renderer, a );
