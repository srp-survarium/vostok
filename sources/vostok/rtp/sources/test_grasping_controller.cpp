...
using vostok::rtp::test_grasping_controller;
...
void	test_grasping_controller::debug_render( vostok::render::debug::renderer& renderer ) const 
{
...
void test_grasping_controller::save( vostok::configs::lua_config_value cfg, bool training_trees )const
{
	controller<test_grasping_action>::save( cfg ,training_trees );
}

void test_grasping_controller::load					( const vostok::configs::lua_config_value &cfg )
{
	controller<test_grasping_action>::load( cfg );
}

void	test_grasping_controller::save_training_sets( vostok::configs::lua_config_value cfg )const
{
	controller<test_grasping_action>::save_training_sets( cfg );
}

void	test_grasping_controller::load_training_sets( const vostok::configs::lua_config_value &cfg )
{
