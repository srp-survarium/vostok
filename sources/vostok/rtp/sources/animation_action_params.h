...
public:
	animation_global_actions_params( vostok::animation::i_animation_controller_set *set );
	

public:
	vostok::animation::i_animation_controller_set		*m_set;
...
#ifndef MASTER_GOLD
	void	save( vostok::configs::lua_config_value cfg )const;
#endif // MASTER_GOLD

	void	load( const vostok::configs::binary_config_value & );
...
#ifndef	MASTER_GOLD
inline void	animation_world_params::save( vostok::configs::lua_config_value v  )const
{
...
inline void	animation_world_params::load( const vostok::configs::binary_config_value &v )
{
