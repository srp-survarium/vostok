...
animation_controller< controller_type >::animation_controller( pcstr name, vostok::animation::i_animation_controller_set *set ):
...
template < class controller_type >
inline animation_controller< controller_type >::animation_controller ( pcstr name, animation::world &w, pcstr animation_set_path, const vostok::configs::binary_config_ptr &cfg ):
super( name, typename action_type::global_actions_params_type ( 0 ) ), 
	m_loaded( false ),
	m_animation_world( &w ),
	m_debug_wolk_initialized( false ),
...
template < class controller_type >
inline animation_controller< controller_type >::animation_controller( pcstr name, animation::world &w,  const vostok::configs::binary_config_ptr &config_ptr ):
super( name, typename action_type::global_actions_params_type ( 0 ) ), 
	m_loaded( false ),
	m_animation_world( &w ),
	m_debug_wolk_initialized( false ),
	...
	m_animation_controller( 0 )
{
	const vostok::configs::binary_config_value cfg = m_config->get_root( );
...
{ 
	...
	VOSTOK_UNREFERENCED_PARAMETERS( dt );
...
#ifndef MASTER_GOLD
template < class controller_type >
inline void		animation_controller< controller_type >::save					( vostok::configs::lua_config_value cfg, bool training_trees )const
{
...
template <class action>
inline void		animation_controller<action>::load					( const vostok::configs::binary_config_value& cfg )
{
	super::load( cfg );
