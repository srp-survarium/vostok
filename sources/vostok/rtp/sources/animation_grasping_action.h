...
#ifndef VOSTOK_RTP_ANIMATION_GRASPING_ACTION_H_INCLUDED
#define VOSTOK_RTP_ANIMATION_GRASPING_ACTION_H_INCLUDED
...
{
	global_actions_params< animation_grasping_action >( vostok::animation::i_animation_controller_set *set ):
...
#endif // #ifndef VOSTOK_RTP_ANIMATION_GRASPING_ACTION_H_INCLUDED