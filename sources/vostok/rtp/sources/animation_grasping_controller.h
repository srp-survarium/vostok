...
#ifndef VOSTOK_RTP_ANIMATION_GRASPING_CONTROLLER_H_INCLUDED
#define VOSTOK_RTP_ANIMATION_GRASPING_CONTROLLER_H_INCLUDED
...
public:
	animation_grasping_controller ( pcstr name, vostok::animation::i_animation_controller_set *set );
	animation_grasping_controller ( pcstr name, animation::world &w, pcstr animation_set_path );
	animation_grasping_controller ( pcstr name, animation::world &w, const vostok::configs::binary_config_ptr &cfg );
...
#endif // #ifndef VOSTOK_RTP_ANIMATION_GRASPING_CONTROLLER_H_INCLUDED