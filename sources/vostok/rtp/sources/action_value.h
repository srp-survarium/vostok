...
public:
	void				render			( vostok::render::debug::renderer& renderer, const iaction< space_param_type > &a ) const;
...
public:
#ifndef	MASTER_GOLD
virtual	void	save		( vostok::configs::lua_config_value cfg,  const action_value_save_load_data< space_param_type, training_sample_type >& data )const;
#endif	// MASTER_GOLD

virtual	void	load		( const vostok::configs::binary_config_value &cfg, action_value_save_load_data< space_param_type, training_sample_type >& data );
