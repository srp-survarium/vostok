...
template <class space_param,  class training_sample_type >
inline void training_set< space_param, training_sample_type >::save( vostok::configs::lua_config_value cfg )const
{
	for( u32 i = 0; i < subset_count; ++ i )
...
#ifndef MASTER_GOLD
template <class training_sample_type >
inline void training_sub_set< training_sample_type >::save( vostok::configs::lua_config_value cfg )const
{
...
template <class space_param,  class training_sample_type >
inline void training_set< space_param, training_sample_type >::load( const vostok::configs::binary_config_value &cfg )
{
	for( u32 i = 0; i < subset_count; ++ i )
...
template < class training_sample_type >
inline void training_sub_set< training_sample_type >::load( const vostok::configs::binary_config_value &cfg )
{
