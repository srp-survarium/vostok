...
struct test_grasping_world_params
{
	...
	void	load						( const vostok::configs::binary_config_value &cfg );
...
public:
	...
	void	render		( const grasping_tree_space_params& to, vostok::render::scene_ptr const& scene,  vostok::render::debug::renderer& renderer, math::color const& color )const;
...
public:
	...
	void	render		( const grasping_space_params& to, vostok::render::scene_ptr const& scene,  vostok::render::debug::renderer& renderer, math::color const& clr)const;
