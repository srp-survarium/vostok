...
namespace rtp {
...
#ifndef	MASTER_GOLD
	inline void	animation_grasping_world_params::save( vostok::configs::lua_config_value config )const
	{
	...
	inline void	animation_grasping_world_params::load( const vostok::configs::binary_config_value &config )
	{
