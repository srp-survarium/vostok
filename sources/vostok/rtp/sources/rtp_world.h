...
VOSTOK_INCLUDE_TO_LINKAGE(rtp_tester);
...
public:
	...
	virtual	base_controller	*create_navigation_controller		( pcstr name, const vostok::configs::binary_config_ptr &cfg );
...
private:
	...
	vostok::render::game::renderer*	m_renderer;
