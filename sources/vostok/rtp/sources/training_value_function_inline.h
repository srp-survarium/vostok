...
template< class action >
void	training_value_function< action >::render		( vostok::render::scene_ptr const& scene, vostok::render::debug::renderer& renderer ) const
{
...
#ifndef MASTER_GOLD
template< class action >
void training_value_function< action >::save( vostok::configs::lua_config_value cfg, bool training )const
{
...
template< class action >
void	training_value_function< action >::load( const vostok::configs::binary_config_value &cfg )
{
...
#ifndef MASTER_GOLD
template< class action >
void training_value_function< action >::save_training_sets( vostok::configs::lua_config_value cfg )const
{


	vostok::configs::lua_config_value cfg_sets = cfg["training_sets"];
...
template< class action >
void training_value_function< action >::load_training_sets	( const vostok::configs::binary_config_value &cfg )
{
	const vostok::configs::binary_config_value cfg_sets = cfg["training_sets"];
