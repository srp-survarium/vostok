...
virtual	render::skeleton_model_ptr	model				( )											= 0;	
...
#ifndef MASTER_GOLD
	virtual	void				save_training_sets	( vostok::configs::lua_config_value cfg )const=0;
#endif // MASTER_GOLD

	virtual	void				load_training_sets	( const vostok::configs::binary_config_value &cfg )=0;

#ifndef MASTER_GOLD
	virtual	void				save				( vostok::configs::lua_config_value cfg, bool training_trees )const = 0;
#endif // MASTER_GOLD

	virtual	void				load				( const vostok::configs::binary_config_value &cfg )=0;
	...
	virtual	void				render				( render::scene_ptr const& scene, render::scene_renderer& scene_renderer, render::debug::renderer& debug_renderer, vostok::render::skeleton_model_ptr const& model, bool render_debug_info ) const = 0;
