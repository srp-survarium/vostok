...
#ifndef VOSTOK_RTP_WORLD_H_INCLUDED
#define VOSTOK_RTP_WORLD_H_INCLUDED
...
struct VOSTOK_NOVTABLE world {
	...
	virtual	base_controller			*create_navigation_controller		( pcstr name, const vostok::configs::binary_config_ptr &cfg ) = 0;
...
#endif // #ifndef VOSTOK_RTP_WORLD_H_INCLUDED