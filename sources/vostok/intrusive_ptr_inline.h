...
#ifndef VOSTOK_INTRUSIVE_PTR_INLINE_H_INCLUDED
#define VOSTOK_INTRUSIVE_PTR_INLINE_H_INCLUDED
...
template <
	...
	typename policy_type
>
DestinationType vostok::static_cast_resource_ptr				(
		vostok::intrusive_ptr<
			ObjectType,
			BaseType,
			policy_type
...
#endif // #ifndef VOSTOK_INTRUSIVE_PTR_INLINE_H_INCLUDED