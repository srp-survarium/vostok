...
#include <vostok/ai/goal_types.h>
#include <vostok/ai/action_types.h>
...
VOSTOK_DECLARE_LINKAGE_ID( ai_entry_point )

vostok::ai::allocator_type* vostok::ai::g_allocator	= 0;
...
vostok::ai::world* vostok::ai::create_world	( engine& engine )
{	
#ifndef MASTER_GOLD	
	if ( !vostok::ai::are_enums_exported )
	{
		vostok::configs::export_enum( "sound_collections", vostok::ai::sounds_tuples, vostok::ai::sounds_tuples + array_size( vostok::ai::sounds_tuples ) );
		vostok::configs::export_enum( "npc_goals", vostok::ai::planning::goals_tuples, vostok::ai::planning::goals_tuples + array_size( vostok::ai::planning::goals_tuples ) );
		vostok::configs::export_enum( "npc_actions", vostok::ai::planning::actions_tuples, vostok::ai::planning::actions_tuples + array_size( vostok::ai::planning::actions_tuples ) );
		vostok::configs::export_enum( "selector_filters", vostok::ai::filter_tuples, vostok::ai::filter_tuples + array_size( vostok::ai::filter_tuples ) );
		vostok::configs::export_enum( "enemy_filters", vostok::ai::enemy_filter_tuples, vostok::ai::enemy_filter_tuples + array_size( vostok::ai::enemy_filter_tuples ) );
		vostok::configs::export_enum( "weapon_filters", vostok::ai::weapon_filter_tuples, vostok::ai::weapon_filter_tuples + array_size( vostok::ai::weapon_filter_tuples ) );
		vostok::configs::export_enum( "cover_filters", vostok::ai::cover_filter_tuples, vostok::ai::cover_filter_tuples + array_size( vostok::ai::cover_filter_tuples ) );
		vostok::configs::export_enum( "animation_filters", vostok::ai::animation_filter_tuples, vostok::ai::animation_filter_tuples + array_size( vostok::ai::animation_filter_tuples ) );
		vostok::configs::export_enum( "sound_filters", vostok::ai::sound_filter_tuples, vostok::ai::sound_filter_tuples + array_size( vostok::ai::sound_filter_tuples ) );
		vostok::configs::export_enum( "position_filters", vostok::ai::position_filter_tuples, vostok::ai::position_filter_tuples + array_size( vostok::ai::position_filter_tuples ) );
		vostok::configs::export_enum( "world_state_properties", vostok::ai::world_state_properties_tuples, vostok::ai::world_state_properties_tuples + array_size( vostok::ai::world_state_properties_tuples ) );
		vostok::ai::are_enums_exported = true;
	}
...
void vostok::ai::destroy_world	( vostok::ai::world*& world )
{
	ai_world* world_instance	= static_cast_checked< vostok::ai::ai_world* >( world );
	DELETE						( world_instance );
	world						= 0;
}

void vostok::ai::set_memory_allocator		( allocator_type& allocator )
{
	ASSERT						( !g_allocator );
...
struct npc_base
{
	...
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR( npc_base )
};
...
{
	VOSTOK_UNREFERENCED_PARAMETER	( leak );
...
typedef vostok::fixed_string<4096>	string_type;
...
struct VOSTOK_NOVTABLE base_lexeme : private boost::noncopyable {
	virtual						~base_lexeme			( ) { }
...
{
	return						VOSTOK_NEW_IMPL( allocator, binary_operation_lexeme )(
									operation_type_or,
...
{
	return						VOSTOK_NEW_IMPL( allocator, binary_operation_lexeme )( operation_type_and, left, *this, true );
}
...
public:
	...
	virtual	base_lexeme_ptr		generate_permutations	( memory::stack_allocator& allocator, base_lexeme const& left ) const
	{
		return					VOSTOK_NEW_IMPL( allocator, binary_operation_lexeme ) ( binary_operation_lexeme::operation_type_and, left, *this, true );
	}
