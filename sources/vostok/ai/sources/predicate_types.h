...
// predicate_type_is_at_position); our reconstruction added predicate_type_animation_playing
// (0x9), predicate_type_sound_playing (0xb) and predicate_type_is_moving (0xe), shifting the
