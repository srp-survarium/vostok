...
{
	return						VOSTOK_NEW_IMPL( allocator, base_lexeme )(
									operation_type_or,
...
{
	return						VOSTOK_NEW_IMPL( allocator, base_lexeme )( operation_type_and, left, *this, true );
}
...
{
	VOSTOK_UNREFERENCED_PARAMETERS		( &problem, &offset );
	NOT_IMPLEMENTED						( );
}
