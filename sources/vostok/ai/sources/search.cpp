...
#include <vostok/ai/search/search.h>
#include <vostok/ai/search/plan_tracker.h>
...
{
	string256							temp;
	vostok::sprintf						( temp, "oracle#%d", id );
	...
	)
{
	...
	string256							temp;
	vostok::sprintf						( temp, "operator#%d", id + offset );
...
void blocks_world_test				( )
{
	...
	generalized_action				pick_up( blocks_domain, vostok::ai::planning::pick_up, "pick_up_action", 10 );
	...
	generalized_action				put_down( blocks_domain, vostok::ai::planning::put_down, "put_down_action", 10 );
	...
	generalized_action				stack( blocks_domain, vostok::ai::planning::stack, "stack_action", 10 );
	...
	generalized_action				unstack( blocks_domain, vostok::ai::planning::unstack, "unstack_action", 10 );
