...
// {
// 	pddl_predicate_lexeme* const result		= VOSTOK_NEW_IMPL( allocator, pddl_predicate_lexeme )( m_predicate );
...
{
	return									*VOSTOK_NEW_IMPL( allocator, and_lexeme )( left, *this, true );
}
