...
#ifndef VOSTOK_AI_SOUND_PLAYER_H_INCLUDED
#define VOSTOK_AI_SOUND_PLAYER_H_INCLUDED
...
struct sound_player : public resources::positional_unmanaged_resource
{
	...
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR( sound_player );
}; // struct sound_player
...
#endif // #ifndef VOSTOK_AI_SOUND_PLAYER_H_INCLUDED