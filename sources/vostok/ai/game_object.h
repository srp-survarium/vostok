...
#ifndef VOSTOK_AI_GAME_OBJECT_H_INCLUDED
#define VOSTOK_AI_GAME_OBJECT_H_INCLUDED
...
struct VOSTOK_NOVTABLE game_object : public loose_ptr_base
{
...
protected:
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR				( game_object );
}; // struct game_object
...
#endif // #ifndef VOSTOK_AI_GAME_OBJECT_H_INCLUDED
