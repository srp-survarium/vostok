...
#ifndef VOSTOK_AI_SEARCH_SEARCH_RESTRICTOR_PLANNER_FORWARD_H_INCLUDED
#define VOSTOK_AI_SEARCH_SEARCH_RESTRICTOR_PLANNER_FORWARD_H_INCLUDED

#include <vostok/ai/search/propositional_planner.h>
...
struct planner_forward
{
	...
	private:
				bool					target_reached_impl		(
											planner_forward::vertex_id_type const& vertex_id,
											planning::world_state::properties_type::const_iterator it_target,
	...
	private:
		...
		target_id_type const&			m_target_vertex_id;
...
#include <vostok/ai/search/search_restrictor_planner_forward_inline.h>

#endif // #ifndef VOSTOK_AI_SEARCH_SEARCH_RESTRICTOR_PLANNER_FORWARD_H_INCLUDED