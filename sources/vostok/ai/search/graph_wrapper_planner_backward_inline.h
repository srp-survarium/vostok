...
#ifndef VOSTOK_AI_SEARCH_GRAPH_WRAPPER_PLANNER_BACKWARD_INLINE_H_INCLUDED
#define VOSTOK_AI_SEARCH_GRAPH_WRAPPER_PLANNER_BACKWARD_INLINE_H_INCLUDED
...
{
	VOSTOK_UNREFERENCED_PARAMETER				( current_vertex_id );
...
#endif // #ifndef VOSTOK_AI_SEARCH_GRAPH_WRAPPER_PLANNER_BACKWARD_INLINE_H_INCLUDED