...
#ifndef VOSTOK_AI_SEARCH_PATH_CONSTRUCTOR_BASE_INLINE_H_INCLUDED
#define VOSTOK_AI_SEARCH_PATH_CONSTRUCTOR_BASE_INLINE_H_INCLUDED
...
{
	VOSTOK_UNREFERENCED_PARAMETER				( neighbour );
	NODEFAULT								( );
}
...
#endif // #ifndef VOSTOK_AI_SEARCH_PATH_CONSTRUCTOR_BASE_INLINE_H_INCLUDED