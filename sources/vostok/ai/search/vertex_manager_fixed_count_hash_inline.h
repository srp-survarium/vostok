...
#ifndef VOSTOK_AI_SEARCH_VERTEX_MANAGER_FIXED_COUNT_HASH_INLINE_H_INCLUDED
#define VOSTOK_AI_SEARCH_VERTEX_MANAGER_FIXED_COUNT_HASH_INLINE_H_INCLUDED
...
{
	return						::vostok::ai::vertex_manager::hash_value( vertex_id ) % m_hash_size;
}
...
#endif // #ifndef VOSTOK_AI_SEARCH_VERTEX_MANAGER_FIXED_COUNT_HASH_INLINE_H_INCLUDED