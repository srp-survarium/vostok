...
#ifndef VOSTOK_AI_SEARCH_SEARCH_RESTRICTOR_BASE_INLINE_H_INCLUDED
#define VOSTOK_AI_SEARCH_SEARCH_RESTRICTOR_BASE_INLINE_H_INCLUDED
...
{
	VOSTOK_UNREFERENCED_PARAMETERS			( &current_vertex_id, &neighbour_vertex, &edge_id );
	return									true;
}
...
#endif // #ifndef VOSTOK_AI_SEARCH_SEARCH_RESTRICTOR_BASE_INLINE_H_INCLUDED