...
#ifndef VOSTOK_AI_SEARCH_OPERATOR_PAIR_INLINE_H_INCLUDED
#define VOSTOK_AI_SEARCH_OPERATOR_PAIR_INLINE_H_INCLUDED
...
#endif // #ifndef VOSTOK_AI_SEARCH_OPERATOR_PAIR_INLINE_H_INCLUDED