...
#ifndef VOSTOK_AI_SEARCH_SEARCH_RESTRICTOR_PLANNER_BACKWARD_INLINE_H_INCLUDED
#define VOSTOK_AI_SEARCH_SEARCH_RESTRICTOR_PLANNER_BACKWARD_INLINE_H_INCLUDED
...
{
	VOSTOK_UNREFERENCED_PARAMETERS	( &neighbour_vertex_id, &current_vertex, &edge_iterator );
...
#endif // #ifndef VOSTOK_AI_SEARCH_SEARCH_RESTRICTOR_PLANNER_BACKWARD_INLINE_H_INCLUDED