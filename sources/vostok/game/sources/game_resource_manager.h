...
//class game;
//
//typedef fastdelegate::FastDelegate< void ( vostok::resources::unmanaged_resource_ptr data ) >	query_resource_callback;
//
...
//
//private:	
//	void			on_resource_loaded		(vostok::resources::queries_result& data);
//
//	typedef vector<vostok::resources::unmanaged_resource_ptr>	game_resources;
