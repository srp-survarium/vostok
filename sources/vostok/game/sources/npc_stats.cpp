...
npc_stats::npc_stats					( vostok::ui::world& ui_world ) :
	m_ui_world							( ui_world ),
	m_caption_color						( vostok::math::color( 255, 255, 128 ).m_value ),
	m_text_color						( vostok::math::color( 128, 255, 255 ).m_value ),
	m_line_height						( 20.f ),
...
void npc_stats::draw					( vostok::render::ui::renderer& ui_renderer, render::scene_view_ptr const& scene_view )
{
