...
stats::stats(vostok::ui::world& ui_world)
:m_ui_world(ui_world)
{
	create	();
}
...
void stats::create()
{
	...
	m_rtp_controllers_dump->set_font		(vostok::ui::fnt_arial);
	m_rtp_controllers_dump->set_text_mode	(vostok::ui::tm_default);
	...
	m_navmesh_info->set_font				(vostok::ui::fnt_arial);
	m_navmesh_info->set_text_mode			(vostok::ui::tm_multiline);
