...
//static vostok::collision::geometry*	s_collision			= NULL;
//static vostok::collision::object*		s_collision_object	= NULL;
//static vostok::physics::shell*		s_statics_shell		= NULL;
...
void game::test					( )
{
	...
	//if ( s_collision )
		//s_collision->render			( m_render, dynamic_cast<vostok::collision::geometry_instance const*>( s_collision_object )->get_matrix() );
