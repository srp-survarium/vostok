...
npc_reach_position_behaviour::npc_reach_position_behaviour	(
...
super								( owner, data, name ),
	...
	m_behaviour							( 0 )
{
	vostok::ai::behaviour_cook_params		cook_params( &m_data["behaviour_config"] );
	...
	query_resource					(
		...
		boost::bind( &npc_reach_position_behaviour::on_behaviour_loaded, this, _1 ),
		g_allocator,
		&user_data_out
	);
}

void npc_reach_position_behaviour::attach_to_object			( object_controlled* o )
{
	m_object							 = o;
...
void npc_reach_position_behaviour::on_behaviour_loaded		( resources::queries_result& data )
{
