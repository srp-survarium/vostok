									   ...
									   resources::query_result_for_cook* parent_query )
{
	...
	vostok::configs::binary_config_ptr resource_config_ptr	= game_config_lua->get_binary_config();
	create_game_objects( resource_config_ptr, parent_query );
}
#endif // #ifndef MASTER_GOLD

void project_cooker_simple::create_game_objects( vostok::configs::binary_config_ptr project_cfg, resources::query_result_for_cook* parent_query )
{
