...
#ifndef VOSTOK_CONFIGS_BINARY_CONFIG_VALUE_H_INCLUDED
#define VOSTOK_CONFIGS_BINARY_CONFIG_VALUE_H_INCLUDED

namespace vostok {
namespace configs {

class VOSTOK_CORE_API binary_config_value {
private:
...
#include <vostok/configs_binary_config_value_inline.h>

#endif // #ifndef VOSTOK_CONFIGS_BINARY_CONFIG_VALUE_H_INCLUDED