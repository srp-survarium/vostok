...
#ifndef VOSTOK_MEMORY_ASSOCIATIVE_CHUNK_READER_INLINE_H_INCLUDED
#define VOSTOK_MEMORY_ASSOCIATIVE_CHUNK_READER_INLINE_H_INCLUDED

#define TEMPLATE_SIGNATURE			template < typename implementation >
#define ASSOCIATIVE_CHUNK_READER	vostok::memory::associative_chunk_reader< implementation >
...
#endif // #ifndef VOSTOK_MEMORY_ASSOCIATIVE_CHUNK_READER_INLINE_H_INCLUDED