...
#include <vostok/core/sources/fs_file_system.h>
...
vostok::command_line::key						s_file_key("file", "", "", "specifies a path to exe/dll file(s)(separate with ';')");
vostok::command_line::key						s_read_key("read", "", "", "outputs finger-print from executable");
vostok::command_line::key						s_write_key("write", "", "", "writes a finger-print to executable", "finger_print_message");
vostok::command_line::key						s_build_id_key("build_id", "", "", "uses given build id rather then one in binary", "id");
vostok::command_line::key						s_big_endian("big_endian", "", "", "treats binaries in big endian format", "id");
vostok::command_line::key						s_working_directory("working_directory", "", "", "for binaries to run when getting build id", "id");
vostok::command_line::key						s_force("force", "", "", "forces rewrite finger-print", "");
...
void   application::initialize ()
{
	...
	vostok::core::initialize					("../../resources/sources/", "main", core::perform_debug_initialization);
}
