...
#ifndef PATH_FINDER_FUNNEL_H_INCLUDED
#define PATH_FINDER_FUNNEL_H_INCLUDED
...
class path_finder_funnel : boost::noncopyable {
public:
	typedef debug::vector< u32 >		channel_type;
	typedef navigation::path_type		path_type;
...
#endif // #ifndef PATH_FINDER_FUNNEL_H_INCLUDED
