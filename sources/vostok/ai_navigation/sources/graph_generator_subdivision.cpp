...
using vostok::ai::navigation::triangle_to_test;
...
static inline void correct_obstructed_edge	(
		vostok::math::float3 const& test_vertex0,
		vostok::math::float3 const& test_vertex1,
		vostok::math::float3 const& test_vertex2,
...
vostok::math::float3 const* graph_generator::select_equal_vertices	(
		subdivided_triangle const& triangle,
		float3 const& testee
	)
{
...
public:
	inline filter_obstructions_predicate	( graph_generator const& generator, vostok::math::plane const& plane ) :
		...
		inline bool operator( )	( vostok::collision::triangle_result const& triangle_result ) const
	{
		...
		if ( vostok::math::is_similar(triangle.plane.d, m_plane->d, vostok::math::epsilon_5) )
			return				true;
