...
struct distance_predicate {
	inline bool	operator( ) ( vostok::collision::ray_triangle_result const& left, vostok::collision::ray_triangle_result const& right )
	{
		return			( left.distance < right.distance );
	}
	
	inline bool	operator( ) ( vostok::collision::ray_object_result const& left, vostok::collision::ray_object_result const& right )
	{
		return			( left.distance < right.distance );
	}
}; // distance_predicate
