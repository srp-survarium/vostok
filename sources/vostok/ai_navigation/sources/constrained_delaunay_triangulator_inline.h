...
{
	void fill_coordinate_indices	( vostok::math::float3 const& normal, u32 (&coordinate_indices)[2] );
	...
	for ( ; i != e; ++i )  {
		...
		if ( vostok::math::is_similar( segment_vertex0[ coordinate_indices[0] ], segment_vertex1[ coordinate_indices[0] ] )
			&& vostok::math::is_similar( segment_vertex0[ coordinate_indices[1] ], segment_vertex1[ coordinate_indices[1] ] ) )
		{
			continue;
		}
