...
#ifndef PATH_FIND_CHANNEL_H_INCLUDED
#define PATH_FIND_CHANNEL_H_INCLUDED
...
class path_find_channel : boost::noncopyable {
public:
				path_find_channel (
...
#endif // #ifndef PATH_FIND_CHANNEL_H_INCLUDED