...
using vostok::ai::navigation::graph_generator_merger;
...
{
	if ( vostok::math::is_similar( v0[ coordinate_indices[0] ], v1[ coordinate_indices[0] ] ) &&
		vostok::math::is_similar( v0[ coordinate_indices[1] ], v1[ coordinate_indices[1] ] ) )
	{
		return;
	}
...
void graph_generator_merger::subdivide_constraint_edges ( float3 const& normal )
{
	...
	/*
+		min	{x=-4.7553029 y=-5.2685590 z=3.7029507}	vostok::math::float3
+		max	{x=-4.6747975 y=4.7314410 z=4.3493414}	vostok::math::float3

+		min	{x=-4.7553029 y=-5.2685590 z=4.2735095}	vostok::math::float3
+		max	{x=-4.7443194 y=4.7314410 z=4.3493409}	vostok::math::float3
	*/
