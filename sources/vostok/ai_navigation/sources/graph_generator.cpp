...
using vostok::ai::navigation::graph_generator;
using vostok::collision::ray_triangles_type;

static vostok::command_line::key		s_test_navigation( "test_navigation", "", "", "test navigation graph generation" );
...
graph_generator::graph_generator			( 
	...
	vostok::ai::navigation::triangles_mesh_type& triangles_mesh
) :
	...
	m_goal_node							( u32(-1) )
{
	...
	static vostok::console_commands::cc_delegate s_subdivision_operation_id_console_command(
	...
	static vostok::console_commands::cc_delegate s_tessellation_operation_id_console_command(
		"navigation_tessellation_operation_id",
		boost::bind( &graph_generator::change_tessellation_operation_id, this, _1 ),
		console_commands::command_type_engine_internal
	);

	static vostok::console_commands::cc_delegate s_save_navigation_mesh_console_command(
		"navigation_save_navigation_mesh",
		boost::bind( &graph_generator::save_navigation_mesh_console_command, this, _1 ),
		console_commands::command_type_engine_internal
	);

	static vostok::console_commands::cc_delegate s_load_navigation_mesh_console_command(
		"navigation_load_navigation_mesh",
		boost::bind( &graph_generator::load_navigation_mesh_console_command, this, _1 ),
		console_commands::command_type_engine_internal
	);

	static vostok::console_commands::cc_delegate s_mark_triangle_console_command(
		"navigation_mark_triangle",
		boost::bind( &graph_generator::mark_triangle, this, _1 ),
		console_commands::command_type_engine_internal
	);

	static vostok::console_commands::cc_u32 s_show_point_id_console_command(
	...
	static vostok::console_commands::cc_u32 s_show_triangle_id_console_command(
	...
	static vostok::console_commands::cc_bool s_show_navigation_mesh_console_command(
	...
	static vostok::console_commands::cc_bool s_show_path_channel_console_command(
	...
	static vostok::console_commands::cc_delegate s_merger_operation_id_console_command(
		"navigation_merger_operation_id",
		boost::bind( &graph_generator::change_merger_operation_id, this, _1 ),
		console_commands::command_type_engine_internal
	);

	static vostok::console_commands::cc_bool s_show_processed_model_console_command(
	...
	static vostok::console_commands::cc_bool s_show_marked_triangles_console_command(
	...
	static vostok::console_commands::cc_bool s_show_triangle_faces_console_command(
	...
	static vostok::console_commands::cc_delegate s_change_draw_range_console_command(
		"navigation_set_draw_range",
		boost::bind( &graph_generator::change_draw_range, this, _1 ),
		console_commands::command_type_engine_internal
	);

	static vostok::console_commands::cc_float s_change_path_finder_agent_radius_command(
	...
	static vostok::console_commands::cc_float s_change_min_agent_radius_command(
	...
	static vostok::console_commands::cc_float s_change_min_agent_height_command(
	...
	static vostok::console_commands::cc_delegate s_change_fuser_operation_id_console_command(
		"navigation_fuser_operation_id",
		boost::bind( &graph_generator::change_fuser_operation_id, this, _1 ),
		console_commands::command_type_engine_internal
	);

	static vostok::console_commands::cc_delegate s_change_merge_delaunay_operation_id_console_command(
		"navigation_merge_delaunay_operation_id",
		boost::bind( &graph_generator::change_merge_delaunay_operation_id, this, _1 ),
		console_commands::command_type_engine_internal
	);

	static vostok::console_commands::cc_delegate s_generate_mesh_console_command(
...
static inline bool true_predicate( vostok::collision::ray_triangle_result const& ) 
{
	return true;
}

void graph_generator::ray_mark_triangle ( vostok::math::float3 const& pos, vostok::math::float3 const& dir )
{
...
void graph_generator::aabb_mark_triangle ( vostok::math::float3 const& pos, vostok::math::float3 const& dir )
{
	if ( m_input_triangles.data.size() ) {
...
void graph_generator::on_resources_loaded	( vostok::resources::queries_result& resources )
{
...
void graph_generator::generate_mesh	( pcstr const args )
{
	...
	VOSTOK_SSCANF					( args, "%s", file_name );
...
void graph_generator::mark_triangle	( pcstr const args )
{
	...
	VOSTOK_SSCANF					( args, "%d", &triangle_id );
...
{
	VOSTOK_SSCANF					( args, "%d", &m_merge_delaunay_max_operation_id );
	clear_geometry				( );
	add_geometry				( m_model->m_collision_geom.c_ptr(), m_transform );
	generate					( );
}
...
{
	u32 input[2];
	u32 result = VOSTOK_SSCANF	( args, "%d %d", &input[0], &input[1] );
	if ( result < 1 ) {
		m_min_triangle_id_to_draw = 0;
...
{
	VOSTOK_SSCANF					( args, "%d", &m_tessellation_max_operation_id );
	clear_geometry				( );
	add_geometry				( m_model->m_collision_geom.c_ptr(), m_transform );
	generate					( );
}
...
void graph_generator::tick					( )
{
	...
	*/
	...
	/*
		+		[385]	{x=15.398192 y=3.0733371 z=39.866676}	vostok::math::float3
		+		[386]	{x=15.090755 y=3.0733368 z=39.801331}	vostok::math::float3
		+		[408]	{x=14.868805 y=3.0733371 z=39.754150}	vostok::math::float3
...
void graph_generator::add_geometry( 
		vostok::collision::geometry* geometry, 
		vostok::math::float4x4 const& transform 
	)
{
