...
using vostok::ai::navigation::triangles_mesh;
using vostok::ai::navigation::edges_type;

u32 const region_colors_count = 7;
vostok::math::color const region_colors[region_colors_count] = {
	vostok::math::color(   0, 255,   0, 64 ),
	vostok::math::color(   0,   0, 255, 64 ),
	vostok::math::color( 255, 255, 255, 64 ),
	vostok::math::color(   0,   0, 255, 64 ),
	vostok::math::color( 255, 255,   0, 64 ),
	vostok::math::color( 255,   0, 255, 64 ),
	vostok::math::color(   0, 255, 255, 64 ),
};
