...
#include <vostok/ui/sources/ui_window.h>
...
class VOSTOK_AI_NAVIGATION_API graph_generator : private core::noncopyable {
public:
					graph_generator		( 
			...
			void	add_geometry				( vostok::collision::geometry* geometry, float4x4 const& transform );
