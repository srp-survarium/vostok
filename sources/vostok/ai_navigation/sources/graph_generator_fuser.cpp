...
using vostok::ai::navigation::graph_generator_fuser;
...
using vostok::math::is_zero;
using vostok::math::is_similar;
...
struct filter_non_fusable_triangles_predicate {
	...
	inline bool operator() ( vostok::collision::triangle_result const& triangle ) 
	{
