...
bool is_in_cuboid( graph_generator::cuboid_type& cuboid, vostok::math::float3 const& vertex )
{
	vostok::math::plane planes[6] = {
		vostok::math::create_plane( cuboid[0], cuboid[1], cuboid[3] ),
		vostok::math::create_plane( cuboid[7], cuboid[5], cuboid[4] ),
		vostok::math::create_plane( cuboid[0], cuboid[4], cuboid[5] ),
		vostok::math::create_plane( cuboid[1], cuboid[5], cuboid[6] ),
		vostok::math::create_plane( cuboid[2], cuboid[6], cuboid[7] ),
		vostok::math::create_plane( cuboid[3], cuboid[7], cuboid[4] ),
	};
