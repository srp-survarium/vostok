...
#ifndef MASTER_GOLD
#	include <vostok/ai_navigation/sources/path_finder_channel.h>
#	include <vostok/ai_navigation/sources/path_finder_modified_funnel.h>
...
static vostok::command_line::key		s_navigation_debug_controls( "navigation_debug_controls", "", "", "ai navigation debug controls enabled" );

navigation_world::navigation_world			( vostok::ai::navigation::engine& engine, vostok::render::scene_ptr const& scene, vostok::render::debug::renderer& renderer ) :
	m_graph_generator	( 0 ),
	m_engine			( engine ),
	m_renderer			( renderer )
{
...
void navigation_world::on_binary_config_resource ( vostok::resources::queries_result& resources ) 
{
#ifndef MASTER_GOLD
...
u32	navigation_world::get_node_id_after_move	(
		...
		vostok::math::float3 const& previous_position, 
		vostok::math::float3 const& new_position 
	)
{
	VOSTOK_UNREFERENCED_PARAMETERS( previous_triangle_id, &previous_position );
...
bool navigation_world::can_stand	( 
		vostok::math::float3 const& vertex,
		u32 const triangle_id,
		float const agent_radius
	)
{
#ifndef MASTER_GOLD
	return					vostok::ai::navigation::can_stand( m_navigation_mesh, vertex, triangle_id, agent_radius );
