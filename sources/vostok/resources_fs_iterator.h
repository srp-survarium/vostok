...
#ifndef VOSTOK_RESOURCES_FS_ITERATOR_H_INCLUDED_
#define VOSTOK_RESOURCES_FS_ITERATOR_H_INCLUDED_
...
class VOSTOK_CORE_API fs_iterator
{
public:
...
protected:
	...
	//friend  void VOSTOK_CORE_API	query_fs_iterator	(pcstr, query_vfs_iterator_callback, memory::base_allocator*, recursive_bool, query_result_for_cook *, bool);
};

class VOSTOK_CORE_API sub_fat_pin_fs_iterator : public fs_iterator
{
public:
...
#endif // #ifndef VOSTOK_RESOURCES_FS_ITERATOR_H_INCLUDED_
