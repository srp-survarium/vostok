...
#ifndef VOSTOK_MEMORY_READER_WRAPPER_H_INCLUDED
#define VOSTOK_MEMORY_READER_WRAPPER_H_INCLUDED

namespace vostok {
namespace memory {

template < typename implementation >
class VOSTOK_CORE_API reader_wrapper {
public:
...
#include <vostok/memory_reader_wrapper_inline.h>

#endif // #ifndef VOSTOK_MEMORY_READER_WRAPPER_H_INCLUDED