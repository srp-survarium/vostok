...
static vostok::uninitialized_reference<vostok::game_server::application>	s_application;
...
struct guard {
	inline	guard				( )
	{
		VOSTOK_CONSTRUCT_REFERENCE( s_application, vostok::game_server::application );
