...
#ifndef VOSTOK_CONSOLE_COMMAND_H_INCLUDED
...
template class VOSTOK_CORE_API boost::function< void (pcstr) >;
#pragma warning( pop )

#pragma warning(push)
#pragma warning(disable:4251)

class VOSTOK_CORE_API save_storage : private core::noncopyable
{
public:
...
class VOSTOK_CORE_API console_command : private core::noncopyable
{
public:
...
class VOSTOK_CORE_API cc_string :public console_command
{
	typedef console_command		super;
public:
...
class VOSTOK_CORE_API cc_float2 :public cc_value<math::float2>{
...
class VOSTOK_CORE_API cc_float3 :public cc_value<math::float3>
{
...
#include <vostok/console_command_inline.h>

#endif // #ifndef VOSTOK_CONSOLE_COMMAND_H_INCLUDED