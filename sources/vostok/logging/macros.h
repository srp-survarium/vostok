...
#define __CHECK_VERBOSITY( level, initiator ) 							\
...
#define __LOG( level, format, data, initiator, ... )	__CHECK_VERBOSITY( level, initiator )	\
...
#define LOGF_ERROR( format, ... )	__LOG_FORCED( ::vostok::logging::error,	format, NULL, VOSTOK_LOG_MODULE_INITIATOR ":", ##__VA_ARGS__ )
#define LOGF_WARNING( format, ... )	__LOG_FORCED( ::vostok::logging::warning,	format, NULL, VOSTOK_LOG_MODULE_INITIATOR ":", ##__VA_ARGS__ )
#define LOGF_INFO( format, ... )	__LOG_FORCED( ::vostok::logging::info,		format, NULL, VOSTOK_LOG_MODULE_INITIATOR ":", ##__VA_ARGS__ )
...
#define LOGI_ERROR( initiator, ... )	__LOG( ::vostok::logging::error,	&::vostok::core::g_log_format, ::vostok::core::g_log_flags, initiator ":", ##__VA_ARGS__ )
#define LOGI_WARNING( initiator, ... )	__LOG( ::vostok::logging::warning,	&::vostok::core::g_log_format, ::vostok::core::g_log_flags, initiator ":", ##__VA_ARGS__ )
#define LOGI_INFO( initiator, ... )		__LOG( ::vostok::logging::info,		&::vostok::core::g_log_format, ::vostok::core::g_log_flags, initiator ":", ##__VA_ARGS__ )
...
#	define LOGI_TRACE( initiator, ... )	__LOG( ::vostok::logging::trace, &::vostok::core::g_log_format, ::vostok::core::g_log_flags, initiator ":",	##__VA_ARGS__ )
#else // #ifdef DEBUG
#	define LOG_TRACE( ... )
#	define LOGI_TRACE( ... )
#endif // #ifdef DEBUG
...
#	define LOGI_DEBUG( initiator, ... )	__LOG( ::vostok::logging::debug, &::vostok::core::g_log_format, ::vostok::core::g_log_flags, initiator ":",	##__VA_ARGS__ )
#else // #ifndef VOSTOK_MASTER_GOLD
#	define LOG_DEBUG( ... )
#	define LOGI_DEBUG( ... )
#endif // #ifndef VOSTOK_MASTER_GOLD

#define LOGI( initiator, type, ... )		__LOG( type,	&::vostok::core::g_log_format, ::vostok::core::g_log_flags, initiator ":", ##__VA_ARGS__ )
...
#define LOGI_FORCED( initiator, type, ... )		__LOG_FORCED( type,	&::vostok::core::g_log_format,	::vostok::core::g_log_flags, initiator ":",	##__VA_ARGS__ )
