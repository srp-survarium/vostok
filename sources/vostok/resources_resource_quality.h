...
#include <vostok/resources_resource_children.h>
...
class VOSTOK_CORE_API resource_quality : public resource_children
{
public:	
...
protected:
	...
	virtual void		decrease_quality				(u32 new_best_quality) { VOSTOK_UNREFERENCED_PARAMETER(new_best_quality); NOT_IMPLEMENTED(); }
	virtual void		increase_quality_to_target		(query_result_for_cook * parent_query) { VOSTOK_UNREFERENCED_PARAMETER(parent_query); NOT_IMPLEMENTED(); }
