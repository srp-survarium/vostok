...
#ifndef VOSTOK_MEMBER_PREDICATES_H_INCLUDED
#define VOSTOK_MEMBER_PREDICATES_H_INCLUDED
...
struct delete_predicate 
{
	...
	template <class T>
	void operator ()					(T * value) const { VOSTOK_DELETE_IMPL(allocator, value); }
...
#endif // #ifndef VOSTOK_MEMBER_PREDICATES_H_INCLUDED