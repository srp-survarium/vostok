...
#ifndef VOSTOK_MATH_COLOR_H_INCLUDED
#define VOSTOK_MATH_COLOR_H_INCLUDED
...
*/
	...
	inline u32	color_get_R		( u32 c )	{ return ((c) & 0xff); }
	inline u32	color_get_G		( u32 c )	{ return (((c) >> 8)  & 0xff);	}
	inline u32	color_get_B		( u32 c )	{ return (((c) >> 16) & 0xff);	}
...
//#include <vostok/math_color_inline.h>

#endif // #ifndef VOSTOK_MATH_COLOR_H_INCLUDED
