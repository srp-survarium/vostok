...
// STATE[STUB]
 udp_match_connection::udp_match_connection(
	...
	m_local_sequence_id				( 0 ),
	m_remote_sequence_id			( 0 ),
	m_received_local_sequence_id	( 0 ),
	m_disconnection_local_sequence_id	( 0 )
{
...
// STATE[STUB]
void udp_match_connection::on_error( client_error_codes_enum client_error_code, boost::system::error_code error_code )
{
	// PDB: both params are __formal (genuinely unused in the original source) - keep
...
u32 udp_match_connection::packets_count( ) const
{
	...
	// typedef
	// 	boost::function< void( vostok::network_core::udp_match_client_session&, u8, vostok::network_core::packet_reader& ) >
	// 	on_packet_received_type;

	// typedef
	// 	boost::intrusive::rbtree_impl< boost::intrusive::setopt< boost::intrusive::detail::member_hook_traits< vostok::network_core::udp_match_client_session, boost::intrusive::set_member_hook< boost::intrusive::none, boost::intrusive::none, boost::intrusive::none, boost::intrusive::none >, 1372 >, vostok::network_core::udp_match_server::comparer, u32, 1 > >
	// 	tree_type;
