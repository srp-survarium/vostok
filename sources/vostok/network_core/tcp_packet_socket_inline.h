...
// claude@NOTE: PDB shows these for the basic_stream_socket<ip::tcp,...>
// instantiation; reconstructed as primary-template member stubs. The fresh
// (08.06) carcass FUNCTION BODY blocks are kept for the matcher to add meat.

// STATE[STUB]
template < typename socket_type >
void tcp_packet_socket< socket_type >::on_packet_received( tcp_packet const* packet, boost::system::error_code const& error_code, u32 bytes_transferred )
{
	VOSTOK_UNREFERENCED_PARAMETERS( packet, error_code, bytes_transferred );
...
void tcp_packet_socket< socket_type >::on_packet_size_received( boost::system::error_code const& error_code, u32 bytes_transferred )
{
	VOSTOK_UNREFERENCED_PARAMETERS( error_code, bytes_transferred );

	// LOCALS
	// const u16 						buffer_size
	// tcp_packet* const 				packet<1>
	// ******
...
// STATE[STUB]
template < typename socket_type >
void tcp_packet_socket< socket_type >::start_receiving( )
{
...
// STATE[STUB]
template < typename socket_type >
void tcp_packet_socket< socket_type >::on_packet_has_been_sent( tcp_packet const* packet_being_sent, boost::system::error_code const& error_code, u32 bytes_transferred )
{
	VOSTOK_UNREFERENCED_PARAMETERS( packet_being_sent, error_code, bytes_transferred );
...
// STATE[STUB]
template < typename socket_type >
void tcp_packet_socket< socket_type >::send( tcp_packet const& packet )
{
...
// STATE[STUB]
template < typename socket_type >
tcp_packet* tcp_packet_socket< socket_type >::new_packet( )
{
	return NULL;
...
// STATE[STUB]
template < typename socket_type >
void tcp_packet_socket< socket_type >::stop_receiving( )
{
	// LOCALS
	// boost::system::error_code 		error_code
	// ******
