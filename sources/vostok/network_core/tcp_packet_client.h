...
public:
	...
	inline	void						set_on_connected			( boost::function< void( ) > const& callback ) { m_on_connected = callback; }

	inline	void						set_on_disconnected			( boost::function< void( ) > const& callback ) { m_on_disconnected = callback; }
