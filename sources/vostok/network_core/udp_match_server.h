...
public:
	...
	typedef boost::function< void( udp_match_client_session&, u8, packet_reader& ) >	server_on_packet_received_type;
	...
	typedef intrusive_list< udp_match_client_session, udp_match_client_session*, &udp_match_client_session::next_in_destroy_list, threading::single_threading_policy, size_policy, no_debug_policy >	clients_to_destroy_type;
...
private:
	/* 0x0008 */	server_on_packet_received_type		m_on_packet_received;
...
protected:
	/* 0x0088 */	clients_type							m_clients;
	/* 0x009c */	clients_to_destroy_type				m_clients_to_destroy;
...
private:
	/* 0x00b8 */	receive_buffer_type					m_receive_buffer;
...
inline void udp_match_server::tick( u32 time_in_ms )
{
