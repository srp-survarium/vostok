...
#ifndef VOSTOK_COMMAND_LINE_EXTENSIONS_H_INCLUDED
#define VOSTOK_COMMAND_LINE_EXTENSIONS_H_INCLUDED
...
enum contains_application_bool
{
	...
	contains_application_true,
				...
				bool	initialized ( );
VOSTOK_CORE_API	void	handle_help_key ( );
VOSTOK_CORE_API	void	show_help_and_exit	( );
VOSTOK_CORE_API	void	check_keys	( );
VOSTOK_CORE_API	bool	show_help	( );
VOSTOK_CORE_API	void	set_finger_print ( pcstr );

} // namespace command_line
} // namespace vostok

#endif // #ifndef VOSTOK_COMMAND_LINE_EXTENSIONS_H_INCLUDED