...
#ifndef VOSTOK_THREADING_POLICIES_H_INCLUDED
#define VOSTOK_THREADING_POLICIES_H_INCLUDED
...
class VOSTOK_CORE_API single_threading_policy : private core::noncopyable {
public:
...
#endif // #ifndef VOSTOK_THREADING_POLICY_H_INCLUDED