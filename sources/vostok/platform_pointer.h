...
#ifndef VOSTOK_PLATFORM_POINTER_TYPE_H_INCLUDED
#define VOSTOK_PLATFORM_POINTER_TYPE_H_INCLUDED
...
{
	struct VOSTOK_CORE_API helper_pod
	{
		union
		{
			T *		pointer;
	...
	struct VOSTOK_CORE_API helper : public helper_pod
	{
...
#endif // #ifndef VOSTOK_PLATFORM_POINTER_TYPE_H_INCLUDED