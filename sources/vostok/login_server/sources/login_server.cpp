...
vostok::client_session* login_server::new_client_session	( )
{
...
void login_server::delete_client_session		( vostok::client_session* const client_session )
{
	...
	)
{
	...
	m_queries_server.set_last_activity_time		( session_id );
}
...
{
	u64 const users_collected		= m_queries_server.disconnect_inactive( m_no_ping_interval );
