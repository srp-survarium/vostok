...
#ifndef VOSTOK_DEBUG_POINTER_CAST_H_INCLUDED
#define VOSTOK_DEBUG_POINTER_CAST_H_INCLUDED
...
inline destination_type pointer_cast( source_type* const source )
{
	...
	return					
		::vostok::detail::pointer_cast::helper<
			pure_source_type,
			destination_type,
			boost::is_const<
				pure_source_type
...
#endif // #ifndef VOSTOK_DEBUG_POINTER_CAST_H_INCLUDED