...
#pragma message( VOSTOK_TODO("PS3: unhandled exception handler") )
	...
	//vostok::debug::detail::generate_file_name			( temp, date_time, vostok::core::application_name(), "error_report", ".log");
	...
	//vostok::logging::flush_log_file		( vostok::fs_new::convert_to_portable_in_place(portable_log_file_name) );
