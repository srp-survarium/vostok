...
#ifndef VOSTOK_DEBUG_MACROS_INLINE_H_INCLUDED
#define VOSTOK_DEBUG_MACROS_INLINE_H_INCLUDED
...
class VOSTOK_DEBUG_API string_helper
{
public:
...
#ifdef VOSTOK_DEFINE_COMPARISON_OPERATOR_FOR__R_ASSERT_CMP
#	error do not define macro VOSTOK_DEFINE_COMPARISON_OPERATOR_FOR__R_ASSERT_CMP
#endif // #ifdef VOSTOK_DEFINE_COMPARISON_OPERATOR_FOR__R_ASSERT_CMP

#define VOSTOK_DEFINE_COMPARISON_OPERATOR_FOR__R_ASSERT_CMP( comparison_operator )	\
	template < typename T1, typename T2 >											\
...
VOSTOK_DEFINE_COMPARISON_OPERATOR_FOR__R_ASSERT_CMP( == )
VOSTOK_DEFINE_COMPARISON_OPERATOR_FOR__R_ASSERT_CMP( != )
VOSTOK_DEFINE_COMPARISON_OPERATOR_FOR__R_ASSERT_CMP( < )
VOSTOK_DEFINE_COMPARISON_OPERATOR_FOR__R_ASSERT_CMP( <= )
VOSTOK_DEFINE_COMPARISON_OPERATOR_FOR__R_ASSERT_CMP( > )
...
#ifdef VOSTOK_DEFINE_COMPARISON_OPERATOR_FOR__R_ASSERT_CMP
#	undef VOSTOK_DEFINE_COMPARISON_OPERATOR_FOR__R_ASSERT_CMP
#else // #ifdef VOSTOK_DEFINE_COMPARISON_OPERATOR_FOR__R_ASSERT_CMP
#	error do not undefine macro VOSTOK_DEFINE_COMPARISON_OPERATOR_FOR__R_ASSERT_CMP
#endif // #ifdef VOSTOK_DEFINE_COMPARISON_OPERATOR_FOR__R_ASSERT_CMP
...
#endif // #ifndef VOSTOK_DEBUG_MACROS_INLINE_H_INCLUDED