...
#ifndef VOSTOK_DEBUG_STATIC_CAST_CHECKED_H_INCLUDED
#define VOSTOK_DEBUG_STATIC_CAST_CHECKED_H_INCLUDED
...
inline destination_type static_cast_checked	( source_type const& source )
{
	...
	::vostok::debug::detail::static_cast_checked::helper<
		source_type const &,
		destination_type,
...
#endif // #ifndef VOSTOK_DEBUG_STATIC_CAST_CHECKED_H_INCLUDED