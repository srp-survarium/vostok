...
#ifndef VOSTOK_VECTORA_H_INCLUDED
#define VOSTOK_VECTORA_H_INCLUDED
...
#define USER_ALLOCATOR	*( ( ( ::vostok::vectora_allocator< typename qualified_type<T>::result >& )( *this ) ).m_allocator )
...
public:
	...
	typedef ::vostok::memory::base_allocator*	allocator_type;
	...
	inline vectora_allocator	( vostok::memory::base_allocator* const allocator) :
		m_allocator		( allocator )
	{
	}

	inline vectora_allocator	( vostok::memory::base_allocator& allocator) :
		m_allocator		( &allocator )
	{
	}
...
public:
	...
	inline				vectora		( vostok::memory::base_allocator* allocator );
...
#include <vostok/vectora_inline.h>

#endif // #ifndef VOSTOK_VECTORA_H_INCLUDED