...
weapon_core_idle_state::weapon_core_idle_state( weapon_core& weapon, resources::resource_ptr<resources::managed_resource,resources::managed_intrusive_base> const* animations, u32 animations_count )
{
	// LOCALS
	// u32 							animation_index
	// u32 							view<1>
...
weapon_core_idle_state* weapon_core_state_cook_template<survarium::weapon_core_idle_state>::new_object(
	mutable_buffer						buffer,
