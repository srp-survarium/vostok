...
// STATE[INLINED]: no standalone symbol in base - LTCG inlined this private helper whole-program
// into its only callers (tick). Not separately scorable. Body matched as a callee of tick.
...
// STATE[INLINED]: no standalone symbol in base - LTCG inlined this private helper whole-program
// into its callers (tick/fire). Not separately scorable.
