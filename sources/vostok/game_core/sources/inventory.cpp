...
void inventory::set_holder( inventory_holder* holder )
{
	...
	// CALL SITE INFO
	// <0x70048f> -> void <unknown>()
	// ******

	// FUNCTION BODY
	// <0x700420>|0x000|+0x009:'27'	{
...
void inventory::set_item( profile_slot_enum slot, resources::resource_ptr<inventory_item,resources::unmanaged_intrusive_base> const& item )
{
	// CALL SITE INFO
...
{
	// LOCALS
	// resources::resource_ptr<inventory_item,resources::unmanaged_intrusive_base> iitem
	// inventory_item::action_behaviour_type const& behaviour_type<1>
	// ******

	// CALL SITE INFO
	// <0x700bf8> -> void <unknown>(bool)
	// <0x700c36> -> bool <unknown>(resources::resource_ptr<inventory_item,resources::unmanaged_intrusive_base> const&)
	// ******

	return false;
	// FUNCTION BODY
	// <0x700b80>|0x000|+0x009:'56'	{
...
void inventory::setup_demo_profile( )
{
	// LOCALS
	// u32 							i<1>
	// resources::resource_ptr<weapon_core,resources::unmanaged_intrusive_base> weapon<2>
...
void inventory::setup_from_profile( player_profile& profile, items_dictionary const& dict )
{
	...
	// u32 							i<1>
	// profile_slot_enum 			current<2>
	// resources::resource_ptr<weapon_core,resources::unmanaged_intrusive_base> weapon<3>
	// u32 							i<2>
	// profile_slot_enum 			current<3>
	// u32 							amount<4>
	// resources::resource_ptr<inventory_item,resources::unmanaged_intrusive_base>& iitem<4>
...
void inventory::unload_to_profile( player_profile& profile, items_dictionary const& dict )
{
	...
	// profile_slot_enum 			current<2>
	// u32 							i<2>
	// resources::resource_ptr<inventory_item,resources::unmanaged_intrusive_base> ammo<3>
	// profile_slot_enum 			current<3>
	// u32 							i<3>
	// profile_slot_enum 			current<4>
	// resources::resource_ptr<inventory_item,resources::unmanaged_intrusive_base>& iitem<5>
...
void call_item_serialize( inventory_slot const& slot, network_core::udp_match_packet& packet, u32 client_offset )
{
	// LOCALS
...
void call_item_deserialize( inventory_slot& slot, network_core::packet_reader& reader )
{
	// LOCALS
	// profile_slot_enum const* 	ignored_slots_start
	// profile_slot_enum const* 	ignored_slots_end
