...
{
	return static_cast_checked< weapon_core_shotgun_reload_base_substate* >( m_logic->current_state( ) )->weapon_and_hands_expression( buffer, is_third_view, user_state_id, weight_driving_animation );
}
...
void weapon_core_shotgun_reload_state::initialize_logic( weapon_core_shotgun_reload_base_substate* reload_start, weapon_core_shotgun_reload_base_substate* reload_one_round, weapon_core_shotgun_reload_base_substate* reload_finish )
{
	...
	static_cast_checked< weapon_core_shotgun_reload_finish_substate* >( reload_finish )->set_animation_playback_state_ptr( &m_animation_playback_state );

	m_logic->add_state( reload_start );
	m_logic->add_state( reload_one_round );
	m_logic->add_state( reload_finish );

	static_cast_checked< weapon_core_shotgun_reload_finish_substate* >( reload_finish )->set_owner_ready_for_transition( &m_animation_has_been_ended );
