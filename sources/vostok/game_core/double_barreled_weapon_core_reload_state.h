...
#ifndef DOUBLE_BARRELED_WEAPON_CORE_RELOAD_STATE_H_INCLUDED
#define DOUBLE_BARRELED_WEAPON_CORE_RELOAD_STATE_H_INCLUDED
...
public:
	...
	virtual	~double_barreled_weapon_core_reload_state( ) { /* no source */ }
...
private:
	...
	/* 0x0168 */	resources::resource_ptr<resources::managed_resource,resources::managed_intrusive_base>[2][2][2]	m_user_animations;
...
#endif // #ifndef DOUBLE_BARRELED_WEAPON_CORE_RELOAD_STATE_H_INCLUDED
