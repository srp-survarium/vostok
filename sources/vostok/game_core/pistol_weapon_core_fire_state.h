...
//	Created 	: 06.12.2025
////////////////////////////////////////////////////////////////////////////
#ifndef PISTOL_WEAPON_CORE_FIRE_STATE_H_INCLUDED
#define PISTOL_WEAPON_CORE_FIRE_STATE_H_INCLUDED
...
class pistol_weapon_core_fire_state : public weapon_core_fire_state_base {
...
protected:
	static resources::class_id_enum const resource_class = resources::pistol_weapon_fire_state_class;

protected:
	// ctor mangles ??0...@@IAE@... -> protected, non-const
			explicit							pistol_weapon_core_fire_state	(
													weapon_core&							weapon,
...
#endif // #ifndef PISTOL_WEAPON_CORE_FIRE_STATE_H_INCLUDED
