...
protected:
	static resources::class_id_enum const resource_class = resources::double_barreled_weapon_aimed_fire_state_class;
...
#endif // #ifndef DOUBLE_BARRELED_WEAPON_CORE_AIMED_FIRE_STATE_H_INCLUDED
