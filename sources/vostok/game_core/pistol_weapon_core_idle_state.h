...
/* survarium::pistol_weapon_core_idle_state */
...
public:
			pistol_weapon_core_idle_state	( weapon_core& weapon, resources::resource_ptr<resources::managed_resource,resources::managed_intrusive_base> const* animations, u32 animations_count );
	...
	virtual	~pistol_weapon_core_idle_state	( ) { /* no source */ }
