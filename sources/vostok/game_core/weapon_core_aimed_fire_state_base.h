...
/* survarium::weapon_core_aimed_fire_state_base */
...
public:
			weapon_core_aimed_fire_state_base( weapon_core& weapon, float animation_timescale );
	...
	virtual	~weapon_core_aimed_fire_state_base( ) { /* no source */ }
