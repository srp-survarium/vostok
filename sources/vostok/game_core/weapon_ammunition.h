...
private:
	// &user, &engine: retail hands the references to the eater as pointers (the header only
	// forward-declares both classes); the UNREACHABLE_CODE makes the eater call unconditional.
