...
/* survarium::weapon_core_chamber_a_round_state_base */
...
public:
			weapon_core_chamber_a_round_state_base( weapon_core& weapon, float animation_time_scale );
	...
	virtual	~weapon_core_chamber_a_round_state_base( ) { /* no source */ }
