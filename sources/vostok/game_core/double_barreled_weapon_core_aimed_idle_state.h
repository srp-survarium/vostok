...
public:
			double_barreled_weapon_core_aimed_idle_state( weapon_core& weapon, resources::resource_ptr<resources::managed_resource,resources::managed_intrusive_base> const* animations, u32 animations_count );
	...
	virtual	~double_barreled_weapon_core_aimed_idle_state( ) { /* no source */ }
