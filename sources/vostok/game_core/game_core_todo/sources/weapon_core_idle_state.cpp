...
#include "pch.h"
#include "weapon_core_idle_state.h"

namespace survarium {

// STATE[STUB]
// survarium::weapon_core_idle_state::weapon_core_idle_state(survarium::weapon_core&, vostok::resources::resource_ptr<vostok::resources::managed_resource,vostok::resources::managed_intrusive_base> const*, const unsigned int)
weapon_core_idle_state::weapon_core_idle_state( weapon_core& weapon, vostok::resources::resource_ptr<vostok::resources::managed_resource,vostok::resources::managed_intrusive_base> const* animations, u32 animations_count )
{
	// LOCALS
	// u32 							animation_index
	// u32 							view<1>
	...
	// FUNCTION BODY
	// <0x7ad22f>|0x000|0x000:'21'
	// <0x7ad252>|0x023|0x023:'22'
	// <0x7ad259>|0x02a|0x007|[1]:'23'
	// <0x7ad271>|0x042|0x018|[2]:'24'
	// <0x7ad289>|0x05a|0x018:'25'
	// <0x7ad2ba>|0x08b|0x031:'26'
	// <0x7ad2bc>|0x08d|0x002:'27'
	// ******
}
...
vostok::animation::mixing::expression weapon_core_idle_state::weapon_and_hands_expression(
	...
	vostok::animation::mixing::animation_lexeme&	weight_driving_animation) const
{
	...
	// FUNCTION BODY
	// <0x7ad3d1>|0x000|0x000:'32'
	// <0x7ad407>|0x036|0x036:'33'
	// <0x7ad426>|0x055|0x01f:'34'
	// ******
}
...
weapon_lexeme_pair weapon_core_idle_state::get_weapon_lexeme_pair( vostok::mutable_buffer& buffer, bool is_third_view, weapon_user_state_enum user_state_id ) const
{
	// LOCALS
	...
	// FUNCTION BODY
	// <0x7ad339>|0x000|0x000:'39'
	// <0x7ad340>|0x007|0x007:'40'
	// <0x7ad363>|0x02a|0x023:'41'
	// ******
}
