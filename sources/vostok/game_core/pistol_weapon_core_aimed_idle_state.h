...
namespace vostok { void use_game_core_pistol_weapon_core_aimed_idle_state( ); }
...
private:
	// ctor mangles ??0...@@AAE@... -> private, non-const (objdiff pairs by mangled name)
				explicit							pistol_weapon_core_aimed_idle_state	( weapon_core& weapon, resources::managed_resource_ptr const* animations, u32 animations_count );
