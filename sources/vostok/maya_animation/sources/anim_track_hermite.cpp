...
//
//void vostok::maya_animation::engineHermiteCreate (EtCurve *animCurve, float x[4], float y[4]);
//
...
//	ki.x1 = k0.time;
//	ki.coeff = vostok::math::float4(0,0,0,0);
//	if ((k0.outTanX == 0.0) &&	(k0.outTanY == 0.0)) 
//	{
//		ki.coeff[3]  = k0.value;
//		return;
//	}else 
//		if( (k0.outTanX == vostok::math::float_max) &&	(k0.outTanY == vostok::math::float_max) )
//	{
//		ki.coeff[3] = k1.value;
//		return;
//	}
...
//}
//
//void anim_track_hermite::bone_pos( vostok::float4x4	&pose, float time )const
//{
//	vostok::float3 translation = vostok::float3(0,0,0);
//	vostok::float3 rotation = vostok::float3(0,0,0);
//	vostok::float3 scale = vostok::float3(1,1,1);
//
