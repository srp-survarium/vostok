...
**********************************************************************/
{
  ...
  int kmy = vostok::memory::uninitialized_value<int>();			/* An index to the knot-vector.            */
  ...
  int knum = vostok::memory::uninitialized_value<int>();			/* Number of knots less and equal than
