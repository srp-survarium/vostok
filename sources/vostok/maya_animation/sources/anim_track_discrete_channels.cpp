...
using vostok::maya_animation::animation_curve_data_header;
using vostok::maya_animation::anim_track_discrete_channels;
...
void			anim_track_discrete_channels::save( vostok::configs::lua_config_value f )const
{
...
void			anim_track_discrete_channels::load(  vostok::configs::lua_config_value const& f )
{
...
void anim_track_discrete_channels::bone_pos( vostok::float4x4 &, float )
{
