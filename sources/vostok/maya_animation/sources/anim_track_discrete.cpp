...
//#include <vostok/maya_animation/anim_track.h>
//
//using namespace vostok::math;
//
//using vostok::maya_animation::anim_track_discrete;
//using vostok::maya_animation::anim_track;
//using vostok::maya_animation::EtCurve;
//
...
//	if( !vostok::math::valid( interval ) )
//		return;
//	const u32	frame_count		= u32(vostok::math::floor( interval/time_delta ));
...
//		
//		m_scale[i] = ( float3(
//		vostok::math::sqrt( bone_pos.e00 * bone_pos.e00 + bone_pos.e10 * bone_pos.e10 +  bone_pos.e20 * bone_pos.e20 ),
//		vostok::math::sqrt( bone_pos.e01 * bone_pos.e01 + bone_pos.e11 * bone_pos.e11 +  bone_pos.e21 * bone_pos.e21 ),
//		vostok::math::sqrt( bone_pos.e02 * bone_pos.e02 + bone_pos.e12 * bone_pos.e12 +  bone_pos.e22 * bone_pos.e22 )
//		));
//	}
//
//}
//
//void	anim_track_discrete::bone_pos( vostok::float4x4 &pose, float time )
//{
...
//	u32		frame	=	vostok::math::floor( frame_time );
