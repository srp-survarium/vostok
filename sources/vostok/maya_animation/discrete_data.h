...
public:
	virtual	void	save	( vostok::configs::lua_config_value & cfg ) const									= 0;
	virtual	void	load	( vostok::configs::lua_config_value const& cfg, bool bone_names_only = false )	= 0;
	virtual	void	check	( vostok::configs::lua_config_value &discrete_data ) const						= 0;
