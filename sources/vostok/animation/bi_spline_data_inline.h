...
#ifndef VOSTOK_ANIMATION_BI_SPLINE_DATA_INLINE_H_INCLUDED
#define VOSTOK_ANIMATION_BI_SPLINE_DATA_INLINE_H_INCLUDED
...
void	bi_spline_data< Point_type >::save( vostok::configs::lua_config_value config  )const 
{
...
template< typename Point_type >
void	bi_spline_data< Point_type >::load( vostok::configs::binary_config_value const& config  )
{
...
#endif // #ifndef VOSTOK_ANIMATION_BI_SPLINE_DATA_INLINE_H_INCLUDED
