...
////////////////////////////////////////////////////////////////////////////
#ifndef VOSTOK_ANIMATION_POLY_CURVE_INLINE_H_INCLUDED
#define VOSTOK_ANIMATION_POLY_CURVE_INLINE_H_INCLUDED

using vostok::animation::poly_curve_order3_domain;
...
template< class Point_type, u32 Dimension  >
inline void	read( poly_curve_order3_domain< Point_type, Dimension > &d, vostok::configs::lua_config_value const& config )
{
...
template< class Point_type, u32 Dimension  >
inline void	write( const poly_curve_order3_domain< Point_type, Dimension > &d, vostok::configs::lua_config_value const& config )
{
	for ( u8 i = 0; i < coeff_number; ++i )
		write( d[i] )
}
...
#endif // #ifndef VOSTOK_ANIMATION_POLY_CURVE_INLINE_H_INCLUDED