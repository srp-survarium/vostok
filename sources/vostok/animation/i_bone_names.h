...
public:
	virtual void			read			( vostok::configs::lua_config_value const &cfg )		=0;
	virtual void			write			( vostok::configs::lua_config_value		&cfg )const	=0;

protected:
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR( i_bone_names )
};
