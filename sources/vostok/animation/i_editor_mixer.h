...
#ifndef VOSTOK_ANIMATION_I_EDITOR_MIXER_H_INCLUDED
#define VOSTOK_ANIMATION_I_EDITOR_MIXER_H_INCLUDED
...
namespace animation {
	...
	protected:
		VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR( i_editor_mixer );
	}; // class i_editor_mixer
} // namespace animation
} // namespace vostok

#endif // #ifndef VOSTOK_ANIMATION_I_EDITOR_MIXER_H_INCLUDED