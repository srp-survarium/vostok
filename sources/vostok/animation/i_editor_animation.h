...
#ifndef VOSTOK_ANIMATION_I_EDITOR_ANIMATION_H_INCLUDED
#define VOSTOK_ANIMATION_I_EDITOR_ANIMATION_H_INCLUDED
...
struct VOSTOK_NOVTABLE i_editor_animation {
...
protected:
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR( i_editor_animation )
}; // class i_editor_animation

} // namespace animation
} // namespace vostok

#endif // #ifndef VOSTOK_ANIMATION_I_EDITOR_ANIMATION_H_INCLUDED