...
using vostok::animation::mixing::n_ary_tree_transition_constructor;
...
using vostok::animation::mixing::n_ary_tree_transition_node;
...
using vostok::animation::mixing::interpolation_direction;
...
n_ary_tree n_ary_tree_transition_constructor::computed_tree( vostok::memory::base_allocator* const allocator )
{
	return
		n_ary_tree(
			m_result,
