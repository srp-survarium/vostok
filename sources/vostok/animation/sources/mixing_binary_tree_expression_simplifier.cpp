...
using vostok::animation::mixing::binary_tree_expression_simplifier;
...
binary_tree_expression_simplifier::binary_tree_expression_simplifier( binary_tree_base_node& expression_node, vostok::mutable_buffer& buffer ) :
	m_buffer						( buffer ),
	m_result						( 0 ),
	m_result_weight					( 0 )
{
...
{
	VOSTOK_UNREFERENCED_PARAMETERS	( &operation, &left_simplifier, &right_simplifier );
}
...
{
	VOSTOK_UNREFERENCED_PARAMETER		( operation );
