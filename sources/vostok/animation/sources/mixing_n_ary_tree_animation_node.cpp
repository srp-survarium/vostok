...
void n_ary_tree_animation_node::visit	( n_ary_tree_double_dispatcher& dispatcher, n_ary_tree_time_scale_node& node )
{
	dispatcher.dispatch	( node, *this );
}
...
void n_ary_tree_animation_node::visit	( n_ary_tree_double_dispatcher& dispatcher, n_ary_tree_weight_transition_node& node )
{
	dispatcher.dispatch	( node, *this );
}

void n_ary_tree_animation_node::visit	( n_ary_tree_double_dispatcher& dispatcher, n_ary_tree_time_scale_transition_node& node )
{
	dispatcher.dispatch	( node, *this );
}