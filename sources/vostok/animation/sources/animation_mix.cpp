...
namespace animation {
	...
	{
		vostok::animation::bone const	&b = m_skeleton.get_bone( bone_idx );
		const bone_index_type bone_count = m_skeleton.bone_count( );

		vostok::animation::bone const** stack = (vostok::animation::bone const**) ALLOCA( bone_count * sizeof( vostok::animation::bone* ) );
		stack[0] = &b;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	static void	render_skeleton(	vostok::render::debug::renderer			&renderer,
