...
private:
			void	on_test_config_loaded	( vostok::resources::queries_result& resource );
			void	check_loaded			(  );
			//void	add_animation			( configs::lua_config_value const &cfg, vostok::resources::query_result_for_user const &anim );
private:
