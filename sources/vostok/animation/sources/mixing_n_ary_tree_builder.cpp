...
using vostok::animation::mixing::n_ary_tree_builder;
...
n_ary_tree n_ary_tree_builder::constructed_n_ary_tree	( vostok::mutable_buffer& buffer, vostok::memory::base_allocator* allocator, u32 const current_time_in_ms )
{
	ASSERT						( m_animations_root );
	ASSERT						( m_buffer_size );
