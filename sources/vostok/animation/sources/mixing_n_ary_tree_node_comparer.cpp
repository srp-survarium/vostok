...
{
	animation_comparer_less_predicate predicate;
...
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= less;
}

void n_ary_tree_node_comparer::dispatch	( n_ary_tree_animation_node& left,		n_ary_tree_time_scale_transition_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= less;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_animation_node& left,		n_ary_tree_time_scale_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= less;
...
////////////////////////////////////////////////////////////////////////////
// n_ary_tree_time_scale_node
////////////////////////////////////////////////////////////////////////////
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_time_scale_node& left,		n_ary_tree_animation_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= more;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_time_scale_node& left,		n_ary_tree_time_scale_node& right )
{
	result				= left < right ? less : right < left ? more : equal;
}

void n_ary_tree_node_comparer::dispatch	( n_ary_tree_time_scale_node& left,		n_ary_tree_time_scale_transition_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	right.to().accept			( *this, left );
	result						= revert( result );
}

void n_ary_tree_node_comparer::dispatch	( n_ary_tree_time_scale_node& left,		n_ary_tree_weight_transition_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= less;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_time_scale_node& left,		n_ary_tree_weight_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= less;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_time_scale_node& left,		n_ary_tree_addition_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= less;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_time_scale_node& left,		n_ary_tree_subtraction_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= less;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_time_scale_node& left,		n_ary_tree_multiplication_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= less;
...
////////////////////////////////////////////////////////////////////////////
// n_ary_tree_time_scale_transition_node
////////////////////////////////////////////////////////////////////////////
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_time_scale_transition_node& left,		n_ary_tree_animation_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= more;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_time_scale_transition_node& left,		n_ary_tree_time_scale_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_time_scale_transition_node& left,		n_ary_tree_time_scale_transition_node& right )
{
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_time_scale_transition_node& left,		n_ary_tree_weight_transition_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= less;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_time_scale_transition_node& left,		n_ary_tree_weight_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= less;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_time_scale_transition_node& left,		n_ary_tree_addition_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= less;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_time_scale_transition_node& left,		n_ary_tree_subtraction_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= less;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_time_scale_transition_node& left,		n_ary_tree_multiplication_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= less;
...
////////////////////////////////////////////////////////////////////////////
// n_ary_tree_weight_transition_node
////////////////////////////////////////////////////////////////////////////
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_weight_transition_node& left,		n_ary_tree_animation_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= more;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_weight_transition_node& left,		n_ary_tree_time_scale_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= more;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_weight_transition_node& left,		n_ary_tree_time_scale_transition_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= more;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_weight_transition_node& left,		n_ary_tree_weight_transition_node& right )
{
	left.from().accept	( *this, right.from() );
	if ( result != equal )
		return;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_weight_transition_node& left,		n_ary_tree_weight_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	left.to().accept	( *this, right );
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_weight_transition_node& left,		n_ary_tree_addition_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= less;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_weight_transition_node& left,		n_ary_tree_subtraction_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= less;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_weight_transition_node& left,		n_ary_tree_multiplication_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= less;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_weight_node& left,			n_ary_tree_time_scale_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= more;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_weight_node& left,			n_ary_tree_time_scale_transition_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= more;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_weight_node& left,			n_ary_tree_weight_transition_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	right.to().accept	( *this, left );
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_addition_node& left,		n_ary_tree_time_scale_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= more;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_addition_node& left,		n_ary_tree_time_scale_transition_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= more;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_addition_node& left,		n_ary_tree_weight_transition_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= more;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_subtraction_node& left,		n_ary_tree_time_scale_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= more;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_subtraction_node& left,		n_ary_tree_time_scale_transition_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= more;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_subtraction_node& left,		n_ary_tree_weight_transition_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= more;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_multiplication_node& left,	n_ary_tree_time_scale_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= more;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_multiplication_node& left,	n_ary_tree_time_scale_transition_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= more;
...
void n_ary_tree_node_comparer::dispatch	( n_ary_tree_multiplication_node& left,	n_ary_tree_weight_transition_node& right )
{
	VOSTOK_UNREFERENCED_PARAMETER	( left );
	VOSTOK_UNREFERENCED_PARAMETER	( right );
	result				= more;
