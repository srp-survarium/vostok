...
void n_ary_tree_time_scale_transition_node::accept	( n_ary_tree_double_dispatcher& dispatcher, n_ary_tree_base_node& node )
{
	node.visit			( dispatcher, *this );
}

void n_ary_tree_time_scale_transition_node::visit	( n_ary_tree_double_dispatcher& dispatcher, n_ary_tree_animation_node& node )
{
	dispatcher.dispatch	( node, *this );
}

void n_ary_tree_time_scale_transition_node::visit	( n_ary_tree_double_dispatcher& dispatcher, n_ary_tree_weight_node& node )
{
	dispatcher.dispatch	( node, *this );
}

void n_ary_tree_time_scale_transition_node::visit	( n_ary_tree_double_dispatcher& dispatcher, n_ary_tree_time_scale_node& node )
{
	dispatcher.dispatch	( node, *this );
}

void n_ary_tree_time_scale_transition_node::visit	( n_ary_tree_double_dispatcher& dispatcher, n_ary_tree_addition_node& node )
{
	dispatcher.dispatch	( node, *this );
}

void n_ary_tree_time_scale_transition_node::visit	( n_ary_tree_double_dispatcher& dispatcher, n_ary_tree_subtraction_node& node )
{
	dispatcher.dispatch	( node, *this );
}

void n_ary_tree_time_scale_transition_node::visit	( n_ary_tree_double_dispatcher& dispatcher, n_ary_tree_multiplication_node& node )
{
	dispatcher.dispatch	( node, *this );
}

void n_ary_tree_time_scale_transition_node::visit	( n_ary_tree_double_dispatcher& dispatcher, n_ary_tree_weight_transition_node& node )
{
	dispatcher.dispatch	( node, *this );
}
