...
template< class Point_type, u32 Dimension  >
void	read( poly_curve_order3_domain< Point_type, Dimension > &d, vostok::configs::lua_config_value const& config )
{
...
template< class Point_type, u32 Dimension  >
void	write( const poly_curve_order3_domain< Point_type, Dimension > &d, vostok::configs::lua_config_value const& config )
{
	for( u8 i = 0; i < coeff_number; ++i )
		write( d[i] )
}
...
template< class DomainType >
inline void	poly_curve< DomainType >::write( vostok::configs::lua_config_value const& config )const
{
