...
animation_interval const* binary_tree_animation_node::clone			(
		...
		vostok::animation::mixing::animation_interval const* const animation_intervals_begin,
		vostok::animation::mixing::animation_interval const* const animation_intervals_end
	)
{
