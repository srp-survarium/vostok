...
using vostok::animation::fermi_dirac_interpolator;
...
using vostok::animation::skeleton;
	...
	u32 vostok::animation::mixing::g_binary_tree_node_constructors	= 0;
	u32 vostok::animation::mixing::g_binary_tree_node_destructors		= 0;
	u32 vostok::animation::mixing::g_n_ary_tree_node_constructors		= 0;
	u32 vostok::animation::mixing::g_n_ary_tree_node_destructors		= 0;
...
void vostok::animation::test_mixer		( skeleton_animation const& skeleton_animation, skeleton const& skeleton )
{
