...
struct test_mixing_animation_group
{
	...
	void	on_animations_loaded	( vostok::resources::queries_result& resource );
	void	add_animation			( configs::lua_config_value const &cfg, vostok::resources::query_result_for_user const &anim, skeleton const*	skeleton );
