...
#if VOSTOK_DEBUG_ANIMATIONS_COUNT
	++m_animations_count;
#endif // #if VOSTOK_DEBUG_ANIMATIONS_COUNT
...
u32 vostok::animation::mixing::computed_operands_count	(
		n_ary_tree_animation_node& from,
		n_ary_tree_animation_node& to,
		bool const skip_time_scale_node
	)
...
#else // #if VOSTOK_DEBUG_ANIMATIONS_COUNT
