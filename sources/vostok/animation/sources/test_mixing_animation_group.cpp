...
using vostok::animation::test_mixing_animation_group;

using vostok::configs::lua_config_ptr;
using vostok::configs::lua_config_value;
using vostok::configs::lua_config_iterator;

void	test_mixing_animation_group::add_animation( lua_config_value const &config, vostok::resources::query_result_for_user const &anim, vostok::animation::skeleton const*	skel )
{
...
test_mixing_animation_group::test_mixing_animation_group( lua_config_value cfg, vostok::animation::skeleton const*	skel    ): 
m_max_mix_time( 0 ),
...
void	test_mixing_animation_group::on_animations_loaded	( vostok::resources::queries_result& resource )
{
...
void	test_mixing_animation_group::set_target( vostok::animation::mixer& mxr, const u32 time )const
{
