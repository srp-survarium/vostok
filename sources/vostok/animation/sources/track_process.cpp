...
#include <vostok/maya_animation/raw_bi_spline.h>
#include <vostok/maya_animation/i_anim_track_discrete_channels.h>


using vostok::animation::animation_world;
using vostok::animation::poly_curve_order3_domain;
using vostok::animation::poly_curve;
using vostok::animation::bi_spline_data;
using namespace vostok::math;



typedef float2 spline_point_type;
typedef vostok::animation::vector< std::pair<float, spline_point_type> >	spline_type;
...
void	animation_world::render_curves( vostok::render::debug::renderer& renderer ) const	
{
