...
#include <vostok/animation/i_bone_names.h>
...
public:	
	virtual void			read			( vostok::configs::lua_config_value const &cfg );
	virtual void			write			( vostok::configs::lua_config_value		&cfg )const;
