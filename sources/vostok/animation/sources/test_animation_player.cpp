...
using vostok::animation::test_animation_player;
	...
	m_loaded				( false )
{
	resources::request	resources[]	= {
		{ "resources/animations/test_animation_player.lua",	vostok::resources::config_lua_class },
...
void test_animation_player::on_test_config_loaded	( vostok::resources::queries_result& resource )
{
...
void test_animation_player::render	( vostok::render::debug::renderer& renderer )
{
	if ( !m_mixer )
		return;
