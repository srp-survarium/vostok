...
class VOSTOK_ANIMATION_API linear_interpolator : public base_interpolator {
public:
	...
	virtual	linear_interpolator* clone		( mixing::n_ary_tree_transition_tree_constructor& constructor ) const;
