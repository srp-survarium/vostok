...
class VOSTOK_ANIMATION_API binary_tree_subtraction_node : public binary_tree_binary_operation_node {
public:
...
STATIC_SIZE_ASSERT(binary_tree_subtraction_node, 0x1C);

} // namespace mixing
} // namespace animation
} // namespace vostok

#include <vostok/animation/mixing_binary_tree_subtraction_node_inline.h>
