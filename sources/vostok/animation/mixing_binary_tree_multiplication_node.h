...
class VOSTOK_ANIMATION_API binary_tree_multiplication_node : public binary_tree_binary_operation_node {
public:
...
#include <vostok/animation/mixing_binary_tree_multiplication_node_inline.h>
