...
#include "vostok/engine/engine.h"
...
// #include <vostok/tasks_allocator.h>
// #include <vostok/tasks_type.h>
// #include <vostok/tasks_task.h>
// #include <vostok/tasks_thread_pool.h>

#include <vostok/tasks_aware_functions.h>
...
void   application::initialize (u32 , pstr const* )
{
	...
	vostok::core::initialize						("test", core::perform_debug_initialization);
}
...
{
	VOSTOK_UNREFERENCED_PARAMETER					( in_container );
...
{
	VOSTOK_UNREFERENCED_PARAMETER					( task_thread_count );
