...
#ifndef VOSTOK_MATH_UINT2_INLINE_H_INCLUDED
#define VOSTOK_MATH_UINT2_INLINE_H_INCLUDED
...
{
#ifdef DEBUG
	x	=	vostok::memory::uninitialized_value <int> ();
	y	=	vostok::memory::uninitialized_value <int> ();
#endif // #ifdef DEBUG
}
...
#endif // #ifndef VOSTOK_MATH_UINT2_INLINE_H_INCLUDED