...
#ifndef VOSTOK_FS_FILE_TYPE_H_INCLUDED
#define VOSTOK_FS_FILE_TYPE_H_INCLUDED
...
#else // #if VOSTOK_FS_NEW_WATCHER_ENABLED

#pragma message(VOSTOK_TODO("Lain 2 Lain: revisit correctness of this casts"))
	...
	inline void		set_owned_by_pointer	(file_type * file, bool value) { VOSTOK_UNREFERENCED_PARAMETERS(file, value); }
...
#endif // #ifndef VOSTOK_FS_FILE_TYPE_H_INCLUDED