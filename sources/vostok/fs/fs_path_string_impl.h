...
template class VOSTOK_FS_API fixed_string<max_path_length>;
#endif // #if !VOSTOK_STATIC_LIBRARIES

class VOSTOK_FS_API path_string_impl
{
public:
...
public:
	...
	void						verify_self	()	{ m_string.verify_self(); verify(m_string.get_buffer()); }
...
#include "fs_path_string_impl_inline.h"
