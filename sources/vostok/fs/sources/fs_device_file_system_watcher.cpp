...
#include "pch.h"
#include <vostok/fs/fs_device_file_system_watcher.h>
...
#include <vostok/fs/fs_watcher_utils.h>
...
size_t   device_file_system_watcher_proxy::write (file_type * file, pcvoid data, size_t size) const
{
