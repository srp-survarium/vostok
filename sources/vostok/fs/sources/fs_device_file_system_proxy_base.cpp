...
#include "pch.h"
#include <vostok/fs/fs_device_file_system_proxy_base.h>
...
size_t	 device_file_system_proxy_base::write (file_type * file, pcvoid data, size_t size) const
{
	return	m_device_file_system->write(file_type_to_handle(file), data, size);
}

size_t   device_file_system_proxy_base::read (file_type * file, pvoid data, size_t size) const
{
...
void   device_file_system_proxy_base::setvbuf (file_type * stream, char * buffer, int mode, size_t size) const
{ 
