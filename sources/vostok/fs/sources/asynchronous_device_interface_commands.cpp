													   ...
													   threading::event *					event_to_fire_after_execute)
{
	...
	open_file_device_query * new_query	=	VOSTOK_NEW_WITH_CHECK_IMPL(allocator, new_query, open_file_device_query)
...
bool   asynchronous_device_interface::query_close_file (file_type * file, memory::base_allocator * allocator, threading::event * event_to_fire_after_execute)
{
	...
	close_file_device_query * new_query	=	VOSTOK_NEW_WITH_CHECK_IMPL(allocator, new_query, close_file_device_query)(file, allocator, m_device, event_to_fire_after_execute);
	if ( !new_query )
		return								false;
														...
														memory::base_allocator * allocator)
{
	...
	write_file_device_query * new_query	=	VOSTOK_NEW_WITH_CHECK_IMPL(allocator, new_query, write_file_device_query)(args, allocator, m_device);
	if ( !new_query )
		return								false;
	push_query								(new_query);
	return									true;
													   ...
													   memory::base_allocator * const allocator)
{
	...
	read_file_device_query * new_query	=	VOSTOK_NEW_WITH_CHECK_IMPL(allocator, new_query, read_file_device_query)(args, allocator, m_device);
	if ( !new_query )
		return								false;
																...
																threading::event *	event_to_fire_after_execute)
{
	...
	query_physical_path_device_query * new_query	=	VOSTOK_NEW_WITH_CHECK_IMPL(allocator, new_query, query_physical_path_device_query)
 															  ...
 															  memory::base_allocator *	allocator)
{
	...
	custom_operation_query * new_query	=	VOSTOK_NEW_WITH_CHECK_IMPL(allocator, new_query, custom_operation_query)
