...
class application : public vostok::core::engine {
public:
			void	initialize		( ){};
			void	execute			( ){};
			void	finalize		( ){};
...
private:
#if(0)
	vostok::animation::animation_data*			m_data[num_data];
	vostok::animation::animation_data_discret*	m_data_discret[num_data];
	vostok::animation::animation_data_hermite*	m_data_hermite[num_data];
	vostok::animation::test_skeleton*				m_skel;
	vostok::animation::t_animation_data<vostok::animation::anim_track_discrete_channels> m_data_discret_channels;
#endif
	u32											m_exit_code;
}; // class application
