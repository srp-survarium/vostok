...
#ifndef VOSTOK_UNCONSTRUCTED_STATIC_H_INCLUDED
#define VOSTOK_UNCONSTRUCTED_STATIC_H_INCLUDED
...
public:
	...
	{ 
		...
		return					::vostok::pointer_cast<Class*>(m_static_memory);
	}
...
private:
	char VOSTOK_DEFAULT_ALIGN		m_static_memory[ sizeof(Class) ];
	Class &						m_variable;
...
#define VOSTOK_CONSTRUCT_REFERENCE(uninitialized_ref, Class) \
	uninitialized_ref + new ( uninitialized_ref.construction_memory() ) Class

#define VOSTOK_CONSTRUCT_REFERENCE_MT_SAFE(uninitialized_ref, Class)						\
...
#define VOSTOK_CONSTRUCT_REFERENCE_BY_PREDICATE_MT_SAFE(uninitialized_ref, construction_predicate)	\
	( uninitialized_ref.initialized() || !uninitialized_ref.should_initialize() )	?				\
		NULL : uninitialized_ref + construction_predicate(uninitialized_ref.construction_memory())

#define VOSTOK_DESTROY_REFERENCE(uninitialized_ref)			\
	uninitialized_ref.destroy();

#endif // #ifndef VOSTOK_UNCONSTRUCTED_STATIC_H_INCLUDED