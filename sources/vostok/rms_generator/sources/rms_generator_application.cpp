...
#include "vostok/sound/sources/sound_spl_cook.h"

using namespace vostok;

static vostok::command_line::key				s_input_filename	("input_file_name",		"i", "RMS Generator", "set input file name");

namespace rms_generator
{

	vostok::memory::doug_lea_allocator_type	g_rms_generator_allocator;
	static vostok::core::simple_engine		s_core_engine;
	...
	void application::initialize	( u32 argc, pstr const* const argv )
	{
		...
		vostok::core::initialize				( "../../resources/sources/", "rms_generator", core::perform_debug_initialization );
	}
	...
	void   application::execute		()
	{
		...
		//}
		//char buffer[256];
		//vostok::buffer_string input_file_name(&buffer[0], array_size(buffer));
