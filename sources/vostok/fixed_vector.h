...
#ifndef VOSTOK_FIXED_VECTOR_H_INCLUDED
#define VOSTOK_FIXED_VECTOR_H_INCLUDED
...
private:
	...
	template < typename T, int max_count >
	inline	void		swap			( vostok::fixed_vector< T, max_count >& left, vostok::fixed_vector< T, max_count >& right);

#include <vostok/fixed_vector_inline.h>

#endif // #ifndef VOSTOK_FIXED_VECTOR_H_INCLUDED
