...
#ifndef VOSTOK_SOUND_SOUND_INSTANCE_PROXY_H_INCLUDED
#define VOSTOK_SOUND_SOUND_INSTANCE_PROXY_H_INCLUDED
...
template class VOSTOK_SOUND_API intrusive_ptr	<	sound_instance_proxy,
...
class VOSTOK_SOUND_API sound_instance_proxy : public resources::positional_unmanaged_resource,
											private noncopyable
{
public:
...
public:
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR( sound_instance_proxy )
protected:
...
#endif // #ifndef VOSTOK_SOUND_SOUND_INSTANCE_PROXY_H_INCLUDED
