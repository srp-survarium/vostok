...
#ifndef VOSTOK_SOUND_SOUND_EMITTER_H_INCLUDED
#define VOSTOK_SOUND_SOUND_EMITTER_H_INCLUDED
...
protected:
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR	( sound_emitter );
protected:
...
#endif // #ifndef VOSTOK_SOUND_SOUND_EMITTER_H_INCLUDED
