...
void check_logging()
{
	...
	{
//		vostok::core::debug::on_thread_spawn		( );
		vostok::logging::on_thread_spawn			( );
...
{
	check_logging();
	VOSTOK_UNREFERENCED_PARAMETERS( BytesRequired );
...
{
	check_logging();
	g_sound_world->add_xaudio_callback_command( MT_NEW(callback_command)(&::vostok::memory::g_mt_allocator, callback_command::ev_stream_end, this, NULL));
...
{
	check_logging();
	VOSTOK_UNREFERENCED_PARAMETERS( pBufferContext );
...
{
	check_logging();
	g_sound_world->add_xaudio_callback_command( MT_NEW(callback_command)(&::vostok::memory::g_mt_allocator, callback_command::ev_buffer_end, this, pBufferContext));
...
{
	check_logging();
	g_sound_world->add_xaudio_callback_command( MT_NEW(callback_command)(&::vostok::memory::g_mt_allocator, callback_command::ev_buffer_error, this, pBufferContext));
