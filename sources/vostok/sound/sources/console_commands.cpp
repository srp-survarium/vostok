...
console_commands::console_commands		( sound_world const& world ) :
	...
	m_sound_world						( world )
{
	static vostok::console_commands::cc_float	s_time_factor	( "sound_time_factor", m_time_factor, 0.0f, 2.0f, false, vostok::console_commands::command_type_engine_internal );
	s_time_factor.subscribe_on_change						( boost::bind( &console_commands::on_time_factor_changed, this ) );

	static vostok::console_commands::cc_bool s_stream_writing	( "sound_stream_writing", m_is_debug_stream_writing_enabled, false, vostok::console_commands::command_type_engine_internal );
	s_stream_writing.subscribe_on_change					( boost::bind( &console_commands::on_stream_writing_changed, this ) );

	static vostok::console_commands::cc_delegate s_dump		( "sound_dump_stream_writing", boost::bind( &console_commands::on_dump_stream_writing, this ), false );

	static vostok::console_commands::cc_u32 s_debug_draw_mode	( "sound_debug_draw_mode", m_debug_draw_mode, 0, 2, false, vostok::console_commands::command_type_engine_internal );
	s_debug_draw_mode.subscribe_on_change					( boost::bind( &console_commands::on_debug_draw_mode_changed, this ) );

	static vostok::console_commands::cc_u32 s_proxy_stats		( "sound_show_proxy_stats", m_proxy_stats, 0, (u32)-1, false, vostok::console_commands::command_type_engine_internal );
...
{
#pragma message( VOSTOK_TODO("dimetcm 2 dimetcm: use thread local storage this") )
