...
public:
	...
	virtual encoded_sound_child_ptr const&	dbg_get_encoded_sound( u32 quality )  const { VOSTOK_UNREFERENCED_PARAMETER(quality); return m_collection[0].first->get_sound_propagator_emitter( )->get_quality_for_resource( ); }
