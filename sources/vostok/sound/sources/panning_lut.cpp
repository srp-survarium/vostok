...
panning_lut::panning_lut	( u8 const channels_num )
{
	speakers	speaker_to_channel	[speakers_count];
	float		speaker_angle		[speakers_count];
    ...
    {
	   /* clear all values */
		u32 offset = speakers_count * pos;
        for( u32 i = 0; i < speakers_count; i++ )
