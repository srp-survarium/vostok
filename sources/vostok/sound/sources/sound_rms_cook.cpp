...
#define VOSTOK_RMS_SAMPLE_RATE	50

static vostok::command_line::key s_discr_frequency (
	"rms_discreteness",
	"rms_discr",
	"sound rms",
	"set discretization frequency(floats per second). Default " VOSTOK_MAKE_STRING( VOSTOK_RMS_SAMPLE_RATE ) "."
);

enum
{
	rms_discreteness_default_value = VOSTOK_RMS_SAMPLE_RATE,
};

#undef VOSTOK_RMS_SAMPLE_RATE
