...
#ifndef VOSTOK_SOUND_ENCODED_SOUND_INTERFACE_H_INCLUDED
...
class VOSTOK_SOUND_API encoded_sound_interface :
...
public:
	...
	virtual	u32				decompress					(	pbyte dest,
															...
															u32 bytes_needed ) = 0;
protected:
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR				( encoded_sound_interface );
protected:
	u64					m_length_in_pcm;
...
#endif // #ifndef VOSTOK_SOUND_ENCODED_SOUND_INTERFACE_H_INCLUDED