...
class VOSTOK_PHYSICS_API bt_rigid_body
{
...
struct VOSTOK_PHYSICS_API bt_rigid_body_construction_info
{
		float			m_mass;
...
VOSTOK_PHYSICS_API bt_rigid_body* create_rigid_body	( bt_rigid_body_construction_info const& construction_info );
VOSTOK_PHYSICS_API void			destroy_rigid_body	( bt_rigid_body* body );
