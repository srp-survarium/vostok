...
class VOSTOK_PHYSICS_API bt_character_controller
{
public:
...
VOSTOK_PHYSICS_API bt_character_controller* create_character_controller( memory::base_allocator& allocator, physics::world* w );
