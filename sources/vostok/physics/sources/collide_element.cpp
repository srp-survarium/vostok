...
void	collide_element::generate_contacts( vostok::collision::on_contact& c, const vostok::collision::geometry_instance& gi  )const
{
	VOSTOK_UNREFERENCED_PARAMETERS			( &c, &gi );
