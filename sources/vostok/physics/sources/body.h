...
////////////////////////////////////////////////////////////////////////////
#ifndef VOSTOK_PHYSICS_BODY_H_INCLUDED
#define VOSTOK_PHYSICS_BODY_H_INCLUDED
...
public:
	virtual	void				set_mass				( float density, const vostok::collision::geometry_instance &og,  vostok::math::float4x4 const &pose_in_body )	=0;
