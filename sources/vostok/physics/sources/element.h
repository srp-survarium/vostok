...
////////////////////////////////////////////////////////////////////////////
#ifndef VOSTOK_PHYSICS_ELEMENT_H_INCLUDED
#define VOSTOK_PHYSICS_ELEMENT_H_INCLUDED
...
public:
			element( body &b, vostok::collision::geometry_instance &cf  );
...
private:
	...
	virtual	bool		collide			( island& i, const vostok::collision::geometry_instance &og, bool reverted_order )const;
