...
////////////////////////////////////////////////////////////////////////////
#ifndef VOSTOK_PHYSICS_BODY_ODE_H_INCLUDED
#define VOSTOK_PHYSICS_BODY_ODE_H_INCLUDED
#include "body.h"
...
private:
	virtual		void				set_mass				( float density, const vostok::collision::geometry_instance &og,  float4x4 const &pose_in_body );
...
private:
	...
	virtual		void				render					( vostok::render::scene_ptr const& scene, render::debug::renderer& renderer ) const;
