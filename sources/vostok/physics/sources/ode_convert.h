...
////////////////////////////////////////////////////////////////////////////
#ifndef VOSTOK_PHYSICS_ODE_CONVERT_H_INCLUDED
#define VOSTOK_PHYSICS_ODE_CONVERT_H_INCLUDED

#include "ode_include.h"

//convert ode position and rotation to vostok matrix return	&out_m
...
inline vostok::math::float3	&cast_xr( float *v )
{
	return *((vostok::math::float3*)v);
}

inline const vostok::math::float3	&cast_xr( const float *v )
{
	return *((vostok::math::float3*)v);
}

inline const vostok::math::float3 &d_position( dxBody const* b )
{
