...
{
	VOSTOK_UNREFERENCED_PARAMETERS(j, time_delta);
...
void joint_base_impl::render		( const dxJoint *j, render::scene_ptr const& scene, vostok::render::debug::renderer& renderer ) const
{
	VOSTOK_UNREFERENCED_PARAMETER(j);
