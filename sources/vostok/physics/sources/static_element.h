...
////////////////////////////////////////////////////////////////////////////
#ifndef VOSTOK_PHYSICS_STATIC_ELEMENT_H_INCLUDED
#define VOSTOK_PHYSICS_STATIC_ELEMENT_H_INCLUDED
...
private:
	...
	virtual	bool	collide			( island& i, const vostok::collision::geometry_instance& og, body& body )const;
	virtual void	on_step_start	( island& , float  ){  ASSERT( false, "statics does not steps" ); };

private:
	virtual	bool	collide			( island& i, const vostok::collision::geometry_instance &gi, bool reverted_order )const;
...
public:
	static_element		( vostok::collision::geometry_instance& cf ):	collide_element( cf )		{;}
