...
public:
	virtual	void			set_update_object	( vostok::physics::update_object_interface *object );
...
private:
	virtual void		deactivate			( vostok::physics::world& w );
...
private:
	...
	vostok::physics::update_object_interface*	m_update_object;
