...
static inline bool create_contact( island& i, const vostok::collision::contact_info &c, body& body, bool reverted )
{
...
static inline bool create_contact( island& i, const vostok::collision::contact_info &c, body& body_0, body& body_1, bool reverted )
{
	contact_joint_info jc = { c, i.integration_step() };
	//contact contact( jc );
...
void on_two_body_contact::operator () ( const vostok::collision::contact_info& c ) 
{
...
void on_one_body_contact::operator () ( const vostok::collision::contact_info& c )
{
