...
//	Description : contact
////////////////////////////////////////////////////////////////////////////
#ifndef VOSTOK_PHYSICS_CONTACT_H_INCLUDED
#define VOSTOK_PHYSICS_CONTACT_H_INCLUDED
...
public:
	virtual	void	render		( vostok::render::scene_ptr const& scene, vostok::render::debug::renderer& renderer ) const; //{joint_base_impl::render( &m_contact, renderer );}

private:
	virtual	void				set_anchor  ( const float3	&anchor )	{ VOSTOK_UNREFERENCED_PARAMETER(anchor); UNREACHABLE_CODE(); }
	virtual	void				get_anchor  ( float3	&anchor )const	{ VOSTOK_UNREFERENCED_PARAMETER(anchor); UNREACHABLE_CODE(); }
