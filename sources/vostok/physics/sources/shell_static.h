...
////////////////////////////////////////////////////////////////////////////
#ifndef VOSTOK_PHYSICS_SHELL_STATIC_H_INCLUDED
#define VOSTOK_PHYSICS_SHELL_STATIC_H_INCLUDED
#include "space_object.h"
#include <vostok/physics/shell.h>
...
public:
	...
	virtual	void			set_update_object	( vostok::physics::update_object_interface * ){	ASSERT( false, "static shell: nothing to update" ); }
	virtual void			move				( vostok::math::float3 const & ){ NODEFAULT(); }
public:
	inline	shell_element&	get_element		( )	{ return m_element; }

private:
	virtual void			deactivate			( vostok::physics::world& ){};
