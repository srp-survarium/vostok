...
namespace dialog_editor {
	...
	public ref class command_add_links : public vostok::editor_base::command
	{
	...
	public ref class command_remove_links : public vostok::editor_base::command
	{
		typedef System::Collections::Generic::List<dialog_graph_link^ > links;
		typedef System::Collections::Generic::List<u32 > nodes_ids_type;
		typedef System::Collections::Generic::Dictionary<u32, nodes_ids_type^> links_ids_type;
	...
	public ref class command_set_actions_and_preconditions : public vostok::editor_base::command
	{
	public:
	...
	public ref class command_change_links_connection_point : public vostok::editor_base::command
	{
		typedef System::Collections::Generic::List<vostok::editor::controls::hypergraph::link^ > links;
	...
	public:
						command_change_links_connection_point	(dialog_hypergraph^ h, links^ lnks, vostok::editor::controls::hypergraph::node^ n, bool dest);
