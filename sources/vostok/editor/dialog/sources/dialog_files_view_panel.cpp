...
:vostok::editor::controls::file_view_panel_base(de->multidocument_base),
m_dialog_editor(de)
{
...
void dialog_files_view_panel::on_node_key_down(System::Object^ sender, System::Windows::Forms::KeyEventArgs^ e)
{
	...
	{
		remove_node(sender, gcnew vostok::editor::tree_view_event_args());
	}
	...
	{
		if(e->Control)
			add_new_folder(sender, gcnew vostok::editor::tree_view_event_args());
		else
			add_new_file(sender, gcnew vostok::editor::tree_view_event_args());
	}
}
...
void dialog_files_view_panel::add_new_folder(System::Object^ , vostok::editor::tree_view_event_args^ )
{
...
void dialog_files_view_panel::add_new_file(System::Object^ , vostok::editor::tree_view_event_args^ )
{
	if(safe_cast<tree_node^>(m_raw_files_tree_view->SelectedNode)->m_node_type!=tree_node_type::single_item)
	{
		m_is_creating_node = true;
...
void dialog_files_view_panel::remove_node(System::Object^ , vostok::editor::tree_view_event_args^ )
{
	m_copied_node = nullptr;
...
void dialog_files_view_panel::copy(bool del)
{
	...
	m_copied_node = safe_cast<vostok::editor::controls::tree_node^>(m_raw_files_tree_view->SelectedNode);
...
void dialog_files_view_panel::paste()
{
	if(m_copied_node!=nullptr)
	{
		bool res = copy_node_impl(m_copied_node, safe_cast<vostok::editor::controls::tree_node^>(m_raw_files_tree_view->SelectedNode), 
									m_copied_node->ForeColor==System::Drawing::Color::LightGray);
...
bool dialog_files_view_panel::copy_node_impl(vostok::editor::controls::tree_node^ s, vostok::editor::controls::tree_node^ d, bool del_old)
{
