...
dialog_node_hypergraph::dialog_node_hypergraph(vostok::dialog_editor::dialog_graph_node_dialog^ owner)
:m_owner(owner)
{
}
...
{
	for each(vostok::editor::controls::hypergraph::node^ n in nds)
		append_node(n);
...
vostok::dialog_editor::dialog_document^ dialog_node_hypergraph::get_owner()
{
