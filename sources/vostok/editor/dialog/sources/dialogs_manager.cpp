...
static vostok::uninitialized_reference<dialogs_manager> g_dialogs_manager;
void vostok::dialog_editor::dialog_manager::create_dialogs_manager()
{
	VOSTOK_CONSTRUCT_REFERENCE(g_dialogs_manager, dialogs_manager)();
}

void vostok::dialog_editor::dialog_manager::destroy_dialogs_manager()
{
	VOSTOK_DESTROY_REFERENCE(g_dialogs_manager);
}

dialogs_manager* vostok::dialog_editor::dialog_manager::get_dialogs_manager()
{
...
void dialogs_manager::request_editor_dialog(pcstr name, vostok::dialog_editor::dialog_manager_callback const& callback)
{	
	...
	else
	{
		...
		vostok::resources::query_resource(
			dialog_path.c_str(),
			vostok::resources::dialog_resources_class,
...
void dialogs_manager::on_editor_dialog_loaded(vostok::resources::queries_result& result)
{
...
void dialogs_manager::request_game_dialog(pcstr name, vostok::dialog_editor::game_dialog_callback const& callback)
{	
	...
	else
	{
		...
		vostok::resources::query_resource(
			name,
			vostok::resources::game_dialog_class,
...
void dialogs_manager::on_game_dialog_loaded(vostok::resources::queries_result& result)
{
	R_ASSERT(result[0].is_successful());
