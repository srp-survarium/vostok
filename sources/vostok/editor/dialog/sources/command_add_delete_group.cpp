...
using vostok::dialog_editor::command_add_group;
using vostok::dialog_editor::command_remove_group;
...
command_add_group::command_add_group(dialog_hypergraph^ h, 
									 ...
									 vostok::editor::controls::hypergraph::node^ n)
:m_hypergraph(h),
m_offset(offset)
{
...
void command_add_group::init_node(vostok::dialog_editor::dialog_graph_node_base^ n, System::Drawing::Point pnt)
{
