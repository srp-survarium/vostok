...
using vostok::dialog_editor::dialog_cooker;
...
void dialog_cooker::translate_query(vostok::resources::query_result_for_cook& parent)
{
...
void dialog_cooker::on_loaded(queries_result& result)
{
	...
	{
		vostok::configs::lua_config_ptr cfg = configs::create_lua_config(parent->get_requested_path());
		dialog* dlg = NEW(dialog)(cfg->get_root());
