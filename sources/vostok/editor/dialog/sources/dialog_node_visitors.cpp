...
#pragma unmanaged
using vostok::dialog_editor::dialog_node_gatherer_visitor;
using vostok::dialog_editor::dialog_node_giver_visitor;
...
{
	VOSTOK_UNREFERENCED_PARAMETER(n);
}
...
void dialog_node_gatherer_visitor::request_subresources(vostok::resources::query_result_for_cook* parent)
{
...
void dialog_node_gatherer_visitor::on_loaded(vostok::resources::queries_result& data)
{
