...
dialog_graph_link^ dialog_document::create_connection(vostok::editor::controls::hypergraph::node^ source, vostok::editor::controls::hypergraph::node^ destination, bool create_dialog_link)
{
...
void dialog_document::add_connection(vostok::editor::controls::hypergraph::node^ source, vostok::editor::controls::hypergraph::node^ destination)
{
...
void dialog_document::generate_node_string_table_id(vostok::dialog_editor::dialog_graph_node_phrase^ n)
{
...
void dialog_document::on_template_loaded(vostok::resources::queries_result& data)
{
...
void dialog_document::on_dialog_loaded(vostok::resources::queries_result& data)
{
	R_ASSERT(data.is_successful());	
