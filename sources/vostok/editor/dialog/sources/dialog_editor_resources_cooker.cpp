...
#pragma unmanaged
using vostok::dialog_editor::dialog_editor_resources_cooker;
using namespace vostok::resources;
using vostok::dialog_editor::dialog_resources;
...
void dialog_editor_resources_cooker::translate_query(vostok::resources::query_result_for_cook& parent)
{
