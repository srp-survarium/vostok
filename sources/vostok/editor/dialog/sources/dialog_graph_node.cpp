...
using vostok::dialog_editor::dialog_graph_node;
using vostok::dialog_editor::dialog_node_base;
using vostok::dialog_editor::dialog_phrase;
...
using vostok::dialog_editor::dialog_node_hypergraph;
...
void dialog_graph_node::initialize()
{
	...
	m_hypergraph->move_mode = vostok::editor::controls::hypergraph::nodes_movability::fixed;
...
void dialog_graph_node::on_added(vostok::editor::controls::hypergraph::hypergraph_control^ parent)
{
...
void dialog_graph_node::on_removed(vostok::editor::controls::hypergraph::hypergraph_control^ parent)
{
...
void dialog_graph_node::assign_style(vostok::editor::controls::hypergraph::node_style^ style)
{
	m_style	= style;
...
void dialog_graph_node::on_dialog_loaded(vostok::resources::queries_result& result)
{
