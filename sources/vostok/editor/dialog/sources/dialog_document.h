...
namespace dialog_editor {
	...
	ref class vostok::editor::controls::scalable_scroll_bar;
	ref class vostok::editor::controls::scroller_event_args;
	class dialog;
	class dialog_node_base;
	struct dialog_graph_node_layout;

	delegate void editor_dialog_delegate(vostok::dialog_editor::dialog_resources_ptr dr);
	struct dialog_resources_delegate
	{
		...
		void callback(vostok::dialog_editor::dialog_resources_ptr dr)
		{
	...
	public ref class dialog_document : public vostok::editor::controls::document_base
	{
	...
	public:
		...
		dialog_graph_link^	create_connection			(vostok::editor::controls::hypergraph::node^ source, vostok::editor::controls::hypergraph::node^ destination, bool create_dialog_link);
	...
	private:
		...
		void				on_template_loaded			(vostok::resources::queries_result& data);
		void				on_dialog_loaded			(vostok::resources::queries_result& data);
