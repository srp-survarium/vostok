...
namespace dialog_editor {
	...
	public ref class command_add_group : public vostok::editor_base::command
	{
		typedef System::Collections::Generic::List<vostok::editor::controls::hypergraph::node^ > nodes;
	...
	public:
						command_add_group	(dialog_hypergraph^ h, pcstr config_string, System::Drawing::Point offset, vostok::editor::controls::hypergraph::node^ n);
	...
	public ref class command_remove_group : public vostok::editor_base::command
	{
		typedef System::Collections::Generic::List<vostok::editor::controls::hypergraph::node^ > nodes;
