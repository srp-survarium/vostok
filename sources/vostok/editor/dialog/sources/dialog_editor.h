...
namespace dialog_editor {
	...
	public ref class dialog_editor_impl : public vostok::editor_base::tool_window
	{
		typedef map<pstr, vostok::dialog_editor::string_tables::string_table_id_options*, vostok::dialog_editor::string_tables::strings_compare_predicate> references_table;
		typedef Collections::Generic::Dictionary<String^, u32> last_translators_ids_type;
	public:
												dialog_editor_impl		( System::String^ resources_path, vostok::editor_base::tool_window_holder^ h);
