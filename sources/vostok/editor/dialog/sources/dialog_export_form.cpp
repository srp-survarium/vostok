...
using vostok::dialog_editor::dialog_export_form;
using vostok::dialog_editor::excel_file;
...
void dialog_export_form::on_export_clicked(System::Object^, System::EventArgs^ )
{
	...
	if(res==::DialogResult::OK)
	{
		for each(System::String^ sel_lang_name in checkedListBox1->CheckedItems)
		{
			...
			vostok::configs::lua_config_value root = cfg->get_root()["translators_id_to_string_table_id"];
