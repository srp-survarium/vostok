...
using vostok::dialog_editor::dialog_precondition_action_editor;
using vostok::dialog_editor::precondition_action_editor_sorter;
using vostok::dialog_editor::dialog_link_ui_type_editor;
...
using vostok::editor::controls::AlphanumComparator;
...
void dialog_precondition_action_editor::make_nodes_from_preconditions(dialog_expression* n, TreeNodeCollection^ root)
{
	...
	if(pr->type!=dialog_link_precondition::e_type::Precondition)
	{
		...
		if(oper)
		{
			vostok::dialog_editor::vector<dialog_expression*>::iterator b = oper->childs()->begin();
...
void	dialog_link_ui_type_editor::run_editor	( vostok::editor::wpf_controls::property_editors::property^ prop )
{
