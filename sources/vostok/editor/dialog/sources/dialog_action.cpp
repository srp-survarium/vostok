...
using vostok::dialog_editor::e_action_functions;
...
void dialog_action::load(vostok::configs::lua_config_value const& cfg)
{
...
void dialog_action::save(vostok::configs::lua_config_value cfg)
{
