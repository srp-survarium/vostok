...
using namespace vostok::dialog_editor;
using vostok::dialog_editor::dialog_document;
using vostok::dialog_editor::dialog_graph_nodes_style_mgr;
using vostok::dialog_editor::dialog_links_manager;
using vostok::dialog_editor::dialog_files_view_panel;
...
using vostok::dialog_editor::drag_drop_create_operation;
using vostok::editor::controls::scalable_scroll_bar;
using vostok::editor::controls::scroller_event_args;

dialog_document::dialog_document(dialog_editor_impl^ ed)
:vostok::editor::controls::document_base(ed->multidocument_base), 
m_owner(ed)
{
	...
	m_hypergraph->on_selection_changed += gcnew vostok::editor::controls::hypergraph::selection_changed(this, &dialog_document::on_hypergraph_selection_changed);
...
void dialog_document::on_resources_loaded(vostok::dialog_editor::dialog_resources_ptr res)
{
...
void dialog_document::load_impl(dialog* d, dialog_graph_node_layout* l)
{
	...
	for(; i!=nodes_vec->end(); ++i)
	{
		...
		if(!n->is_dialog())
		{
			...
			if(vostok::dialog_editor::string_tables::get_string_tables()->get_text_by_id(str.c_str())==NULL)
			{
...
void dialog_document::on_activated(System::Object^ , System::EventArgs^ )
{
	if(this->Visible)
	{
		...
		for each(vostok::editor::controls::hypergraph::node^ n in m_hypergraph->all_nodes())
		{
