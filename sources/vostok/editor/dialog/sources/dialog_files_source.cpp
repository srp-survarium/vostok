...
using vostok::dialog_editor::dialog_files_source;
using System::Windows::Forms::TreeNode;
using System::Reflection::BindingFlags;
using vostok::dialog_editor::dialogs_node_sorter;
...
dialog_files_source::dialog_files_source()
{
	...
	m_watcher_subscriber_id	=	vostok::resources::subscribe_watcher("resources/dialogs/configs", boost::bind(&file_watcher_delegate::callback, m_callback, _1));
}
...
void dialog_files_source::fs_callback(vostok::vfs::vfs_notification const & info)
{
...
void dialog_files_source::on_fs_iterator_ready(vostok::vfs::vfs_locked_iterator const & fs_it)
{
...
void dialog_files_source::process_fs(vostok::vfs::vfs_iterator const & in_it, String^ file_path)
{
