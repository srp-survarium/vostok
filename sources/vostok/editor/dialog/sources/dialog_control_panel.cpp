...
using vostok::dialog_editor::dialog_control_panel;
...
{
	ImageList^ images_list = vostok::editor_base::image_loader::load_images("images70x53", "dialog_editor.resources", 70, safe_cast<int>(images70x53_count), this->GetType()->Assembly);
