...
#pragma unmanaged
using vostok::dialog_editor::string_tables::string_table_id_options;
...
void string_table_id_options::load(vostok::configs::lua_config_value const& cfg)
{
	m_category = (e_string_table_category)(u32)cfg["category"];
	m_references_count = cfg["references_count"];
	vostok::configs::lua_config_iterator it = cfg["batch_file_names"].begin();
...
void string_table_id_options::save(vostok::configs::lua_config_value cfg)
{
