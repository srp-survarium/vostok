...
namespace dialog_editor {
	...
	public ref class dialog_graph_link : public vostok::editor::controls::hypergraph::link
	{
	...
	public:
		...
		void						load	(vostok::configs::lua_config_value const& cfg){m_link->load(cfg);};
		void						save	(vostok::configs::lua_config_value cfg)		{m_link->save(cfg);};
