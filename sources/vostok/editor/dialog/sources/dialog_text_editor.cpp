...
using vostok::dialog_editor::dialog_text_editor;
...
using vostok::dialog_editor::dialog_graph_node_base;
...
void dialog_text_editor::update_selected_node(vostok::dialog_editor::dialog_graph_node_base^ n)
{
	if(n->is_dialog())
	{
