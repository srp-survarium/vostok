...
void dialog_graph_node_base::assign_style(vostok::editor::controls::hypergraph::node_style^ style)
{
	m_style	= style;
...
void dialog_graph_node_base::on_added(vostok::editor::controls::hypergraph::hypergraph_control^ parent)
{
	super::on_added(parent);
	parent->display_rectangle = parent->display_rectangle;
}

void dialog_graph_node_base::on_removed(vostok::editor::controls::hypergraph::hypergraph_control^ parent)
{
