...
namespace dialog_editor {
	...
	public ref class dialog_files_view_panel :  public vostok::editor::controls::file_view_panel_base
	{
		typedef vostok::editor::controls::file_view_panel_base super;
		System::Windows::Forms::ImageList^ tree_view_image_list;
		vostok::editor::controls::tree_node^ m_copied_node;
	...
	public:
		...
		virtual	void	remove_node						(System::Object^ sender, vostok::editor::tree_view_event_args^ e) override;
		virtual	void	copy							(bool del) override;
		virtual	void	paste							() override;

		property vostok::editor::controls::tree_node^ copied_node
		{
				void	set								(vostok::editor::controls::tree_node^ n)	{m_copied_node=n;};
				vostok::editor::controls::tree_node^ 	get	()										{return m_copied_node;};
		};
	...
	protected:
		...
		virtual	void	add_new_folder					(System::Object^ sender, vostok::editor::tree_view_event_args^ e) override;
		virtual	void	add_new_file					(System::Object^ sender, vostok::editor::tree_view_event_args^ e) override;
	...
	private:
				bool	copy_node_impl					(vostok::editor::controls::tree_node^ s, vostok::editor::controls::tree_node^ d, bool del_old);
