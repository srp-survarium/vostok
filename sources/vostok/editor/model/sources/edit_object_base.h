...
ref class edit_object_mesh : public model_editor_object
{
	...
	typedef System::Collections::Generic::List<vostok::editor::wpf_controls::hypergraph::link_id^> links_list;
...
public:
	...
	vostok::editor::wpf_controls::property_container^	get_portals_edit_property_container			( );
	vostok::editor::wpf_controls::property_container^	get_portals_generation_property_container	( );
