...
void bsp_tree_node::generate_portals( portal_blanks_type& blanks, triangle_ids_type& portal_triangles  )
{
	...
	else
	{
		...
		for ( portal_blanks_type::iterator blank_it = m_portal_blanks.begin(); blank_it != blank_end_it; ++blank_it )
		{
			...
			typedef	vostok::ai::navigation::constrained_delaunay_triangulator::indices_type triangulator_indices_type;
			typedef vostok::ai::navigation::delaunay_triangulator delaunay_triangulator;
			...
			vostok::ai::navigation::constrained_delaunay_triangulator( 
				m_mesh.vertices, 
				input_indices, 
				output_indices, 
...
void bsp_tree_node::extract_portal_triangles ( triangulator_indices_type const& indices, edges_type const& sorted_edges, input_indices_type const& indices_from_blank, math::plane const& portal_blank_plane )
{
	...
	vostok::buffer_vector<adjacency_type> adjacencies ( ALLOCA( sizeof( adjacency_type ) * triangle_count ), triangle_count, triangle_count );
