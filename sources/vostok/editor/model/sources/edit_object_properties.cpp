...
typedef vostok::editor::wpf_controls::control_containers::button button;

namespace vostok {
namespace model_editor {

ref class material_instance_ui_type_editor : public vostok::editor::wpf_controls::property_editors::i_external_property_editor
{
...
void material_instance_ui_type_editor::run_editor( property_editors::property^ prop )
{
	...
	if(s->m_base_texture_name && s->m_base_texture_name->Length>0)
		vostok::editor_base::resource_chooser::set_shared_context("diffuse_texture", s->m_base_texture_name);
...
vostok::editor::wpf_controls::property_container^	edit_object_mesh::get_portals_generation_property_container( )
{
	property_container^	result = gcnew property_container;
