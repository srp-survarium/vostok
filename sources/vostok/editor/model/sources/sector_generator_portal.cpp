...
void sector_generator_portal::initialize_outer_edges()
{
	...
	vostok::ai::navigation::fill_coordinate_indices( m_plane.normal, coordinate_indices );
...
//	return true;
//}
//static inline bool false_predicate( vostok::collision::ray_triangle_result const& ) 
//{
//	return false;
//}
void sector_generator_portal::test_if_hanged( triangles_mesh_type const& mesh )
{
	...
	for ( u32 i = 0; i < edges_count; ++i )
	{
		...
		R_ASSERT( success );
		vostok::collision::triangles_type triangles( g_allocator );
	...
	float max_distance ) const
{
	...
	coord_indices_pair coordinate_indices;
	vostok::ai::navigation::fill_coordinate_indices( group_plane.normal, coordinate_indices );
...
{
	using namespace vostok::collision;
	...
	struct triangle_plane_closer_to_point 
		: public std::binary_function<vostok::collision::triangle_result const&, vostok::collision::triangle_result const&, bool>
	{
		triangle_plane_closer_to_point( triangles_mesh_type const& mesh, math::float3 const& point )
		:m_mesh( &mesh ), m_point( point ){}
		bool operator() ( vostok::collision::triangle_result const& left, vostok::collision::triangle_result const& right ) const
		{
