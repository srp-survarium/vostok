...
void sectors_view::in_constructor()
{
	...
	m_property_grid_host = gcnew vostok::editor::wpf_controls::property_grid::host;
...
void sectors_view::set_property_container( vostok::editor::wpf_controls::property_container^ cont )
{
