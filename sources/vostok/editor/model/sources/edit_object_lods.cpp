...
typedef vostok::editor::wpf_controls::hypergraph::properties_node	hypergraph_node;
typedef vostok::editor::wpf_controls::hypergraph::link_id	hypergraph_link;
...
{
	vostok::editor::wpf_controls::hypergraph::hypergraph_control^ hg = m_lod_view_panel->hypergraph_host1->hypergraph;
