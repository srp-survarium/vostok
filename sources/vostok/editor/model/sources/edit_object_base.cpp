...
{
	if(persist_string=="vostok.model_editor.lod_view_panel")
		return m_lod_view_panel;
	else if(persist_string=="vostok.model_editor.property_grid_panel")
		return m_object_surfaces_panel;
	else if(persist_string=="vostok.model_editor.collision_property_grid_panel")
