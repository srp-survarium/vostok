...
using namespace vostok::editor::wpf_controls::control_containers;
...
vostok::editor::wpf_controls::property_container^	edit_object_solid_mesh::get_portals_generation_property_container( )
{
	property_container^	result = gcnew property_container;
...
{
	vostok::render::editor::renderer* r = m_model_editor->editor_renderer();
...
{
	if(persist_string=="vostok.model_editor.collision_property_grid_panel")
		return m_collision_panel;
	else if(persist_string=="vostok.model_editor.object_portals_panel")
		return m_object_portals_panel;
	else if(persist_string=="vostok.model_editor.portal_generation_view")
		return m_portal_generation_view;
	else if(persist_string=="vostok.model_editor.sectors_view")
...
//?		button->IsEnabled = false;
		...
		vostok::editor::wpf_controls::property_container^ sectors_properties = gcnew vostok::editor::wpf_controls::property_container();
