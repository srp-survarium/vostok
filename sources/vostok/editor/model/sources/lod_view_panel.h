...
namespace model_editor {
	...
	{
		typedef vostok::editor::wpf_controls::hypergraph::link_event_args link_event_args;
		typedef vostok::editor::wpf_controls::hypergraph::node_event_args node_event_args;
		typedef vostok::editor::wpf_controls::hypergraph::selection_event_args selection_event_args;
	public:
		lod_view_panel( )
		{
			InitializeComponent();
	...
	public: vostok::editor::wpf_controls::hypergraph::hypergraph_host^  hypergraph_host1;
	protected: 
...
#pragma region Windows Form Designer generated code
		...
		{
			this->hypergraph_host1 = (gcnew vostok::editor::wpf_controls::hypergraph::hypergraph_host());
			this->SuspendLayout();
			// 
			// hypergraph_host1
			// 
