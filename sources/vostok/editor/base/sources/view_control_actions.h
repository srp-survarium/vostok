...
public:
				...
				~collision_objects		( );
	u32							count	( );
	const vostok::collision::object*	get		( u32 idx );
	void						add		( vostok::collision::object const* );
	void						clear	( );
private:
	vostok::collision::objects_type*	m_list;
};
...
public:
				...
				~collision_ray_objects		( );
	u32							count	( );
	const vostok::collision::ray_object_result&	get		( u32 idx );
	void						add			( vostok::collision::ray_object_result& o );
	void						clear	( );
private:
	vostok::collision::ray_objects_type*	m_list;
};
...
public:
				...
				~collision_ray_triangles	( );
	u32							count	( );
	const vostok::collision::ray_triangle_result&	get		( u32 idx );
	void						add		( vostok::collision::ray_triangle_result& o );
	void						clear	( );
private:
	vostok::collision::ray_triangles_type*	m_list;
};
