...
public value struct vostokColor
{
	inline vostokColor		( vostok::math::color const& other)				{ r=other.get_R()/255.0f; g=other.get_Gf(); b=other.get_Bf(); a=other.get_Af();}
	inline operator	vostok::math::color	( )									{ return vostok::math::color(r,g,b,a); }
	inline vostok::math::color math_color	( )									{ return vostok::math::color(r,g,b,a); }
...
public delegate vostokColor		color_getter_type					();
public delegate void			color_setter_type					(vostokColor);
