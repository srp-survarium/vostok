...
properties_holder::properties_holder( configs::lua_config_value const& properties_config, System::String^ library_full_path ){
	...
	m_properties_config				= CRT_NEW(vostok::configs::lua_config_value)( properties_config );
	...
	if (prop_type == "string"){
		...
		if ( (*property_descriptor_value).value_exists("special") )
			if (gcnew String((*property_descriptor_value)["special"]) == "collection"){
				...
				descr->dynamic_attributes->add(gcnew vostok::editor::wpf_controls::property_editors::attributes::collection_attribute(gcnew System::Func<Boolean>(collection_holder, &property_value_editable_collection::add_property), 
				...
				descr->dynamic_attributes->add( gcnew editor::wpf_controls::hypergraph::node_property_attribute( false, false ));
				descr->is_read_only = prop_readonly;
				descr->dynamic_attributes->add(gcnew vostok::editor::wpf_controls::property_editors::attributes::special_attribute(gcnew String((*property_descriptor_value)["special"])));
		...
		prop_descriptor->dynamic_attributes->add(gcnew vostok::editor::wpf_controls::property_editors::attributes::combo_box_items_attribute(values));
	...
	String^ property_path)
{
		...
		using vostok::editor::wpf_controls::property_editors::attributes::string_select_file_editor_attribute;
