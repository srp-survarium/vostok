...
{
	m_list	= NEW(vostok::collision::objects_type)(g_allocator);
}
...
const vostok::collision::object* collision_objects::get( u32 idx )
{
	return m_list->at(idx);
}

void collision_objects::add( vostok::collision::object const* o )
{
	m_list->push_back( o );
}
...
{
	m_list	= NEW(vostok::collision::ray_objects_type)(g_allocator);
}
...
const vostok::collision::ray_object_result& collision_ray_objects::get( u32 idx )
{
	return m_list->at(idx);
}
void collision_ray_objects::add( vostok::collision::ray_object_result& o )
{
 m_list->push_back(o);
}
...
{
	m_list	= NEW(vostok::collision::ray_triangles_type)(g_allocator);
}
...
const vostok::collision::ray_triangle_result& collision_ray_triangles::get( u32 idx )
{
	return m_list->at(idx);
}
void collision_ray_triangles::add( vostok::collision::ray_triangle_result& o )
{
	m_list->push_back(o);
}
