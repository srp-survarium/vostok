...
public ref class property_vec3f : public  vostok::editor::wpf_controls::i_property_value{
...
//vec2f
public ref class property_vec2f : public  vostok::editor::wpf_controls::i_property_value {
