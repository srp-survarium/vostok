...
#ifndef OPTIONS_DIALOG_H_INCLUDED
#define OPTIONS_DIALOG_H_INCLUDED
...
namespace editor_base {
	...
	virtual	void	register_page	( System::String^ full_name, editor_base::options_page^ page );
...
#pragma endregion
		...
		private:
			editor_base::options_page^	m_active_page;
			bool						m_initialized;
...
#endif // #ifndef OPTIONS_DIALOG_H_INCLUDED