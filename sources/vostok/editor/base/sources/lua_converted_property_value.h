...
template<typename TConfigType, typename TValueType>
//generic<typename TValueType>
public ref class lua_converted_property_value: vostok::editor::wpf_controls::i_property_value
{
public:
	lua_converted_property_value( const vostok::configs::lua_config_value& config_value, String^ property_path, i_lua_value_converter<TConfigType,TValueType>^ converter  )
	{
