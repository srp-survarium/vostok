...
public:
	...
	virtual		void		start_input				( int mode, int button, vostok::collision::object const* coll, math::float3 const& pos ) override;
	virtual		void		execute_input			( ) override;
	virtual		void		end_input				( ) override;
	virtual		void		draw					( render::scene_view_pointer scene_view, vostok::render::render_output_window_pointer output_window ) override;
