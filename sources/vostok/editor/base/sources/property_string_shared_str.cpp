...
property_string_shared_str::property_string_shared_str			( vostok::shared_string& value) :
	m_value					(&value)
{
}
...
{
	*m_value				= vostok::editor_base::unmanaged_string( safe_cast< System::String^ >( object ) ).c_str( );
}
