...
{
	lock_radio_button->Checked		= vostok::editor::wpf_controls::settings::curve_editor_lock_zoom;
	unlock_radio_button->Checked	= !vostok::editor::wpf_controls::settings::curve_editor_lock_zoom;
	m_hierarchical_item_indent_text_box->Text = vostok::editor::wpf_controls::settings::hierarchical_item_indent.ToString( );
}
...
void		wpf_controls_page::activate_page		( )
{
	if( !m_initialized )
	{
		m_curve_editor_lock_zoom		= vostok::editor::wpf_controls::settings::curve_editor_lock_zoom;
		m_hierarchical_item_indent		= vostok::editor::wpf_controls::settings::hierarchical_item_indent;
...
bool		wpf_controls_page::accept_changes		( )
{
	...
	vostok::editor::wpf_controls::settings::curve_editor_lock_zoom	= m_curve_editor_lock_zoom;
	vostok::editor::wpf_controls::settings::hierarchical_item_indent	= m_hierarchical_item_indent;
