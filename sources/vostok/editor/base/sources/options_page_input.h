...
#ifndef OPTIONS_PAGE_INPUT_H_INCLUDED
#define OPTIONS_PAGE_INPUT_H_INCLUDED
...
namespace editor_base {
	...
	/// </summary>
	public ref class options_page_input : public System::Windows::Forms::UserControl, options_page
	{
	public:

		enum class	enum_action_chage{ add, remove };
		ref class action_item
		{
		public:
			action_item( System::String^ n , System::String^ k )
				:action_name	( n ),
				action_shortcut	( k )
			{}

			System::String^ action_name;
			System::String^ action_shortcut;
		};

		ref class action_item_change : public action_item
		{
			typedef action_item super;
		public:
			action_item_change( enum_action_chage c, System::String^ n , System::String^ k )
				:super			( n, k ),
				m_change_type	( c )
			{ }	

			enum_action_chage m_change_type;
		};


	public:
						options_page_input( input_engine^ input_engine )
	...
	private: System::Windows::Forms::ComboBox^  contexts_combo_box;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->contexts_combo_box = (gcnew System::Windows::Forms::ComboBox());
			...
			this->shortcut_text_box->Location = System::Drawing::Point(146, 194);
			...
			this->shortcut_text_box->Size = System::Drawing::Size(134, 20);
			...
			this->label2->Location = System::Drawing::Point(9, 178);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(81, 13);
			this->label2->TabIndex = 22;
			this->label2->Text = L"Use shortcut in:";
			// 
			// contexts_combo_box
			// 
			this->contexts_combo_box->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			this->contexts_combo_box->FormattingEnabled = true;
			this->contexts_combo_box->Location = System::Drawing::Point(12, 195);
			this->contexts_combo_box->Name = L"contexts_combo_box";
			this->contexts_combo_box->Size = System::Drawing::Size(128, 21);
			this->contexts_combo_box->TabIndex = 23;
			// 
			// default_button
			// 
			this->default_button->Anchor = static_cast<System::Windows::Forms::AnchorStyles>((System::Windows::Forms::AnchorStyles::Top | System::Windows::Forms::AnchorStyles::Right));
			this->default_button->Location = System::Drawing::Point(285, 266);
			this->default_button->Name = L"default_button";
			this->default_button->Size = System::Drawing::Size(75, 23);
			this->default_button->TabIndex = 24;
			this->default_button->Text = L"Defaults";
			this->default_button->UseVisualStyleBackColor = true;
			this->default_button->Click += gcnew System::EventHandler(this, &options_page_input::default_button_Click);
			// 
			// options_page_input
			// 
			...
			this->Controls->Add(this->contexts_combo_box);
...
#pragma endregion
	...
	private:
		...
		typedef System::Collections::Generic::SortedDictionary<System::String^, action_item_list^ > name_to_action_list;
//		typedef System::Collections::Generic::SortedDictionary<System::String^, action_item_list^ >	key_to_action_list;

		name_to_action_list				m_name_to_action;
//.		System::Collections::Generic::SortedDictionary<System::String^, action_item_list^ > m_key_to_action;
	...
	private: 
		...
		System::Void 					update_assigned_to_combo		( );
		...
		System::String^					exctract_first_keys				( System::String^ keys);
		...
		System::Void 					shortcut_text_box_PreviewKeyDown( System::Object^  sender, System::Windows::Forms::PreviewKeyDownEventArgs^  e);
		System::Void 					shortcut_text_box_MouseCaptureChanged( System::Object^  sender, System::EventArgs^  e);
		System::Void 					default_button_Click			( System::Object^  sender, System::EventArgs^  e);
		void							enable_shortcuts_cb				( bool benable );
		void							enable_assigned_cb				( bool benable );
};
...
#endif // #ifndef OPTIONS_PAGE_INPUT_H_INCLUDED