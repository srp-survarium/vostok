...
#include <vostok/editor/controls/property_container_interface.h>
#include <vostok/editor/controls/property_incrementable.h>

ref class property_container;

using vostok::editor::controls::property_grid;
...
using vostok::editor::controls::property_container_interface;
using vostok::editor::controls::property_value;
using vostok::editor::controls::property_mouse_events;
using vostok::editor::controls::property_incrementable;
