...
void	hypergraph_control::h_scroll_change					(Object^ , vostok::editor::controls::scroller_event_args^ e)
{
	m_need_recalc				= false;
...
void	hypergraph_control::v_scroll_change					(Object^ , vostok::editor::controls::scroller_event_args^ e)
{
	m_need_recalc				= false;
...
bool vostok::editor::controls::hypergraph::is_output(connection_type t)
{
	return t==connection_type::inout || t==connection_type::output;
}

bool vostok::editor::controls::hypergraph:: is_input(connection_type t)
{
...
//-------------------------------------------
using vostok::editor::controls::hypergraph::links_manager_default;
