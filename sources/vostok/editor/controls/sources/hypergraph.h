...
#pragma region Windows Form Designer generated code
		...
		{
			this->m_v_scroll = (gcnew vostok::editor::controls::scalable_scroll_bar());
			this->m_h_scroll = (gcnew vostok::editor::controls::scalable_scroll_bar());
			...
			this->m_v_scroll->direction = vostok::editor::controls::scalable_scroll_bar::Direction::Vertical;
			...
			this->m_v_scroll->scroller_moved += gcnew System::EventHandler<vostok::editor::controls::scroller_event_args^ >(this, &hypergraph_control::v_scroll_change);
			...
			this->m_h_scroll->direction = vostok::editor::controls::scalable_scroll_bar::Direction::Horizontal;
			...
			this->m_h_scroll->scroller_moved += gcnew System::EventHandler<vostok::editor::controls::scroller_event_args^ >(this, &hypergraph_control::h_scroll_change);
