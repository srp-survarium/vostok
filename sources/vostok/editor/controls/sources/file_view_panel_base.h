	...
	namespace editor
	{
		...
		private: System::ComponentModel::IContainer^  components;
				...
				void InitializeComponent(void)
				{
					...
					this->m_raw_files_tree_view = (gcnew vostok::editor::controls::tree_view());
					this->SuspendLayout();
					// 
...
//					this->m_raw_files_tree_view->item_create += gcnew System::EventHandler<vostok::editor::tree_view_event_args^ >(this, &file_view_panel_base::add_new_file);
...
//					this->m_raw_files_tree_view->group_create += gcnew System::EventHandler<vostok::editor::tree_view_event_args^ >(this, &file_view_panel_base::add_new_folder);
...
//					this->m_raw_files_tree_view->item_remove += gcnew System::EventHandler<vostok::editor::tree_view_event_args^ >(this, &file_view_panel_base::remove_node);
					// 
					// file_view_panel_base
					// 
		...
		#pragma endregion
			...
			protected: 
				...
				vostok::editor::controls::tree_view^		m_raw_files_tree_view;
