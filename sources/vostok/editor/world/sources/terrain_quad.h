...
#include <vostok/collision/terrain_collision_utils.h>
...
struct terrain_quad: public collision::terrain_quad
{
	...
	void				debug_draw		( render::debug_vertices_type& vertices, vostok::render::debug_indices_type& indices, u32 clr, math::float3 const& camera_pos );
