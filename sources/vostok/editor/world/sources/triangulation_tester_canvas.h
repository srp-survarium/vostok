...
namespace vostok {
	...
	public:
		...
		void	build_lua_config		( vostok::configs::lua_config_ptr& config );
	...
	private:
		...
		void	load_lua_config			( vostok::configs::lua_config_ptr& config );
		void	center_view				( );
...
#pragma endregion
	private:
		typedef vostok::debug::vector< vostok::math::float3 > vertices_type;
		typedef vostok::ai::navigation::delaunay_triangulator::indices_type indices_type;
