...
// 	{
// 		vostok::editor::controls::tree_node^ src_node = safe_cast<vostok::editor::controls::tree_node^>(n);
// 		vostok::editor::controls::tree_node^ dst_node = gcnew vostok::editor::controls::tree_node(src_node->Name);
// 
// 		if(filter)
// 		{
...
void object_in_compound_chooser_form::initialize( project^ p, System::String^ initial, System::String^ f )
{
	...
	vostok::editor::controls::tree_view^ tree	= p->ui()->treeView;
