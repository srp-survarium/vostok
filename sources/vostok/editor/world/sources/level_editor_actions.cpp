...
#include <vostok/editor/base/transform_control_defines.h>
...
typedef vostok::editor_base::action_delegate action_delegate;
typedef vostok::editor_base::execute_delegate_managed execute_delegate_managed;
typedef vostok::editor_base::enabled_delegate_managed enabled_delegate_managed;
typedef vostok::editor_base::checked_delegate_managed checked_delegate_managed;

void level_editor::register_actions( )
{
	vostok::editor_base::gui_binder^ gui_binder = get_gui_binder( );
	...
	gui_binder->register_image( "base", action_name,		vostok::editor_base::tool_select );
	...
	gui_binder->register_image( "base", action_name,	vostok::editor_base::tool_translate );
	...
	gui_binder->register_image( "base", action_name,		vostok::editor_base::tool_scale );
	...
	gui_binder->register_image( "base", action_name,	vostok::editor_base::tool_rotate );
	...
	gui_binder->register_image( "base", action_name,	vostok::editor_base::debug_draw );
	...
	get_input_engine()->register_action( gcnew	vostok::editor_base::mouse_action_editor_control_snap(action_name,  gcnew vostok::editor_base::active_control_getter(this, &level_editor::get_active_control), vostok::editor_base::snap_mode::vertex_snap, view_window()), "V+LButton(View)" );

	action_name = "manipulator face snap mode";
	get_input_engine()->register_action( gcnew	vostok::editor_base::mouse_action_editor_control_snap(action_name, gcnew vostok::editor_base::active_control_getter(this, &level_editor::get_active_control), vostok::editor_base::snap_mode::face_snap, view_window()), "C+LButton(View)" );

	action_name = "manipulator step mode";
	get_input_engine()->register_action			( gcnew vostok::editor_base::mouse_action_editor_control_snap(action_name,  gcnew vostok::editor_base::active_control_getter(this, &level_editor::get_active_control), vostok::editor_base::snap_mode::step_snap, view_window()), "X+LButton(View)" );
	...
	action_name = "touch";
	get_input_engine()->register_action( gcnew	vostok::editor_base::mouse_action_touch_object(action_name, view_window()),						"LButton(View)" );
	...
	gui_binder->register_image( "base", action_name,	vostok::editor_base::pin );
	ide()->add_action_button_item( gui_binder, action_name, "ToolToolStrip", 4);

	action_name		= "edit object pivot";
	a				=  gcnew action_delegate(action_name, gcnew  execute_delegate_managed(&vostok::editor_base::transform_control_object::switch_edit_pivot_mode) );
	a->set_checked	(gcnew checked_delegate_managed(&vostok::editor_base::transform_control_object::is_edit_pivot_mode));
	...
	//gui_binder->register_image( "base", action_name, vostok::editor_base::node_group );
	...
	gui_binder->register_image		( "base", action_name,	vostok::editor_base::show_render_statistics );
	ide()->add_action_button_item	( gui_binder, action_name, "RenderOptionsStrip", 3);

	action_name		= "discrete modify +X axis";
	action_control_step_modify^	act	= gcnew action_control_step_modify( action_name, this, vostok::editor_base::enum_transform_axis_x, 1.0f );
	get_input_engine()->register_action( act ,"Z+Right(View)");

	action_name		= "discrete modify -X axis";
	act				= gcnew action_control_step_modify( action_name, this, vostok::editor_base::enum_transform_axis_x, -1.0f );
	get_input_engine()->register_action( act ,"Z+Left(View)");

	action_name		= "discrete modify +Y axis";
	act				= gcnew action_control_step_modify( action_name, this, vostok::editor_base::enum_transform_axis_y, 1.0f );
	...
	act				= gcnew action_control_step_modify( action_name, this, vostok::editor_base::enum_transform_axis_z, 1.0f );
...
{
	VOSTOK_UNREFERENCED_PARAMETER	( sender );
...
void level_editor::view_panel_drag_drop( System::Object^ sender, System::Windows::Forms::DragEventArgs^ e )
{
	...
	bool bpick = view_window()->ray_query(	vostok::editor_base::collision_object_type_dynamic, 
															origin, 
															direction, 
															&picked_collision, 
															&picked_position );
	...
	if( !bpick )
		bpick = vostok::editor_base::transform_control_base::plane_ray_intersect(float3( 0, 0, 0 ),	
															float3( 0, 1, 0 ),
															origin,						
															direction,
															picked_position);
