...
public ref class property_property_container : public vostok::editor::controls::property_value {
public:
							property_property_container	(vostok::editor::property_holder_ptr object);
...
private:
	vostok::editor::property_holder_ptr*		m_object;
