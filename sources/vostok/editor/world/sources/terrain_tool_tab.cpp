...
using vostok::editor_base::activate_control_event;
using vostok::editor_base::deactivate_control_event;
using vostok::editor_base::property_changed;
...
void terrain_tool_tab::in_constructor()
{
	...
	form									= gcnew vostok::editor::terrain_painter_control_tab(m_tool);
...
//.	active_control_property_grid->SelectedObject = c;
	vostok::editor::wpf_controls::property_container^ container = gcnew vostok::editor::wpf_controls::property_container;
	vostok::editor_base::object_properties::initialize_property_container( c, container );
...
void terrain_tool_tab::button2_Click(System::Object^, System::EventArgs^)
{
	...
	vostok::geometry_utils::geometry_collector		collector(debug::g_mt_allocator);
...
void terrain_tool_tab::button5_Click( System::Object^ , System::EventArgs^)
{
	...
	vostok::ai::navigation::graph_generator* graph_generator = m_tool->get_level_editor()->get_editor_world().get_ai_navigation_world().get_graph_generator();
	...
	//vostok::ai::navigation::graph_generator::cuboid_type cuboid;
