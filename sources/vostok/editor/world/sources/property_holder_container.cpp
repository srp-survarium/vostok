...
using vostok::editor::wpf_controls::special_attribute;

vostok::editor::property_value* property_holder::add_property_holder				(
...
vostok::editor::property_value* property_holder::add_special_property_holder				(
	System::String^ identifier,
	System::String^ category,
	System::String^ description,
	vostok::editor::property_holder_ptr value,
	...
	)
{
	...
	attribute_array[0] = gcnew vostok::editor::wpf_controls::special_attribute(holder_type);
