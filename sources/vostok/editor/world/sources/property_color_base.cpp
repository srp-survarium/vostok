...
{
	VOSTOK_UNREFERENCED_PARAMETER		( notify_parent );
...
void property_color_base::on_double_click	(vostok::editor::controls::property_grid^ property_grid)
{
	VOSTOK_UNREFERENCED_PARAMETER		( property_grid );
#if 0
