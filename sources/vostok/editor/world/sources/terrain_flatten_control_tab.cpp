...
using vostok::editor::terrain_flatten_control_tab;
using vostok::editor::terrain_modifier_flatten;
...
void terrain_flatten_control_tab::on_control_activated(vostok::editor::editor_control_base^ c)
{
...
void terrain_flatten_control_tab::on_control_deactivated(vostok::editor::editor_control_base^ c)
{
	Hide						();
	VOSTOK_UNREFERENCED_PARAMETER	(c);
}
