...
{
	VOSTOK_UNREFERENCED_PARAMETER( selected );
}
...
void volumetric_sound::load_props ( configs::lua_config_value const& config_value )
{
	...
	if ( selected_collision_geometry != "")
		owner_tool( )->get_level_editor( )->get_project( )->query_project_item( selected_collision_geometry, gcnew vostok::editor::queried_object_loaded( this, &volumetric_sound::collision_geometry_loaded ) );
