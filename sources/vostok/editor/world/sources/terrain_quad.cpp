...
void terrain_quad::export_lines(vostok::vectora<u16>& dest_indices, u32& idx)
{
...
void terrain_quad::export_tris(vostok::vectora<u16>& dest_indices, u32& idx, bool clockwise)
{
	if(clockwise)
	{
	// CW
...
void terrain_quad::export_tris(vostok::vectora<u32>& dest_indices, u32& idx, bool clockwise)
{
	if(clockwise)
	{
	// CW
