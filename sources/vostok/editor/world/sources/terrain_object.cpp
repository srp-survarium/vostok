...
void terrain_node::query_vertices( )
{
	...
	if(	m_vertices.m_ext_file )
	{
		...
		bool res =   vostok::resources::convert_physical_to_virtual_path (&resource_path, actual_file_name, resources::sources_mount );
...
void terrain_node::on_render_model_ready( resources::queries_result& data )
{
	...
	VOSTOK_DELETE_IMPL					(debug::g_mt_allocator, pdata);
