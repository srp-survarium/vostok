...
using vostok::editor::transform_control_translation;
...
using vostok::collision::space_partitioning_tree;
...
transform_control_translation::transform_control_translation( vostok::editor::level_editor^ le ):
super						( le ),
...
void transform_control_translation::initialize		( )
{
	...
	vostok::non_null<collision::geometry>::ptr tmp_geom = collision::create_triangle_mesh_geometry( g_allocator, (float3*)&vertices[0], vertices.size(), &collision_indices[0], collision_indices.size() );
...
{
	VOSTOK_UNREFERENCED_PARAMETER	( transform );
...
void transform_control_translation::draw					( vostok::math::float4x4 const& view_matrix )
{
...
void transform_control_translation::draw_impl				( vostok::math::float4x4 const& view_matrix, bool transparent_mode )
{
...
void transform_control_translation::draw_last_position			( vostok::math::float4x4 const& view_matrix, bool transparent_mode )
{
	vostok::render::editor::renderer& rend = m_level_editor->get_editor_renderer();
