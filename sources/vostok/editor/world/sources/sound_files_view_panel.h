	...
	namespace editor
	{
		...
		#pragma region Windows Form Designer generated code
			...
			void InitializeComponent(void)
			{
				...
				this->m_sound_files_tree_view = (gcnew vostok::editor::controls::tree_view());
				...
				this->m_property_grid = (gcnew vostok::editor::controls::property_grid());
		...
		private:
			...
			vostok::editor::controls::tree_view^		m_sound_files_tree_view;
			System::Windows::Forms::Panel^			m_tree_view_panel;
			vostok::editor::controls::property_grid^	m_property_grid;
