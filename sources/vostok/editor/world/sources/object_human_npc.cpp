...
/*
void model_name_ui_type_editor::run_editor( vostok::editor::wpf_controls::property_editors::property^ prop )
{
...
void animation_name_ui_type_editor::run_editor( vostok::editor::wpf_controls::property_editors::property^ prop )
{
	wpf_controls::property_container^ container = safe_cast< wpf_controls::property_container^ >( prop->property_owners[0] );
	object_human_npc^ npc			= safe_cast< object_human_npc^ >( container->owner );
