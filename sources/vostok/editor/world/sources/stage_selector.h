...
#ifndef STAGE_SELECTOR_H_INCLUDED
#define STAGE_SELECTOR_H_INCLUDED
...
namespace vostok
{
	namespace editor
	{
		typedef System::Collections::Generic::ICollection<System::String^> IStringCollection;
	
		public ref class stage_selector : public System::Windows::Forms::Form
		{
		...
		private:
			...
			/// </summary>
		private: vostok::editor::controls::tree_view^		m_tree_view;
		...
		#pragma region Windows Form Designer generated code
			...
			void InitializeComponent()
			{
				...
				this->m_tree_view = (gcnew vostok::editor::controls::tree_view());
				...
				this->m_cancel_button->Click += gcnew System::EventHandler(this, &stage_selector::m_cancel_button_Click);
				// 
				// ok_button
				// 
				...
				this->ok_button->Click += gcnew System::EventHandler(this, &stage_selector::ok_button_Click);
				// 
				// effect_selector
				// 
				...
				this->Load += gcnew System::EventHandler(this, &stage_selector::effect_selector_Load);
...
#endif // #ifndef STAGE_SELECTOR_H_INCLUDED