...
tool_compound::tool_compound(vostok::editor::level_editor^ le)
:super(le, "compound")
{
...
vostok::editor::tool_tab^ tool_compound::ui()
{
	return m_tool_tab;
}
...
object_base^ tool_compound::load_object(vostok::configs::lua_config_value const& t)
{
	VOSTOK_UNREFERENCED_PARAMETER	( t );
...
void tool_compound::get_objects_list(vostok::editor::names_list list, vostok::editor::enum_list_mode mode)
{
	VOSTOK_UNREFERENCED_PARAMETERS	( list, mode );
}
...
void tool_compound::on_make_new_library_object()
{
	...
	m_object_tab->set_compound_object	(o, vostok::editor::mode_new);
...
void tool_compound::on_edit_library_object(System::String^ name)
{
	...
	m_object_tab->set_compound_object	(safe_cast<object_compound^>(o), vostok::editor::mode_edit_library);
	m_object_tab->Show					();
}
