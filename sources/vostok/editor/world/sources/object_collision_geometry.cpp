...
using vostok::editor::wpf_controls::control_containers::control_container;
using vostok::editor::wpf_controls::property_descriptor;
using vostok::editor::wpf_controls::property_container;
using vostok::editor_base::transform_control_translation;
using vostok::editor_base::transform_control_rotation;
...
{
	image_index				= vostok::editor_base::misc_tree_icon;
}
...
{
	VOSTOK_UNREFERENCED_PARAMETER( is_destroy );
...
void object_collision_geometry::render ( )
{
	...
	//octahedron
	{
		...
		vostok::render::debug_vertices_type	draw_vertices( g_allocator );
		draw_vertices.resize				( vcount );
		vostok::render::debug_indices_type	draw_indices( g_allocator );
		...
		{
			vostok::render::vertex_colored& v = draw_vertices[i];
...
{
	if( vostok::editor::wpf_controls::dot_net_helpers::is_type<transform_control_translation^>( transform ) ||
		vostok::editor::wpf_controls::dot_net_helpers::is_type<transform_control_rotation^>( transform ) )
		return true;
