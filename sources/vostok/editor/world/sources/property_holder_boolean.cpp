...
vostok::editor::property_value* property_holder::add_bool		(
...
{
	vostok::editor::bool_holder^ b_holder = gcnew vostok::editor::bool_holder(identifier, config);
	return add_bool		(
						identifier,
						category,
						description,
						default_value,
						gcnew boolean_getter_type(b_holder, &vostok::editor::bool_holder::get),
						gcnew boolean_setter_type(b_holder, &vostok::editor::bool_holder::set),
						read_only,
						notify_parent,
						password,
						refresh_grid);
