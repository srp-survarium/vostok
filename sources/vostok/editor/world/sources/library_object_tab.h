...
#pragma endregion
			protected:
					...
					vostok::editor::controls::property_grid^	m_property_grid_restrictions;
//					vostok::editor_base::property_holder*	m_library_object_ph;
					vostok::editor_base::property_holder_wrapper^	m_library_object_ph;
