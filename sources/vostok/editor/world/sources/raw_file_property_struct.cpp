...
void	raw_file_property_struct::load(Action<raw_file_property_struct^>^ on_load_callback, memory::base_allocator* allocator)
{
	...
	query_result_delegate* rq = VOSTOK_NEW_IMPL(allocator, query_result_delegate)(gcnew query_result_delegate::Delegate(this, &raw_file_property_struct::on_file_property_loaded));
...
void	raw_file_property_struct::on_file_property_loaded		(vostok::resources::queries_result& data)
{
