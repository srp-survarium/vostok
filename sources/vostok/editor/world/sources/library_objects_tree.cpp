...
void library_objects_tree::new_folder_menu_item_Click( System::Object^, System::EventArgs^ )
{
	...
	tree_node^ new_node				= gcnew vostok::editor::controls::tree_node("NewFolder");
	new_node->ImageIndex			= vostok::editor_base::node_group;
	new_node->SelectedImageIndex	= vostok::editor_base::node_group;
