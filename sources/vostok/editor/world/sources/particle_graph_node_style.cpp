...
#include <vostok/editor/base/images/images92x25.h>
#include <vostok/editor/base/images_loading.h>


using vostok::editor::particle_graph_node_style;
using vostok::editor::particle_graph_node_style_mgr;
...
particle_graph_node_style_mgr::particle_graph_node_style_mgr()
{
	...
	m_images  = vostok::editor_base::image_loader::load_images("images92x25", 92, safe_cast<int>(vostok::editor_base::images92x25_count), this->GetType());
	m_mini_images  = vostok::editor_base::image_loader::load_images("images30x25", 30, safe_cast<int>(vostok::editor_base::images30x25_count), this->GetType());
	load_library();
}
particle_graph_node_style_mgr::~particle_graph_node_style_mgr()
{
...
void particle_graph_node_style_mgr::on_library_loaded(vostok::resources::queries_result& data)
{
...
//-------------------------------------------------------------------------------------------
void particle_graph_node_style::load(vostok::configs::lua_config_value const& t)
{
