...
#include <vostok/editor/base/images/images9x9.h>
...
void particle_source_nodes_container::in_constructor(){
	...
	m_enabled					= true;
	m_images					= vostok::editor_base::image_loader::load_images("images9x9", 9, safe_cast<int>(editor_base::images9x9_count), this->GetType());
}
