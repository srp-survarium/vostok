...
typedef vostok::editor::wpf_controls::logic_view::logic_view_host wpf_logic_view;
typedef vostok::editor::wpf_controls::logic_view::event_control wpf_logic_event;
