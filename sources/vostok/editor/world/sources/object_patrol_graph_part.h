...
namespace vostok
{
	...
	namespace editor
	{
		...
		using	vostok::editor_base::type_converters::Float3_to_Vector3D_converter;
		using	vostok::editor::wpf_controls::property_editors::attributes::type_converter_attribute;
