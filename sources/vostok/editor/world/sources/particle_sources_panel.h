...
public:
		...
		particle_graph_node^					add_node_to_container	(particle_source_nodes_container^ container,String^ node_name, String^ node_type, vostok::editor_base::images92x25 image_type_id);
		void									load_tools_panel();
		void									on_toolbar_panel_loaded	(vostok::resources::queries_result& data);
