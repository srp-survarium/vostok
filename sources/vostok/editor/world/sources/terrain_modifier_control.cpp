...
void terrain_control_base::draw( render::scene_view_pointer scene_view, vostok::render::render_output_window_pointer /*output_window*/ )
{
...
terrain_modifier_height::terrain_modifier_height(vostok::editor::level_editor^ le, tool_terrain^ tool)
:super			( le, tool ),
m_smooth_mode	( false )
{
