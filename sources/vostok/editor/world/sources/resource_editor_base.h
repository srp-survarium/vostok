...
using vostok::editor::wpf_controls::property_grid_value_changed_event_args;
	...
	namespace editor
	{
		...
		public:
			virtual Boolean				load_panels						(Form^ parent, Boolean create_base_panel_objects) override;
					void				set_options_and_holder			(const resources::unmanaged_resource_ptr& options_ptr, vostok::editor_base::property_holder* holder);
