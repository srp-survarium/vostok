...
using vostok::editor::controls::document_base;
using Flobbster::Windows::Forms::PropertySpec;

using vostok::editor::wpf_controls::property_grid_value_changed_event_handler;
...
{
	m_images							= vostok::editor_base::image_loader::load_images("images16x16", "vostok.editor.resources", 16, safe_cast<int>(images16x16_count), this->GetType()->Assembly);
...
Boolean						resource_editor_base::load_panels					(Form^ parent, Boolean create_base_panel_objects)
{
	...
	VOSTOK_UNREFERENCED_PARAMETER										(create_base_panel_objects);
...
void						resource_editor_base::set_options_and_holder		(const resources::unmanaged_resource_ptr& options_ptr, vostok::editor_base::property_holder* holder)
{
