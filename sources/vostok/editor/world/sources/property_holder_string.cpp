...
using vostok::editor::wpf_controls::property_grid_editors::string_select_file_editor_attribute;
using vostok::editor::wpf_controls::property_grid_editors::external_editor_attribute;
using vostok::editor::wpf_controls::property_grid_editors::external_editor_event_handler;
using System::String;

vostok::editor::property_value* property_holder::add_string				(
...
{
	vostok::editor::string_holder^ str_holder = gcnew vostok::editor::string_holder(identifier, config);
	return add_string(
				identifier,
			   category,
			   description,
			   default_value,
			   gcnew string_getter_type(str_holder, &vostok::editor::string_holder::get),
				gcnew string_setter_type(str_holder, &vostok::editor::string_holder::set),
				read_only,
				notify_parent,
				password,
				refresh_grid);
	...
	)
{
	...
	spec->Attributes[0] = gcnew vostok::editor::wpf_controls::property_grid_editors::external_editor_attribute(type_of_external_editor);
	...
	)
{
	...
	attribute_array[0] = gcnew vostok::editor::wpf_controls::property_grid_editors::combo_box_items_attribute(values);
	...
	)
{
	...
	if (value_editor == value_editor_tree_view) {
		...
		array<System::Attribute^>^ attribute_array = gcnew array<System::Attribute^>(1);
		attribute_array[0] = gcnew vostok::editor::wpf_controls::property_grid_editors::combo_box_items_attribute(value_count, values);
		spec->Attributes = attribute_array;
	}
	m_container->add_property	(
		spec,
