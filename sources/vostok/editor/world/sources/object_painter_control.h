...
public:
	...
	virtual		void			draw					( render::scene_view_pointer scene, vostok::render::render_output_window_pointer ) override;
...
public:
	...
	float3			get_position			( );
private:
	void			on_model_loaded			(  vostok::resources::queries_result& data );
