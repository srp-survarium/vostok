...
using vostok::editor::controls::tree_view_selection_event_args;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->treeView->selected_items_changed += gcnew System::EventHandler<vostok::editor::controls::tree_view_selection_event_args^ >(this, &project_tab::treeView_selected_items_changed);
