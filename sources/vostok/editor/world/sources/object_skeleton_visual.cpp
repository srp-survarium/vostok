...
object_skeleton_visual::object_skeleton_visual(tool_solid_visual^ t, vostok::render::scene_ptr const& scene ):
	super				( t ), 
...
void object_skeleton_visual::on_resource_loaded( vostok::resources::queries_result& data )
{
...
void object_skeleton_visual::initialize_collision	()
{
	...
	//m_collision.create_from_geometry	( this, (*m_model_instance)->m_collision_geometry.c_ptr(), vostok::editor::collision_type_dynamic );
	//m_collision.insert					( );
