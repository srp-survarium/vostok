...
public ref class command_set_object_transform : public vostok::editor_base::command
{
public:
...
public ref class command_set_object_name : public vostok::editor_base::command
{
public:
