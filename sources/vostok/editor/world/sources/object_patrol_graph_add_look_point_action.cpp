...
object_patrol_graph_add_look_point_action::object_patrol_graph_add_look_point_action ( String^ name, editor_base::scene_view_panel^ view ) :
	super			( name ),
	m_window_view	( view )
{	
}

bool object_patrol_graph_add_look_point_action::do_it ( )
{
