...
void options_page_view_panel::activate_page()
{
	...
	float gs							= vostok::editor_base::transform_control_base::gizmo_size;
...
bool options_page_view_panel::changed( )
{
	...
	float const gs	= vostok::editor_base::transform_control_base::gizmo_size;
...
void options_page_view_panel::cancel_changes()
{
	...
	vostok::editor_base::transform_control_base::gizmo_size = gs;
...
void options_page_view_panel::gizmo_size_track_ValueChanged(System::Object^, System::EventArgs^ )
{
	...
	vostok::editor_base::transform_control_base::gizmo_size = f;
}
