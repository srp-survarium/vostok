...
using vostok::editor::terrain_heightmap_control_tab;

void terrain_heightmap_control_tab::in_constructor()
{
}

void terrain_heightmap_control_tab::on_control_activated(vostok::editor::editor_control_base^ c)
{
...
void terrain_heightmap_control_tab::on_control_deactivated(vostok::editor::editor_control_base^ c)
{
	Hide						();
	VOSTOK_UNREFERENCED_PARAMETER	(c);
}
...
{
	VOSTOK_UNREFERENCED_PARAMETER	( b_sync_ui );
