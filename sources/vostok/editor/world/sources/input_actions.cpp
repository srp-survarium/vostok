...
action_control_step_modify::action_control_step_modify( System::String^ action_name, 
														level_editor^ le, 
														vostok::editor_base::enum_transform_axis axis, 
														float value )
:super			( action_name ),
m_value			( value ),
m_axis			( axis ),
...
bool action_control_step_modify::enabled( )
{
	...
	return (dynamic_cast<vostok::editor_base::transform_control_base^>(m_level_editor->get_active_control()) != nullptr );
}

bool action_control_step_modify::do_it( )
{
	vostok::editor_base::transform_control_base^ control = dynamic_cast<vostok::editor_base::transform_control_base^>(m_level_editor->get_active_control());
