...
namespace vostok
{
	namespace editor 
	{
		...
		private: vostok::editor::wpf_controls::animation_curve_editor^  animation_curve_editor_control1;
		protected: 
		...
		#pragma region Windows Form Designer generated code
			...
			void InitializeComponent( void )
			{
				...
				this->animation_curve_editor_control1 = (gcnew vostok::editor::wpf_controls::animation_curve_editor( ) );
				this->SuspendLayout();
				// 
				// m_host
				// 
