...
{
	System::Object^ o = vostok::editor_base::resource_chooser::get_shared_context("diffuse_texture");
...
{
	return (nullptr!=vostok::editor_base::resource_chooser::get_shared_context("diffuse_texture"));
}
...
{
	VOSTOK_UNREFERENCED_PARAMETERS( filter, read_only );
