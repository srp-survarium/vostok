...
using vostok::editor::wpf_controls::animation_curve_editor;
...
namespace vostok
{
	...
	namespace editor
	{
		...
		typedef vostok::editor::wpf_controls::float_curve_key_type					curve_key_type;
		typedef vostok::editor::wpf_controls::curve_editor::visual_curve				visual_curve;
		typedef vostok::editor::wpf_controls::curve_editor::visual_curve_key			visual_curve_key;
		typedef vostok::editor::wpf_controls::curve_editor::curves_link				curves_link;
		...
		typedef vostok::animation::enum_channel_id									anim_channel;
		...
		private:
			...
			curve_key_type	key_type						( vostok::animation::enum_channel_id channel, u32 idx );
			math::float2	channel_key_tangent				( vostok::animation::enum_channel_id channel, u32 idx, s32 tangent_idx );
