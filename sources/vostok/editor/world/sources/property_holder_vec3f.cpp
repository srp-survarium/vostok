...
vostok::editor::property_value* property_holder::add_vec3f				(
...
{
	vostok::editor::float3_holder^ f3_holder = gcnew vostok::editor::float3_holder(identifier, config); 
	return add_vec3f(
		identifier,
		category,
		description,
		default_value,
		gcnew float3_getter_type(f3_holder, &vostok::editor::float3_holder::get),
		gcnew float3_setter_type(f3_holder, &vostok::editor::float3_holder::set),
		read_only,
		notify_parent,
		password,
		refresh_grid);
...
vostok::editor::property_value* property_holder::add_vec2f				(
		System::String^ identifier,
		System::String^ category,
		System::String^ description,
