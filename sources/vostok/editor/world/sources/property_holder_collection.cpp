...
using vostok::editor::property_holder_collection;

public ref class property_value_managed : public vostok::editor::controls::property_value {
public:
...
public ref class property_object_managed : public vostok::editor::controls::property_value 
{
public:
...
vostok::editor::property_value* property_holder::add_property( System::Object^ object, System::Reflection::PropertyInfo^ property_info)
{
...
vostok::editor::property_value* property_holder::add_collection				(
...
vostok::editor::property_value* property_holder::add_property( 
