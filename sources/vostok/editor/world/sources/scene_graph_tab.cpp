...
using vostok::editor::scene_graph_tab;
using vostok::editor::scene_graph_node;
using vostok::editor::object_base;

using vostok::editor::scene_links_manager;
...
void scene_graph_tab::in_constructor()
{
	...
	m_hypergraph->nodes_style_manager	= gcnew vostok::editor::scene_graph_nodes_style_mgr();
}
...
void  scene_graph_tab::m_hypergraph_on_selection_changed()
{
	...
	m_level_editor->get_command_engine()->run( 
		gcnew vostok::editor::command_select(	m_level_editor->get_project(), 
											list, 
...
//---------------------------------------------------------
scene_links_manager::scene_links_manager(hypergraph_control^ h, vostok::editor::link_storage^ s)
:m_hypergraph(h),
m_link_storage(s)
{
	m_links	= gcnew links;
