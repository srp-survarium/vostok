...
typedef vostok::editor::object_patrol_graph_node				node;
typedef vostok::editor::object_patrol_graph_edge				edge;
typedef vostok::editor::object_patrol_graph_look_point		look_point;

typedef vostok::editor::object_patrol_graph_link_nodes_action				link_nodes_action;
typedef vostok::editor::object_patrol_graph_complete_graph_action			complete_graph_action;
typedef vostok::editor::object_patrol_graph_delete_part_action			delete_part_action;
typedef vostok::editor::object_patrol_graph_change_edge_direction_action	change_edge_direction_action;
typedef vostok::editor::object_patrol_graph_add_look_point_action			add_look_point_action;

using	vostok::editor_base::gui_binder;
using	vostok::editor_base::action_delegate;
using	vostok::editor_base::execute_delegate_managed;
using	vostok::editor_base::enabled_delegate_managed;
using	vostok::editor_base::checked_delegate_managed;
...
void object_patrol_graph::initialize_in_tool ( tool_misc^ tool )
{
	...
	gui_binder->register_image			( "base", action_name, vostok::editor_base::preview_cube );
	...
	gui_binder->register_image			( "base", action->name( ), vostok::editor_base::preview_cube );
...
{
	VOSTOK_UNREFERENCED_PARAMETER	( bdestroy );
	destroy_collision			( );
}
