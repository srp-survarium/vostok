...
public:
	typedef vostok::editor::wpf_controls::property_editors::attributes::value_range_and_format_attribute	value_range_and_format_attribute;
	typedef vostok::editor::wpf_controls::property_editors::attributes::vector3_attribute					vector3_attribute;
	typedef vostok::editor::wpf_controls::property_grid::refresh_grid_on_change_attribute					refresh_grid_on_change_attribute;
...
*/
	...
	property vostokColor	color{
		vostokColor			get		( )				{ return m_color; }
		void				set		( vostokColor c );
	}
