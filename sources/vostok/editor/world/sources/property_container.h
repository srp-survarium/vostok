...
public ref class property_container :
	...
	public vostok::editor::controls::property_container_interface
{
public:
	...
	typedef vostok::editor::controls::property_value				property_value;
...
public:
		...
		void	load				(vostok::configs::lua_config_value const& lv);
		void	save				(vostok::configs::lua_config_value lv);
		void	in_create			();
		void	in_destroy			();
protected:
	System::Collections::ArrayList^	m_restricted_items;
public:
	vostok::editor::property_holder*		m_property_holder; //tmp for external initialization-destruction
