...
void job_behaviour_camera_track::load			( configs::lua_config_value const& config )
{
	...
	if ( selected_track != "")
		parent_job->tool->get_level_editor()->get_project()->query_project_item( selected_track, gcnew vostok::editor::queried_object_loaded(this, &job_behaviour_camera_track::selected_track_loaded) );		
}
