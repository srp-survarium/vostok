...
//using vostok::editor::wpf_controls::property_grid_editors::external_editor_event_handler;
class property_holder;

typedef vostok::intrusive_ptr<
	property_holder, 
	vostok::editor_intrusive_base,	
	vostok::threading::single_threading_policy
> property_holder_ptr;

class property_holder : public vostok::editor::property_holder {
public:
							property_holder		(
								LPCSTR display_name,
								vostok::editor::property_holder_collection* collection,
								vostok::editor::property_holder_holder* holder
							);
...
public:
	virtual	vostok::editor::property_holder_holder* holder( );
	virtual	void			clear				( );

			vostok::editor::property_value* add_property	( System::Object^ object, System::Reflection::PropertyInfo^ property_info );

			vostok::editor::property_value* add_property( 
	...
	//bool
	virtual	vostok::editor::property_value* add_bool	(
								System::String^ identifier,
								System::String^ category,
								System::String^ description,
								bool const &default_value,
								vostok::configs::lua_config_value const& config,
								readonly_enum const& read_only,
								notify_parent_on_change_enum const& notify_parent,
								password_char_enum const& password,
								refresh_grid_on_change_enum const& refresh_grid
	...
	//integer
	virtual	vostok::editor::property_value*	add_integer(
								System::String^ identifier,
								System::String^ category,
								System::String^ description,
	...
	//float
	virtual	vostok::editor::property_value*	add_float(
								System::String^ identifier,
								System::String^ category,
								System::String^ description,
	...
	//string
	virtual	vostok::editor::property_value*	add_string				(
								System::String^ identifier,
								System::String^ category,
								System::String^ description,
	...
	//color
	virtual vostok::editor::property_value*	add_color(
								System::String^ identifier,
								System::String^ category,
								System::String^ description,
	...
	//vec3f
	virtual	vostok::editor::property_value*	add_vec3f(
								System::String^ identifier,
								System::String^ category,
								System::String^ description,
	...
	//vec2f
	virtual	vostok::editor::property_value*	add_vec2f(
								System::String^ identifier,
								System::String^ category,
								System::String^ description,
	...
	//property_holder
	virtual	vostok::editor::property_value*	add_property_holder(
								System::String^ identifier,
								System::String^ category,
								System::String^ description,
								vostok::editor::property_holder_ptr value,
								readonly_enum const& read_only,
								notify_parent_on_change_enum const& notify_parent,
								password_char_enum const& password,
								refresh_grid_on_change_enum const& refresh_grid
							);
	vostok::editor::property_value* add_special_property_holder	(
								System::String^ identifier,
								System::String^ category,
								System::String^ description,
								vostok::editor::property_holder_ptr value,
	...
	//collection
	virtual	vostok::editor::property_value*	add_collection(
								System::String^ identifier,
								System::String^ category,
								System::String^ description,
								vostok::editor::property_holder_collection* collection,
...
public:
	typedef vostok::editor::property_holder_collection	collection_type;
...
private:
	...
	vostok::editor::property_holder_holder*		m_holder;
	bool										m_disposing;
}; // class property_holder
