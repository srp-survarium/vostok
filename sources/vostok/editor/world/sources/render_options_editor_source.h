...
// {
// public:
// 	render_options_editor_source_filter(vostok::render::texture_options::ETType* filter_type)
...
ref class render_options_editor_source: public vostok::editor::controls::tree_view_source
{
