...
using vostok::editor::particle_hypergraph;
...
{
	VOSTOK_UNREFERENCED_PARAMETERS(lnk);
...
{
	VOSTOK_UNREFERENCED_PARAMETERS(nds, lnks);
...
void	particle_hypergraph::on_node_property_changed(System::Object^ sender, System::Windows::Forms::PropertyValueChangedEventArgs^ e)
{
	...
	VOSTOK_UNREFERENCED_PARAMETERS(e, n);
