...
void gui_binder::update_menu_item(ToolStripMenuItem^ menu_item)
{
	...
	vostok::editor::checked_state item_check_state	= action->checked_state();
	menu_item->Checked		= (item_check_state!=vostok::editor::checked_state::uncheckable);

	if(item_check_state!=vostok::editor::checked_state::uncheckable)
	{
		menu_item->Checked		= true;
		menu_item->CheckState	= (item_check_state==vostok::editor::checked_state::checked)	?
...
void gui_binder::update_button(ToolStripButton^ button_item, System::String^ action_name)
{
	...
	vostok::editor::checked_state item_check_state	= action->checked_state();
	button_item->Checked	= (item_check_state==vostok::editor::checked_state::checked);
}
