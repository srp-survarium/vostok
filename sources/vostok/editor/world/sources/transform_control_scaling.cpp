...
using vostok::editor::transform_control_scaling;
...
transform_control_scaling::transform_control_scaling( vostok::editor::level_editor^ le ):
super						( le ),
m_arrow_length				( 4.f ),
...
void transform_control_scaling::draw					( vostok::math::float4x4 const& inv_view_matrix )
{
...
void transform_control_scaling::draw_impl( vostok::math::float4x4 const& inv_view_matrix, bool transparent_mode )
{
...
void transform_control_scaling::draw_last_position			( vostok::math::float4x4 const& view_matrix, bool transparent_mode )
{
	vostok::render::editor::renderer& rend = m_level_editor->get_editor_renderer();
