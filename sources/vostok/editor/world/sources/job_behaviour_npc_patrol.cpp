	...
	:job_behaviour_base(parent_job)
{
	...
	query_result_delegate* rq = VOSTOK_NEW_IMPL(g_allocator, query_result_delegate)(gcnew query_result_delegate::Delegate(this, &job_behaviour_npc_patrol::on_behaviour_config_loaded), g_allocator);
...
void job_behaviour_npc_patrol::on_select_patrol	( wpf_controls::property_editors::property^ , Object^ )
{
 	...
 	if ( editor_base::resource_chooser::choose( "project_item", selected_patrol, "vostok.editor.object_patrol_graph", selected, true ) )
 	{
