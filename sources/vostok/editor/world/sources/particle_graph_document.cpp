...
using vostok::editor::particle_graph_document;
using vostok::editor::particle_links_manager;
using vostok::editor::particle_graph_node;
using vostok::editor::particle_node_connection_editor;
...
{
	particle_graph_node^ n = gcnew particle_graph_node_emitter(vostok::editor_base::image_node_emitter, parent_editor);
...
void						particle_graph_document::load					()
{
		...
		query_result_delegate* rq = VOSTOK_NEW_IMPL(g_allocator, query_result_delegate)(gcnew query_result_delegate::Delegate(this, &particle_graph_document::on_document_loaded));
		vostok::resources::query_resource(
			unmanaged_string(m_file_path).c_str(),
			vostok::resources::config_lua_class,
