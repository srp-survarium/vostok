...
typedef vostok::resources::unmanaged_resource_ptr unmanaged_resource_ptr;
...
//		typedef vostok::editor::wpf_controls::property_editors::property prop;
		...
		/// </summary>
		public ref class texture_document : vostok::editor::controls::document_base, i_resource_document
		{
