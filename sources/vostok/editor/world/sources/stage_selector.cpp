...
void stage_selector::effect_items_loaded( Object^, System::EventArgs^ )
{
	...
	resources::request*	arr			= VOSTOK_NEW_ARRAY_IMPL(*::vostok::editor::g_allocator, resources::request, count );
	unmanaged_string** str_arr		= VOSTOK_NEW_ARRAY_IMPL(*::vostok::editor::g_allocator, unmanaged_string*, count );
	...
	VOSTOK_DELETE_ARRAY_IMPL(*::vostok::editor::g_allocator, str_arr);
	VOSTOK_DELETE_ARRAY_IMPL(*::vostok::editor::g_allocator, arr);
