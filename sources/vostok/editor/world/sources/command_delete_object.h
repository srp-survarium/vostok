...
public ref class command_delete_objects :	public vostok::editor_base::command
{
public:
...
public ref class command_delete_object_impl :	public vostok::editor_base::command
{
public:
