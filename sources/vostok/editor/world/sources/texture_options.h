...
namespace vostok {
	namespace editor {
		...
		public:
			texture_options(fs::path_string absolute_resource_path, vostok::fs::path_string file_path);
		...
		public:
			...
			// detail ext
			vostok::fs::path_string		normal_name;
			vostok::fs::path_string		color_name;
			float						detail_scale;

			// bump	
			ETBumpMode					bump_mode;
			vostok::fs::path_string		bump_name;
		...
		private:
			void			on_file_property_loaded		(vostok::resources::queries_result& data);
		...
		typedef	vostok::resources::resource_ptr<texture_options, resources::unmanaged_intrusive_base>	texture_options_ptr;
