...
public ref class level_editor : public vostok::editor_base::editor_base
{
	typedef vostok::editor_base::editor_base super;
...
public:
	...
	vostok::editor_base::command_engine^	get_command_engine	( ) ;
	vostok::editor_base::input_engine^	get_input_engine	( );
	vostok::editor_base::gui_binder^		get_gui_binder		( );
	vostok::editor_base::scene_view_panel^ view_window		( );
	vostok::editor_base::camera_view_panel^ camera_view_panel	( );
	...
	void					add_library_object				( float3 position, tool_base^ tool, System::String^ library_name );
		...
		object_base^		object_by_id					( u32 id);
			...
			vostok::editor_base::scene_view_panel^	get_camera_view_panel				( );
			...
			void			on_active_control_changed		( vostok::editor_base::editor_control_base^ c );
			...
			void				set_transform_object		( vostok::editor_base::transform_control_object^ d );
...
inline	render::editor::renderer&	get_editor_renderer		();
	...
	vostok::editor_base::editor_control_base^	get_active_control	( );
	vostok::editor_base::editor_control_base^ get_editor_control	( System::String^ control_id );
			void 			set_active_control				( System::String^ control_id );
			void			register_editor_control			( vostok::editor_base::editor_control_base^ c );
			void			unregister_editor_control		( vostok::editor_base::editor_control_base^ c );
...
private:
			...
			vostok::editor_base::editor_control_base^		m_active_control;
			System::Collections::ArrayList				m_editor_controls;

			vostok::editor_base::transform_control_scaling^			m_transform_control_scaling;
			vostok::editor_base::transform_control_rotation^			m_transform_control_rotation;
			vostok::editor_base::transform_control_translation^		m_transform_control_translation;
