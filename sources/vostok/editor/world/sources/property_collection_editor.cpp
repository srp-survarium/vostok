...
property_collection_editor::property_collection_editor				( vostok::editor::editor_world& world, Type^ type) :
	inherited					( type ),
	m_world						( world )
{
}
...
Object^ property_collection_editor::CreateInstance					(Type^ type)
{
	...
	vostok::editor::controls::property_value^	raw_value = container->value(descriptor->item);
