...
namespace vostok{
	namespace editor {
		...
		/// <summary>
		/// Summary for object_in_compound_chooser_form
		///
		...
		/// </summary>
		public ref class object_in_compound_chooser_form : public System::Windows::Forms::Form
		{
		public:
			object_in_compound_chooser_form(void)
			{
				InitializeComponent();
				//
		...
		protected:
			...
			/// </summary>
			~object_in_compound_chooser_form()
			{
				if (components)
				{
					delete components;
		...
		public: vostok::editor::controls::tree_view^  treeView;
...
#pragma region Windows Form Designer generated code
			...
			{
				this->treeView = (gcnew vostok::editor::controls::tree_view());
				...
				this->treeView->selected_items_changed += gcnew System::EventHandler<controls::tree_view_selection_event_args^>(this, &object_in_compound_chooser_form::treeView_selected_items_changed);
				// 
				// ok_button
				// 
				...
				this->ok_button->Click += gcnew System::EventHandler(this, &object_in_compound_chooser_form::ok_button_Click);
				// 
				// cancel_button
				// 
				...
				this->cancel_button->Click += gcnew System::EventHandler(this, &object_in_compound_chooser_form::cancel_button_Click);
				// 
				// object_in_compound_chooser_form
				// 
				...
				this->Name = L"object_in_compound_chooser_form";
				this->Text = L"object_in_compound_chooser_form";
