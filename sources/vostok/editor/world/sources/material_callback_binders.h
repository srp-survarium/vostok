...
namespace vostok
{
	namespace editor
	{
		...
		delegate void material_effect_fs_iterator_delegate( material_property_base^, vostok::vfs::vfs_locked_iterator const & );
		...
		public:
			...
			void func( vostok::vfs::vfs_locked_iterator const & fs_it )
			{
