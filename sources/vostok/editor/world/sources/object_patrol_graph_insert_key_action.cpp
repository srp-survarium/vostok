...
#include "pch.h"
#include "object_patrol_graph_insert_key_action.h"
...
object_patrol_graph_insert_key_action::object_patrol_graph_insert_key_action( String^ name, editor_base::scene_view_panel^ view )
:super			( name ),
m_window_view	( view )
{}

bool			object_patrol_graph_insert_key_action::do_it						( )
{
	...
	if( m_window_view->ray_query( editor_base::collision_object_type_dynamic | editor_base::collision_object_type_terrain, &object, &pos ) )
	{
		...
		m_object_patrol_graph->insert_key( pos );
...
void			object_patrol_graph_insert_key_action::set_patrol_graph_object		( object_patrol_graph^ obj )
{
