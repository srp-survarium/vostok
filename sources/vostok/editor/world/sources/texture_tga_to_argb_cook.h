	...
	namespace editor
	{
		...
		public:
				...
				virtual	mutable_buffer	allocate_resource	(resources::query_result_for_cook &	in_query, 
															 ...
															 bool								file_exist)
				{
					VOSTOK_UNREFERENCED_PARAMETERS		(& in_query, file_size, out_offset_to_file, file_exist);
				...
				virtual void		create_resource		(resources::query_result_for_cook & in_out_query, 
														 mutable_buffer						in_out_unmanaged_resource_buffer)
				{
					VOSTOK_UNREFERENCED_PARAMETERS		(& in_out_query, & in_out_unmanaged_resource_buffer);
					NOT_IMPLEMENTED						();
//					in_out_query.finish_query			(result_error);
				...
				{
					VOSTOK_UNREFERENCED_PARAMETER			(resource);
					NOT_IMPLEMENTED						();
				}
