...
/*
public ref class model_name_ui_type_editor : public vostok::editor::wpf_controls::property_editors::i_external_property_editor
{
public:
...
public ref class animation_name_ui_type_editor : public vostok::editor::wpf_controls::property_editors::i_external_property_editor
{
public:
	virtual	void			run_editor	( vostok::editor::wpf_controls::property_editors::property^ prop );
