...
public ref class object_scene : public object_logic 
{
	...
	typedef vostok::editor::wpf_controls::logic_view::logic_entity_view		wpf_logic_entity_view;
	typedef vostok::editor::wpf_controls::hypergraph::properties_node			wpf_hypergpaph_node;
