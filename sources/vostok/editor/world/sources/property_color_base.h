...
public ref class property_color_base abstract :
	public vostok::editor::controls::property_value,
	public property_container_holder,
	public vostok::editor::controls::property_mouse_events,
	public vostok::editor::controls::property_incrementable
{
public:
...
public:
	...
	virtual	void			on_double_click		(vostok::editor::controls::property_grid^ property_grid);
