...
#include <vostok/editor/base/sources/i_context_manager.h>
...
System::Void input_engine::register_action	( vostok::editor_base::action^ action, String^ shorcut)
{
...
void input_engine::register_action_impl	( vostok::editor_base::input_action^  action )
{
...
bool input_engine::unregister_action_impl	( System::String^ name, bool destroy )
{
	...
	vostok::editor_base::input_action^ action = items[0]->m_action;
