...
#pragma region Windows Form Designer generated code
		...
		{
			this->m_hypergraph = (gcnew vostok::editor::controls::hypergraph::hypergraph_control());
			this->SuspendLayout();
			// 
			// m_hypergraph
			// 
			...
			this->m_hypergraph->current_view_mode = vostok::editor::controls::hypergraph::view_mode::full;
			...
			this->m_hypergraph->move_mode = vostok::editor::controls::hypergraph::nodes_movability::movable;
			...
			this->m_hypergraph->visibility_mode = vostok::editor::controls::hypergraph::nodes_visibility::all;
			this->m_hypergraph->on_selection_changed += gcnew vostok::editor::controls::hypergraph::selection_changed(this, &scene_graph_tab::m_hypergraph_on_selection_changed);
			// 
			// scene_graph_tab
			// 
...
ref class scene_links_manager : public vostok::editor::controls::hypergraph::links_manager
{
public:
