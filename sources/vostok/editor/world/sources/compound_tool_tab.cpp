...
void compound_tool_tab::post_constructor( )
{
	...
	vostok::editor_base::gui_binder^ gui_binder = l_editor->get_gui_binder( );
	...
	l_editor->get_input_engine()->register_action( a ,"");
	gui_binder->register_image( "base", action_name,	vostok::editor_base::object_light );
	l_editor->ide()->add_action_button_item( gui_binder, action_name, "CompositeEditToolStrip", 10);
	...
	l_editor->get_input_engine()->register_action( a ,"");
	gui_binder->register_image( "base", action_name,	vostok::editor_base::terrain_painter );
	l_editor->ide()->add_action_button_item( gui_binder, action_name, "CompositeEditToolStrip", 10);
	...
	a->set_enabled	(gcnew enabled_delegate_managed(this, &compound_tool_tab::is_in_edit_mode));
	l_editor->get_input_engine()->register_action( a ,"");
	gui_binder->register_image( "base", action_name,	vostok::editor_base::node_joint );
	l_editor->ide()->add_action_button_item( gui_binder, action_name, "CompositeEditToolStrip", 10);
	...
	a->set_enabled	(gcnew enabled_delegate_managed(this, &compound_tool_tab::is_in_edit_mode));
	l_editor->get_input_engine()->register_action( a ,"");
	gui_binder->register_image( "base", action_name,	vostok::editor_base::npc_tree_icon );
	l_editor->ide()->add_action_button_item( gui_binder, action_name, "CompositeEditToolStrip", 10);
	...
	l_editor->get_input_engine()->register_action( a ,"");
	gui_binder->register_image( "base", action_name,	vostok::editor_base::camera_track );
	l_editor->ide()->add_action_button_item( gui_binder, action_name, "CompositeEditToolStrip", 10);
...
{
	VOSTOK_UNREFERENCED_PARAMETERS			( prev_path );
