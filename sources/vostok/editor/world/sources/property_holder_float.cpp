...
vostok::editor::property_value* property_holder::add_float				(
...
{
	vostok::editor::float_holder^ f_holder = gcnew vostok::editor::float_holder(identifier, config);
	return add_float		(
		identifier,
		category,
		description,
		default_value,
		gcnew float_getter_type(f_holder, &vostok::editor::float_holder::get),
		gcnew float_setter_type(f_holder, &vostok::editor::float_holder::set),
		read_only,
		notify_parent,
		password,
		refresh_grid);
	...
	)
{
	...
	attribute_array[0] = gcnew vostok::editor::wpf_controls::value_range_and_format_attribute(min_value, max_value, 0.1, 4);
	...
	)
{
	...
	array<System::Attribute^>^ attribute_array = gcnew array<System::Attribute^>(1);
	attribute_array[0] = gcnew vostok::editor::wpf_controls::value_range_and_format_attribute(min_value_func, max_value_func, 0.1, 4);
	spec->Attributes = attribute_array;
