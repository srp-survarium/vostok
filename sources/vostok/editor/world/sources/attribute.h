...
typedef System::Action<vostok::editor::wpf_controls::property_grid::property^>	button_delegate;
...
public ref class library_name_ui_type_editor : public vostok::editor::wpf_controls::property_editors::i_external_property_editor
{
public:
