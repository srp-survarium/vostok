...
void job_behaviour_camera_director_default::load			( configs::lua_config_value const& config )
{
	...
	if ( active_camera != "")
		parent_job->tool->get_level_editor()->get_project()->query_project_item( active_camera, gcnew vostok::editor::queried_object_loaded(this, &job_behaviour_camera_director_default::selected_camera_loaded) );		
