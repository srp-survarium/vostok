...
using vostok::resources::sound_object_resource;
...
namespace vostok
{
	namespace editor
	{
		...
		void		sound_file_struct::load_sound_file()
		{
			...
			resources::request	requests[]		=	{ request_name.c_str(), vostok::resources::ogg_sound_wrapper_class};
		...
		void		sound_file_struct::sound_file_loaded(vostok::resources::queries_result& data)
		{
