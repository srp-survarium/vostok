...
public:
	particle_float_curve_data_source_holder(vostok::editor::property_holder_ptr holder,configs::lua_config_value const& config, particle_graph_node^ node, String^ property_name,String^ property_description ,String^ property_category, float def_value);
...
private:
	...
	vostok::editor::property_holder_ptr*		m_holder;
	configs::lua_config_value* m_config;
...
public:
	particle_color_curve_data_source_holder(vostok::editor::property_holder_ptr holder,configs::lua_config_value const& config, particle_graph_node^ node, String^ property_name,String^ property_description ,String^ property_category, u32 def_value);
private:
