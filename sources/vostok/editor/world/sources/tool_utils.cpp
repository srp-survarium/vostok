...
#include <vostok/editor/engine.h>
#include <vostok/game/resource_manager.h>

using vostok::editor::tool_utils;
using vostok::editor::utils_tool_tab;
using vostok::editor::object_base;
using vostok::editor::object_camera;

tool_utils::tool_utils(vostok::editor::detail::world& w)
:super(w)
{
...
{
	fs::path_string name			= vostok::fs::get_executable_path();
...
object_base* tool_utils::load_object(vostok::configs::lua_config_value const& t)
{
...
void tool_utils::on_preview_visual_ready(vostok::resources::unmanaged_resource_ptr data)
{
...
static tree_node^ make_hierrarchy(tree_node_collection^ root, pcstr name)
{
	...
	tree_node^		result;
	do{
		p						= vostok::strings::get_token(p, tok, '/');
