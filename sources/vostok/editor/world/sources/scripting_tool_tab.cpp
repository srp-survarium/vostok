...
void scripting_tool_tab::fill_objects_list( )
{
	m_library_objects_tree->fill_objects_list( nullptr );
}

void scripting_tool_tab::post_constructor( )
{
...
void scripting_tool_tab::on_activate()
{
	m_tool->get_level_editor()->set_active_tool( m_tool );
}

void scripting_tool_tab::on_deactivate()
{
