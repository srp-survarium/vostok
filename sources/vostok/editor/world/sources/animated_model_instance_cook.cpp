...
animated_model_instance_cook::animated_model_instance_cook	( vostok::physics::world* physics_world ) :
...
void animated_model_instance_cook::on_subresources_loaded	( resources::queries_result& data )
{
	...
	animated_model_instance* new_model_instance		= VOSTOK_NEW_IMPL( g_allocator, animated_model_instance );
	...
	vostok::animation::animation_player* player		= VOSTOK_NEW_IMPL( g_allocator, vostok::animation::animation_player );
...
void animated_model_instance_cook::delete_resource	( resources::resource_base* resource )
{
	...
	VOSTOK_DELETE_IMPL								( g_allocator, player );
	VOSTOK_DELETE_IMPL								( g_allocator, model_instance );
}
