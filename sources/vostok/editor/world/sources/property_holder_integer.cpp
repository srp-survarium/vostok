...
vostok::editor::property_value* property_holder::add_integer				(
...
{
	vostok::editor::integer_holder^ i_holder = gcnew vostok::editor::integer_holder(identifier, config);
	return add_integer		(
		identifier,
		category,
		description,
		default_value,
		gcnew integer_getter_type(i_holder, &vostok::editor::integer_holder::get),
		gcnew integer_setter_type(i_holder, &vostok::editor::integer_holder::set),
		read_only,
		notify_parent,
		password,
		refresh_grid);
	...
	)
{
	...
	attribute_array[0] = gcnew vostok::editor::wpf_controls::value_range_and_format_attribute(min_value, max_value);
	...
	)
{
	...
	array<System::Attribute^>^ attribute_array = gcnew array<System::Attribute^>(1);
	attribute_array[0] = gcnew vostok::editor::wpf_controls::value_range_and_format_attribute(min_value_func, max_value_func, 1, 0);
	spec->Attributes = attribute_array;
