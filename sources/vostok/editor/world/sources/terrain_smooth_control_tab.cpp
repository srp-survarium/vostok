...
using vostok::editor::terrain_smooth_control_tab;
using vostok::editor::terrain_modifier_smooth;
...
void terrain_smooth_control_tab::on_control_activated(vostok::editor::editor_control_base^ c)
{
...
void terrain_smooth_control_tab::on_control_deactivated(vostok::editor::editor_control_base^ c)
{
	Hide						();
	VOSTOK_UNREFERENCED_PARAMETER	(c);
}
