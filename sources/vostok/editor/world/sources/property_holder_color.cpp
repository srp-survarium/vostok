...
vostok::editor::property_value* property_holder::add_color				(
...
{
	vostok::editor::color_holder^ c_holder = gcnew vostok::editor::color_holder(identifier, config);
	return add_color		(
		identifier,
		category,
		description,
		default_value,
		gcnew color_getter_type(c_holder, &vostok::editor::color_holder::get),
		gcnew color_setter_type(c_holder, &vostok::editor::color_holder::set),
		read_only,
		notify_parent,
		password,
		refresh_grid);
