...
:super(le, "scripting")
{
	default_image_index			= vostok::editor_base::script_object_tree_icon;

	job_resource_type_by_job_type = gcnew Generic::Dictionary< String^, String^>( );
	job_resource_type_by_job_type->Add("camera",	"vostok.editor.object_camera");
	job_resource_type_by_job_type->Add("timing",	"vostok.editor.object_timer");
	job_resource_type_by_job_type->Add("lights",	"vostok.editor.object_light");
	job_resource_type_by_job_type->Add("triggers",	"vostok.editor.object_proximity_trigger");
	job_resource_type_by_job_type->Add("composite", "vostok.editor.object_composite");
	job_resource_type_by_job_type->Add("values_storage", "vostok.editor.object_values_storage");
	job_resource_type_by_job_type->Add("npc", "vostok.editor.object_human_npc");
...
//	m_library->fill_tree	( nodes, vostok::editor_base::npc_tree_icon, true, nullptr );
}
