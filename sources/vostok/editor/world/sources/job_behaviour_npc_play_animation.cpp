	...
	:job_behaviour_base(parent_job)
{
	...
	query_result_delegate* rq = VOSTOK_NEW_IMPL(g_allocator, query_result_delegate)(gcnew query_result_delegate::Delegate(this, &job_behaviour_npc_play_animation::on_behaviour_config_loaded), g_allocator);
