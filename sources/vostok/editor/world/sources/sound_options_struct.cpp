...
using vostok::editor::sound_options_struct;
...
namespace vostok
{
	namespace editor
	{
		...
		void	sound_options_struct::load(Action<sound_options_struct^>^ on_load_callback, memory::base_allocator* allocator)
		{
			...
			query_result_delegate* rq = VOSTOK_NEW_IMPL(allocator, query_result_delegate)(gcnew query_result_delegate::Delegate(this, &sound_options_struct::on_file_property_loaded));
		...
		void	sound_options_struct::on_file_property_loaded		(vostok::resources::queries_result& data)
		{
