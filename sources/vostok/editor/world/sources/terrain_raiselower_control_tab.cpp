...
using vostok::editor::terrain_raiselower_control_tab;
using vostok::editor::terrain_modifier_raise_lower;
...
void terrain_raiselower_control_tab::on_control_activated(vostok::editor::editor_control_base^ c)
{
	VOSTOK_UNREFERENCED_PARAMETER(c);
	Show						();
	sync						(true);
}

void terrain_raiselower_control_tab::on_control_deactivated(vostok::editor::editor_control_base^ c)
{
	Hide						();
	VOSTOK_UNREFERENCED_PARAMETER	(c);
}
