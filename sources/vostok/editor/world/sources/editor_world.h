...
public:
		editor_world			( vostok::editor::engine& engine );
								~editor_world			( );
...
public:
	...
	virtual HWND				camera_view_handle		( );
			...
			void				on_fs_iterator_render_options_ready( fs_new::virtual_path_string const & options_path, vostok::vfs::vfs_locked_iterator const & fs_it );
			
			void				on_active_control_changed( editor_base::editor_control_base^ c );
	virtual	void				tick					( );
			void				render					( u32 frame_id, vostok::math::float4x4 view_matrix );
...
public:
			...
			void				on_idle					( );
			void				on_idle_end				( );
			inline	vostok::editor::engine&				engine			( );
...
public:
	...
	vostok::editor_base::scene_view_panel^ view_window		( ) {return m_view_window;}
	vostok::editor_base::camera_view_panel^ camera_view_panel	( ) {return m_camera_view_window;}
	
			vostok::ui::world*			get_ui_world		( ){ return m_ui_world; }
			level_editor^				get_level_editor	( );
			editor_base::gui_binder^	get_gui_binder		( );

public:
	vostok::editor_base::tool_window^ create_model_editor		( );
...
private:
	...
	gcroot<vostok::editor_base::scene_view_panel^>	m_view_window;
	gcroot<vostok::editor_base::camera_view_panel^>	m_camera_view_window;
...
public:
	...
	vostok::physics::world&				get_physics_world		( ) { return *m_physics_world; }
	vostok::ai::navigation::world&		get_ai_navigation_world	( ) { return *m_ai_navigation_world; }
...
private:
	...
	gcroot<vostok::editor::controls::mode_strip_button^> m_render_options_button;
