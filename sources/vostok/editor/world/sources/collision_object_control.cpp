...
collision_object_transform_control::collision_object_transform_control(	vostok::collision::geometry const* geometry, 
...
void collision_object_transform_control::set_matrix		( vostok::math::float4x4 const& matrix )
{
	m_transform_general = matrix;
	collision_object::set_matrix		( m_transform_original*m_transform_general );
}

void collision_object_transform_control::set_matrix_original		( vostok::math::float4x4 const& matrix )
{
	m_transform_original = matrix;
	set_matrix( m_transform_general );
}

vostok::math::float4x4 const& collision_object_transform_control::get_matrix_original	( ) const
{
