...
void project::save_project( System::String^ project_name )
{
	...
	vostok::ai::navigation::graph_generator* graph_generator = get_level_editor()->get_editor_world().get_ai_navigation_world().get_graph_generator();
...
{
	VOSTOK_UNREFERENCED_PARAMETERS( object, t );
