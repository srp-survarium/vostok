...
wpf_property_container^ texture_editor_resource::get_property_container( bool )
{
	...
	vostok::render::texture_options::ETType type = get_texture_type_from_name(s.c_str());
	...
	switch (type)
	{
		//case vostok::render::texture_options::bump:
		...
		case vostok::render::texture_options::terrain:
...
//.			container->properties["Part 2D/bump_name"]->category = "Terrain";
		...
		case vostok::render::texture_options::type_2d:
