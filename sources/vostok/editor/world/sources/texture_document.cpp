...
using vostok::editor::wpf_controls::property_grid::host;
using vostok::editor::wpf_controls::property_grid::property_grid_control;
...
typedef vostok::resources::queries_result queries_result;
