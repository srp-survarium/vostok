...
// using vostok::resources::ogg_sound_cook_wrapper;
// using vostok::resources::ogg_sound_cook;
// using vostok::resources::ogg_cook;
// using vostok::resources::ogg_converter;
// using vostok::resources::ogg_options_converter;
using vostok::resources::resources_manager;

namespace vostok
{
	namespace editor
	{
		sound_editor::sound_editor(vostok::editor::editor_world& world):m_world(world)
		{
...
// 			register_cook			(&ogg_converter_obj);
		...
		{
			if (persist_string == "vostok.editor.sound_files_view_panel")
				return			m_sound_files_panel;

			if (persist_string == "vostok.editor.sound_items_view_panel")
				return			m_sound_items_panel;

			if (persist_string == "vostok.editor.sound_item_editor_panel")
