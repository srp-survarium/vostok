...
using vostok::sound_editor::collection_play_type;
...
void sound_collection_wrapper::save(vostok::configs::lua_config_value& root)
{
...
void sound_collection_wrapper::load(vostok::configs::lua_config_value const& cfg)
{
...
void sound_collection_wrapper::on_options_loaded(vostok::resources::queries_result& data)
{
...
void sound_collection_wrapper::on_sound_loaded(vostok::resources::queries_result& data)
{
