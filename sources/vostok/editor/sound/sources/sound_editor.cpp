...
using vostok::sound_editor::composite_sound_wrapper;
using vostok::sound_editor::sound_collection_wrapper;
using vostok::sound_editor::sound_object_type;
using namespace vostok::sound;
using namespace System::Windows::Forms;

sound_editor::sound_editor(String^ res_path, vostok::sound::world& sound_world, vostok::render::world& render_world, tool_window_holder^ holder)
...
{
	if(persist_string=="vostok.sound_editor.toolbar_panel")
		return m_toolbar_panel;

	if(persist_string=="vostok.sound_editor.instance_properties_panel")
		return m_instance_properties_panel;

	if(persist_string=="vostok.sound_editor.object_properties_panel")
		return m_object_properties_panel;

	if(persist_string=="vostok.sound_editor.tree_view_panel")
...
vostok::sound::calculation_type sound_editor::calculation::get()
{
	return m_sound_world->get_calculation_type();
}

void sound_editor::calculation::set(vostok::sound::calculation_type new_val)
{
