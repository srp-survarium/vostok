...
namespace sound_editor {
	...
	public:
		...
		virtual void		add_item				(sound_collection_item^ itm) override {VOSTOK_UNREFERENCED_PARAMETER(itm);};
		virtual void		remove_item				(sound_collection_item^ itm) override {VOSTOK_UNREFERENCED_PARAMETER(itm);};
	...
	private:
		void				on_single_sound_loaded	(vostok::resources::queries_result& data);
		void				on_wav_options_loaded	(vostok::resources::queries_result& data);
		void				read_spl_curve			(vostok::configs::lua_config_value const& cfg);
