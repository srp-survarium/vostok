...
using vostok::sound_editor::composite_sound_item;
...
m_editor(ed)
{
	...
	m_tree_view->selected_items_changed += gcnew EventHandler<vostok::editor::controls::tree_view_selection_event_args^>(this, &composite_sound_document::on_selection_changed);
...
void composite_sound_document::on_selection_changed(Object^, vostok::editor::controls::tree_view_selection_event_args^)
{
