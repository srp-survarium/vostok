...
namespace sound_editor {
	...
	public ref class sound_scene_add_objects_command: public vostok::editor_base::command
	{
	...
	public ref class sound_scene_remove_objects_command: public vostok::editor_base::command
	{
		typedef List<Guid> ids_list;
	...
	public ref class sound_scene_change_object_transform_command: public vostok::editor_base::command
	{
	public:
	...
	public ref class sound_scene_change_objects_property_command: public vostok::editor_base::command
	{
		typedef List<Guid> ids_list;
	public:
