...
using vostok::sound_editor::tree_view_panel;
...
void tree_view_panel::selection_changed ( Object^, vostok::editor::controls::tree_view_selection_event_args^ )
{
...
vostok::sound_editor::tree_view_files_source_mode	tree_view_panel::get_mode()
{
	tree_view_files_source^ s = safe_cast<tree_view_files_source^>(m_raw_files_tree_view->source);
	return s->mode;
}
		...
		case fs_operation_type::file_create:
			{
				if(get_mode()==tree_view_files_source_mode::show_collections)
				{
					...
					vostok::fs_new::virtual_path_string file_name = unm_res_path.c_str();
					file_name += "collections/";
					file_name += unmanaged_string(new_node_path).c_str();
					file_name += unmanaged_string(extension).c_str();
					vostok::configs::lua_config_ptr cfg_ptr = vostok::configs::create_lua_config(file_name.c_str());
					vostok::configs::lua_config_value root = cfg_ptr->get_root()["collection"];
				...
				else if(get_mode()==tree_view_files_source_mode::show_composite)
				{
					...
					file_name += unmanaged_string(extension).c_str();
					vostok::configs::lua_config_ptr cfg_ptr = vostok::configs::create_lua_config(file_name.c_str());
					vostok::configs::lua_config_value root = cfg_ptr->get_root()["composite_sound"];
