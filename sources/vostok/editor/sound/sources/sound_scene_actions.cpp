...
using vostok::sound_editor::action_select_active_control;
using vostok::sound_editor::mouse_action_editor_control;
using vostok::sound_editor::mouse_action_select_object;
using vostok::sound_editor::start_all_sound_action;
using vostok::sound_editor::stop_all_sound_action;
using vostok::sound_editor::sound_scene_document;
using vostok::sound_editor::enum_selection_method;
...
//-------------------------------------------------------------------------------------------
bool vostok::sound_editor::check_picked_object(vostok::collision::space_partitioning_tree* collision_tree, vostok::collision::object const* object, float3 const& cam_origin, float3 const& cam_direction)
{
	...
	bool res1 = collision_tree->ray_query(
		...
		10000.f,  
		collision_results, 
		vostok::collision::objects_predicate_type(&obj, &check_object_predicate::callback)	
	);
	return !res1;
}
