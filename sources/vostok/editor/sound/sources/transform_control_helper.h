...
namespace sound_editor {
	...
	public ref class se_transform_value_object: public vostok::editor_base::transform_control_object
	{
	public:
						se_transform_value_object	(math::float4x4* m, Action<bool>^ d);
		virtual			~se_transform_value_object	();
		virtual void	start_modify				(vostok::editor_base::transform_control_base^) override;
		virtual void	execute_preview				(vostok::editor_base::transform_control_base^) override;
		virtual void	end_modify					(vostok::editor_base::transform_control_base^) override;
