...
namespace sound_editor {
	...
	public ref class sound_collection_add_items_command: public vostok::editor_base::command
	{
	public:
	...
	public ref class sound_collection_remove_items_command: public vostok::editor_base::command
	{
	public:
		...
		virtual bool	commit				() override;
		virtual void	rollback			() override;
				void	save_childs			(tree_node^ n, vostok::configs::lua_config_value& root);
				void	remove_childs		(vostok::configs::lua_config_value& root);
				void	add_childs			(vostok::configs::lua_config_value& root);
	...
	public ref class sound_collection_change_objects_property_command: public vostok::editor_base::command
	{
	...
	public ref class sound_collection_create_collection_command: public vostok::editor_base::command
	{
	public:
