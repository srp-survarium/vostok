...
namespace sound_editor {
	...
	public ref class sound_collection_document: public vostok::editor::controls::document_base
	{
	...
	private:
				...
				void			on_selection_changed			(Object^, vostok::editor::controls::tree_view_selection_event_args^);
