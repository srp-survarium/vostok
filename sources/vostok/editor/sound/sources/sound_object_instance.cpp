...
:m_sound_object(w)
{
	...
	vostok::editor_base::object_properties::initialize_property_container(this, m_container);
}
...
void sound_object_instance::save(vostok::configs::lua_config_value cfg)
{
...
void sound_object_instance::load(vostok::configs::lua_config_value const& cfg)
{
...
void sound_object_instance::set_transform(float4x4 const& transform)
{
	...
	{
		vostok::math::float4x4 m = transform;
		vostok::math::clamp(s.x, 0.05f, 1000.0f);
		vostok::math::clamp(s.y, 0.05f, 1000.0f);
		vostok::math::clamp(s.z, 0.05f, 1000.0f);
		m.set_scale(s);
		*m_transform = m;
	}
	else
...
void sound_object_instance::render(vostok::render::debug::renderer& r, vostok::render::scene_ptr const& s)
{
