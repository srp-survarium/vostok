...
using vostok::sound_editor::sound_scene_add_objects_command;
using vostok::sound_editor::sound_scene_remove_objects_command;
using vostok::sound_editor::sound_scene_change_object_transform_command;
using vostok::sound_editor::sound_scene_change_objects_property_command;
