...
namespace sound_editor {
	...
	struct check_object_predicate
	{
		...
		bool callback(vostok::collision::ray_object_result const& r)
		{
		...
		vostok::collision::ray_object_result m_result;
	}; // struct check_object_predicate
	
	bool check_picked_object(vostok::collision::space_partitioning_tree* collision_tree, vostok::collision::object const* object, float3 const& cam_origin, float3 const& cam_direction);
	...
	public:
		...
		virtual vostok::editor_base::checked_state	checked_state	( ) override;
