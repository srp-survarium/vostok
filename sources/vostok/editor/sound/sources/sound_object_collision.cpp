...
using vostok::sound_editor::sound_object_collision;
using vostok::sound_editor::sound_object_collision_dynamic;
using vostok::sound_editor::sound_object_instance;
using vostok::collision::space_partitioning_tree;
using vostok::collision::geometry_instance;
...
void sound_object_collision::destroy(vostok::memory::base_allocator* allocator)
{
	if(initialized())
	{
		remove();
