...
using vostok::sound_editor::sound_collection_add_items_command;
using vostok::sound_editor::sound_collection_remove_items_command;
using vostok::sound_editor::sound_collection_change_objects_property_command;
using vostok::sound_editor::sound_collection_create_collection_command;
...
void sound_collection_remove_items_command::save_childs(tree_node^ n, vostok::configs::lua_config_value& root)
{
...
void sound_collection_remove_items_command::remove_childs(vostok::configs::lua_config_value& root)
{
...
void sound_collection_remove_items_command::add_childs(vostok::configs::lua_config_value& root)
{
	sound_collection_item^ item = gcnew sound_collection_item();
	item->load(root);
	String^ full_path = gcnew String((pcstr)root["full_path"]);
