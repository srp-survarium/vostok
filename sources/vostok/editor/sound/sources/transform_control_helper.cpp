...
using vostok::sound_editor::se_transform_control_helper;
using vostok::sound_editor::se_transform_value_object;
...
//-------------------------------------------------------------------------------------------
se_transform_value_object::se_transform_value_object(vostok::math::float4x4* m, Action<bool>^ d)
:m_delegate(d)
{
	m_value_transform = m;
...
{
	VOSTOK_UNREFERENCED_PARAMETER(control);
