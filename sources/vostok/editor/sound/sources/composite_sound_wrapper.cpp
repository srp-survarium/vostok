...
void composite_sound_wrapper::save(vostok::configs::lua_config_value& root)
{
...
void composite_sound_wrapper::load(vostok::configs::lua_config_value const& cfg)
{
...
void composite_sound_wrapper::on_options_loaded(vostok::resources::queries_result& data)
{
...
void composite_sound_wrapper::on_sound_loaded(vostok::resources::queries_result& data)
{
