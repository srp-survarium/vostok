...
channels_editor::channels_editor(animation_editor^ ed)
{
	...
	m_multidocument_base = gcnew vostok::editor::controls::document_editor_base("animation_channels_editor", false);
	...
	m_multidocument_base->creating_new_document = gcnew vostok::editor::controls::document_create_callback(this, &channels_editor::on_document_creating);
	m_multidocument_base->content_reloading = gcnew vostok::editor::controls::content_reload_callback(this, &channels_editor::find_dock_content);
...
{
	if( persist_string == "vostok.animation_editor.channels_files_view_panel" )
		return m_file_view_panel;
	else if( persist_string == "vostok.animation_editor.channels_layout_panel" )
		return m_layout_panel;

	return ( nullptr );
}

vostok::editor::controls::document_base^ channels_editor::on_document_creating( )
{
