...
using vostok::animation::animation_expression_emitter_ptr;
using vostok::editor::wpf_controls::dot_net_helpers;
...
{
	configs::lua_config_ptr cfg_ptr = vostok::configs::create_lua_config(
...
vostok::animation::mixing::expression animation_collection_item::emit ( mutable_buffer& buffer, bool& is_last_animation )
{
...
void animation_collection_item::item_loaded_callback(vostok::resources::queries_result& data)
{
