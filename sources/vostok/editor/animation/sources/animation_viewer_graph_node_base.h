...
namespace animation_editor {
	...
	public ref class animation_viewer_graph_node_base: public vostok::editor::controls::hypergraph::node
	{
		typedef vostok::editor::controls::hypergraph::node	super;
	protected:
	...
	public:
		...
		virtual void				assign_style			(vostok::editor::controls::hypergraph::node_style^ style) override;
		...
		virtual void				on_added				(vostok::editor::controls::hypergraph::hypergraph_control^ parent) override;
		virtual void				on_removed				(vostok::editor::controls::hypergraph::hypergraph_control^ parent) override;
		virtual void				save					(vostok::configs::lua_config_value cfg);
		virtual void				load					(vostok::configs::lua_config_value const& cfg, animation_viewer_hypergraph^ h);
