...
using vostok::animation_editor::animation_viewer_graph_link_weighted;
...
void animation_viewer_graph_link_weighted::load(vostok::configs::lua_config_value const& cfg)
{
	super::load(cfg);
...
void animation_viewer_graph_link_weighted::save(vostok::configs::lua_config_value cfg)
{
	super::save(cfg);
	cfg["weight"] = weight;
...
void animation_viewer_graph_link_weighted::draw(System::Drawing::Graphics^ g, System::Drawing::Pen^ pen, vostok::editor::controls::hypergraph::nodes_link_style link_style)
{
