...
using namespace vostok::editor::wpf_controls::animation_setup;
...
namespace animation_editor {
	...
	public ref class animation_groups_document: public vostok::editor::controls::document_base
	{
...
animation_group_object^			get_group						(System::Guid id);
	...
	private:
				...
				void			on_groups_loaded				(vostok::resources::queries_result& result);
