	...
	:	m_subscribe_id(0)
{
	...
	m_subscribe_id = vostok::resources::subscribe_watcher(unmanaged_string( animation_editor::single_animations_path ).c_str( ), boost::bind(&file_watcher_delegate::callback, m_callback, _1));
}
...
void animation_files_source::fs_callback( vostok::vfs::vfs_notification const & info )
{
...
void animation_files_source::refresh( )
{
	...
	resources::query_vfs_iterator( unmanaged_string( animation_editor::single_animations_path ).c_str( ), boost::bind(&fs_iterator_delegate::callback, q, _1 ), g_allocator, vostok::resources::recursive_true );
}

void animation_files_source::on_fs_iterator_ready(vostok::vfs::vfs_locked_iterator const & fs_it)
{
...
void animation_files_source::process_fs(vostok::vfs::vfs_iterator const & fs_it, String^ file_path)
{
