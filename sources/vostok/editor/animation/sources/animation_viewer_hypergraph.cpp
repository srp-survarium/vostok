...
using vostok::animation_editor::animation_viewer_hypergraph;
using vostok::animation_editor::viewer_document;
using vostok::animation_editor::animation_viewer_graph_link;
using vostok::animation_editor::animation_viewer_graph_node_base;
using vostok::editor::controls::hypergraph::node;
using vostok::editor::controls::hypergraph::node_style;
...
void animation_viewer_hypergraph::save(vostok::configs::lua_config_value cfg, nodes^ nds, links^ lnks)
{
//	saving nodes
	if(nds!=nullptr)
	{
...
void animation_viewer_hypergraph::save(vostok::configs::lua_config_value cfg)
{
...
u32 animation_viewer_hypergraph::assign_node_id(vostok::animation_editor::animation_viewer_graph_node_base^ n, u32 new_id)
{
	u32 id = 0;
...
void animation_viewer_hypergraph::remove_node_id(vostok::animation_editor::animation_viewer_graph_node_base^ n)
{
...
vostok::animation_editor::animation_viewer_graph_node_base^ animation_viewer_hypergraph::find_node_by_id(nodes^ nds, u32 id)
{
	for each(animation_viewer_graph_node_base^ n in nds)
	{
		if(id==n->id)
...
animation_viewer_graph_link^ animation_viewer_hypergraph::create_link(animation_viewer_graph_node_base^ src_node, animation_viewer_graph_node_base^ dst_node)
{
	...
	vostok::editor::controls::hypergraph::connection_point^ src_pt;
	vostok::editor::controls::hypergraph::connection_point^ dst_pt;
...
vostok::animation_editor::viewer_editor^ animation_viewer_hypergraph::get_editor() 
{
	return m_owner->get_editor();
}

void animation_viewer_hypergraph::set_animation_node_new_intervals_list(animation_viewer_graph_node_base^ n, List<vostok::animation_editor::animation_node_interval^>^ lst, u32 cycle_index)
{
