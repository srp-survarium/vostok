...
using vostok::animation_editor::animation_node_playing_instance;
using vostok::animation_editor::mix_self;
...
void animation_node_playing_instance::save(vostok::configs::lua_config_value& cfg)
{
...
void animation_node_playing_instance::load(vostok::configs::lua_config_value const& cfg)
{
...
vostok::animation_editor::animation_node_playing_instance::wpf_property_container^ animation_node_playing_instance::time_offset::get()
{
