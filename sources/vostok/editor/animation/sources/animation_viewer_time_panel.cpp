...
using vostok::animation_editor::animation_viewer_time_panel;
...
animation_viewer_time_panel::animation_viewer_time_panel(vostok::animation_editor::viewer_editor^ ed)
{
	m_editor = ed;
