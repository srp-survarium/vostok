...
using vostok::animation_editor::channels_files_source;
using System::Windows::Forms::TreeNode;
using System::Reflection::BindingFlags;
using vostok::animation_editor::channels_node_sorter;
...
channels_files_source::channels_files_source()
{
	...
	m_watcher_subscribe_id	=	vostok::resources::subscribe_watcher(unmanaged_string( animation_editor::single_animations_path ).c_str( ), 
...
void channels_files_source::fs_callback(vostok::vfs::vfs_notification const & info)
{
...
void channels_files_source::on_fs_iterator_ready(vostok::vfs::vfs_locked_iterator const & fs_it)
{
...
void channels_files_source::process_fs(vostok::vfs::vfs_iterator const & in_it, String^ file_path)
{
