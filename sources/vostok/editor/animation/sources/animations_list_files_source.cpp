...
using vostok::animation_editor::animations_list_files_source;
...
void animations_list_files_source::fs_callback(vostok::vfs::vfs_notification const & info)
{
...
void animations_list_files_source::on_fs_iterator_ready(vostok::vfs::vfs_locked_iterator const & fs_it)
{
...
void animations_list_files_source::process_fs(vostok::vfs::vfs_iterator const & in_it, String^ file_path)
{
