...
void animation_viewer_graph_link::load(vostok::configs::lua_config_value const& cfg)
{
	VOSTOK_UNREFERENCED_PARAMETER(cfg);
}

void animation_viewer_graph_link::save(vostok::configs::lua_config_value cfg)
{
