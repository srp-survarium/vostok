...
namespace animation_editor {
	...
	public:
		...
		void			save_group_settings			(vostok::configs::lua_config_value& cfg);
		void			load						(vostok::configs::lua_config_value const& cfg);
		void			load_group_settings			(vostok::configs::lua_config_value const& cfg);
		void			refresh_view				();
...
animation_node_interval^	get_interval			(u32 index);
	...
	private:
		void			on_animation_loaded			(vostok::animation_editor::animation_node_clip_instance^ new_clip);
