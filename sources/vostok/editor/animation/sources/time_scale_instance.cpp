...
using vostok::animation_editor::time_scale_instance;
...
void time_scale_instance::save(vostok::configs::lua_config_value& cfg)
{
	cfg["time_scale"] = m_value;
	m_interpolator->save(cfg);
}

void time_scale_instance::load(vostok::configs::lua_config_value const& cfg)
{
