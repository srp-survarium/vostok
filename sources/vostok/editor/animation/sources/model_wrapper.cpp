...
using vostok::animation_editor::model_wrapper;
...
vostok::render::skeleton_model_ptr model_wrapper::model() 
{
...
void model_wrapper::on_model_loaded(vostok::resources::queries_result& result)
{
...
void model_wrapper::calculate_animations_events(vostok::vectora<editor_animations_event>& events)
{
	if(m_mixer)
		m_mixer->calculate_animations_events(events);
}

void model_wrapper::get_current_anim_states(vostok::vectora<editor_animation_state>& result, u32 current_time_in_ms)
{
	if(m_mixer)
