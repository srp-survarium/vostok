...
using namespace vostok::editor::wpf_controls::property_editors;
...
namespace animation_editor {
	...
	public:
		...
		virtual void				load									(vostok::configs::lua_config_value const& cfg, animation_viewer_hypergraph^ h) override;
		...
		virtual void				draw_caption							(System::Windows::Forms::PaintEventArgs^ e) override;
				...
				vostok::animation::skeleton_animation_ptr clip				();
