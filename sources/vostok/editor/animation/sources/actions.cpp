...
using vostok::animation_editor::action_select_active_control;
using vostok::animation_editor::mouse_action_editor_control;
using vostok::animation_editor::action_navigation_mode;
using vostok::animation_editor::action_navigation_pause;
using vostok::animation_editor::action_switch_saving_navigation_scene;
using vostok::animation_editor::action_change_navigation_vector;
using vostok::animation_editor::action_navigation_jump;
using vostok::animation_editor::action_render_debug_info;
using vostok::animation_editor::animation_editor;
////////////////////////////////////////////////////////////////////////////
//-- public ref class action_select_active_control ------------------------------------------
////////////////////////////////////////////////////////////////////////////
action_select_active_control::action_select_active_control(System::String^ name, animation_editor^ ae, vostok::editor_base::editor_control_base^ c)
:super(name),
...
vostok::editor_base::checked_state action_select_active_control::checked_state( )
{
...
bool mouse_action_editor_control::capture()
{
	...
	vostok::collision::object const* picked_collision = NULL;
...
vostok::editor_base::checked_state action_navigation_mode::checked_state( )
{
...
vostok::editor_base::checked_state action_navigation_pause::checked_state( )
{
...
vostok::editor_base::checked_state action_switch_saving_navigation_scene::checked_state( )
{
...
vostok::editor_base::checked_state action_navigation_jump::checked_state( )
{
	return (m_animation_editor->is_in_navigation_mode()) ?
		editor_base::checked_state::checked	: 
		editor_base::checked_state::unchecked;
...
vostok::editor_base::checked_state action_render_debug_info::checked_state( )
{
