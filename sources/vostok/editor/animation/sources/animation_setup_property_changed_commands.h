...
namespace animation_editor {
	...
	public ref class animation_setup_item_property_changed_command : vostok::editor_base::command
	{
	public:
	...
	public ref class animation_setup_property_changed_command: vostok::editor_base::command
	{
