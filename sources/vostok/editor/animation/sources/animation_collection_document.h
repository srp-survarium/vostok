...
namespace vostok 
{
	namespace animation_editor 
	{
		...
		public ref class animation_collection_document : public vostok::editor::controls::document_base
		{
		...
		private:
					...
					void				selection_changed				( Object^, vostok::editor::controls::tree_view_selection_event_args^ );
