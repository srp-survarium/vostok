...
using vostok::animation_editor::animation_viewer_change_property;
...
void animation_viewer_change_property::init_weight_values(vostok::animation_editor::animation_viewer_graph_link_weighted^ initial_link)
{
	...
	if(!vostok::math::is_similar(sum, 0.0f))
	{
		for each(animation_viewer_graph_link_weighted^ l in lnks)
		{
			...
			vostok::math::clamp(new_val, 0.0f, 1.0f);
