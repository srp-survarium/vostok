...
using vostok::editor::wpf_controls::hierarchy_item_id;
...
namespace vostok
{
	namespace animation_editor
	{
		...
		public ref class animation_collection_document_add_items_command: public vostok::editor_base::command
		{
		public:
		...
		public ref class animation_collection_document_remove_items_command: public vostok::editor_base::command
		{
		public:
		...
		public ref class animation_collection_document_reorganize_command: public vostok::editor_base::command
		{
		public:
		...
		public ref class animation_collection_document_change_objects_property_command: public vostok::editor_base::command
		{
		...
		public ref class animation_collection_document_create_collection_command: public vostok::editor_base::command
		{
		public:
