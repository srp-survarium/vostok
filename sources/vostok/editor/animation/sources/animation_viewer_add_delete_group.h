...
namespace animation_editor {
	...
	public ref class animation_viewer_add_group : public vostok::editor_base::command
	{
	...
	public ref class animation_viewer_remove_group : public vostok::editor_base::command
	{
		typedef System::Collections::Generic::List<vostok::editor::controls::hypergraph::node^ > nodes;
