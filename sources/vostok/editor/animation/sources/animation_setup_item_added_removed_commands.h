...
namespace animation_editor {
	...
	public ref class animation_setup_item_added_command : vostok::editor_base::command
	{
	public:
	...
	public ref class animation_setup_item_removed_command : vostok::editor_base::command
	{
	public:
