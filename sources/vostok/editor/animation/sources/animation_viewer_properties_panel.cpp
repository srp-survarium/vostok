...
using vostok::animation_editor::animation_viewer_properties_panel;
...
:vostok::editor::controls::item_properties_panel_base(ed->multidocument_base),
m_owner(ed)
{
	...
	m_property_grid_host->browsable_attribute_state = vostok::editor::wpf_controls::property_editors::browsable_state::or;
