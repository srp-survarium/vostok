...
using vostok::animation_editor::animation_node_interpolator;
using vostok::animation_editor::interpolator_type;
...
void animation_node_interpolator::save(vostok::configs::lua_config_value& cfg)
{
...
void animation_node_interpolator::load(vostok::configs::lua_config_value const& cfg)
{
	vostok::configs::lua_config_value val = cfg;
	if(val["interpolator"].get_type()==vostok::configs::t_table_named)
	{
...
vostok::animation_editor::animation_node_interpolator::wpf_property_container^ animation_node_interpolator::time::get()
{
