...
using namespace vostok::editor::wpf_controls::hypergraph;
...
namespace animation_editor {
	...
	public ref class animation_groups_add_group_command: public vostok::editor_base::command
	{
	public:
	...
	public ref class animation_groups_add_link_command: public vostok::editor_base::command
	{
	public:
	...
	public ref class animation_groups_delete_selected_command: public vostok::editor_base::command
	{
	...
	public ref class animation_groups_change_model_command: public vostok::editor_base::command
	{
	public:
	...
	public ref class animation_groups_nodes_move_command: public vostok::editor_base::command
	{
	public:
	...
	public ref class animation_groups_add_intervals_command: public vostok::editor_base::command
	{
	...
	public ref class animation_groups_remove_intervals_command: public vostok::editor_base::command
	{
		typedef List<animation_node_interval_instance^> intervals_list;
	public:
	...
	public ref class animation_groups_change_property_command: public vostok::editor_base::command
	{
	public:
	...
	public ref class animation_groups_change_interval_property_command: public vostok::editor_base::command
	{
	public:
	...
	public ref class animation_groups_change_link_property_command: public vostok::editor_base::command
	{
	public:
	...
	public ref class animation_groups_change_node_value_property_command: public vostok::editor_base::command
	{
	public:
