...
using vostok::animation_editor::animation_editor_viewport_panel;
using vostok::editor::controls::serializer;
	...
	m_scene		( NEW( render::scene_ptr ) )
{
	...
	m_multidocument_base = gcnew vostok::editor::controls::document_editor_base("animation_setup_manager", false);
...
void animation_setup_manager::on_scene_created( vostok::render::scene_ptr const& scene )
{
	*m_scene					= scene;
...
vostok::editor::controls::document_base^ animation_setup_manager::on_document_creating()
{
...
{
	if(persist_string=="vostok.animation_editor.animations_list_panel")
		return m_animations_list_panel;

	if(persist_string=="vostok.animation_editor.animation_setup_properties_panel")
...
void animation_setup_manager::on_resources_loaded(vostok::resources::queries_result& result)
{
...
void animation_setup_manager::set_target(vostok::animation::mixing::animation_lexeme& l, u32 const current_time_in_ms)
{
	if(m_model)
	{
		m_model->reset();
