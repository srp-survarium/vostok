...
namespace animation_editor {
	public ref class animation_groups_animations_tree : public vostok::editor::controls::file_view_panel_base
	{
		typedef vostok::editor::controls::file_view_panel_base super;
	public:
						animation_groups_animations_tree	(vostok::editor::controls::document_editor_base^ d);
