...
using namespace vostok::editor::wpf_controls::animation_lexeme_panel;
...
namespace animation_editor {
	...
	public:
		...
		property vostok::editor::wpf_controls::animation_lexeme_panel::animation_lexeme_panel^ lexeme_panel
		{
			vostok::editor::wpf_controls::animation_lexeme_panel::animation_lexeme_panel^ get () {return m_lexeme_panel_host->panel;};
		};
	...
	private:
		...
		void				on_presaved_clip_loaded		( vostok::resources::queries_result& data );
