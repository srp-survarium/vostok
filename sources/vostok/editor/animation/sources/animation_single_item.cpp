...
using vostok::animation::animation_expression_emitter;
...
vostok::animation::mixing::expression animation_single_item::emit	( mutable_buffer& buffer, bool& is_last_animation )
{
...
void animation_single_item::item_loaded_callback(vostok::resources::queries_result& data)
{
