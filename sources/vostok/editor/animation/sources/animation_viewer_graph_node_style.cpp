...
using vostok::animation_editor::animation_viewer_graph_node_style;
using vostok::animation_editor::animation_viewer_graph_nodes_style_mgr;
using vostok::editor::controls::hypergraph::view_mode;
using vostok::editor::controls::hypergraph::point_align;
using vostok::editor::controls::hypergraph::connection_type;
using vostok::editor::controls::hypergraph::connection_point_style;
////////////////////////////////////////////////////////////////////////////
//- class animation_viewer_graph_nodes_style_mgr -------------------------------------------------------
////////////////////////////////////////////////////////////////////////////
animation_viewer_graph_nodes_style_mgr::animation_viewer_graph_nodes_style_mgr()
{
...
void animation_viewer_graph_nodes_style_mgr::assign_style(node^ n, System::String^ style_name)
{
...
void animation_viewer_graph_nodes_style_mgr::load_library()
{
	query_result_delegate* rq = NEW(query_result_delegate)(gcnew query_result_delegate::Delegate(this, &animation_viewer_graph_nodes_style_mgr::on_library_loaded), g_allocator);
	vostok::resources::query_resource(
		"resources/library/node_styles/animation_viewer_node_styles.library",
...
void animation_viewer_graph_nodes_style_mgr::on_library_loaded(vostok::resources::queries_result& data)
{
	...
	for (; i!=e; ++i) 
	{
		...
		animation_viewer_graph_node_style^ style = gcnew animation_viewer_graph_node_style();
		style->load(*i);
		m_library->Add(style);
	}
}
////////////////////////////////////////////////////////////////////////////
//- class animation_viewer_graph_node_style ------------------------------------------------------------
////////////////////////////////////////////////////////////////////////////
void animation_viewer_graph_node_style::load(vostok::configs::lua_config_value const& t)
{
	name = gcnew System::String(t["name"]);
	border_pen->Width = (t.value_exists("border_pen_width"))?(float)t["border_pen_width"]:1;
	int width = t["width"];
	int height = t["height"];
	...
	vostok::configs::lua_config_value::iterator b = t["connection_styles"].begin();
	vostok::configs::lua_config_value::iterator e = t["connection_styles"].end();
	for(; b!=e; ++b)
	{
		...
		if(a=="left")
		{
			...
			new_style->base_rect = System::Drawing::Rectangle(0, (height-10)/2, 10, 10);
		}
		else if(a=="top")
		{
		...
		else if(a=="right")
		{
			...
			new_style->base_rect = System::Drawing::Rectangle(width-10, (height-10)/2, 10, 10);
		}
		else if(a=="bottom")
		{
