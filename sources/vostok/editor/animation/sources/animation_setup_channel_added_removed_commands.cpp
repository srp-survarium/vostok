...
using vostok::animation_editor::animation_setup_channel_added_command;
using vostok::animation_editor::animation_setup_channel_removed_command;
using vostok::animation_editor::animation_setup_paste_channel_command;
