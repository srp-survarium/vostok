...
using vostok::editor::controls::item_properties_panel_base;
...
namespace vostok
{
	namespace animation_editor
	{
		...
		public:
			...
			vostok::editor::controls::document_base^ on_document_creating	();

			property vostok::editor::controls::document_editor_base^	multidocument_base
			{	
				vostok::editor::controls::document_editor_base^	get( ) { return m_multidocument_base; }
			}
		...
		public:
			...
			void						scene_created				( vostok::render::scene_ptr const& scene );
		...
		private:
			...
			void						model_loaded				( vostok::resources::queries_result& result );
		...
		private:
			...
			vostok::editor::controls::document_editor_base^	m_multidocument_base;
