...
namespace animation_editor {
	...
	public:
		...
		[vostok::editor::wpf_controls::property_editors::attributes::value_range_and_format_attribute(Single::MinValue, Single::MaxValue, 0.01f, 3, update_on_edit_complete = true)]
