...
using vostok::editor::controls::document_editor_base;
	...
	m_scene		( NEW( render::scene_ptr ) )
{
	...
	m_multidocument_base->creating_new_document				= gcnew vostok::editor::controls::document_create_callback(this, &animation_collections_editor::on_document_creating);
	m_multidocument_base->content_reloading					= gcnew vostok::editor::controls::content_reload_callback(this, &animation_collections_editor::find_dock_content);
...
{
	if( persist_string == "vostok.animation_editor.animation_files_view_panel" )
		return m_animations_view_panel;
	if( persist_string == "vostok.animation_editor.animation_collections_view_panel" )
		return m_collections_view_panel;
	if( persist_string == "vostok.editor.controls.item_properties_panel_base" )
		return m_instance_properties_panel;

	return ( nullptr );
}
vostok::editor::controls::document_base^ animation_collections_editor::on_document_creating	( )
{
...
void animation_collections_editor::scene_created ( vostok::render::scene_ptr const& scene )
{
	*m_scene					= scene;
...
void animation_collections_editor::model_loaded ( vostok::resources::queries_result& result )
{
