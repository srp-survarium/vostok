...
using vostok::editor::wpf_controls::float_curve;
...
namespace animation_editor {
	...
	public:
		...
		vostok::animation::base_interpolator* interpolator		() {return m_interpolator;};
		System::Object^				parent						() {return m_parent;}
		void						save						(vostok::configs::lua_config_value& cfg);
		void						load						(vostok::configs::lua_config_value const& cfg);
		...
		[vostok::editor::wpf_controls::property_editors::attributes::value_range_and_format_attribute(0, Single::MaxValue, 0.00001f, 5, update_on_edit_complete = true)]
		...
		property float_curve^		visual
		{
				...
				void				set							(float_curve^ new_val) {VOSTOK_UNREFERENCED_PARAMETER(new_val);};
		};
	...
	private:
		...
		vostok::animation::base_interpolator*	m_interpolator;
