...
namespace animation_editor {
	...
	public:
		...
		[vostok::editor::wpf_controls::property_editors::attributes::value_range_and_format_attribute(0, Single::MaxValue, 0.001f, 3, update_on_edit_complete = true)]
		...
		[vostok::editor::wpf_controls::property_editors::attributes::value_range_and_format_attribute(0, Single::MaxValue, 1.0f, 3, update_on_edit_complete = true)]
