...
using vostok::editor::wpf_controls::property_editors::attributes::combo_box_items_attribute;
using vostok::animation_editor::animation_ui_type_lexeme_editor;
...
void animation_viewer_graph_node_animation::save(vostok::configs::lua_config_value cfg)
{
	super::save(cfg);
	cfg["type"] = 1;
...
void animation_viewer_graph_node_animation::load(vostok::configs::lua_config_value const& cfg, animation_viewer_hypergraph^ h)
{
	super::load(cfg, h);
...
void animation_viewer_graph_node_animation::on_added(vostok::editor::controls::hypergraph::hypergraph_control^ parent)
{
...
vostok::animation::skeleton_animation_ptr animation_viewer_graph_node_animation::clip()
{
	if(m_clips->Count>0)
...
////////////////////////////////////////////////////////////////////////////
void animation_ui_type_lexeme_editor::run_editor(vostok::editor::wpf_controls::property_editors::property^ prop)
{
