...
using vostok::animation_editor::animation_groups_animations_tree;

animation_groups_animations_tree::animation_groups_animations_tree(vostok::editor::controls::document_editor_base^ d)
:super(d)
{
