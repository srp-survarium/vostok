...
namespace animation_editor {
	...
	public ref class animation_setup_channel_added_command : vostok::editor_base::command
	{
	public:
	...
	public ref class animation_setup_channel_removed_command : vostok::editor_base::command
	{
	public:
	...
	public ref class animation_setup_paste_channel_command : vostok::editor_base::command
	{
	public:
