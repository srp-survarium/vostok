...
using vostok::animation_editor::animation_lexeme_editor;
using vostok::animation_editor::viewer_editor;
using vostok::animation_editor::animation_viewer_graph_node_base;
using vostok::animation_editor::animation_viewer_graph_node_animation;
using vostok::editor::wpf_controls::animation_setup::animation_channel_partition_type;
...
animation_lexeme_editor::animation_lexeme_editor(viewer_editor^ ed)
{
	...
	if( !vostok::editor::controls::serializer::deserialize_dock_panel_root( this, m_main_dock_panel, "animation_lexeme_editor",
...
{
	if( persist_string == "vostok.animation_editor.animations_view_panel" )
...
{
	vostok::editor::controls::serializer::serialize_dock_panel_root( this, m_main_dock_panel, "animation_lexeme_editor" );
...
void animation_lexeme_editor::on_presaved_clip_loaded(vostok::resources::queries_result& data)
{
	vostok::configs::lua_config_ptr cfg_ptr = static_cast_resource_ptr<vostok::configs::lua_config_ptr>(data[0].get_unmanaged_resource());
...
void animation_lexeme_editor::on_animation_loaded(vostok::animation_editor::animation_node_clip_instance^ new_clip)
{
...
void animation_viewer_graph_node_animation::on_animation_loaded(vostok::animation_editor::animation_node_clip_instance^ new_clip)
{
	if(new_clip==nullptr)
		return;
