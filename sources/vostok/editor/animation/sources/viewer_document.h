...
////////////////////////////////////////////////////////////////////////////
#ifndef VOSTOK_ANIMATION_EDITOR_VIEWER_DOCUMENT_H_INCLUDED
#define VOSTOK_ANIMATION_EDITOR_VIEWER_DOCUMENT_H_INCLUDED
...
namespace animation_editor {
	...
	using vostok::animation::editor_animation_state;
	using vostok::animation::mixing::expression;
	using vostok::animation::mixing::animation_lexeme;
	using vostok::animation::mixing::animation_lexeme_ptr;
	...
	public ref class viewer_document : public vostok::editor::controls::document_base
	{
		typedef vostok::editor::controls::document_base super;
		typedef List<vostok::editor::controls::hypergraph::node^ > nodes;
		typedef List<vostok::editor::controls::hypergraph::link^ > links;
		typedef vostok::editor::wpf_controls::property_container wpf_property_container;
		typedef map<u32, vostok::animation::mixing::animation_lexeme_ptr> lexemes_collection_type;
...
animation_viewer_graph_link^	create_connection				(vostok::editor::controls::hypergraph::node^ source, vostok::editor::controls::hypergraph::node^ destination);
	...
	private:
				void		on_resources_loaded				(vostok::resources::queries_result& result);
				void		on_new_model_loaded				(vostok::resources::queries_result& result);
...
animation_playback::animation_item^	item_by_user_data		(u32 ud);
				void		create_animation_item			(vostok::animation::mixing::animation_lexeme_ptr l);
				void		update_animation_items			(vectora<vostok::animation::editor_animation_state> const& cur_anim_states);
...
#endif // #ifndef VOSTOK_ANIMATION_EDITOR_VIEWER_DOCUMENT_H_INCLUDED