...
{
	InitializeComponent();
	m_multidocument_base = gcnew vostok::editor::controls::document_editor_base("animation_groups_editor");
	m_multidocument_base->main_dock_panel->DockBackColor = System::Drawing::SystemColors::AppWorkspace;
	m_multidocument_base->creating_new_document = gcnew vostok::editor::controls::document_create_callback(this, &animation_groups_editor::on_document_creating);
	m_multidocument_base->content_reloading = gcnew vostok::editor::controls::content_reload_callback(this, &animation_groups_editor::find_dock_content);
...
{
	if(persist_string=="vostok.animation_editor.animation_groups_toolbar")
		return m_toolbar;

	if(persist_string=="vostok.animation_editor.animation_groups_controllers_tree")
		return m_controllers_tree;

	if(persist_string=="vostok.animation_editor.animation_groups_animations_tree")
...
void animation_groups_editor::select_model()
{
	...
	if(vostok::editor_base::resource_chooser::choose("solid_visual", d->model, nullptr, selected, true))
