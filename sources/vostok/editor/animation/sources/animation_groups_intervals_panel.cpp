...
using vostok::animation_editor::animation_groups_intervals_panel;
...
void animation_groups_intervals_panel::animation_loaded(vostok::animation_editor::animation_node_clip_instance^ new_clip)
{
