...
void viewer_editor::init_controls()
{
	...
	m_multidocument_base = gcnew vostok::editor::controls::document_editor_base("animation_viewer_editor");
	...
	m_multidocument_base->creating_new_document = gcnew vostok::editor::controls::document_create_callback(this, &viewer_editor::on_document_creating);
	m_multidocument_base->content_reloading = gcnew vostok::editor::controls::content_reload_callback(this, &viewer_editor::find_dock_content);
...
bool viewer_editor::close_query()
{
	...
	{
		System::Collections::Generic::List<vostok::editor::controls::document_base^ >^ lst = gcnew System::Collections::Generic::List<vostok::editor::controls::document_base^>();
...
{
	if(persist_string=="vostok.animation_editor.animation_viewer_toolbar_panel")
		return m_toolbar_panel;

	if(persist_string=="vostok.animation_editor.animation_viewer_properties_panel")
		return m_properties_panel;

	if(persist_string=="vostok.animation_editor.animation_viewer_time_panel")
		return m_time_panel;

	return (nullptr);
}

vostok::editor::controls::document_base^ viewer_editor::on_document_creating()
{
...
void viewer_editor::on_node_property_changed(System::Object^ sender, value_changed_event_args^ e)
{
	...
	{
		//safe_cast<vostok::editor::wpf_controls::property_editors::item::item_editor_base^>(e->changed_property->property_parent->owner_editor)->reset_sub_properties();
...
void viewer_editor::run_lexeme_editor(vostok::animation_editor::animation_viewer_graph_node_base^ n)
{
	m_lexeme_editor->show(m_multidocument_base->main_dock_panel, n);
}

void viewer_editor::set_animation_node_new_intervals_list(animation_viewer_graph_node_base^ n, List<vostok::animation_editor::animation_node_interval^>^ lst, u32 cycle_index)
{
	if( m_multidocument_base->active_document != nullptr )
