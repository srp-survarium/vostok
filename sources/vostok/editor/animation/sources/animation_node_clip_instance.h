...
namespace animation_editor {
	...
	public:
									animation_node_clip_instance	(animation_node_clip^ base, vostok::configs::lua_config_ptr cfg);
									~animation_node_clip_instance	();
		wpf_property_container^		container						() {return m_container;};
		float						animation_length				();
		vostok::animation::skeleton_animation_ptr	animation			();
		vostok::animation::i_editor_animation*	editor_animation	();
		void						save							();
		pcstr						name							();
		...
		[vostok::editor::wpf_controls::property_editors::attributes::value_range_and_format_attribute(-1, Int32::MaxValue, 1, 0, update_on_edit_complete = true)]
	...
	private:
		...
		vostok::animation::skeleton_animation_ptr*	m_animation_clip;
		vostok::configs::lua_config_ptr*				m_config;	
