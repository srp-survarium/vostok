...
namespace animation_editor {
	...
	public ref class animation_viewer_hypergraph: public vostok::editor::controls::hypergraph::hypergraph_control
	{
	...
	//	virtual void	do_layout					() override;
				...
				void	undo						();
				void	redo						();
				void	save						(vostok::configs::lua_config_value cfg);
				void	save						(vostok::configs::lua_config_value cfg, nodes^ nds, links^ lnks);
