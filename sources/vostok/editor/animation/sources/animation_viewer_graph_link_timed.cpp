...
using vostok::animation_editor::animation_viewer_graph_link_timed;
...
void animation_viewer_graph_link_timed::load(vostok::configs::lua_config_value const& cfg)
{
	super::load(cfg);
	m_time->time_s = (float)cfg["playing_time"];
}

void animation_viewer_graph_link_timed::save(vostok::configs::lua_config_value cfg)
{
	super::save(cfg);
	cfg["playing_time"] = m_time->time_s;
}

void animation_viewer_graph_link_timed::draw(System::Drawing::Graphics^ g, System::Drawing::Pen^ pen, vostok::editor::controls::hypergraph::nodes_link_style link_style)
{
...
vostok::animation_editor::animation_viewer_graph_link_timed::wpf_property_container^ animation_viewer_graph_link_timed::playing_time::get()
{
