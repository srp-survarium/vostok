...
using vostok::animation_editor::animations_view_source;
using System::Windows::Forms::TreeNode;
using System::Reflection::BindingFlags;
using vostok::animation_editor::animations_node_sorter;
...
void animations_view_source::on_fs_iterator_ready(vostok::vfs::vfs_locked_iterator const & fs_it)
{
...
void animations_view_source::process_fs(vostok::vfs::vfs_iterator const & in_it, String^ file_path)
{
