...
void viewer_document::set_target( vostok::animation_editor::animation_viewer_graph_node_base^ n )
{
	if( n == nullptr )
	{
...
void viewer_document::create_animation_item( vostok::animation::mixing::animation_lexeme_ptr lexeme )
{
...
void viewer_document::update_animation_items( vostok::vectora<vostok::animation::editor_animation_state> const& cur_anim_states )
{
...
bool viewer_document::can_create_expression_from_node( vostok::animation_editor::animation_viewer_graph_node_base^ n )
{
	if( n == nullptr )
		return false;
...
expression viewer_document::create_expression_from_node( vostok::animation_editor::animation_viewer_graph_node_base^ n, vostok::mutable_buffer& buffer, bool create_anim_items )
{
	animation_viewer_graph_node_animation^ anim = dynamic_cast<animation_viewer_graph_node_animation^>( n );
	if( anim )
	{
...
animation_lexeme_ptr viewer_document::create_animation_lexeme( vostok::animation_editor::animation_viewer_graph_node_animation^ node, vostok::mutable_buffer& buffer, bool create_anim_items )
{
