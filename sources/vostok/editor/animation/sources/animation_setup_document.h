...
namespace animation_editor {
	...
	public ref class animation_setup_document : public vostok::editor::controls::document_base
	{
	...
	public:
		...
		virtual	void		del										() override;
				...
				void		load_channel							(vostok::configs::lua_config_value const& cfg);
				void		save_all_channels						();
				void		save_channel							(animation_channel^ ch, vostok::configs::lua_config_value& cfg);
