...
using namespace vostok::editor_base;
...
namespace animation_editor {
	...
	public delegate void navigation_controller_delegate		(vostok::animation::mixing::expression const& expr, u32 current_time_in_ms);
	public delegate void animation_clip_request_callback	(animation_node_clip_instance^ clip);
	public delegate void request_delegate					(vostok::resources::queries_result& data, animation_clip_request_callback^ callback);
	...
	struct navigation_controller_query
	{
		...
		void callback(vostok::animation::mixing::expression const& expr, u32 current_time_in_ms)
		{
	...
	struct animation_clip_query
	{
		...
		void callback(vostok::resources::queries_result& data)
		{
	...
	public:
		static const		u32					expression_alloca_buffer_size = 64 * vostok::Kb;
	...
	private:
				...
				void							on_controller_loaded	(vostok::resources::queries_result& result);
				void							tick_navigation_mode	();
				void							on_render_resources_ready(vostok::resources::queries_result& data);
				void							query_create_render_resources();
				void							controller_set_target_callback(vostok::animation::mixing::expression const& expr, u32 current_time_in_ms);
				void							inc_time_scale			();
				void							dec_time_scale			();
				void							reset_time_scale		();
				void							on_anim_clip_loaded		(vostok::resources::queries_result& result, animation_clip_request_callback^ cb);
	...
	private:
		...
		vostok::rtp::animation_controller_ptr*	m_controller;
		...
		vostok::configs::lua_config_ptr*			m_controller_config;
