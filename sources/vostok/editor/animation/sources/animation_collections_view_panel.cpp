...
animation_collections_view_panel::animation_collections_view_panel( animation_collections_editor^ parent )
	:vostok::editor::controls::file_view_panel_base( parent->multidocument_base, "Animation Collections" ),
	m_parent  ( parent )
{
	in_constructor	( );
	HideOnClose		= true;
...
void animation_collections_view_panel::in_constructor()
{
	...
	m_raw_files_tree_view->selected_items_changed += gcnew EventHandler<vostok::editor::controls::tree_view_selection_event_args^>(this, &animation_collections_view_panel::selection_changed);
...
void animation_collections_view_panel::selection_changed(Object^, vostok::editor::controls::tree_view_selection_event_args^)
{
