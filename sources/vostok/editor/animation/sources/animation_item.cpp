...
{
	if( vostok::editor::wpf_controls::dot_net_helpers::is_type<animation_collection_item^>( this ) )
		return animation_item_type::animation_collection_item;

	R_ASSERT( vostok::editor::wpf_controls::dot_net_helpers::is_type<animation_single_item^>( this ) );
