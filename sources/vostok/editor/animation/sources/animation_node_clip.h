...
namespace animation_editor {
	...
	public:
									animation_node_clip		(System::String^ name, vostok::animation::skeleton_animation_ptr anim, vostok::configs::lua_config_ptr cfg, animation_editor_form^ f);
									~animation_node_clip	();		
	...
	private:
		...
		vostok::animation::i_editor_animation*		m_animation;
