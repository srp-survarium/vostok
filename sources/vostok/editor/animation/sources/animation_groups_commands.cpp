...
using vostok::animation_editor::animation_groups_add_group_command;
using vostok::animation_editor::animation_groups_delete_selected_command;
using vostok::animation_editor::animation_groups_add_link_command;
using vostok::animation_editor::animation_groups_change_model_command;
using vostok::animation_editor::animation_groups_nodes_move_command;
using vostok::animation_editor::animation_groups_add_intervals_command;
using vostok::animation_editor::animation_groups_remove_intervals_command;
using vostok::animation_editor::animation_groups_change_property_command;
using vostok::animation_editor::animation_groups_change_interval_property_command;
using vostok::animation_editor::animation_groups_change_link_property_command;
using vostok::animation_editor::animation_groups_change_node_value_property_command;
...
:m_document(d)
{
	...
	vostok::configs::lua_config_ptr controller_cfg = vostok::configs::create_lua_config();
	vostok::strings::stream stream(g_allocator);
	vostok::configs::lua_config_value controller_root = controller_cfg->get_root()["animation_controller_set"]["animation_groups"];
	vostok::configs::lua_config_value scene_root = controller_cfg->get_root()["scene"]["nodes"];
	vostok::configs::lua_config_value groups_root = controller_cfg->get_root()["groups"];
...
void animation_groups_delete_selected_command::rollback()
{
	...
	vostok::configs::lua_config_iterator it_contr = config_ptr->get_root()["animation_controller_set"]["animation_groups"].begin();
	vostok::configs::lua_config_iterator it_scene = config_ptr->get_root()["scene"]["nodes"].begin();
	vostok::configs::lua_config_iterator it_groups = config_ptr->get_root()["groups"].begin();
	...
	vostok::configs::lua_config_iterator it_links = config_ptr->get_root()["scene"]["links"].begin();
