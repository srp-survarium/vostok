...
using vostok::particle_editor::particle_links_manager;
...
{
	vostok::editor::controls::hypergraph::connection_point^ dst_point = src_node->get_connection_point("parent");
	if(dst_point==nullptr)
		dst_point = src_node->add_connection_point(node::typeid, "parent");

	vostok::editor::controls::hypergraph::connection_point^ src_point = dst_node->get_connection_point("child");
...
void particle_links_manager::destroy_link(node^ src_node, node^ dst_node)
{
	...
	vostok::editor::controls::hypergraph::connection_point^ pt_src = src_node->get_connection_point("parent");
	vostok::editor::controls::hypergraph::connection_point^ pt_dst = dst_node->get_connection_point("child");
