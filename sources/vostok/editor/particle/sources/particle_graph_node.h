...
namespace vostok {
	namespace particle_editor {
		...
		public ref class particle_graph_node : public vostok::editor::controls::hypergraph::node, public i_cloneable<particle_graph_node>
		{
		...
		private:
			static vostok::editor::controls::drag_cursor_collection^	m_cursors;
...
// 			property vostok::editor_base::property_holder_wrapper^	prop_holder{
// 				vostok::editor_base::property_holder_wrapper^			get(){return m_property_holder;};
// 			}
