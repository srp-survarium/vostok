...
using vostok::particle_editor::particle_graph_node_style;
using vostok::particle_editor::particle_graph_node_style_mgr;
...
particle_graph_node_style_mgr::particle_graph_node_style_mgr()
{
	...
	m_images		= vostok::editor_base::image_loader::load_images("images92x25", "particle_editor.resources", 92, safe_cast<int>(images92x25_count), this->GetType()->Assembly);
	m_mini_images	= vostok::editor_base::image_loader::load_images("images30x25", "particle_editor.resources", 30, safe_cast<int>(images30x25_count), this->GetType()->Assembly);	
}
