...
using vostok::particle_editor::particle_graph_node;
...
{
	m_node_config					= CRT_NEW(vostok::configs::lua_config_value)((*vostok::configs::create_lua_config()).get_root()["node_config"]);
...
void					particle_graph_node::OnMouseMove		(MouseEventArgs^ e)
{
	...
	if(is_on_graph){
		vostok::editor::controls::hypergraph::node::OnMouseMove(e);
	}
}
...
void					particle_graph_node::OnMouseDown		(MouseEventArgs^ e)
{
	...
	if(is_on_graph){		
		vostok::editor::controls::hypergraph::node::OnMouseDown(e);
...
void					particle_graph_node::OnMouseUp			(MouseEventArgs^ e)
{
	...
	if(is_on_graph){
		vostok::editor::controls::hypergraph::node::OnMouseUp(e);	
		safe_cast<particle_hypergraph^>(parent_hypergraph)->hide_available_nodes(this);
...
static void get_final_lua_config_value(	vostok::configs::lua_config_value const& from_value, 
										vostok::configs::lua_config_value final_value)
{
...
void particle_graph_node::set_parent_node_impl(particle_graph_node^ node){
	...
	using namespace vostok::editor::controls::hypergraph;
