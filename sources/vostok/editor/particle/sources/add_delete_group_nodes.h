...
public ref class add_group : public vostok::editor_base::command
{
...
public ref class remove_group : public vostok::editor_base::command
{
	typedef System::Collections::Generic::List<vostok::editor::controls::hypergraph::node^ > nodes;
public:
	remove_group	(particle_hypergraph^ h, List<vostok::editor::controls::hypergraph::node^ >^ nds);
