...
static void draw_text(vostok::ui::world& ui_world, vostok::render::scene_view_ptr const& scene_view, pcstr str, float pos_x, float pos_y, u32 clr)
{
...
void particle_editor::on_document_delete_lod( vostok::editor::controls::tree_node^ node )
{
	String^ message;
