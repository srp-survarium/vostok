...
namespace vostok {
	namespace particle_editor {
		public ref class particle_graph_node_style : public vostok::editor::controls::hypergraph::node_style
		{
		public:
			void	load	(configs::lua_config_value const& t);
		}; // ref class particle_graph_node_style

		ref class particle_graph_node_style_mgr : public vostok::editor::controls::hypergraph::nodes_style_manager
		{
		private:
