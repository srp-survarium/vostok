...
namespace vostok {
	...
	namespace particle_editor {
		...
		ref class vostok::editor::controls::hypergraph::connection_point;
		...
		enum class vostok::editor::controls::hypergraph::view_mode;

		public ref class particle_hypergraph : public vostok::editor::controls::hypergraph::hypergraph_control
		{
		private:
			typedef vostok::editor::controls::hypergraph::hypergraph_control super;
		...
		private: 
			...
			vostok::editor_base::command_engine^			m_command_engine;

		public:
			property vostok::editor_base::command_engine^ comm_engine{
				vostok::editor_base::command_engine^				get() {return m_command_engine;}
			}
