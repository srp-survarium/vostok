...
using namespace vostok::editor;
using vostok::editor::controls::hypergraph::hypergraph_control;
using vostok::editor::controls::hypergraph::connection_editor;
using vostok::editor::controls::hypergraph::connection_point;
...
void particle_graph_document::in_constructor()
{
	...
	m_hypergraph->current_view_mode = vostok::editor::controls::hypergraph::view_mode::full;
	...
	m_hypergraph->move_mode = vostok::editor::controls::hypergraph::nodes_movability::by_nodes_movability;
	m_hypergraph->link_style = vostok::editor::controls::hypergraph::nodes_link_style::line;
	...
	m_hypergraph->visibility_mode = vostok::editor::controls::hypergraph::nodes_visibility::all;
	m_hypergraph->on_selection_changed += gcnew vostok::editor::controls::hypergraph::selection_changed(this, &particle_graph_document::on_selection_changed);
	...
	m_particle_system_ptr = CRT_NEW(vostok::particle::particle_system*)();
...
controls::hypergraph::link^ particle_graph_document::create_connection		(vostok::editor::controls::hypergraph::node^ source, vostok::editor::controls::hypergraph::node^ destination)
{
	...
	vostok::editor::controls::hypergraph::connection_point^ src_pt = src->get_connection_point("child");
	vostok::editor::controls::hypergraph::connection_point^ dst_pt = dst->get_connection_point("parent");
	if(src_pt==nullptr)
	...
	vostok::editor::controls::hypergraph::link^ new_link = gcnew vostok::editor::controls::hypergraph::link(src_pt, dst_pt);
	
	return new_link;	
}
void particle_graph_document::add_connection			(vostok::editor::controls::hypergraph::node^ source, vostok::editor::controls::hypergraph::node^ destination)
{
...
{
	VOSTOK_UNREFERENCED_PARAMETERS(lnks);
}	
...
void particle_graph_document::load_partialy					(String^ part_path)
{
		...
		query_result_delegate* rq = VOSTOK_NEW_IMPL(g_allocator, query_result_delegate)(gcnew query_result_delegate::Delegate(this, &particle_graph_document::on_document_loaded), g_allocator);
...
void particle_graph_document::load_from_config(vostok::configs::lua_config_ptr config)
{
...
void particle_graph_document::on_document_loaded		(vostok::resources::queries_result& data)
{
...
void particle_graph_document::copy(Boolean is_cut)
{
	if(m_hypergraph->selected_nodes->Count > 0)
	{
		...
		vostok::os::copy_to_clipboard	( (pcstr)stream.get_buffer() );
...
void particle_graph_document::paste					()
{
	if(m_hypergraph->selected_nodes->Count > 0)
	{
		...
		configs::lua_config_ptr config = vostok::configs::create_lua_config_from_string( string );
		FREE					( string );
...
void particle_graph_document::gather_statistics(vostok::particle::preview_particle_emitter_info* out_buffer)
{
...
void particle_graph_document::particle_system_property_changed(particle_graph_node^ node, vostok::configs::lua_config_value& value){
...
void particle_graph_document::particle_system_node_added(particle_graph_node^ node, vostok::configs::lua_config_value& value){
 	configs::lua_config_value outgoing	= configs::create_lua_config()->get_root()["incoming"];
