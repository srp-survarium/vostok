...
namespace render { 
	...
	namespace particle_editor {
		...
		public ref class particle_editor : public vostok::editor_base::tool_window
		{
		public:
										particle_editor		( System::String^ res_path, vostok::render::world& render_world, vostok::ui::world& ui_world, vostok::editor_base::tool_window_holder^ h) ;
		...
		private:
			...
			vostok::editor_base::tool_window_holder^		m_holder;
			bool										m_closed;
			...
			vostok::editor_base::scene_view_panel^		m_view_window;
			vostok::editor_base::input_engine^			m_input_engine;
			vostok::editor_base::gui_binder^				m_gui_binder;
			vostok::editor_base::options_dialog^			m_options_dialog;


			vostok::editor::controls::item_properties_panel_base^	m_properties_panel;
			vostok::editor::controls::file_view_panel_base^		m_particles_panel;
			vostok::editor::controls::toolbar_panel_base^			m_toolbar_panel;
...
private:	System::Windows::Forms::ToolStripMenuItem^  optionsToolStripMenuItem;
		...
		public:
			...
			property vostok::editor_base::editor_control_base^		active_control;
			
			property pe_transform_control_helper^		transform_helper{
				pe_transform_control_helper^		get() {return m_transform_control_helper;}
			}

			property vostok::editor_base::scene_view_panel^		view_window{
				vostok::editor_base::scene_view_panel^			get() {return m_view_window;}
			}
			property vostok::editor::controls::item_properties_panel_base^	properties_panel{
				vostok::editor::controls::item_properties_panel_base^		get(){return m_properties_panel;}
			}

			property vostok::editor::controls::file_view_panel_base^		particles_panel{
				vostok::editor::controls::file_view_panel_base^				get(){return m_particles_panel;}
			}

			property vostok::editor::controls::toolbar_panel_base^			tollbar_panel{
				vostok::editor::controls::toolbar_panel_base^				get(){return m_toolbar_panel;}
			}
			...
			property vostok::editor_base::gui_binder^			gui_binder{
				vostok::editor_base::gui_binder^				get(){return m_gui_binder;}
			}
		...
		private:
			...
			void			on_document_delete_lod			(  vostok::editor::controls::tree_node^ node );
			void			on_tree_view_expand_node		(Object^, TreeViewCancelEventArgs^ e);
			void			load_document					(vostok::editor::controls::tree_node^ node);
			void			load_particles_library			( );
			void			on_particles_library_loaded		( vostok::resources::queries_result& data );
		...
		public:
			...
			void			add_context_menu_to_tree_view_node(vostok::editor::controls::tree_node^ node);
