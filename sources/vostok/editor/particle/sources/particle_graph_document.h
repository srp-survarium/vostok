...
namespace vostok
{
	namespace particle_editor
	{
		...
		ref class vostok::editor::controls::hypergraph::node;
		ref class vostok::editor::controls::hypergraph::link;
		/// <summary>
		/// Summary for particle_graph_document
		/// </summary>
		public ref class particle_graph_document : public vostok::editor::controls::document_base
		{
			typedef vostok::editor::controls::document_base super;
			typedef Generic::List<vostok::editor::controls::hypergraph::node^ >	nodes;
			typedef Generic::List<vostok::editor::controls::hypergraph::link^ >	links;
		...
		private:
			...
			String^										m_lod_name;
			vostok::particle::particle_system**			m_particle_system_ptr;
			math::float4x4*								m_particle_system_root_matrix;
						
			Collections::Generic::List<vostok::editor::controls::hypergraph::node^>^		m_cuted_nodes;
		...
		public:
			...
			property vostok::particle::particle_system**	particle_system_ptr {
				vostok::particle::particle_system**		get(){return m_particle_system_ptr;}
			}
		...
		public:
			...
			vostok::editor::controls::hypergraph::link^	create_connection		(vostok::editor::controls::hypergraph::node^ source, vostok::editor::controls::hypergraph::node^ destination);
			void						add_connection			(vostok::editor::controls::hypergraph::node^ source, vostok::editor::controls::hypergraph::node^ destination);
			...
			void						on_document_loaded		(vostok::resources::queries_result& data);
			...
			void						gather_statistics(vostok::particle::preview_particle_emitter_info* out_buffer);

			void						particle_system_property_changed		(particle_graph_node^ node, vostok::configs::lua_config_value& value);
			void						particle_system_node_added				(particle_graph_node^ node, vostok::configs::lua_config_value& value);
