...
#ifndef VOSTOK_MEMORY_SEQUENTIAL_CHUNK_READER_INLINE_H_INCLUDED
#define VOSTOK_MEMORY_SEQUENTIAL_CHUNK_READER_INLINE_H_INCLUDED

#define TEMPLATE_SIGNATURE			template < typename implementation >
#define SEQUENTIAL_CHUNK_READER		vostok::memory::sequential_chunk_reader< implementation >
...
#endif // #ifndef VOSTOK_MEMORY_SEQUENTIAL_CHUNK_READER_INLINE_H_INCLUDED