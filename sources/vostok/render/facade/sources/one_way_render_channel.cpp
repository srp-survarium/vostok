...
void one_way_render_channel::render_on_draw_scene			( vostok::render::scene_ptr const& scene, vostok::render::scene_view_ptr const& scene_view, bool const use_depth )
{
