...
renderer::renderer			( vostok::render::one_way_render_channel& channel, vostok::memory::base_allocator& allocator, vostok::render::engine::world& engine_world ) :
...
void renderer::draw_line	( scene_ptr const& scene, float3 const& start_point, float3 const& end_point, vostok::math::color const& color, bool const use_depth )
{
...
void  renderer::draw_cross( scene_ptr const& scene, float3 const& p, float const half_size, vostok::math::color const& color, bool const use_depth )
{
...
void renderer::draw_aabb		( scene_ptr const& scene, float3 const& center, float3 const& size, vostok::math::color const& color, bool const use_depth )
{
	draw_cube					(
		scene,
...
void renderer::draw_ellipsoid	( scene_ptr const& scene, float4x4 const& matrix, float3 const& size, vostok::math::color const& color, bool const use_depth )
{
	draw_lines					(
		scene,
		matrix,
...
void renderer::draw_cylinder	( scene_ptr const& scene, float4x4 const& matrix, float3 const& size, vostok::math::color const& color, bool const use_depth )
{
	//math::aabb bb = (math::aabb().identity()*size).modify(matrix);
	//if(frustum.test_inexact(bb)==math::intersection_outside)
	//	return;
...
void renderer::draw_cone			( scene_ptr const& scene, float4x4 const& matrix, float3 const& size, vostok::math::color const& color, bool const use_depth )
{
...
void renderer::draw_cube_solid		( scene_ptr const& scene, float4x4 const& matrix, float3 const& size, vostok::math::color const& color, bool const use_depth )
{
	//math::aabb bb = (math::aabb().identity()*size).modify(matrix);
	//if(frustum.test_inexact(bb)==math::intersection_outside)
	//	return;
...
void renderer::draw_cylinder_solid	( scene_ptr const& scene, float4x4 const& matrix, float3 const& size, vostok::math::color const& color, bool const use_depth )
{
	draw_primitive_solid		( 
		scene,
		// this is temporary, coordinates of the primitive need to be updated.
...
void renderer::draw_primitive_solid	( scene_ptr const& scene, float4x4 const& matrix, float3 const& size, float const* const vertices,  u32 vertex_count, u16 const* const faces, u32 const index_count, vostok::math::color const& color, bool const use_depth )
{
...
void renderer::draw_arrow		( scene_ptr const& scene, float3 const& start_point, float3 const& end_point, vostok::math::color const& line_color, vostok::math::color const& cone_color, bool const use_depth )
{
...
void renderer::draw_arrow		( scene_ptr const& scene, float3 const& start_point, float3 const& end_point, vostok::math::color const& color, bool const use_depth )
{
	draw_arrow					(
		scene,
		start_point,
...
void renderer::draw_line_ellipsoid( scene_ptr const& scene, float4x4 const& matrix, vostok::math::color const& color, bool const use_depth )
{
	draw_lines(
		scene,
		matrix,
...
void renderer::draw_line_hemisphere( scene_ptr const& scene, float4x4 const& matrix, float3 const& size, bool bdraw_base, vostok::math::color const& color, bool const use_depth )
{
	// base is XY plane
	draw_lines(
		scene,
...
void renderer::draw_line_capsule( scene_ptr const& scene, float4x4 const& matrix, float3 const& size, vostok::math::color const& color, bool const use_depth )
{
...
void renderer::draw_solid_capsule( scene_ptr const& scene, float4x4 const& matrix, float3 const& size, vostok::math::color const& color, bool const use_depth )
{
...
void renderer::draw_lines( scene_ptr const& scene, vostok::vectora< vertex_colored > const& vertices, vostok::vectora< u16 > const& indices, bool const use_depth )
{
...
void renderer::draw_triangles	( scene_ptr const& scene, vostok::render::debug_vertices_type const &vertices, vostok::render::debug_indices_type const& indices, bool const use_depth )
{
	R_ASSERT_CMP				( vertices.size(), <=, max_debug_vertices_count );
