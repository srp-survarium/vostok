...
#ifndef VOSTOK_RENDER_FACADE_RENDER_STAGE_TYPES_H_INCLUDED
#define VOSTOK_RENDER_FACADE_RENDER_STAGE_TYPES_H_INCLUDED
namespace vostok {
namespace render {
...
#endif // #ifndef VOSTOK_RENDER_FACADE_RENDER_STAGE_TYPES_H_INCLUDED
