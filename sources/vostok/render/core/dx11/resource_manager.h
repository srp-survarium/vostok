...
#include <vostok/render/core/shader_macros.h>	// for shader_defines_list only!
...
public:
	...
	struct shader_source
	{
		...
		data(::vostok::debug::g_mt_allocator),
		includes(::vostok::debug::g_mt_allocator)
#endif // #ifdef MASTER_GOLD
		{}
		vostok::vectora<u8>		data;
		u32						time;
		vostok::vectora<pcstr>	includes;
	};
...
#if 0
	void					initialize_texture_storage	( vostok::configs::lua_config_value const & cfg);
#endif
...
private:
	...
	void on_texture_source_changed  (vostok::vfs::vfs_notification const & info);
