...
#ifndef VOSTOK_RENDER_CORE_SHADER_CONSTANT_BUFFER_INLINE_H_INCLUDED
#define VOSTOK_RENDER_CORE_SHADER_CONSTANT_BUFFER_INLINE_H_INCLUDED
...
// 	
// 	m_changed					= true;//vostok::memory::compare(
// 		//vostok::const_buffer(destination_ptr, copy_size),
// 		//vostok::const_buffer(src_ptr, copy_size)
// 	//) != 0;
// 	
// 	if (m_changed)
// 		vostok::memory::copy		(destination_ptr, copy_size, src_ptr, copy_size);
}
...
// 	u32 const copy_size			= ((s32)size <= ( (s32)m_buffer_size - offset)) ? size : ((s32) m_buffer_size - offset);
// 
// 	vostok::memory::zero			(destination_ptr, copy_size);
// 	
// 	m_changed					= true;
}
...
#endif // #ifndef VOSTOK_RENDER_CORE_SHADER_CONSTANT_BUFFER_INLINE_H_INCLUDED