...
#ifndef VOSTOK_RENDER_CORE_SHADER_CONSTANT_BUFFER_H_INCLUDED
#define VOSTOK_RENDER_CORE_SHADER_CONSTANT_BUFFER_H_INCLUDED
...
//
//private:
//	VOSTOK_ALIGN( 16)	fixed_vector<T,limit>	m_array;
//	u32										m_low, m_hi;
//
//}; // t_cache
...
private:
	...
	//	VOSTOK_ALIGN(16) float_cache			m_float_cache;
	// Will be used later
	//	VOSTOK_ALIGN(16)	t_i					c_i;
	//	VOSTOK_ALIGN(16)	t_b					c_b;
...
#include <vostok/render/core/shader_constant_buffer_inline.h>

#endif // #ifndef VOSTOK_RENDER_CORE_SHADER_CONSTANT_BUFFER_H_INCLUDED