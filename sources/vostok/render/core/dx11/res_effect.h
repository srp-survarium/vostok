...
#include <vostok/render/core/res_input_layout.h>
...
typedef vostok::intrusive_ptr< res_vs, resource_intrusive_base, threading::single_threading_policy >	ref_vs;

struct gs_data;
typedef res_xs< gs_data >		res_gs;
typedef vostok::intrusive_ptr< res_gs, resource_intrusive_base, threading::single_threading_policy >	ref_gs;

struct ps_data;
typedef res_xs< ps_data >		res_ps;
typedef vostok::intrusive_ptr< res_ps, resource_intrusive_base, threading::single_threading_policy >	ref_ps;

class res_state;
typedef vostok::intrusive_ptr<res_state, resource_intrusive_base, threading::single_threading_policy>	ref_state;

class res_declaration;

class res_input_layout;
typedef vostok::intrusive_ptr<res_input_layout, resource_intrusive_base, threading::single_threading_policy>			input_layout_ptr;
...
public:
	res_effect() :
#ifndef MASTER_GOLD
			used_shaders(vostok::debug::g_mt_allocator),
...
#ifndef MASTER_GOLD
	vostok::vectora<fs_new::virtual_path_string>	used_shaders;
...
typedef vostok::intrusive_ptr < custom_config, custom_config, threading::simple_lock > custom_config_ptr;
...
typedef	vostok::resources::resource_ptr < binary_shader_source, vostok::resources::unmanaged_intrusive_base > binary_shader_source_ptr;
