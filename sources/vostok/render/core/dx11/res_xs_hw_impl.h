...
#ifndef VOSTOK_RENDER_CORE_RES_XS_HW_IMPL_H_INCLUDED
#define VOSTOK_RENDER_CORE_RES_XS_HW_IMPL_H_INCLUDED
...
{
	VOSTOK_UNREFERENCED_PARAMETERS( shader_code, hardware_shader);
	NODEFAULT;
	return 0;
}
...
#endif // #ifndef VOSTOK_RENDER_CORE_RES_XS_HW_IMPL_H_INCLUDED