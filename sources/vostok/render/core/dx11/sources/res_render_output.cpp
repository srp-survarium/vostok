...
void res_render_output::update_depth_stencil_buffer()
{
	...
	m_texture_zb = resource_manager::ref().create_texture( m_depth_rexture_name.get_buffer(), 0, 0, false, true, true, 0 );
