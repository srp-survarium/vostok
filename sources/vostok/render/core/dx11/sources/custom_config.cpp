...
template<class T, class T2> static void construct(T const& value, T2& item, vostok::mutable_buffer& data_buffer)
{
...
template<class T> static void fill_data(T const& value, vostok::mutable_buffer& data_buffer)
{
...
template<class T> static void fill_data_crc_buffer(T const& value, vostok::mutable_buffer& buffer)
{
	if (value.id)
	{
		u32 len = strings::length(value.id) + 1;
...
template<class T> static custom_config* create_custom_config_impl(T const& value, vostok::mutable_buffer& data_buffer, u32& out_data_crc, bool is_calc_data_crc)
{
...
template<class T> static custom_config_ptr create_custom_config_impl(T const& value, u32& out_data_crc, bool is_calc_data_crc)
{
	...
	vostok::mutable_buffer b( ALLOC(byte, num_bytes_for_data), num_bytes_for_data );
...
custom_config_ptr create_custom_config(effect_options_descriptor const& value, vostok::mutable_buffer& data_buffer, u32& out_data_crc, bool is_calc_data_crc)
{
	return create_custom_config_impl(value, data_buffer, out_data_crc, is_calc_data_crc);
}

custom_config_ptr create_custom_config(custom_config_value const& value, vostok::mutable_buffer& data_buffer, u32& out_data_crc, bool is_calc_data_crc)
{
	return create_custom_config_impl(value, data_buffer, out_data_crc, is_calc_data_crc);
}

custom_config_ptr create_custom_config(configs::binary_config_value const& value, vostok::mutable_buffer& data_buffer, u32& out_data_crc, bool is_calc_data_crc)
{
	return create_custom_config_impl(value, data_buffer, out_data_crc, is_calc_data_crc);
}
...
configs::binary_config_value copy_binary_config_value(configs::binary_config_value const& value, vostok::mutable_buffer buffer, u32& out_data_crc, bool in_calc_data_crc)
{
