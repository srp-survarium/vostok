...
class res_signature;
typedef vostok::intrusive_ptr<res_signature const, res_signature const, threading::single_threading_policy>	signature_const_ptr;
...
typedef vostok::intrusive_ptr<res_input_layout const, resource_intrusive_base const, threading::single_threading_policy>	ref_input_layout_const;
