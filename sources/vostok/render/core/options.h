...
#ifndef VOSTOK_RENDER_OPTIONS2_H_INCLUDED
#define VOSTOK_RENDER_OPTIONS2_H_INCLUDED
...
public:
	...
	void	load_from_config			 (vostok::configs::binary_config_value const& config);

	fs_new::virtual_path_string	get_current_configuration	 ();
	
#ifndef MASTER_GOLD
	void	save_to_config				 (vostok::configs::lua_config_value& config);
...
private:
	...
	void	load_impl					 (vostok::memory::reader& F);
...
public:
	vostok::console_commands::console_command* first_command;
	vostok::console_commands::console_command* last_command;
...
#endif // #ifndef VOSTOK_RENDER_OPTIONS2_H_INCLUDED