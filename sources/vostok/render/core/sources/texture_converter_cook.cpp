...
vostok::command_line::key	g_highquality_dds("hq_dds", "", "render", "using nvidia texture converter for producing DDS texture (slow, but high quality)");
...
{
	VOSTOK_UNREFERENCED_PARAMETER				(is_additional_buffer);
...
{
	VOSTOK_UNREFERENCED_PARAMETER				(file_exist);
	u32 buffer_size						=	0;
