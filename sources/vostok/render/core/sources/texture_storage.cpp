...
#if 0
void texture_storage::initialize( vostok::configs::lua_config_value  const & initial_params, size_t memory_amount, D3D_USAGE usage)
{
	...
	vostok::configs::lua_config_value::const_iterator it = initial_params.begin();
	vostok::configs::lua_config_value::const_iterator end = initial_params.end();
