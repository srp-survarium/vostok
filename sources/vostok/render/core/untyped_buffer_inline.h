...
#ifndef VOSTOK_RENDER_CORE_UNTYPED_BUFFER_INLINE_H_INCLUDED
#define VOSTOK_RENDER_CORE_UNTYPED_BUFFER_INLINE_H_INCLUDED
...
#endif // #ifndef VOSTOK_RENDER_CORE_UNTYPED_BUFFER_INLINE_H_INCLUDED