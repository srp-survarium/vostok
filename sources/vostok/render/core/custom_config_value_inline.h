...
#ifndef VOSTOK_RENDER_CORE_CUSTOM_CONFIG_VALUE_INLINE_H_INCLUDED
#define VOSTOK_RENDER_CORE_CUSTOM_CONFIG_VALUE_INLINE_H_INCLUDED
...
inline bool custom_config_value::operator == (config_value_type const& right) const
{
	...
	if (left.type==vostok::configs::t_table_named && (right.type==vostok::configs::t_table_named || right.type==vostok::configs::t_table_indexed))
	{
...
#endif // #ifndef VOSTOK_RENDER_CORE_CUSTOM_CONFIG_VALUE_INLINE_H_INCLUDED