...
#ifndef VOSTOK_RENDER_CORE_SHADER_CONSTANT_SOURCE_INLINE_H_INCLUDED
#define VOSTOK_RENDER_CORE_SHADER_CONSTANT_SOURCE_INLINE_H_INCLUDED
...
#endif // #ifndef VOSTOK_RENDER_CORE_SHADER_CONSTANT_SOURCE_INLINE_H_INCLUDED