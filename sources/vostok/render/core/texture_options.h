...
//public:
////.	ETType						type;
//	vostok::fs_new::virtual_path_string		format;//+
//	ETTextureDimension			texture_dimension; //+
////.	ETAlphaBlendMode			alpha_blend_mode;
////.	ETPackMode					pack_mode;
//	bool						has_mip_levels;//+
////.	bool						is_cubemap;
////.	vostok::fs_new::virtual_path_string		normal_name;
////.	vostok::fs_new::virtual_path_string		color_name;
////.	float						detail_scale;
////.	ETBumpMode					bump_mode;
////.	vostok::fs_new::virtual_path_string		bump_name;
////.	int							tile;
//}; // struct texture_options
