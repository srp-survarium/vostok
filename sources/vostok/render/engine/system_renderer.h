...
#include "vostok/render/core/vertex_stream.h"
#include "vostok/render/core/index_stream.h"
...
public:
	...
	void draw_screen_lines	( vostok::math::float3 const* points, u32 count, color clr, float width, u32 pattern, bool use_depth);
	void draw_3D_point		( vostok::math::float3 const& position, float width, color const color);
