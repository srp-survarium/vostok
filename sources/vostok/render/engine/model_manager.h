...
#include <vostok/render/engine/sources/convex_volume.h>
#include <vostok/render/engine/visual.h>
#include <vostok/render/engine/editor_visual.h>
#include <vostok/render/engine/render_queue.h>
...
// 	u32				create_ib( u32 size, u32 usage, pcvoid data);
	...
	// --Porting to DX10_
// 	void 			update_vb( u32 buffer_id, vostok::vectora<vostok::render::buffer_fragment> const& fragments);
// 	void 			update_ib( u32 buffer_id, vostok::vectora<vostok::render::buffer_fragment> const& fragments);
...
public:
	...
	void			add_editor_visual	( u32 id, vostok::render::visual_ptr v, float4x4 trans, bool selected, bool system_object, bool beditor);
