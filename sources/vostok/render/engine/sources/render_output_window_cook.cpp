...
render_output_window_cook::render_output_window_cook():
	resources::unmanaged_cook(vostok::resources::render_output_window_class, reuse_false, use_current_thread_id, use_current_thread_id)
{}
...
mutable_buffer render_output_window_cook::allocate_resource(resources::query_result_for_cook& in_query, const_buffer raw_file_data, bool file_exist)
{
	...
	return mutable_buffer(ALLOC(u8, sizeof(vostok::render::render_output_window)), sizeof(vostok::render::render_output_window));
}
...
{	
	VOSTOK_UNREFERENCED_PARAMETERS(&in_out_unmanaged_resource_buffer, &raw_file_data);
	...
	render_output_window* created_resource	= new(in_out_unmanaged_resource_buffer.c_ptr())vostok::render::render_output_window(window_configuration);
	scene_manager::ref().add_render_output_window(created_resource);
	
	in_out_query.set_unmanaged_resource(created_resource, resources::nocache_memory, sizeof(vostok::render::render_output_window));
