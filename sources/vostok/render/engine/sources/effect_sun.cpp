...
)
{
	...
	compiler.set_texture( "t_material", "$user$material", 0, false, 0 );
	compiler.set_texture( "t_emissive", "$user$emmisive", 0, false, 0 );
	compiler.set_texture( "t_cascaded_shadow_map", "$user$cascaded_shadow_map", 0, false, 0 );
	compiler.set_texture( "t_jitter_lookup", "$user$jitter_lookup", 0, false, 0 );
	compiler.set_texture( "t_pcf_random_rotates", "engine/ssao_rotate", 0, false, 0 );
	compiler.end_pass( );
