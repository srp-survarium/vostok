...
void effect_fstage_volume_sphere_base_materials::compile( effect_compiler& compiler, custom_config_value const& config)
{
	...
	compile_begin("vertex_base", "forward_volume_sphere_base", compiler, &configuration, config);
