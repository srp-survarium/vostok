...
static u32 s_particle_render_mode_value = vostok::particle::enum_particle_render_mode(vostok::particle::normal_particle_render_mode); // in percents
static vostok::console_commands::cc_u32 s_particle_render_mode("particle_render_mode", 
