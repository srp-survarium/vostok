...
#ifndef VOSTOK_RENDER_GRASS_H_INCLUDED
#define VOSTOK_RENDER_GRASS_H_INCLUDED
...
public:
	...
	void test_grass_data_loaded					(vostok::resources::queries_result& result);
...
#endif // #ifndef VOSTOK_RENDER_GRASS_H_INCLUDED