...
namespace vostok
{
	...
	namespace render
	{
		...
		public:
			...
			void					on_fs_iterator_ready_source		(texture_cook_wrapper_data* data, vostok::resources::fs_iterator fs_it);
			void					on_fs_iterator_ready_converted	(texture_cook_wrapper_data* data, vostok::resources::fs_iterator fs_it);
