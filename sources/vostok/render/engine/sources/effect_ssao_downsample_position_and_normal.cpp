...
)
{
	...
	compiler.begin_pass( "ssao_downsample_depth_and_normals", NULL, "ssao_downsample_depth_and_normals", shader_configuration( ), NULL );
	...
	compiler.begin_technique( );
	compiler.begin_pass( "ssao_downsample_depth_and_normals", NULL, "ssao_downsample_depth", shader_configuration( ), NULL );
	compiler.set_depth( false, false );
	compiler.set_alpha_blend( false );
	compiler.set_texture( "t_position", "$user$position", 0, false, u32( -1 ) );
	compiler.end_pass( );
