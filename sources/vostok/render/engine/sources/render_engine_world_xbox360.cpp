...
void world::set_view_matrix			( vostok::render::scene_view_ptr const& scene_view, vostok::math::float4x4 const& view )
{
	VOSTOK_UNREFERENCED_PARAMETERS( &scene_view, view );
	NOT_IMPLEMENTED( );
}

void world::set_projection_matrix	( vostok::render::scene_view_ptr const& scene_view, vostok::math::float4x4 const& projection )
{
	VOSTOK_UNREFERENCED_PARAMETERS( &scene_view, projection );
	NOT_IMPLEMENTED( );
}

void world::set_world_matrix		( vostok::render::scene_view_ptr const& scene_view, vostok::float4x4 const& world )
{
	VOSTOK_UNREFERENCED_PARAMETERS( &scene_view, world );
	NOT_IMPLEMENTED( );
}
...
//void world::draw_debug_lines		( vostok::render::vector< vostok::render::vertex_colored > const& vertices, vostok::render::vector< u16 > const& indices )
//{
...
//}
//
//void world::draw_debug_triangles	( vostok::render::vector< vostok::render::vertex_colored > const& vertices, vostok::render::vector< u16 > const& indices )
//{
...
void world::add_model				( scene_ptr const& in_scene, render::render_model_instance_ptr const& v, vostok::math::float4x4 const& transform, bool apply_transform )
{
...
void world::update_model_vertex_buffer	( render::render_model_instance_ptr const& v, vostok::vectora<vostok::render::buffer_fragment> const& fragments )
{
...
void world::update_model_index_buffer	( render::render_model_instance_ptr const& v, vostok::vectora<vostok::render::buffer_fragment> const& fragments )
{
	VOSTOK_UNREFERENCED_PARAMETERS	( v, fragments );
	NOT_IMPLEMENTED();
}
...
{
	VOSTOK_UNREFERENCED_PARAMETERS( grid_density );
	NOT_IMPLEMENTED();
}
...
//void world::change_model_shader		( vostok::render::visual_ptr v, char const* shader, char const* texture )
//{
//	VOSTOK_UNREFERENCED_PARAMETERS( v, shader, texture );
//	NOT_IMPLEMENTED();
//}
...
void world::add_light					( scene_ptr const& in_scene, u32 id, vostok::render::light_props const& props )
{
	VOSTOK_UNREFERENCED_PARAMETERS	(&in_scene, id, &props);
	NOT_IMPLEMENTED();
}

void world::update_light				( scene_ptr const& in_scene, u32 id, vostok::render::light_props const& props )
{
	VOSTOK_UNREFERENCED_PARAMETERS	(&in_scene, id, &props);
	NOT_IMPLEMENTED();
}
...
void world::add_decal					( scene_ptr const& in_scene, u32 id, vostok::render::decal_properties const& properties )
{
	VOSTOK_UNREFERENCED_PARAMETERS( &in_scene, &id, &properties );
	NOT_IMPLEMENTED();
}

void world::update_decal				( scene_ptr const& in_scene, u32 id, vostok::render::decal_properties const& properties )
{
	VOSTOK_UNREFERENCED_PARAMETERS( &in_scene, &id, &properties );
	NOT_IMPLEMENTED();
}
...
void world::terrain_update_cell_buffer	( scene_ptr const& in_scene, render::render_model_instance_ptr const& v, vostok::vectora<vostok::render::terrain_buffer_fragment> const& fragments, vostok::math::float4x4 const& transform)
{
...
void world::update_particle_system_instance	( vostok::particle::particle_system_instance_ptr instance, vostok::render::scene_ptr const& in_scene, vostok::math::float4x4 const& transform, bool visible, bool paused)
{
...
void world::restart_preview_particle_system	( vostok::particle::particle_system** preview_ps, scene_ptr const& scene )
{
	NOT_IMPLEMENTED	( VOSTOK_UNREFERENCED_PARAMETERS( preview_ps, &scene ) );
}

void world::set_looping_preview_particle_system	( particle::particle_system** preview_ps, scene_ptr const& scene, bool looping )
{
	NOT_IMPLEMENTED	( VOSTOK_UNREFERENCED_PARAMETERS( preview_ps, &scene, looping ) );
}
...
void world::draw_3D_screen_lines		( vostok::render::scene_ptr const& scene, math::float3 const* points, u32 count, math::color const& clr, float width, u32 pattern, bool use_depth )
{
	NOT_IMPLEMENTED	( VOSTOK_UNREFERENCED_PARAMETERS( &scene, points, count, clr, width, pattern, use_depth ) );
}

void world::draw_3D_screen_point		( vostok::render::scene_ptr const& scene, float3 const& position, math::color clr, float width, bool use_depth )
{
	NOT_IMPLEMENTED	( VOSTOK_UNREFERENCED_PARAMETERS( &scene, position, clr, width, use_depth ) );
}

void world::draw_screen_lines			( vostok::render::scene_ptr const& scene, vostok::math::float2 const* points, u32 count, vostok::math::color const& clr, float width, u32 pattern )
{
	NOT_IMPLEMENTED	( VOSTOK_UNREFERENCED_PARAMETERS( &scene, points, count, clr, width, pattern ) );
}
...
void	world::set_selection_parameters		( vostok::math::float4 const& selection_color, float selection_rate )
{
...
void world::set_sky_material				( vostok::render::scene_ptr const& scene, vostok::resources::unmanaged_resource_ptr mtl_ptr)
{
...
{
	VOSTOK_UNREFERENCED_PARAMETERS( async_effects );
	NOT_IMPLEMENTED				( );
}
