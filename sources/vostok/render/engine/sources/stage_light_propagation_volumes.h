...
private:
			...
			//void			process_spot_light					(u32 const cascade_index, vostok::render::light* in_light);
			// Render to Reflective Shadow Map
			void			render_to_rms						(//vostok::render::light* in_light,
			...
			void			render_to_point_rms					(vostok::render::light* l, u32 const face_index);
			void			render_to_sky_rms					(u32 const face_index, u32 const cascade_index);
			void			render_to_spot_rms					(vostok::render::light* l);
			void			render_to_sun_rms					(vostok::render::light* sun, u32 const cascade_index);
			
			void			downsample_rsm						(vostok::float3 const& light_direction, 
			...
			void			set_rsm_contants					(vostok::math::float3 const& light_direction, 
																 vostok::math::float3 const& grid_origin, 
																 float grid_scale);
			void			set_light_constans					(vostok::render::light* l);
