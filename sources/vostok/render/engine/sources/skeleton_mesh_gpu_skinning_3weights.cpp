...
static D3D_INPUT_ELEMENT_DESC hardware_3weights_skinning_vertex_layout[] =
{
	...
	{"BLENDWEIGHT",	0, DXGI_FORMAT_R32G32_FLOAT,	0, 16,	D3D_INPUT_PER_VERTEX_DATA, 0},
	{"NORMAL",		0, DXGI_FORMAT_R8G8B8A8_UNORM,	0, 24,	D3D_INPUT_PER_VERTEX_DATA, 0},
	{"TANGENT",		0, DXGI_FORMAT_R8G8B8A8_UNORM,	0, 28,	D3D_INPUT_PER_VERTEX_DATA, 0},
	{"BINORMAL",	0, DXGI_FORMAT_R8G8B8A8_UNORM,	0, 32, 	D3D_INPUT_PER_VERTEX_DATA, 0},
	{"TEXCOORD",	0, DXGI_FORMAT_R32G32_FLOAT,	0, 36, 	D3D_INPUT_PER_VERTEX_DATA, 0},
};

skeleton_mesh_gpu_skinning_3weights::skeleton_mesh_gpu_skinning_3weights( ) { m_vertex_input_type = skeletal_4_bones_mesh_vertex_input_type; }
...
)
{
	...
	ref_declaration const& declaration	= resource_manager::ref().create_declaration( hardware_3weights_skinning_vertex_layout, array_size( hardware_3weights_skinning_vertex_layout ) );

	void* ptr = (void*)verts_reader.pointer();
	hardware_3weights_skinning_vertex* const prepared_vertices = static_cast< hardware_3weights_skinning_vertex* >( ptr );

	bool const dynamic		= true;
	u32 const stride		= sizeof( hardware_3weights_skinning_vertex );
	m_vertex_buffer			=
		resource_manager::ref().create_buffer	(
