...
#ifndef VOSTOK_RENDER_SPEEDTREE_SHADER_PARAMETERS_H_INCLUDED
#define VOSTOK_RENDER_SPEEDTREE_SHADER_PARAMETERS_H_INCLUDED
...
struct speedtree_common_parameters
{
	...
	void set						(renderer_context* context, speedtree_tree_component* tree_component, vostok::math::float3 const& lod_reference_position);
...
#endif // #ifndef VOSTOK_RENDER_SPEEDTREE_SHADER_PARAMETERS_H_INCLUDED