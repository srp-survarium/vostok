...
{
	// DOF part.
	dof_height_lights				= vostok::math::float3(1,1,1);
	...
	frame_height_lights				= vostok::math::float3(1,1,1);
	frame_mid_tones					= vostok::math::float3(1,1,1);
	frame_shadows					= vostok::math::float3(0,0,0);
	frame_fade_color				= vostok::math::float3(0,0,0);
	frame_fade_amount				= 0.0f;
	frame_gamma_correction_factor	= 1.0f;
	
	enable_scene					= true;
	
	environment_sun_position		= vostok::math::float3(0,500,0);
	environment_far_fog_color		= vostok::math::float3(1,1,1);
	environment_sun_color			= vostok::math::float3(0.87f, 0.8f, 0.8f);
	
	environment_ambient_color		= vostok::math::float3(0.15f, 0.15f, 0.15f);
//	environment_ambient_color		= vostok::math::float3(1.f, 1.f, 1.f);
