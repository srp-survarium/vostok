...
void stage_light_propagation_volumes::set_rsm_contants(vostok::math::float3 const& light_direction, 
													   vostok::math::float3 const& grid_origin, 
													   float grid_scale)
{
...
void stage_light_propagation_volumes::set_light_constans(vostok::render::light* l)
{
...
void stage_light_propagation_volumes::render_to_rms(//vostok::render::light* in_light,
													vostok::math::float3 const& light_color,
...
void stage_light_propagation_volumes::render_to_sun_rms(vostok::render::light* sun, u32 const cascade_index)
{
...
void stage_light_propagation_volumes::render_to_point_rms(vostok::render::light* l, u32 const face_index)
{
...
void stage_light_propagation_volumes::render_to_spot_rms(vostok::render::light* l)
{
...
void stage_light_propagation_volumes::downsample_rsm(vostok::float3 const& light_direction, 
													 vostok::float3 const& grid_origin, 
													 float grid_scale)
{
...
void stage_light_propagation_volumes::inject_lighting(u32 const cascade_index, 
													  vostok::math::float3 const& light_position, 
													  vostok::math::float3 const& light_direction,
													  float light_fov)
{
