...
namespace vostok {
namespace render {
// 24 target lines are likely retail-compiled-out source.
...
// 32 target lines are likely retail-compiled-out source.
...
// 69 target lines are likely retail-compiled-out source.
