...
static vostok::console_commands::cc_bool s_sun_moving("sun_moving", 
															s_sun_moving_value, 
															false, 
...
static vostok::console_commands::cc_float sun_shadow_cascad_0_z_bias("sun_shadow_cascad_0_z_bias", s_sun_shadow_z_bias_value[0], 0.0f, 1.0f, true, vostok::console_commands::command_type_engine_internal);
static vostok::console_commands::cc_float sun_shadow_cascad_1_z_bias("sun_shadow_cascad_1_z_bias", s_sun_shadow_z_bias_value[1], 0.0f, 1.0f, true, vostok::console_commands::command_type_engine_internal);
static vostok::console_commands::cc_float sun_shadow_cascad_2_z_bias("sun_shadow_cascad_2_z_bias", s_sun_shadow_z_bias_value[2], 0.0f, 1.0f, true, vostok::console_commands::command_type_engine_internal);
static vostok::console_commands::cc_float sun_shadow_cascad_3_z_bias("sun_shadow_cascad_3_z_bias", s_sun_shadow_z_bias_value[3], 0.0f, 1.0f, true, vostok::console_commands::command_type_engine_internal);
...
void stage_shadow_direct::render_terrain(vostok::math::float3 const& viewer_position)
{
//////////////////////////////////////////////////////////////////////////
