...
public:
	...
	scene*		create_scene	( vostok::render::scene_configuration const& renderer_configuration);
	void		destroy			( scene* scene);

	scene_view*	create_scene_view();
	void		destroy			( scene_view* view);

	render_output_window*		create_render_output_window( vostok::render::output_window_configuration const& window_configuration );
