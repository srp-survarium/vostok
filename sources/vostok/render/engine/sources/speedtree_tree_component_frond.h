...
#ifndef VOSTOK_RENDER_ENGINE_SPEEDTREE_TREE_COMPONENT_FROND_H_INCLUDED
#define VOSTOK_RENDER_ENGINE_SPEEDTREE_TREE_COMPONENT_FROND_H_INCLUDED
...
STATIC_SIZE_ASSERT( frond_vertex, 0x38 );
...
public:
	...
	{
		return SpeedTree::GEOMETRY_TYPE_FRONDS;
	}
...
STATIC_SIZE_ASSERT( speedtree_tree_component_frond, 0x70 );

} // namespace render
} // namespace vostok

#endif // VOSTOK_RENDER_ENGINE_SPEEDTREE_TREE_COMPONENT_FROND_H_INCLUDED
