...
void speedtree_tree_component_billboard::init(speedtree_forest& forest, TInstanceArray const& instances_of_tree)
{
	...
	for (u32 instance_index=0; instance_index<instances_of_tree.size(); instance_index++)
	{
		...
		//total_vertices.push_back( billboard_vertex( speedtree_to_vostok(instance.GetPos()), instance.GetScale(), float3(rotation_xyz.x, rotation_xyz.y/*instance.GetRotationAngle()*/, rotation_xyz.z), transform, 0) );
		//total_vertices.push_back( billboard_vertex( speedtree_to_vostok(instance.GetPos()), instance.GetScale(), float3(rotation_xyz.x, rotation_xyz.y/*instance.GetRotationAngle()*/, rotation_xyz.z), transform, 1) );
		//total_vertices.push_back( billboard_vertex( speedtree_to_vostok(instance.GetPos()), instance.GetScale(), float3(rotation_xyz.x, rotation_xyz.y/*instance.GetRotationAngle()*/, rotation_xyz.z), transform, 2) );
		//total_vertices.push_back( billboard_vertex( speedtree_to_vostok(instance.GetPos()), instance.GetScale(), float3(rotation_xyz.x, rotation_xyz.y/*instance.GetRotationAngle()*/, rotation_xyz.z), transform, 3) );
