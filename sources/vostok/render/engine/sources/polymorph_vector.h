...
#ifndef VOSTOK_RENDER_ENGINE_POLYMORPH_VECTOR_H_INCLUDED
#define VOSTOK_RENDER_ENGINE_POLYMORPH_VECTOR_H_INCLUDED
...
// 	template < typename T >
// 	inline	void					swap			( ::vostok::polymorph_vector< T >& left, ::vostok::polymorph_vector< T >& right );

#include "polymorph_vector_inline.h"

#endif // #ifndef VOSTOK_RENDER_ENGINE_POLYMORPH_VECTOR_H_INCLUDED