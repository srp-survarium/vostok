...
void dof_shader_constants::set(vostok::math::float3 const& blurriness_height_lights, float distance, float region, float power, float near_blur_amout, float far_blur_amout, float bokeh_dof_radius, float bokeh_dof_density)
{
...
//void stage_postprocess::on_material_loaded(vostok::resources::queries_result& result)
//{
//	if (result.is_successful())
//	{
//		//m_test_material = static_cast_checked<vostok::render::material*>(result[0].get_unmanaged_resource().c_ptr());
//		//vostok::render::material_manager::ref().initialize_material_effects(m_material_post_effects[0], m_test_material, false);
...
void stage_postprocess::measure_per_pixel_luminance(res_texture* scene_texture, vostok::math::float4& out_avrg_min_max)
{
...
vostok::math::float4 stage_postprocess::get_frame_luminance_parameters()
{
...
vostok::math::float4 stage_postprocess::compute_luminance_parameters(u32 frame_delta)
{
