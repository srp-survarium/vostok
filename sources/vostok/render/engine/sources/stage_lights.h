...
private:
			...
			void	render_speedtree_lighting	(vostok::render::lod_entry const* lod,
...
private:
			...
			void	render_to_hw_shadowmap	 ( u32 shadow_quality, float z_bias, u32 smap_size, u32 smap_size_index, vostok::math::float4x4 const& view_matrix, vostok::math::float4x4 const& projection_matrix, u32 marge );
			
			void	make_skin_scattering_texture( vostok::render::render_surface_instance* instance, light* l );
...
private:
	...
	vostok::math::float4x4	m_view_to_light_matrix;
	vostok::math::float4x4	m_light_to_texture_matrix;
