...
void render_model_cook::on_fs_iterator_ready_submeshes( cook_intermediate_data* cook_data, vostok::vfs::vfs_locked_iterator const & fs_it )
{
...
static vostok::render::enum_vertex_input_type	mesh_type_to_vertex_input_type	(vostok::render::mesh_type_enum type)
{
	switch (type)
	{
		case mt_static_mesh:
