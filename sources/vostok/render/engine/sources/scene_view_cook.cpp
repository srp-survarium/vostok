...
scene_view_cook::scene_view_cook():
	resources::unmanaged_cook(vostok::resources::scene_view_class, reuse_false, use_current_thread_id, use_current_thread_id)
{}
...
mutable_buffer scene_view_cook::allocate_resource(resources::query_result_for_cook& in_query, const_buffer raw_file_data, bool file_exist)
{
	...
	return mutable_buffer(ALLOC(u8, sizeof(vostok::render::scene_view)), sizeof(vostok::render::scene_view));
}
...
{	
	...
	scene_view* created_resource	= new(in_out_unmanaged_resource_buffer.c_ptr())vostok::render::scene_view();
	scene_manager::ref().add_scene_view(created_resource);
	
	in_out_query.set_unmanaged_resource(created_resource, resources::nocache_memory, sizeof(vostok::render::scene_view));
