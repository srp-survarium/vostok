...
static void push_point(vostok::vectora<vostok::render::ui::vertex>& out_vertices, u32 index, float x, float y, float z, u32 c, float u, float v)
{
...
static void draw_text(vostok::ui::world& ui_world, pcstr str, u32 pos_x, u32 pos_y, u32 clr)
{
...
static void draw_text_shadowed(vostok::ui::world& ui_world, pcstr str, u32 pos_x, u32 pos_y, u32 clr)
{
	draw_text(ui_world, str, pos_x + 1, pos_y + 1, vostok::math::color(0, 0, 0, 220).m_value);
	//draw_text(ui_world, str, pos_x - 1, pos_y - 1, vostok::math::color(0, 0, 0, 220).m_value);
	//draw_text(ui_world, str, pos_x + 1, pos_y - 1, vostok::math::color(0, 0, 0, 220).m_value);
	//draw_text(ui_world, str, pos_x - 1, pos_y + 1, vostok::math::color(0, 0, 0, 220).m_value);
...
u32 statistics_group::render(vostok::ui::world& ui_world, u32 x, u32 y)
{
 	u32 y_offset = 15;
 	
 	draw_text_shadowed(ui_world, m_name.c_str(), x, y, vostok::math::color(25, 255, 25, 220).m_value);
 	...
 	for (statistics_base* it = first_statistics; it != 0; it = it->m_next)
 	{
 		...
 		draw_text_shadowed(ui_world, value.c_str(), x + 10, y + y_offset, vostok::math::color(255, 255, 255, 220).m_value);
...
void statistics::render(vostok::ui::world& ui_world, u32 x, u32 y)
{
 	u32 y_offset = 0;
	u32 x_offset = 0;
...
//		draw_text_shadowed(ui_world, out_text[i].c_str(), 10, 10 + i * 20, vostok::math::color(255, 255, 255, 220).m_value);
}
