...
using vostok::render::skeleton_mesh_gpu_skinning_4weights;
...
void skeleton_mesh_gpu_skinning_4weights::load				( vostok::configs::binary_config_value const& properties, vostok::memory::chunk_reader& r )
{
	...
	//	vostok::render::base_basis basis;
	//	basis.set			( (*i).N );
...
void skeleton_mesh_gpu_skinning_4weights::update( vostok::render::vector<float4x4> const& bones )
{
