...
{
	VOSTOK_UNREFERENCED_PARAMETER		(is_addintional_buffer);
...
void texture_cook_wrapper::on_fs_iterator_ready_source			(texture_cook_wrapper_data* data, vostok::resources::fs_iterator fs_it)
{
...
void texture_cook_wrapper::on_fs_iterator_ready_converted		(texture_cook_wrapper_data* data, vostok::resources::fs_iterator fs_it)
{
	//
