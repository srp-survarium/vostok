...
#ifndef VOSTOK_RENDER_SPEEDTREE_FOREST_H_INCLUDED
#define VOSTOK_RENDER_SPEEDTREE_FOREST_H_INCLUDED
...
struct speedtree_forest
{
	...
	void				set_wind_direction	(vostok::math::float3 const& wind_direction);
	...
	void				get_visible_tree_components	(renderer_context* context,
													 vostok::math::float3 const& lod_reference_point,
													 bool sort_result, 
...
private:
	...
	void cull_and_compute_lod				(renderer_context* context, vostok::math::float3 const& lod_reference_point, bool sort_result);
...
#endif // #ifndef VOSTOK_RENDER_SPEEDTREE_FOREST_H_INCLUDED