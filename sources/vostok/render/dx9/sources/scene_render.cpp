...
#include <vostok/render/common/sources/blender_combine.h>
...
#pragma message(VOSTOK_TODO("uncomment when you are going to implement shadow maps"))	
...
void scene_render::render(const float4x4& view_mat, const float4x4& proj_mat)
{
	...
	//////////////////////////////////////////////////////////////////////////
	// Setup frame
	VOSTOK_UNREFERENCED_PARAMETERS	( view_mat, proj_mat );
