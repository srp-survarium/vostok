...
typedef vostok::intrusive_ptr<res_input_signature, res_base>	ref_input_sign;
#	endif	//	USE_DX10
...
typedef vostok::intrusive_ptr<res_vs, res_base, threading::single_threading_policy>	ref_vs;
...
typedef vostok::intrusive_ptr<res_ps, res_base, threading::single_threading_policy>	ref_ps;
...
typedef vostok::intrusive_ptr<res_gs, res_base>	ref_gs;
#	endif	//	USE_DX10
...
typedef vostok::intrusive_ptr<res_state, res_base, threading::single_threading_policy>	ref_state;
...
typedef vostok::intrusive_ptr<res_declaration, res_base, threading::single_threading_policy>	ref_declaration;
