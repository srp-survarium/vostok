...
#include <vostok/render/common/sources/blender_terrain_NEW.h>
...
void terrain::update_cell_buffer( visual_ptr visual, vostok::vectora<buffer_fragment_NEW> const& fragments, float4x4 const& transform)
{
											 ...
											 mutable_buffer						in_out_unmanaged_resource_buffer)
{
	...
	vostok::fs::file_name_with_no_extension_from_path	(&cell_name, req_path);
