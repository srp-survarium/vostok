...
#include <vostok/render/common/sources/hw_caps.h>
...
{
public:
	hw_wrapper( vostok::render::engine::wrapper& wrapper, HWND hwnd);
	~hw_wrapper();
...
private:
	vostok::render::engine::wrapper&	m_wrapper;
	bool		m_move_window;
	hw_caps		m_caps;
	HWND		m_hwnd;
...
#include <vostok/render/common/sources/hw_wrapper_inline.h>
