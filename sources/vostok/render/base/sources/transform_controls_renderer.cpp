...
#include <vostok/render/base/detail_world.h>

#include "debug_renderer.h"

using vostok::float3;
using vostok::float4x4;
using vostok::render::base::editor::detail::transform_control_base;
using vostok::render::base::editor::detail::translation_control;
using vostok::render::base::editor::detail::scaling_control;
using vostok::render::base::editor::detail::rotation_control;

transform_control_base::transform_control_base ( vostok::render::base::debug::renderer& helper_renderer ):
...
translation_control::translation_control		( vostok::render::base::debug::renderer& helper_renderer ):
...
scaling_control::scaling_control	( vostok::render::base::debug::renderer& helper_renderer ):
transform_control_base( helper_renderer),
m_arrow_size		( 5.f ),
m_arrow_head_radius	( 0.15f )
{
...
rotation_control::rotation_control	( vostok::render::base::debug::renderer& helper_renderer ):
