...
using vostok::render::ui_renderer;
using vostok::render::ui_command;
using vostok::render::ui::command;
using vostok::render::ui::shader;
using vostok::render::ui::vertex;

ui_renderer::ui_renderer( vostok::render::base_world& world, vostok::render::platform& platform )
:m_world(world),
m_platform(platform)
{}
...
ui_command::ui_command(u32 max_verts, int prim_type, int point_type, vostok::render::platform& p)
...
ui_command::ui_command( vertex* begin, vertex* end, int prim_type, int point_type, vostok::render::platform& p)
...
{
	VOSTOK_UNREFERENCED_PARAMETER(shader);
}
