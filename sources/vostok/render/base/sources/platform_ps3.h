...
#include <vostok/render/base/renderer_ps3.h>
...
public: // base_world methods
	...
	virtual	void	update_visual_vertex_buffer	( vostok::render::visual_ptr v, vectora<buffer_fragment> const& fragments );
	virtual	void	update_visual_index_buffer	( vostok::render::visual_ptr v, vectora<buffer_fragment> const& fragments );
