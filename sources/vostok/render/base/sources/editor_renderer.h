...
class editor_renderer :
	public vostok::render::editor::renderer,
	private boost::noncopyable 
{
public:
	editor_renderer( vostok::render::base_world& world, platform& platform );
...
public:
		...
		virtual void	add_visual					( u32 id, vostok::render::visual_ptr v, vostok::math::float4x4 const& transform, bool selected = false, bool system_object = false );
		virtual void	update_visual				( u32 id, vostok::math::float4x4 const& transform, bool selected = false );
		virtual void	remove_visual				( u32 id );
		virtual void	render_visuals				( );
		virtual void	update_visual_vertex_buffer	( vostok::render::visual_ptr const& object, vectora<buffer_fragment> const& fragments );
		virtual void	change_visual_shader		( vostok::render::visual_ptr const& object, char const* shader, char const* texture );
		...
		virtual	void 	terrain_update_cell_buffer	( visual_ptr v, vostok::vectora<buffer_fragment_NEW> & fragments, float4x4 const& transform, command_finished_callback const& finish_callback, u32 finish_callback_argument);
...
private:
		...
		inline	void 	update_triangles	( u32 add_count );
				...
				void	create_primitive	( vostok::vectora< float3 >& avertices, 
												vostok::vectora< u16 >& aindices, 
