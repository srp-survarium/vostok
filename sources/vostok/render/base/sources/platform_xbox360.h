...
#include <vostok/render/base/renderer_xbox360.h>
...
public:
	...
	virtual	void			add_visual					( u32 id, vostok::render::visual_ptr v, float4x4 const& transform, bool selected, bool system_object, bool beditor );
	...
	virtual	void			add_light					( u32 id, vostok::render::light_props const& props, bool beditor );
	virtual	void			update_light				( u32 id, vostok::render::light_props const& props, bool beditor );
