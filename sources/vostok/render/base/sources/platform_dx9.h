...
#include <vostok/render/dx9/renderer.h>
...
#include <vostok/render/common/sources/hw_wrapper.h>
#include <vostok/render/common/sources/render_device.h>
#include <vostok/render/dx9/sources/visual.h>
#include <vostok/render/dx9/sources/scene_render.h>

#include <vostok/render/common/sources/environment.h>
#include <vostok/render/common/sources/lights_db.h>
#include <vostok/render/common/sources/terrain.h>

#include <vostok/render/dx9/sources/model_manager.h>
...
class platform :
//	public vostok::render::base_world,
	public vostok::render::platform,
	public vostok::render::dx9::renderer
{
public:
	typedef vostok::render::vector< vostok::render::vertex_colored >	colored_vertices_type;
	typedef vostok::render::vector< u16 >								colored_indices_type;

	typedef vostok::render::ui::vertex const *	ui_vertices_type;

public:
							platform					( vostok::render::engine::wrapper& wrapper, HWND window_handle );
	virtual					~platform					( );
	virtual	void			clear_resources			( );
	// platform methods
public:
	virtual	void			set_view_matrix			( math::float4x4 const& view_matrix );
	virtual	void			set_projection_matrix	( vostok::float4x4 const& projection );
	...
	virtual	void			set_world_matrix		( vostok::float4x4 const& w );
	vostok::float4x4 const&	get_world_matrix		( ) const;
	...
	virtual	void			add_visual					( u32 id, vostok::render::visual_ptr v, float4x4 const& transform, bool selected /*= false*/, bool system_object /*= false*/, bool beditor );
	virtual	void			update_visual				( u32 id, vostok::math::float4x4 const& transform, bool selected );
	virtual	void			remove_visual				( u32 id );
	virtual	void			update_visual_vertex_buffer	( vostok::render::visual_ptr v, vostok::vectora<vostok::render::buffer_fragment> const& fragments );
	virtual	void			update_visual_index_buffer	( vostok::render::visual_ptr v, vostok::vectora<vostok::render::buffer_fragment> const& fragments );
	virtual	void			change_visual_shader		( vostok::render::visual_ptr v, char const* shader, char const* texture );
	...
	virtual	void 			terrain_update_cell_buffer	( visual_ptr v, vostok::vectora<buffer_fragment_NEW> const& fragments, float4x4 const& transform);
...
#include <vostok/render/base/sources/platform_dx9_inline.h>
