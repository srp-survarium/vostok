...
using vostok::render::command_terrain_cell_remove_texture;
using vostok::render::texture_string;

command_terrain_cell_remove_texture::command_terrain_cell_remove_texture( base_world& world, vostok::render::visual_ptr v, u32 tex_user_id)
:m_world		(world),
m_visual		(v),
