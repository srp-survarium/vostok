...
{
	VOSTOK_UNREFERENCED_PARAMETER	( id );
}

void platform::update_visual_vertex_buffer	( vostok::render::visual_ptr v, vectora<buffer_fragment> const& fragments )
{
	VOSTOK_UNREFERENCED_PARAMETERS( &v, &fragments );
}

void platform::update_visual_index_buffer	( vostok::render::visual_ptr v, vectora<buffer_fragment> const& fragments )
{
	VOSTOK_UNREFERENCED_PARAMETERS( &v, &fragments );
}
...
void platform::terrain_update_cell_buffer	( visual_ptr v, vostok::vectora<buffer_fragment_NEW> const& fragments, float4x4 const& transform)
{
...
{
	VOSTOK_UNREFERENCED_PARAMETERS( beditor, bgame );
	UNREACHABLE_CODE	( );
}
