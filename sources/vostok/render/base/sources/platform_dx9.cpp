...
#include "pch.h"
#include <vostok/render/base/sources/platform_dx9.h>
//#include <vostok/render/base/sources/platform_api_dx9.h>
// #include <vostok/render/dx9/sources/visual.h>
...
// #include <vostok/render/common/sources/terrain.h>
...
//using vostok::render::dx9::world;
using vostok::resources::managed_resource_ptr;
using vostok::memory::chunk_reader;
...
platform::platform					( vostok::render::engine::wrapper& wrapper, HWND const window_handle ) :
// #pragma warning ( push )
...
void platform::set_view_matrix		( vostok::float4x4 const& view )
{
	if (m_scene)
		m_scene->set_v(view);
...
void platform::set_world_matrix	( vostok::float4x4 const& w )
{
	if ( m_scene )
		m_scene->set_w(w);
...
*/
	resources::request	resources[]	= {
		{ "resources/textures/ui/ui_skull.dds",					vostok::resources::raw_data_class },
		{ "resources/textures/ui/ui_font_arial_21_1024.dds",	vostok::resources::raw_data_class },
	};
...
void platform::on_ui_texture_loaded	( vostok::resources::queries_result& data )
{
	ASSERT							( !data.empty( ) );
	ASSERT							( data.size( ) == 2 );
...
//{
//	resources::request	resources[]	= {
//		{ "resources/barrel_close_1.ogf",					vostok::resources::raw_data_class },
////		{ "resources/stalker_dolg_1.ogf",			vostok::resources::raw_data_class },
//	};
//
//	vostok::resources::query_resources	(
//		resources,
...
//void platform::on_test_visual_loaded	( vostok::resources::queries_result& data )
//{
//	ASSERT							( !data.empty( ) );
//	
...
void platform::add_visual( u32 id, vostok::render::visual_ptr v, float4x4 const& transform, bool selected, bool system_object, bool beditor )
{	
