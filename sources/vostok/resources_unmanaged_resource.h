...
#ifndef VOSTOK_RESOURCES_UNMANAGED_RESOURCE_H_INCLUDED
#define VOSTOK_RESOURCES_UNMANAGED_RESOURCE_H_INCLUDED
...
class VOSTOK_CORE_API unmanaged_resource :	public resource_base, 
...
class VOSTOK_CORE_API positional_unmanaged_resource : public unmanaged_resource
{
public:
...
namespace resources_detail {
	...
	template class VOSTOK_CORE_API vostok::resources::child_resource_ptr <	vostok::resources::unmanaged_resource, 	
																		vostok::resources::unmanaged_intrusive_base	>;	

	template class VOSTOK_CORE_API vostok::resources::resource_ptr < vostok::resources::unmanaged_resource, 	
																 vostok::resources::unmanaged_intrusive_base>;	

	template class VOSTOK_CORE_API vostok::intrusive_ptr< vostok::resources::unmanaged_resource, 	
													  vostok::resources::unmanaged_intrusive_base,
													  vostok::threading::simple_lock>;	
		
	template class VOSTOK_CORE_API boost::function< void ( vostok::resources::queries_result& data ) >;
...
#endif // #ifndef VOSTOK_RESOURCES_UNMANAGED_RESOURCE_H_INCLUDED
