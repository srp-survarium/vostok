...
#ifndef VOSTOK_BUFFER_VECTOR_INLINE_H_INCLUDED
#define VOSTOK_BUFFER_VECTOR_INLINE_H_INCLUDED

#define TEMPLATE_SIGNATURE	template < typename T >
#define BUFFER_VECTOR		vostok::buffer_vector< T >
...
#endif // VOSTOK_CORE_BUFFER_VECTOR_INLINE_H_INCLUDED