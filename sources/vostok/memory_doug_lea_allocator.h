...
#ifndef VOSTOK_MEMORY_DOUG_LEA_ALLOCATOR_H_INCLUDED
#define VOSTOK_MEMORY_DOUG_LEA_ALLOCATOR_H_INCLUDED
...
class VOSTOK_CORE_API doug_lea_allocator : public base_allocator {
public:
					doug_lea_allocator	(
...
#endif // #ifndef VOSTOK_MEMORY_DOUG_LEA_ALLOCATOR_H_INCLUDED