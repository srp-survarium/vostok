...
static vostok::command_line::key	s_no_memory_guard_key("no_memory_guard", "", "memory", "disables runtime memory guard protection");
...
#pragma message(VOSTOK_TODO("add check \"object has been modified after it was freed\" - check 0xfeeefeee"))
