...
static vostok::command_line::key s_no_memory_usage_stats("no_memory_usage_stats", "", "memory", "disable CRT and GetProcessHeap() memory usage stats detection. Use this option if another program injected thread into application, which uses one of these allocators." );
