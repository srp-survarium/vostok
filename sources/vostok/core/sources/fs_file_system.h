...
void VOSTOK_CORE_API	set_allocator_thread_id	(u32 thread_id);
...
void VOSTOK_CORE_API	set_on_resource_leaked_callback	(on_resource_leaked_callback);
void VOSTOK_CORE_API	set_on_unmount_started_callback	(on_unmount_started_callback);

//-----------------------------------------------------------------------------------
// fat_inline_data
//-----------------------------------------------------------------------------------

struct VOSTOK_CORE_API fat_inline_data
{
public:
	struct item
	{
...
class VOSTOK_CORE_API file_system : public core::noncopyable {
public:
...
private:
	...
	friend class		::vostok::fs::file_system_impl;
	friend class		::vostok::resources::fs_iterator;
...
extern vostok::uninitialized_reference<file_system>	g_fat;
