...
pvoid base_allocator::on_malloc		( pvoid buffer, size_t buffer_size, size_t previous_size, pcstr const description ) const
{
	...
	VOSTOK_UNREFERENCED_PARAMETER	( previous_size );
...
{
	VOSTOK_UNREFERENCED_PARAMETER	( can_clear );
...
pvoid base_allocator::malloc_impl		( size_t size VOSTOK_CORE_DEBUG_PARAMETERS_DESCRIPTION_DECLARATION VOSTOK_CORE_DEBUG_PARAMETERS_DECLARATION )
{
	return						call_malloc ( size VOSTOK_CORE_DEBUG_PARAMETERS_DESCRIPTION VOSTOK_CORE_DEBUG_PARAMETERS );
}

pvoid base_allocator::realloc_impl	( pvoid pointer, size_t new_size VOSTOK_CORE_DEBUG_PARAMETERS_DESCRIPTION_DECLARATION VOSTOK_CORE_DEBUG_PARAMETERS_DECLARATION )
{
	return						call_realloc ( pointer, new_size VOSTOK_CORE_DEBUG_PARAMETERS_DESCRIPTION VOSTOK_CORE_DEBUG_PARAMETERS );
}

void base_allocator::free_impl		( pvoid pointer VOSTOK_CORE_DEBUG_PARAMETERS_DECLARATION )
{
	call_free					( pointer VOSTOK_CORE_DEBUG_PARAMETERS );
}
