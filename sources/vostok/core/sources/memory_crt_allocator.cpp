...
using vostok::memory::crt_allocator;
...
{
	VOSTOK_UNREFERENCED_PARAMETERS	(arena_id, buffer, buffer_size);
...
pvoid crt_allocator::malloc_impl	( size_t const size VOSTOK_CORE_DEBUG_PARAMETERS_DESCRIPTION_DECLARATION VOSTOK_CORE_DEBUG_PARAMETERS_DECLARATION )
{
	...
	return							result;//( on_malloc	( result, size, 0, VOSTOK_CORE_DEBUG_PARAMETERS_DESCRIPTION_PARAMETER ) );
}

pvoid crt_allocator::realloc_impl	( pvoid pointer, size_t const new_size VOSTOK_CORE_DEBUG_PARAMETERS_DESCRIPTION_DECLARATION VOSTOK_CORE_DEBUG_PARAMETERS_DECLARATION )
{
#ifdef DEBUG
	VOSTOK_UNREFERENCED_PARAMETER		( description );
#endif // #ifdef DEBUG
...
void crt_allocator::free_impl		( pvoid pointer VOSTOK_CORE_DEBUG_PARAMETERS_DECLARATION )
{
	VOSTOK_CORE_DEBUG_PARAMETERS_UNREFERENCED_GUARD;
...
pvoid crt_allocator::call_malloc	( size_t size VOSTOK_CORE_DEBUG_PARAMETERS_DESCRIPTION_DECLARATION VOSTOK_CORE_DEBUG_PARAMETERS_DECLARATION )
{
	return							( malloc_impl( size VOSTOK_CORE_DEBUG_PARAMETERS_DESCRIPTION VOSTOK_CORE_DEBUG_PARAMETERS ) );
}

pvoid crt_allocator::call_realloc	( pvoid pointer, size_t new_size VOSTOK_CORE_DEBUG_PARAMETERS_DESCRIPTION_DECLARATION VOSTOK_CORE_DEBUG_PARAMETERS_DECLARATION )
{
	return							( realloc_impl( pointer, new_size VOSTOK_CORE_DEBUG_PARAMETERS_DESCRIPTION VOSTOK_CORE_DEBUG_PARAMETERS ) );
}

void crt_allocator::call_free		( pvoid pointer VOSTOK_CORE_DEBUG_PARAMETERS_DECLARATION )
{
	free_impl						( pointer VOSTOK_CORE_DEBUG_PARAMETERS );
}
