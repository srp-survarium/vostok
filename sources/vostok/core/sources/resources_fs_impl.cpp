...
{
	fs_task *	new_task			=	VOSTOK_NEW_IMPL(* allocator, fs_task)(fs_task::type_update_disk_node_name);
#ifndef MASTER_GOLD
...
{
	fs_task *	new_task			=	VOSTOK_NEW_IMPL(* allocator, fs_task)(fs_task::type_mount_disk_node);
...
{
	fs_task *	new_task			=	VOSTOK_NEW_IMPL(* allocator, fs_task)(fs_task::type_unmount_disk_node);
...
{
	fs_task *	new_task			=	VOSTOK_NEW_IMPL(* allocator, fs_task)(fs_task::type_update_file_size_in_fat);
#ifndef MASTER_GOLD
	new_task->file_change_info		=	file_change_info;
#endif // #ifndef MASTER_GOLD
...
void   query_erase_file (pcstr const	opt_physical_path, 
						 ...
						 memory::base_allocator * const allocator)
{
	fs_task *	new_task			=	VOSTOK_NEW_IMPL(* allocator, fs_task)(fs_task::type_erase_file);
