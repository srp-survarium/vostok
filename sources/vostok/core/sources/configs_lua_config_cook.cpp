													 ...
													 bool								file_exist)
{
	...
	return									mutable_buffer (lua_allocate( sizeof(vostok::configs::lua_config) ), 
															sizeof(vostok::configs::lua_config));
}
				 						 ...
				 						 mutable_buffer						in_out_unmanaged_resource_buffer)
{
	...
	#pragma message(VOSTOK_TODO("Keep in mind: resource is not really allocated from unmanaged arena, but is said to be. Fix cooker to use unmanaged allocator"))
