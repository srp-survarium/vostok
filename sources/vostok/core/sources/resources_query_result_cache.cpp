...
#pragma message(VOSTOK_TODO("consider using hashmap with per-hash interlocked synchronization if profiler shows too much waiting for name_registry_mutex"))
