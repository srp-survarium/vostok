...
{
	#pragma message							(VOSTOK_TODO("Change to helper to unmanaged allocator when you can"))
...
{
	#pragma message (VOSTOK_TODO("temporary solution. Remember to make it well with new task queues"))
	m_in_sync_call						=	true;
	do 
	{
		try_async_query						();
