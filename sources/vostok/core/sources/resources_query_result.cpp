...
static vostok::command_line::key s_assert_on_resource_failure( "assert_on_resource_failure", "assert_on_resource_failure", "resources", "asserts when resources loading or cooking failed", "" );
...
{
	VOSTOK_UNREFERENCED_PARAMETER				(resource_request_path);
