...
signalling_bool   base_of_intrusive_base::try_unregister_from_fat_or_from_name_registry (Resource * const object, u32 count_that_allows_unregister) const
{
	...
	VOSTOK_UNREFERENCED_PARAMETER				( rare_message );
...
#pragma message(VOSTOK_TODO("calling destroy_resource right in user thread, at this time it seems as sufficient"))
