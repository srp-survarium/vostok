...
static vostok::command_line::key		s_floating_point_control_disabled("floating_point_control_disabled", "", "math", "disables floating point control flags setup for each thread");
