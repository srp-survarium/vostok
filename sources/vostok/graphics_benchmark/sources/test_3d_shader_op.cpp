...
public:
	...
	virtual	void						load(memory::chunk_reader& )
	{
		//if(chunk.chunk_exists( model_chunk_gcontainer ))
		{
			...
			geom					= vostok::render::model_manager::ref().(vertex_buffer_id, index_buffer_id);*/
		}
	}
	virtual	void						render();
...
void test_3d_shader_op::on_test_visual_loaded	( vostok::resources::queries_result& data)
{
	(void)&data;
	...
	//s_visual				= NEW(simple_visual)();////vostok::render::engine::model_manager::create_instance( type);
...
{ 
	...
	m_sphere_matrix = vostok::math::mul4x3(
