...
static vostok::uninitialized_reference<vostok::graphics_benchmark::application>	s_application;
...
struct guard {
	inline	guard				( )
	{
		VOSTOK_CONSTRUCT_REFERENCE( s_application, vostok::graphics_benchmark::application );
