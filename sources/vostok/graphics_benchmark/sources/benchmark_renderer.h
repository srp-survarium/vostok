...
public:
	...
	typedef vostok::render::vector< colored_vertex >	colored_vertices_type;
	typedef vostok::render::vector< low_colored_vertex >	low_colored_vertices_type;
	...
	void render_cooked_mesh		( u32 mesh_index, vostok::math::float4x4 const& wvp_matrix = vostok::math::float4x4().identity());
	void render_3d_sphere		( gpu_timer& gtimer, vostok::math::float4x4 const& wvp_matrix);
...
private:
	...
	vostok::render::ref_geometry		m_geom;
	vostok::render::ref_geometry		m_low_geom;

	vostok::render::ref_geometry		m_geom_sized[ enum_vertex_size_COUNT ];

	vostok::render::constant_host*	m_WVP;
