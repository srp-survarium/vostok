...
#ifndef VOSTOK_LIMITED_INTRUSIVE_LIST_INLINE_H_INCLUDED
#define VOSTOK_LIMITED_INTRUSIVE_LIST_INLINE_H_INCLUDED

#define TEMPLATE_SIGNATURE		template <typename T, typename BaseWithMember, T* BaseWithMember::*MemberNext >
#define LIMITED_INTRUSIVE_LIST	vostok::limited_intrusive_list<T, BaseWithMember, MemberNext>
...
#endif // #ifndef VOSTOK_LIMITED_INTRUSIVE_LIST_INLINE_H_INCLUDED