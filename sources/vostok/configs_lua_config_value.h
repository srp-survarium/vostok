...
#ifndef VOSTOK_CONFIGS_LUA_CONFIG_VALUE_H_INCLUDED
#define VOSTOK_CONFIGS_LUA_CONFIG_VALUE_H_INCLUDED
...
class VOSTOK_CORE_API	lua_config_iterator {
public:
...
private:
	/*VOSTOK_DEFAULT_ALIGN*/ char	m_table_object_fake[ luabind_object_sizeof ];	// sizeof(luabind::object);
	::luabind::object*		m_container_table;
	/*VOSTOK_DEFAULT_ALIGN*/ char	m_iterator_fake[ luabind_object_iterator_sizeof ];// sizeof(luabind::object::iterator);
	::luabind::iterator*	m_iterator;
}; // class lua_config_iterator

class VOSTOK_CORE_API lua_config_value {
public:
	enum save_as_option {
		leave_old_value,
...
private:
	/*VOSTOK_DEFAULT_ALIGN*/ char	m_object_fake[ luabind_object_sizeof ];			// sizeof(luabind::object);
...
VOSTOK_CORE_API	lua_config_value create_lua_config_value	( binary_config_value const& value );

} // namespace configs
} // namespace vostok

	inline	void		swap					( vostok::configs::lua_config_value& left, vostok::configs::lua_config_value& right ) { left.swap(right); }

#ifdef MASTER_GOLD
#error class must not be used in MASTER_GOLD
#endif

#endif // #ifndef VOSTOK_CONFIGS_LUA_CONFIG_VALUE_H_INCLUDED