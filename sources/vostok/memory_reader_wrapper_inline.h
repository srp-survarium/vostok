...
#ifndef VOSTOK_MEMORY_READER_WRAPPER_INLINE_H_INCLUDED
#define VOSTOK_MEMORY_READER_WRAPPER_INLINE_H_INCLUDED

#define TEMPLATE_SIGNATURE	template < typename implementation >
#define READER_WRAPPER		vostok::memory::reader_wrapper< implementation >
...
TEMPLATE_SIGNATURE
inline vostok::math::float2	READER_WRAPPER::r_float2			( )
{
	return				( r< math::float2 >( ) );
}

TEMPLATE_SIGNATURE
inline vostok::math::float3	READER_WRAPPER::r_float3			( )
{
	return				( r< math::float3 >( ) );
}

TEMPLATE_SIGNATURE
inline vostok::math::float4	READER_WRAPPER::r_float4			( )
{
	return				( r< math::float4 >( ) );
}

TEMPLATE_SIGNATURE
inline vostok::math::float4x4 READER_WRAPPER::r_float4x4			( )
{
...
#if 0
TEMPLATE_SIGNATURE
inline vostok::math::float3 READER_WRAPPER::r_direction_q16		( )
{
	return				( math::float3::decompress( r_u16( ) ) );
}

TEMPLATE_SIGNATURE
inline vostok::math::float3 READER_WRAPPER::r_position_q48		( )
{
...
#endif // #ifndef VOSTOK_MEMORY_READER_WRAPPER_INLINE_H_INCLUDED