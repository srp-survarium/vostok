...
#ifndef VOSTOK_TYPE_ENUM_FLAGS_H_INCLUDED
#define VOSTOK_TYPE_ENUM_FLAGS_H_INCLUDED
...
class VOSTOK_CORE_API enum_flags
{
public:
...
class VOSTOK_CORE_API flags_type
{
public:
...
#endif // /#ifndef VOSTOK_TYPE_ENUM_FLAGS_H_INCLUDED