...
#ifndef VOSTOK_RAW_PTR_H_INCLUDED
#define VOSTOK_RAW_PTR_H_INCLUDED
...
template < typename type, typename pointer_type >
inline		void		swap		( vostok::raw_ptr< type, pointer_type >& left, vostok::raw_ptr< type, pointer_type >& right );

template < typename inherited_type, typename type, typename pointer_type >
inline		bool		operator==	( inherited_type* left, vostok::raw_ptr< type, pointer_type > const& right );
...
#include <vostok/raw_ptr_inline.h>
...
#endif // #ifndef VOSTOK_RAW_PTR_H_INCLUDED