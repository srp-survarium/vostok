...
#ifndef VOSTOK_RESOURCES_COOK_CLASSES_H_INCLUDED
#define VOSTOK_RESOURCES_COOK_CLASSES_H_INCLUDED
...
class VOSTOK_CORE_API managed_cook : public cook_base
{
public:
...
class VOSTOK_CORE_API inplace_managed_cook : public cook_base
{
public:
		typedef fastdelegate::FastDelegate< void	(resources::query_result_for_cook &	in_out_query, 
													 resources::managed_resource_ptr 			out_resource,
...
class VOSTOK_CORE_API unmanaged_cook : public cook_base
{
public:
...
class VOSTOK_CORE_API inplace_unmanaged_cook : public cook_base
{
public:
...
#endif // #ifndef VOSTOK_RESOURCES_COOK_CLASSES_H_INCLUDED