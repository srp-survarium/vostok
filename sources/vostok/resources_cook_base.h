...
#ifndef VOSTOK_RESOURCES_COOK_H_INCLUDED
#define VOSTOK_RESOURCES_COOK_H_INCLUDED
...
public:
	...
	virtual float						satisfaction_with			(u32 quality_level, math::float4x4 const & user_matrix, u32 users_count) { VOSTOK_UNREFERENCED_PARAMETERS(quality_level, &user_matrix, users_count); NOT_IMPLEMENTED(return 1); }
...
private:
	class VOSTOK_CORE_API cook_users_count_functionality
	{
	public:
...
VOSTOK_CORE_API void					register_cook			(cook_base *	processor);
VOSTOK_CORE_API cook_base *			unregister_cook			(class_id_enum	resource_class);
...
#endif // #ifndef VOSTOK_RESOURCES_POST_PROCESSOR_H_INCLUDED