...
static vostok::uninitialized_reference<vostok::texture_compressor_test::application>	s_application;
...
struct guard {
	inline	guard				( )
	{
		VOSTOK_CONSTRUCT_REFERENCE( s_application, vostok::texture_compressor_test::application );
