...
#include <vostok/engine_test_suite.h>
...
static vostok::command_line::key			s_build_resources		("build_resources", "", "application", "runs engine in build resources mode");
...
void on_tests_resources_mount_completed ( bool *						out_completed, 
										  vostok::resources::mount_ptr *	out_mount, 
										  vostok::resources::mount_ptr	result )
{
...
void mount_tests_resources				( vostok::resources::mount_ptr * out_mount, pcstr resources_path )
{
	...
	resources::query_mount_physical			( "resources/tests", test_resources_path.c_str(), "tests", fs_new::watcher_enabled_true,
											  ...
											  &::vostok::memory::g_mt_allocator, resources::recursive_false );
...
static vostok::threading::atomic32_type s_resources_callbacks_have_been_dispatched;
