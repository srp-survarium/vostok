...
{
public:
							engine_world			( vostok::engine_user::module_proxy& proxy, pcstr command_line, pcstr application, pcstr build_date );
...
public:
	...
	vostok::engine_user::world& engine_user_world		( ) const	{ return *m_engine_user_world; }
