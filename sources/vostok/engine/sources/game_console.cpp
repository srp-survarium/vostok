...
game_console::game_console( ui::world& uw, input::world& iw, vostok::memory::base_allocator& a )
:super			( uw, a ),
m_input_world	( iw )
{
...
void game_console::tick( vostok::render::scene_view_ptr const& scene_view )
{
