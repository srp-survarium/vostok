...
#ifndef VOSTOK_EDITOR_CONSOLE_H_INCLUDED
#define VOSTOK_EDITOR_CONSOLE_H_INCLUDED
...
public:
			editor_console				( vostok::ui::world& uw, vostok::memory::base_allocator& a );

// engine::console interface
	virtual bool			get_active			( ) const;
	virtual void			on_activate			( );
	virtual void			on_deactivate		( );
	virtual void			tick				( vostok::render::scene_view_ptr const& scene_view );
...
#endif // #ifndef VOSTOK_EDITOR_CONSOLE_H_INCLUDED