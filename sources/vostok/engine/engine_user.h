...
#ifndef VOSTOK_ENGINE_ENGINE_USER_H_INCLUDED
#define VOSTOK_ENGINE_ENGINE_USER_H_INCLUDED
...
//	virtual	float	get_last_frame_time			( ) = 0;
	...
	virtual vostok::engine::console* create_game_console(  ui::world& uw, input::world& iw ) = 0;
...
struct VOSTOK_NOVTABLE module_proxy {
...
protected:
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR( module_proxy )
}; // class module_proxy

} // namespace engine_user
} // namespace vostok

#endif // #ifndef VOSTOK_ENGINE_ENGINE_USER_H_INCLUDED