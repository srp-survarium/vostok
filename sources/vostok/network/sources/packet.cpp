...
using vostok::network::packet;

boost::asio::const_buffers_1 vostok::network::buffer_to_send( packet& packet )
{
...
boost::asio::mutable_buffers_1 vostok::network::buffer_to_receive_into( packet& packet )
{
