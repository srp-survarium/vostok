...
#ifndef VOSTOK_NETWORK_SERVER_H_INCLUDED
#define VOSTOK_NETWORK_SERVER_H_INCLUDED
...
class VOSTOK_NETWORK_API server : private core::noncopyable {
public:
...
public:
	...
	void	send							( vostok::network::client_session& client, packet const* packet );
...
private:
	connection_action_enum	on_connection_requested		( vostok::network::client_session& client );
	connection_action_enum	on_connection_requested_impl( vostok::network::client_session& client );
			void	on_disconnected			( vostok::network::client_session& client );
			void	on_disconnected_impl	( vostok::network::client_session& client );
			void	on_packet_received		( vostok::network::client_session& client, vostok::network::packet const& packet );
			void	on_packet_received_impl	( vostok::network::client_session& client, vostok::network::packet const& packet );
			void	create_server			( );
...
#endif // #ifndef VOSTOK_NETWORK_SERVER_H_INCLUDED