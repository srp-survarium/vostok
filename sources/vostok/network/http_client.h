...
public:
	typedef boost::function< void ( pcstr ) >				on_content_downloaded_type;
	...
	inline	void		set_on_error				( on_error_type const& on_error )
	{
		m_on_error			= on_error;
	}

			void		get							( pcstr server, pcstr path, on_content_downloaded_type const& callback );
...
private:
	...
	on_content_downloaded_type			m_on_content_downloaded;
	on_error_type					m_on_error;
	on_error_type					m_client_on_error;
