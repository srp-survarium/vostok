...
using vostok.editor.wpf_controls.control_containers;
using vostok.editor.wpf_controls.helpers;
using vostok.editor.wpf_controls.property_editors.attributes;

namespace vostok.editor.wpf_controls.property_editors.item
{
