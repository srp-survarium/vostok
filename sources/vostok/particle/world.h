...
struct VOSTOK_NOVTABLE world : public resources::unmanaged_resource {
	...
	virtual	void	play							( particle_system_instance_ptr particle_system_instance, vostok::math::float4x4 const& transform, bool use_transform, bool always_loop) = 0;
	...
	virtual	void	update_preview					( particle_system** preview_particle_system, vostok::configs::lua_config_value config_value ) = 0;
...
#endif // #ifndef VOSTOK_PARTICLE_WORLD_H_INCLUDED