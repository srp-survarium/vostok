...
{
	typedef platform_pointer<particle_system_lod, vostok::platform_pointer_default>::type particle_system_lod_ptr_type;
...
protected:
	...
	u32					save_binary						(vostok::mutable_buffer& buffer, bool cals_size = false);
	void				load_binary						(vostok::mutable_buffer& buffer );
	
	u32					save_lod_actions_binary			(particle_system_lod& lod, vostok::mutable_buffer& buffer, bool cals_size = false);
	void				load_lod_actions_binary			(particle_system_lod& lod, vostok::mutable_buffer& buffer);
