...
class preview_particle_system : public particle_system {
	typedef vostok::intrusive_list<guid_to_object_pair,guid_to_object_pair*,&guid_to_object_pair::next> guids_list_type;
...
public:
	void add_emitter					(u32 lod_index, pcstr emitter_id, pcstr group_id, vostok::configs::lua_config_value const& emitter_config);
	...
	void on_group_changed				(vostok::configs::lua_config_value const& config, pcstr group_id);
