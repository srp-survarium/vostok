...
inline half3::half3			( vostok::math::float3 const& copy )
{
	x = copy.x;
	y = copy.y;
	z = copy.z;
...
inline half3::operator vostok::math::float3 ( ) const
{
	return vostok::math::float3(float(x), float(y), float(z));
}
...
{
	return vostok::math::sqrt( x*x + y*y + z*z );
}
...
inline half4::half4 ( vostok::math::float4 const& copy )
{
	x = copy.x;
	y = copy.y;
	z = copy.z;
...
inline half4::operator vostok::math::float4 ( ) const
{
	return vostok::math::float4(float(x), float(y), float(z), float(w));
}
...
{
	return vostok::math::sqrt( x*x + y*y + z*z  + w*w );
}
