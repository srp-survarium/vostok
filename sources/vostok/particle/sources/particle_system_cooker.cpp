...
#pragma message(VOSTOK_TODO("Lain 2 IronNick : do not read files manually, use managed/unmanaged cooks that do it for you!"))
...
void particle_system_cooker::on_fs_iterator_ready_source( particle_system_cooker_data* data, vostok::vfs::vfs_locked_iterator const & fs_it )
{
...
void particle_system_cooker::on_fs_iterator_ready_converted( particle_system_cooker_data* data, vostok::vfs::vfs_locked_iterator const & fs_it )
{
	...
	vostok::vfs::vfs_iterator fs_it_converted = fs_it.is_end() ? fs_it : fs_it.find_child(converted_path.c_str());
...
void particle_system_cooker::on_config_loaded(resources::queries_result& result)
{
	...
	vostok::memory::zero(out_buffer, resource_size);
...
vostok::uninitialized_reference<particle_system_cooker>	s_particle_system_cook_object;
...
void register_particles_system_cooker()
{
	...
	VOSTOK_CONSTRUCT_REFERENCE	( s_particle_system_cook_object, particle_system_cooker ) ( );
...
void unregister_particles_system_cooker()
{
	...
	VOSTOK_DESTROY_REFERENCE		( s_particle_system_cook_object );
