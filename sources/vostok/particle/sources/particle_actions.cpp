...
u32 particle_action_billboard::save_binary( vostok::mutable_buffer& buffer, bool calc_size)
{
	return m_subimage_index.save_binary(buffer, calc_size);
}

void particle_action_billboard::load_binary( vostok::mutable_buffer& buffer)
{
...
{
	VOSTOK_UNREFERENCED_PARAMETERS(instance, time_delta);
...
{
	VOSTOK_UNREFERENCED_PARAMETERS(instance,P,time_delta);
}
...
{
	VOSTOK_UNREFERENCED_PARAMETERS(time, instance);
...
{
	VOSTOK_UNREFERENCED_PARAMETERS(time);
...
u32 particle_action_initial_color::save_binary(vostok::mutable_buffer& buffer, bool calc_size)
{
	return m_init_color.save_binary(buffer, calc_size);
}

void particle_action_initial_color::load_binary(vostok::mutable_buffer& buffer)
{
...
void particle_action_initial_rotation::init( particle_emitter_instance* instance, base_particle* P, float time )
{
	...
	float3 rotation = vostok::math::pi_x2 * m_init_rotation.evaluate(instance->get_linear_emitter_time(), float3(0.0f, 0.0f, 0.0f), range_time_type, P->seed());
...
u32 particle_action_initial_rotation::save_binary(vostok::mutable_buffer& buffer, bool calc_size)
{
	return m_init_rotation.save_binary(buffer, calc_size);
}

void particle_action_initial_rotation::load_binary(vostok::mutable_buffer& buffer)
{
...
u32 particle_action_rotation_over_lifetime::save_binary(vostok::mutable_buffer& buffer, bool calc_size)
{
	return m_rotation_over_life.save_binary(buffer, calc_size);
}

void particle_action_rotation_over_lifetime::load_binary(vostok::mutable_buffer& buffer)
{
...
u32 particle_action_rotation_over_velocity::save_binary(vostok::mutable_buffer& buffer, bool calc_size)
{
	return m_rotation_over_velocity.save_binary(buffer, calc_size);
}

void particle_action_rotation_over_velocity::load_binary(vostok::mutable_buffer& buffer)
{
...
u32 particle_action_initial_velocity::save_binary(vostok::mutable_buffer& buffer, bool calc_size)
{
	return m_init_velocity.save_binary(buffer, calc_size);
}

void particle_action_initial_velocity::load_binary(vostok::mutable_buffer& buffer)
{
...
u32 particle_action_initial_rotation_rate::save_binary(vostok::mutable_buffer& buffer, bool calc_size)
{
	return m_init_rate.save_binary(buffer, calc_size);
}

void particle_action_initial_rotation_rate::load_binary(vostok::mutable_buffer& buffer) 
{
...
u32 particle_action_initial_size::save_binary(vostok::mutable_buffer& buffer, bool calc_size)
{
	return m_init_size.save_binary(buffer, calc_size);
}

void particle_action_initial_size::load_binary(vostok::mutable_buffer& buffer) 
{
...
u32 particle_action_velocity_over_lifetime::save_binary(vostok::mutable_buffer& buffer, bool calc_size)
{
	return m_velocity_over_life.save_binary(buffer, calc_size);
}

void particle_action_velocity_over_lifetime::load_binary(vostok::mutable_buffer& buffer)
{
...
u32 particle_action_acceleration::save_binary(vostok::mutable_buffer& buffer, bool calc_size)
{
	return m_acceleration.save_binary(buffer, calc_size);
}

void particle_action_acceleration::load_binary(vostok::mutable_buffer& buffer)
{
...
u32 particle_action_size_over_lifetime::save_binary(vostok::mutable_buffer& buffer, bool calc_size)
{
	return m_size_over_life.save_binary(buffer, calc_size);
}

void particle_action_size_over_lifetime::load_binary(vostok::mutable_buffer& buffer) 
{
...
u32 particle_action_size_over_velocity::save_binary(vostok::mutable_buffer& buffer, bool calc_size)
{
	return m_size_over_velocity.save_binary(buffer, calc_size);
}

void particle_action_size_over_velocity::load_binary(vostok::mutable_buffer& buffer)
{
...
u32 particle_action_color_over_lifetime::save_binary(vostok::mutable_buffer& buffer, bool calc_size)
{
	return m_color_over_life.save_binary(buffer, calc_size);
}

void particle_action_color_over_lifetime::load_binary(vostok::mutable_buffer& buffer)
{
...
u32 particle_action_orbit::save_binary(vostok::mutable_buffer& buffer, bool calc_size)
{
...
void particle_action_orbit::load_binary(vostok::mutable_buffer& buffer)
{
