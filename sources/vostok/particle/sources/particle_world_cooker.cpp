...
particle_world_cooker::particle_world_cooker():
	resources::unmanaged_cook(vostok::resources::particle_world_class, reuse_false, use_resource_manager_thread_id, use_resource_manager_thread_id)
{}
...
{	
	...
	new_particle_world->m_allocator.initialize	(
			...
			math::align_down< u64 >( in_out_unmanaged_resource_buffer.size(), sizeof( vostok::particle::base_particle ) ),
			"particle_world"
		);
...
vostok::uninitialized_reference<particle_world_cooker>	s_particle_world_cooker_object;
...
void register_particle_world_cooker()
{
	...
	VOSTOK_CONSTRUCT_REFERENCE(s_particle_world_cooker_object, particle_world_cooker)();
...
void unregister_particle_world_cooker()
{
	...
	VOSTOK_DESTROY_REFERENCE	  (s_particle_world_cooker_object);
