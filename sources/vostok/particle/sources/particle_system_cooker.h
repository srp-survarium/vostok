...
public:
	...
	void					on_fs_iterator_ready_source		(particle_system_cooker_data* data, vostok::vfs::vfs_locked_iterator const & fs_it);
	void					on_fs_iterator_ready_converted	(particle_system_cooker_data* data, vostok::vfs::vfs_locked_iterator const & fs_it);
...
extern vostok::uninitialized_reference<particle_system_cooker> s_particle_system_cook_object;
