...
static vostok::console_commands::cc_u32 s_particle_simulation_speed("particle_simulation_speed", 
...
#ifndef MASTER_GOLD
static vostok::uninitialized_reference<preview_particle_system_cooker>	s_preview_particle_system_cook_object;
#endif // #ifndef MASTER_GOLD

void register_preview_particle_system_cooker()
{
#ifndef MASTER_GOLD
	VOSTOK_CONSTRUCT_REFERENCE	( s_preview_particle_system_cook_object, preview_particle_system_cooker ) ( );
...
void unregister_preview_particle_system_cooker()
{
	...
	VOSTOK_DESTROY_REFERENCE		( s_preview_particle_system_cook_object );
#endif // #ifndef MASTER_GOLD
}
...
base_particle* particle_world::allocate_particle( )
{
	...
	base_particle* particle		= VOSTOK_NEW_IMPL( m_allocator, base_particle )();
...
{
	--m_num_particles;
	VOSTOK_DELETE_IMPL( m_allocator, P );
}
...
void particle_world::set_transform_to_particle_instance(particle_system_instance* instance, vostok::math::float4x4 const& transform)
{
...
void particle_world::tick( float time_delta, vostok::math::float4x4 const& view_matrix )
{
	...
	vostok::math::clamp( k, 0.001f, 1.0f);
...
// {
// 	particle_system_instance_ptr out_ptr = ((vostok::particle::particle_system*)in_particle_system.c_ptr())->play(*this, transform);
// 	
// 	vostok::particle::particle_system_instance_impl* inst = (vostok::particle::particle_system_instance_impl*)out_ptr.c_ptr();
...
particle_system* particle_world::add						( configs::lua_config_value const& init_values, math::float4x4 const& transform )
{
	...
	new_ps->set_creation_source(
		...
		"",
		vostok::resources::memory_usage_type(vostok::resources::nocache_memory, sizeof(preview_particle_system))
		);
...
void particle_world::update_preview							( particle_system** in_particle_system, vostok::configs::lua_config_value config_value )
{
	preview_particle_system* preview_ps = (preview_particle_system*)*in_particle_system;
