...
void particle_system_wrapper_cook::translate_query( query_result_for_cook& parent )
{
	...
	converted_path.assignf					("resources/particles/%s.binary_particle", parent.get_requested_path());
...
void register_particles_system_cooks()
{
	...
	VOSTOK_CONSTRUCT_REFERENCE				( s_particle_system_wrapper_cook, particle_system_wrapper_cook ) ( );
	VOSTOK_CONSTRUCT_REFERENCE				( s_particle_system_cook, particle_system_cook ) ( );
...
void unregister_particles_system_cooks()
{
	...
	VOSTOK_DESTROY_REFERENCE					( s_particle_system_cook );
	VOSTOK_DESTROY_REFERENCE					( s_particle_system_wrapper_cook );
