...
#include <vostok/particle/particle_data_type.h> // for enum_particle_data_type
...
class particle_action : public particle_action_platform {
	...
	typedef vostok::platform_pointer<particle_action, vostok::platform_pointer_default>::type particle_action_ptr_type;
...
public:
	...
	virtual u32					save_binary			(vostok::mutable_buffer&, bool) {return 0;}
	virtual void				load_binary			(vostok::mutable_buffer&) {}
...
class particle_modifier : public particle_action {
	...
	typedef vostok::platform_pointer<particle_modifier, vostok::platform_pointer_default>::type particle_modifier_ptr_type;
public:
...
public:
	...
	virtual u32						save_binary		(vostok::mutable_buffer&, bool);
	virtual void					load_binary		(vostok::mutable_buffer&);
...
public:
	...
	virtual void		set_defaults			(bool mt_alloc = false);
	virtual bool		is_init_modifier		() const {return true;};
	inline particle_domain_complex& domain			( ) { return m_domain; }
