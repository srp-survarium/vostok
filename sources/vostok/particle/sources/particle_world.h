...
public:
	...
	virtual	void	tick								( float time_delta, vostok::math::float4x4 const& view_matrix );
	...
	virtual	void	update_preview					( particle_system** preview_particle_system, vostok::configs::lua_config_value config_value );
...
public:
	base_particle*	allocate_particle					();
			...
			void	set_transform_to_particle_instance	(particle_system_instance* instance, vostok::math::float4x4 const& transform);
