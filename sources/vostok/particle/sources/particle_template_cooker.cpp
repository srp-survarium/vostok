...
particle_template_cooker::particle_template_cooker(vostok::particle::world& world) 
...
void particle_template_cooker::on_fs_iterator_ready_source( particle_template_cooker_data* data, vostok::resources::fs_iterator fs_it )
{
...
void particle_template_cooker::on_fs_iterator_ready_converted( particle_template_cooker_data* data, vostok::resources::fs_iterator fs_it )
{
	fs::path_string converted_path;
	converted_path.append			(data->resource_path.c_str());
	converted_path.append			(".binary");
	
	vostok::resources::fs_iterator fs_it_converted		= fs_it.find_child(converted_path.c_str());
...
void particle_template_cooker::on_fs_iterators_ready( particle_template_cooker_data* data )
{
	...
	vostok::particle::stream load_st(in_buffer, true);
...
//	
//	vostok::particle::stream save_st(out_buffer, false);
...
void particle_template_cooker::on_lua_config_loaded(resources::queries_result& result)
{
	...
	vostok::memory::copy(out_buffer,sizeof(particle_system),&temp_resource,sizeof(particle_system));
	...
	vostok::particle::stream load_st(right_out_buffer, true);
...
static vostok::uninitialized_reference<particle_template_cooker>	s_particle_template_cook_object;

void register_particles_template_cooker( vostok::particle::world& world )
{
	VOSTOK_CONSTRUCT_REFERENCE	( s_particle_template_cook_object, particle_template_cooker ) ( world );
...
void unregister_particles_template_cooker()
{
	...
	VOSTOK_DESTROY_REFERENCE		( s_particle_template_cook_object );
}
