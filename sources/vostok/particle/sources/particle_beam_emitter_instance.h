...
private:
	...
	void apply_noise						  (u32 beam_index, vostok::math::float3 const& up_vector, vostok::math::float3 const& right_vector, float noise_power, u32 step, bool first_fill, base_particle* P, u32 num_particles);
