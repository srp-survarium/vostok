...
void application::initialize( )
{
	...
	VOSTOK_CONSTRUCT_REFERENCE				( m_fs_devices, fs_new::simple_asynchronous_interface )(fs_new::watcher_enabled_false);
	//VOSTOK_CONSTRUCT_REFERENCE				( m_fs_devices, fs_new::simple_synchronous_interface )(fs_new::watcher_enabled_false);
