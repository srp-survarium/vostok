...
#ifndef VOSTOK_RESOURCES_RESOURCE_BASE_H_INCLUDED
#define VOSTOK_RESOURCES_RESOURCE_BASE_H_INCLUDED

#include <vostok/fs_path_string.h>
#include <vostok/resources_callbacks.h>
#include <vostok/fs_platform_configuration.h>
#include <vostok/resources_resource_quality.h>
#include <vostok/resources_resource_ptr.h>
#include <vostok/resources_fs_iterator.h>
#include <vostok/vfs/iterator.h>

template struct VOSTOK_CORE_API boost::intrusive::make_set_member_hook< boost::intrusive::link_mode<boost::intrusive::auto_unlink> >;
template class	VOSTOK_CORE_API boost::intrusive::set_member_hook< boost::intrusive::link_mode<boost::intrusive::auto_unlink> >;
...
class VOSTOK_CORE_API resource_base : public resource_quality
{
public:
...
private:
	...
	memory_type *						m_memory_type_data;
 	...
 	template < ::vostok::platform_pointer_enum pointer_for_fat_size>
	friend	class						::vostok::fs::fat_node;
...
#endif // #ifndef VOSTOK_RESOURCES_RESOURCE_BASE_H_INCLUDED