...
#ifndef VOSTOK_COLLISION_GEOMETRY_H_INCLUDED
#define VOSTOK_COLLISION_GEOMETRY_H_INCLUDED
...
//								geometry			( ) : m_matrix ( float4x4().identity() ){}
	...
	virtual u32					get_custom_data		( u32 triangle_id ) const { VOSTOK_UNREFERENCED_PARAMETER(triangle_id); return 0; };
	...
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR			( geometry )
private:
//	float4x4				m_matrix;
}; // class geometry

//#define VOSTOK_IMPLEMENT_COLLISION_GEOMETRY_VISIT_FUNCTIONS	
...
//#define VOSTOK_IMPLEMENT_COLLISION_GEOMETRY_VISIT_FUNCTIONS_NOT_IMPLEMENTED	
...
#endif // #ifndef VOSTOK_COLLISION_GEOMETRY_H_INCLUDED
