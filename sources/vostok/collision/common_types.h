...
#ifndef VOSTOK_COLLISION_COMMON_TYPES_H_INCLUDED
...
struct primitive;
struct VOSTOK_NOVTABLE enumerate_primitives_callback{
	virtual void enumerate( float4x4 const &transform, primitive const &p ) = 0;
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR			( enumerate_primitives_callback )
...
#endif // #ifndef VOSTOK_COLLISION_COMMON_TYPES_H_INCLUDED