...
#ifndef TRIANGLE_MESH_GEOMETRY_INSTANCE_H_INCLUDED
#define TRIANGLE_MESH_GEOMETRY_INSTANCE_H_INCLUDED
...
class triangle_mesh_geometry_instance : public geometry_instance
{
public:
							triangle_mesh_geometry_instance	( float4x4 const& matrix, non_null<triangle_mesh_geometry const>::ptr triangle_mesh );
	virtual					~triangle_mesh_geometry_instance( );
	...
	VOSTOK_IMPLEMENT_COLLISION_GEOMETRY_VISIT_FUNCTIONS_NOT_IMPLEMENTED

private:
	float4x4									m_matrix;
	float4x4									m_inverted_matrix;	
	non_null<triangle_mesh_geometry const>::ptr m_triangle_mesh;
}; // class triangle_mesh_geometry_instance

} // namespace collision
} // namespace vostok

#endif // #ifndef TRIANGLE_MESH_GEOMETRY_INSTANCE_H_INCLUDED