...
#ifndef TERRAIN_GEOMETRY_INSTANCE_H_INCLUDED
#define TERRAIN_GEOMETRY_INSTANCE_H_INCLUDED
...
class terrain_geometry_instance : public geometry_instance
{
public:
							terrain_geometry_instance	( float4x4 const& matrix, float phisical_size, u32 vertex_row_size, const float* heightfield, bool delete_by_collision_object );
	virtual					~terrain_geometry_instance	( );
...
}; // class terrain_geometry_instance

} // namespace collision
} // namespace vostok

#endif // #ifndef TERRAIN_GEOMETRY_INSTANCE_H_INCLUDED