...
using vostok::collision::colliders::ray_aabb_collider;
using vostok::math::float3;

static inline float invert	( float const value )
{
	if ( vostok::math::is_zero( value ) )
		return				( 0.f );
...
static const float VOSTOK_ALIGN(16) ps_cst_plus_inf[4] = {
	vostok::math::infinity, 
	vostok::math::infinity,
	vostok::math::infinity,
	vostok::math::infinity
};
static const float VOSTOK_ALIGN(16) ps_cst_minus_inf[4] = {
	-vostok::math::infinity,
	-vostok::math::infinity,
	-vostok::math::infinity,
	-vostok::math::infinity
...
using vostok::collision::colliders::sse::aabb_a16;

bool ray_aabb_collider::intersects_aabb_sse	( aabb_a16 const& aabb, float& distance ) const
{
#pragma message(VOSTOK_TODO("Lain 2 Arkom: link error with bbox.intersect( m_origin, direction, intersection_point ) "))

#if 0
	//That function return incorrect result with following arguments
	//AABB:	center		{x=0.00000000 y=1.6431688 z=0.00000000}		vostok::math::float3
	//		extents		{x=3.6015866 y=1.6431690 z=2.2099221}		vostok::math::float3
	//Ray:	origin		{ x=3.6265864 y=0.025000000 z=1.4092371}	vostok::math::float3
	//		direction	{ x=-1.0000000 y=0.00000000 z=0.00000000}	vostok::math::float3
