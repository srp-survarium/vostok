...
#ifndef CYLINDER_GEOMETRY_INSTANCE_H_INCLUDED
#define CYLINDER_GEOMETRY_INSTANCE_H_INCLUDED
...
public:
	...
	inline	float			half_length			( ) const { return m_matrix.get_scale().y; }
private:
	float4x4			m_matrix;
...
#endif // #ifndef CYLINDER_GEOMETRY_INSTANCE_H_INCLUDED
