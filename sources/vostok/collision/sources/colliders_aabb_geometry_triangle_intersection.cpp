...
using vostok::collision::colliders::aabb_geometry;
using vostok::math::float3;

#if !VOSTOK_USE_OLD_TRIANGLE_AABB_TEST
...
VOSTOK_COLLISION_API int triBoxOverlap(float3 const& boxcenter, float3 const& boxhalfsize, float3 const (&triverts)[3] )
{
...
//   float3 axis;
   ...
   fex = vostok::math::abs(e0[X]);
   fey = vostok::math::abs(e0[Y]);
   fez = vostok::math::abs(e0[Z]);
   AXISTEST_X01(e0[Z], e0[Y], fez, fey);
   AXISTEST_Y02(e0[Z], e0[X], fez, fex);
   AXISTEST_Z12(e0[Y], e0[X], fey, fex);

   fex = vostok::math::abs(e1[X]);
   fey = vostok::math::abs(e1[Y]);
   fez = vostok::math::abs(e1[Z]);
   AXISTEST_X01(e1[Z], e1[Y], fez, fey);
   AXISTEST_Y02(e1[Z], e1[X], fez, fex);
   AXISTEST_Z0(e1[Y], e1[X], fey, fex);

   fex = vostok::math::abs(e2[X]);
   fey = vostok::math::abs(e2[Y]);
   fez = vostok::math::abs(e2[Z]);
...
#endif // #if !VOSTOK_USE_OLD_TRIANGLE_AABB_TEST
