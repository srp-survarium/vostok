...
using vostok::collision::resource_guard;

triangle_mesh_resource::triangle_mesh_resource	( base_allocator* allocator, vostok::resources::managed_resource_ptr const resource ) :
	super					( allocator ),
	m_indices				( *allocator ),
	m_resource				( resource )
{
...
void triangle_mesh_resource::render			( vostok::render::scene_ptr const& scene, vostok::render::debug::renderer& renderer, float4x4 const& matrix ) const
{
	resource_guard			guard( m_resource, mesh(), m_indices );
