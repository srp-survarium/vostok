...
using vostok::collision::colliders::ray_object;
...
ray_object::ray_object		(
		...
		vostok::collision::loose_oct_tree const& tree,
		float3 const& origin,
...
{
	VOSTOK_ALIGN(16) sse::aabb_a16	aabb;
...
bool ray_object::false_triangle_predicate	( vostok::collision::ray_triangle_result const& ) const
{
	return false;
}
...
{
	VOSTOK_ALIGN(16) float	distance;
...
struct negative_distance_detector {
	inline bool operator ( ) ( vostok::collision::ray_triangle_result const& triangle ) const
	{
