...
using vostok::collision::detail::geometry_instance;
...
using vostok::collision::on_contact;
...
public:
	...
	{
		vostok::collision::ray_triangle_result&	raw_triangle = const_cast<vostok::collision::ray_triangle_result&>( triangle );
...
void geometry_instance::generate_contacts		( on_contact& c, vostok::collision::geometry_instance const& oi ) const
{
...
vostok::math::aabb const& geometry_instance::get_aabb	( ) const
{
	return						m_aabb;
}

void geometry_instance::render					( vostok::render::debug::renderer& renderer ) const
{
