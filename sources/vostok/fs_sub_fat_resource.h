...
#ifndef VOSTOK_FS_SUB_FAT_RESOURCE_H_INCLUDED
#define VOSTOK_FS_SUB_FAT_RESOURCE_H_INCLUDED
...
template class VOSTOK_CORE_API boost::function< void ( resources::fs_iterator ) >;

struct VOSTOK_CORE_API find_results_struct
{
...
#endif // #ifndef VOSTOK_FS_SUB_FAT_RESOURCE_H_INCLUDED