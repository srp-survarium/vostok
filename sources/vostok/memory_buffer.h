...
#ifndef VOSTOK_MEMORY_BUFFER_H_INCLUDED
#define VOSTOK_MEMORY_BUFFER_H_INCLUDED

namespace vostok {

class VOSTOK_CORE_API mutable_buffer
{
public:
...
class VOSTOK_CORE_API const_buffer
{
public:
...
#endif // #ifndef VOSTOK_MEMORY_BUFFER_H_INCLUDED