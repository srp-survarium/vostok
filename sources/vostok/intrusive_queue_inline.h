...
#ifndef VOSTOK_INTRUSIVE_QUEUE_INLINE_H_INCLUDED
#define VOSTOK_INTRUSIVE_QUEUE_INLINE_H_INCLUDED

#define TEMPLATE_SIGNATURE	template <typename T, typename BaseWithMember, T* BaseWithMember::*MemberNext, typename Policy>
#define INTRUSIVE_QUEUE		vostok::intrusive_queue<T, BaseWithMember, MemberNext, Policy>
...
#endif // #ifndef VOSTOK_INTRUSIVE_QUEUE_INLINE_H_INCLUDED