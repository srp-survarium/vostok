...
#ifndef VOSTOK_THREADING_FUNCTIONS_PS3_INLINE_H_INCLUDED
#define VOSTOK_THREADING_FUNCTIONS_PS3_INLINE_H_INCLUDED
...
VOSTOK_THREADING_INLINE pvoid interlocked_exchange_pointer				( atomic_ptr_type& target, pvoid value )
{
...
VOSTOK_THREADING_INLINE pvoid interlocked_compare_exchange_pointer		( atomic_ptr_type& target, pvoid const exchange, pvoid const comparand )
{
...
#endif // #ifndef VOSTOK_THREADING_FUNCTIONS_PS3_INLINE_H_INCLUDED