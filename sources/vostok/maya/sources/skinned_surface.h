...
struct sk_bone
{
	...
	MStatus		save		( vostok::memory::writer& w ) const;
};
...
typedef vostok::maya::vector<bone_influences>	influences_vec;
...
typedef vostok::maya::vector<mesh_influences*>	mesh_influences_vec;
typedef vostok::maya::vector<sk_bone>				bones_vec;
