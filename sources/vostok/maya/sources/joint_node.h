...
protected:
	virtual	MStatus	do_export_node							( vostok::configs::lua_config_value cfg );	
private:
	MStatus	export_rigidly_connected						( vostok::configs::lua_config_value table );	
	MStatus	export_joint									( vostok::configs::lua_config_value table );	
public:
