...
#ifndef VOSTOK_MATERIAL_H_INCLUDED
#define VOSTOK_MATERIAL_H_INCLUDED

#include <maya/MPxHwShaderNode.h>
#include <maya/MGeometryData.h>

class vostok_material_node : public MPxNode
{
	public:
                      vostok_material_node	( );
    virtual           ~vostok_material_node	( );
...
#endif // #ifndef VOSTOK_MATERIAL_H_INCLUDED