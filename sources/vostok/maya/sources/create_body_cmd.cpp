...
const MString createBodyCmd::Name	( "vostok_body" );
...
{ 
	...
	if(!bEdit)
	{
		...
		MString cmd 	= "vostok_constraint -edit -type rigid "; // normal
		//MString cmd 	= "vostok_constraint -edit -type ball "; // to export collision per each joint
