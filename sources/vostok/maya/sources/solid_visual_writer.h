...
struct render_surface
{
	...
	MStatus	save				( vostok::memory::writer& F );
...
public:
	...
	MStatus		write_render_geometry				( vostok::memory::writer& w );
	MStatus		write_collision_geometry			( vostok::memory::writer& w );
...
private:
	...
	typedef vostok::maya::vector<render_surface*>	render_surfaces;
