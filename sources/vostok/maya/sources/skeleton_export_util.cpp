...
const MString skeleton_export_cmd::Name	( "vostok_skeleton_export" );

static pcstr extension = "skeleton";

MStatus		export_skeleton_node( MObject  &ik_anim_joint_object, vostok::configs::lua_config_value &cfg, const  MSelectionList &all_claster_joints )
{
	MStatus				stat;
	...
	vostok::configs::lua_config_value my_cfg = cfg; 
	...
	for(u32 i = 0 ; i < ch_cnt ; ++i )
	{
		...
		vostok::configs::lua_config_value temp_cfg = my_cfg;
...
MStatus		export_skeleton( MSelectionList &all_claster_joints, vostok::configs::lua_config_value &cfg  )
{
	...
	vostok::configs::lua_config_value object_movenent_cfg = cfg; 
...
MStatus		export_skeleton( MString file_name )
{
	...
	{
		cfg->save_as	( file_name.asChar(), vostok::configs::target_sources );
