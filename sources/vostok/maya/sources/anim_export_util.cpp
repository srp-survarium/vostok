...
static vostok::threading::mutex s_build_animation_data_mutex;
...
void run_build_animation_data_thread( const discrete_data *data, bi_spline_skeleton_animation *animation_data )
{
	...
	vostok::threading::spawn( boost::bind( &build_animation_data_thread, data, animation_data ), "build_animation_data_thread", "build_animation_data_thread", 0, 0, vostok::threading::tasks_aware ); ;
