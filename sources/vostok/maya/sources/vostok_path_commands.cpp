...
const MString	vostok_path_cmd::Name		= "vostok_path";
...
MSyntax	vostok_path_cmd::newSyntax()
{
	MSyntax	syntax;
...
MStatus	vostok_path_cmd::doIt( const MArgList& args)
{
	MString path	= vostok::maya::g_maya_engine.get_resources_path();
