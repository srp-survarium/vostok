...
{
	VOSTOK_UNREFERENCED_PARAMETER( max );
	VOSTOK_UNREFERENCED_PARAMETER( min );
	VOSTOK_UNREFERENCED_PARAMETER( unit_type );
	VOSTOK_UNREFERENCED_PARAMETER( low_limit );
	VOSTOK_UNREFERENCED_PARAMETER( high_limit );
...
{
	VOSTOK_UNREFERENCED_PARAMETER( style );
	VOSTOK_UNREFERENCED_PARAMETER( path );
...
//	bool		translational	= ( degree == tx ) || ( degree == ty ) || ( degree == tz );	
 ...
 {
		VOSTOK_UNREFERENCED_PARAMETER( clientData );
		VOSTOK_UNREFERENCED_PARAMETER( otherPlug );
		MStatus				stat;
...
void joint_node::postConstructor()
{
	...
	CHK_STAT_RV				(stat);
	vostok::maya::g_maya_engine.register_callback_id	( cbid );
}
...
MStatus	joint_node::do_export_node	(vostok::configs::lua_config_value cfg )
{
