...
#ifndef VOSTOK_SHADER_NODE_H_INCLUDED
#define VOSTOK_SHADER_NODE_H_INCLUDED

class vostok_shader_node : public MPxNode
{
public:
					vostok_shader_node			( );
	virtual			~vostok_shader_node		( );
...
#endif // #ifndef VOSTOK_SHADER_NODE_H_INCLUDED