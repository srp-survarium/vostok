...
#define VOSTOK_MAYA_BUILDING

#define VOSTOK_LOG_MODULE_INITIATOR	"maya"
...
using vostok::maya::vector;
using vostok::maya::map;
using vostok::maya::set;

typedef vector<u16>					u16vec;
typedef vector<u32>					u32vec;
typedef vector<vostok::math::float3>		float3vec;
typedef vector<vostok::math::float2>		float2vec;
