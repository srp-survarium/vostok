...
// Static data
const MString vostok_material_node::Name	( material_node_type_name );
MTypeId const vostok_material_node::id	( material_node_type_id );

// Attributes 
MObject vostok_material_node::aColor;
MObject vostok_material_node::aTranslucenceCoeff;
MObject vostok_material_node::aDiffuseReflectivity;
MObject vostok_material_node::aIncandescence;
MObject vostok_material_node::aOutColor;
MObject vostok_material_node::aPointCamera;
MObject vostok_material_node::aNormalCamera;
MObject vostok_material_node::aLightData;
MObject vostok_material_node::aLightDirection;
MObject vostok_material_node::aLightIntensity;
MObject vostok_material_node::aLightAmbient;
MObject vostok_material_node::aLightDiffuse;
MObject vostok_material_node::aLightSpecular;
MObject vostok_material_node::aLightShadowFraction;
MObject vostok_material_node::aPreShadowIntensity;
MObject vostok_material_node::aLightBlindData;
MObject vostok_material_node::aPower;
MObject vostok_material_node::aSpecularity;

MObject vostok_material_node::aRayOrigin;
MObject vostok_material_node::aRayDirection;
MObject vostok_material_node::aObjectId;
MObject vostok_material_node::aRaySampler;
MObject vostok_material_node::aRayDepth;

MObject vostok_material_node::aReflectGain;

MObject vostok_material_node::aTriangleNormalCamera;


void vostok_material_node::postConstructor( )
{
	setMPSafe(true);
}

vostok_material_node::vostok_material_node()
{}

vostok_material_node::~vostok_material_node()
{}

void * vostok_material_node::creator()
{
	return CRT_NEW(vostok_material_node)();
}

MStatus vostok_material_node::initialize()
{
...
MStatus vostok_material_node::compute( const MPlug& plug, MDataBlock& block ) 
{ 
