...
#ifndef VOSTOK_ONE_WAY_THREADS_CHANNEL_WITH_RESPONSE_H_INCLUDED
#define VOSTOK_ONE_WAY_THREADS_CHANNEL_WITH_RESPONSE_H_INCLUDED
...
template <class T>
class VOSTOK_CORE_API threads_channel_query_base_helper 
{
public:
...
template <class T>
class VOSTOK_CORE_API threads_channel_query_base : public threads_channel_query_base_helper<T> {
public:
...
#include <vostok/one_way_threads_channel_with_response_inline.h>

#endif // #ifndef VOSTOK_ONE_WAY_THREADS_CHANNEL_WITH_RESPONSE_H_INCLUDED