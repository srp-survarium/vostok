...
#ifndef VOSTOK_NON_NULL_PTR_INLINE_H_INCLUDED
#define VOSTOK_NON_NULL_PTR_INLINE_H_INCLUDED

#define TEMPLATE_SIGNATURE			template < typename type, typename pointer_type >
#define NON_NULL_PTR				vostok::non_null_ptr< type, pointer_type >
...
#endif // #ifndef VOSTOK_NON_NULL_PTR_INLINE_H_INCLUDED