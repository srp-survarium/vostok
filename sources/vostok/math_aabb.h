...
#ifndef VOSTOK_MATH_AABB_H_INCLUDED
#define VOSTOK_MATH_AABB_H_INCLUDED

namespace vostok {
namespace math {

class VOSTOK_CORE_API aabb {
public:
	typedef float	type;
...
#include <vostok/math_aabb_inline.h>

#endif // #ifndef VOSTOK_MATH_AABB_H_INCLUDED