...
#ifndef VOSTOK_RESOURCES_VFS_ITERATOR_H_INCLUDED_
#define VOSTOK_RESOURCES_VFS_ITERATOR_H_INCLUDED_
...
#include <vostok/vfs/vfs_base_node.h>
...
class VOSTOK_VFS_API vfs_iterator
{
public:
