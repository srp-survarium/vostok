...
class VOSTOK_VFS_API vfs_intrusive_mount_base
{
public:
...
template class VOSTOK_CORE_API vostok::intrusive_ptr< vostok::vfs::vfs_mount, 
												  vostok::vfs::vfs_intrusive_mount_base, 
												  vostok::threading::simple_lock >;

class VOSTOK_VFS_API vfs_mount : public vfs_intrusive_mount_base
{
public:
