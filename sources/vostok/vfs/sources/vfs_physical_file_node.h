...
#include "vfs_universal_file_node.h"
...
public:
	...
	flags_type<flags_enum, threading::multi_threading_policy_base>	m_file_flags;
	node_type							base;
}; // class fat_disk_node
												 		 ...
												 		 u32 const								file_size)
{
	...
	physical_file_node<T> *	new_node	=	(physical_file_node<T>*) VOSTOK_MALLOC_IMPL(allocator, node_size, "physical_file_node");
	if ( !new_node )
		return								NULL;
