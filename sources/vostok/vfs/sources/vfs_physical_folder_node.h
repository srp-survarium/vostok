...
#include "vfs_base_folder_node.h"
...
private:
	flags_type<flags_enum, threading::multi_threading_policy_base>	m_folder_flags;
public:
															...
															fs_new::virtual_path_string const &	name)
{
	...
	physical_folder_node<T> * const new_node	=	(physical_folder_node<T> *)VOSTOK_MALLOC_IMPL(allocator, node_size, "physical_folder_node");
