...
#include "vfs_archive_folder_mount_root_node.h"
#include "vfs_physical_file_mount_root_node.h"
#include "vfs_physical_folder_mount_root_node.h"
										 ...
										 query_mount_arguments &					args)
{
	...
	Node<T> * const new_node			=	(Node<T> *)VOSTOK_MALLOC_IMPL(args.allocator, node_size, "vfs_node");
	if ( !new_node )
		return								NULL;
