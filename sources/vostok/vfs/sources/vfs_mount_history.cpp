										 ...
										 mount_history_container &	history)
{
	...
	mount_history_container::mutex_raii	raii	(history);
...
{
	mount_history_container::mutex_raii	raii(mount_history);
...
struct filter_helper
{
	...
	{
		VOSTOK_UNREFERENCED_PARAMETERS		(description, physical_path, virtual_path);
