...
#ifndef VOSTOK_MEMORY_BASE_ALLOCATOR_H_INCLUDED
#define VOSTOK_MEMORY_BASE_ALLOCATOR_H_INCLUDED

#include <vostok/detail_noncopyable.h>
#include <vostok/memory_debug_parameters.h>

#ifdef MASTER_GOLD
#	define VOSTOK_USE_MEMORY_TOOLS	0
#else // #ifdef MASTER_GOLD
#	define VOSTOK_USE_MEMORY_TOOLS	1
#endif // #ifdef MASTER_GOLD

namespace vostok {
namespace memory {

class VOSTOK_CORE_API base_allocator : private core::noncopyable {
public:
					base_allocator		(
#ifndef MASTER_GOLD
...
protected:
	virtual	pvoid	call_malloc			( size_t size_t VOSTOK_CORE_DEBUG_PARAMETERS_DESCRIPTION_DECLARATION VOSTOK_CORE_DEBUG_PARAMETERS_DECLARATION ) = 0;
	virtual	pvoid	call_realloc		( pvoid pointer, size_t new_size VOSTOK_CORE_DEBUG_PARAMETERS_DESCRIPTION_DECLARATION VOSTOK_CORE_DEBUG_PARAMETERS_DECLARATION ) = 0;
...
#else // #if VOSTOK_USE_MEMORY_TOOLS
	inline	pvoid	on_malloc			( pvoid buffer, size_t buffer_size, size_t previous_size, pcstr description ) const { VOSTOK_UNREFERENCED_PARAMETER(buffer_size); VOSTOK_UNREFERENCED_PARAMETER(previous_size); VOSTOK_UNREFERENCED_PARAMETER(description); return buffer; }
	inline	void	on_free				( pvoid buffer, bool can_clear = true ) const { VOSTOK_UNREFERENCED_PARAMETER(can_clear); VOSTOK_UNREFERENCED_PARAMETER(buffer); }
...
protected:
	...
	pvoid	m_arena_end;
	pcstr	m_arena_id;
	bool	m_use_memory_monitor; // sushi@TODO: This field was added, but related logic is not yet.
...
#endif // #ifndef VOSTOK_MEMORY_BASE_ALLOCATOR_H_INCLUDED
