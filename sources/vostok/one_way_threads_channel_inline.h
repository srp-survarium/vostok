...
#ifndef VOSTOK_ONE_WAY_THREADS_CHANNEL_INLINE_H_INCLUDED
#define VOSTOK_ONE_WAY_THREADS_CHANNEL_INLINE_H_INCLUDED
...
inline void one_way_threads_channel< ForwardQueueType, BackwardQueueType >::delete_value				( pointer_type const value )
{
	...
	VOSTOK_DELETE_IMPL					( m_owner_allocator, temp );
}
...
#endif // #ifndef VOSTOK_ONE_WAY_THREADS_CHANNEL_INLINE_H_INCLUDED