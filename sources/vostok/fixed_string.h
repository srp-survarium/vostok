...
template class VOSTOK_CORE_API  fixed_string<512>;
template class VOSTOK_CORE_API  fixed_string<1024>;
template class VOSTOK_CORE_API  fixed_string<2048>;
template class VOSTOK_CORE_API  fixed_string<4096>;
template class VOSTOK_CORE_API  fixed_string<8192>;

} // namespace vostok

#include <vostok/fixed_string_inline.h>
