...
typedef vostok::vectora<undo_>		history;
typedef history::iterator				history_it;

typedef vostok::fixed_string<512>			text_editor_string;
struct dynamic_text
{
...
private:
			...
			void		draw_highlighted_rect(vostok::render::ui::renderer& render, vostok::render::scene_view_ptr const& scene_view);
			void		draw_cursor			(vostok::render::ui::renderer& render, vostok::render::scene_view_ptr const& scene_view);
...
//--
	...
	typedef vostok::vectora<base_edit_action*>edit_actions;
