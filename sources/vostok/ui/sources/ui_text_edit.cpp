...
void ui_text_edit::draw(vostok::render::ui::renderer& render, vostok::render::scene_view_ptr const& scene_view)
{
...
void ui_text_edit::draw_highlighted_rect(vostok::render::ui::renderer& render, vostok::render::scene_view_ptr const& scene_view)
{
	...
	vostok::render::ui::vertex const vertices[] = {
		vostok::render::ui::vertex( pos1.x,	pos1.y+h,	0.0f, clr, 0,	1 ),
		vostok::render::ui::vertex( pos1.x,	pos1.y,		0.0f, clr, 0,	0 ),
		vostok::render::ui::vertex( pos2.x,	pos2.y+h,	0.0f, clr, 1,	1 ),
		vostok::render::ui::vertex( pos2.x,	pos2.y,		0.0f, clr, 1,	0 )
	};
...
void ui_text_edit::draw_cursor(vostok::render::ui::renderer& render, vostok::render::scene_view_ptr const& scene_view)
{
