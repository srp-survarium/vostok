...
void ui_image::draw( vostok::render::ui::renderer& renderer, vostok::render::scene_view_ptr const& scene_view )
{
	int prim_type			= 0;
...
//	u32 max_verts			= 1*4; // use TriangleList+ IndexBuffer(0-1-2, 3-2-1)
	...
	vostok::render::ui::vertex const vertices[] = {
		vostok::render::ui::vertex( pos.x,		pos.y+size.y,	0.0f, m_color, m_tex_coords.x,	m_tex_coords.w ),
		vostok::render::ui::vertex( pos.x,		pos.y,			0.0f, m_color, m_tex_coords.x,	m_tex_coords.y ),
		vostok::render::ui::vertex( pos.x+size.x,	pos.y+size.y,	0.0f, m_color, m_tex_coords.z,	m_tex_coords.w ),
		vostok::render::ui::vertex( pos.x+size.x,	pos.y,			0.0f, m_color, m_tex_coords.z,	m_tex_coords.y )
	};
