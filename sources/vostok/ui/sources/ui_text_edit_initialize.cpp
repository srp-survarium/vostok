...
{
	VOSTOK_UNREFERENCED_PARAMETERS	(a1, a2);
...
{
	return VOSTOK_NEW_IMPL(parent->allocator(), functor_edit_action)(functor, parent, key, action, state);
}
										...
										input::world* input_world)
{
	...
	return VOSTOK_NEW_IMPL(parent->allocator(), insert_char_action)(parent, key, action, st, c, c_shift, b_translate, input_world);
}
...
{
	return VOSTOK_NEW_IMPL(parent->allocator(), shift_state_action)(parent, key, state);
}
