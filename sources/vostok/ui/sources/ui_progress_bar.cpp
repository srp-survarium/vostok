													...
													) const
{
	...
	vostok::render::ui::vertex const back_vertices[] = {
		vostok::render::ui::vertex( pos.x,			pos.y + size.y,	0.0f, m_back_color.m_value, 0, 1 ),
		vostok::render::ui::vertex( pos.x,			pos.y,			0.0f, m_back_color.m_value, 0, 0 ),
		vostok::render::ui::vertex( pos.x + size.x,	pos.y + size.y,	0.0f, m_back_color.m_value, 1, 1 ),
		vostok::render::ui::vertex( pos.x + size.x,	pos.y,			0.0f, m_back_color.m_value, 1, 0 )
	};
												...
												) const
{
	...
	vostok::render::ui::vertex const top_vertices[] = {
		vostok::render::ui::vertex( inner_pos.x,					inner_pos.y + inner_size.y,	0.0f, m_front_color.m_value, 0,	1 ),
		vostok::render::ui::vertex( inner_pos.x,					inner_pos.y,				0.0f, m_front_color.m_value, 0,	0 ),
		vostok::render::ui::vertex( inner_pos.x + inner_size.x,	inner_pos.y + inner_size.y,	0.0f, m_front_color.m_value, 1,	1 ),
		vostok::render::ui::vertex( inner_pos.x + inner_size.x,	inner_pos.y,				0.0f, m_front_color.m_value, 1,	0 )
	};
