...
struct VOSTOK_NOVTABLE window
{
	...
	virtual void			draw				(vostok::render::ui::renderer& render, vostok::render::scene_view_ptr const& scene_view)	= 0;
	virtual void			tick				()								= 0;
	...
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR( window )
}; // struct window

struct VOSTOK_NOVTABLE dialog
{
...
protected:
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR( dialog )
}; // struct dialog

struct VOSTOK_NOVTABLE text
{
...
protected:
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR( text )
}; // struct text

struct VOSTOK_NOVTABLE text_edit
{
...
protected:
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR( text_edit )
}; // struct text_edit

struct VOSTOK_NOVTABLE image
{
...
protected:
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR( image )
}; // struct image

struct VOSTOK_NOVTABLE scroll_source
{
public:
...
protected:
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR( scroll_source )
}; // struct scroll_source

struct VOSTOK_NOVTABLE scroll_view
{
...
protected:
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR( scroll_view )
}; // struct scroll_view

struct VOSTOK_NOVTABLE font
{
...
protected:
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR( font )
}; // struct font

struct VOSTOK_NOVTABLE progress_bar
{
...
protected:
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR( progress_bar )
}; // struct progress_bar
