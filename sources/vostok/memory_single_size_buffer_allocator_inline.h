...
#ifndef VOSTOK_MEMORY_SINGLE_SIZE_BUFFER_ALLOCATOR_INLINE_H_INCLUDED
#define VOSTOK_MEMORY_SINGLE_SIZE_BUFFER_ALLOCATOR_INLINE_H_INCLUDED
...
template < int DataSize, class ThreadingPolicy >
inline pvoid single_size_buffer_allocator< DataSize, ThreadingPolicy >::malloc_impl( size_t size VOSTOK_CORE_DEBUG_PARAMETERS_DESCRIPTION_DECLARATION VOSTOK_CORE_DEBUG_PARAMETERS_DECLARATION )
{
...
template < int DataSize, class ThreadingPolicy >
inline void single_size_buffer_allocator< DataSize, ThreadingPolicy >::free_impl( pvoid pointer VOSTOK_CORE_DEBUG_PARAMETERS_DECLARATION )
{
	VOSTOK_CORE_DEBUG_PARAMETERS_UNREFERENCED_GUARD;
	deallocate					( pointer );
}
...
#endif // #ifndef VOSTOK_MEMORY_SINGLE_SIZE_BUFFER_ALLOCATOR_INLINE_H_INCLUDED