...
#ifndef VOSTOK_MATH_FUNCTIONS_H_INCLUDED
#define VOSTOK_MATH_FUNCTIONS_H_INCLUDED
...
VOSTOK_CORE_API	float   table_sin		( int angle_in_degrees );
VOSTOK_CORE_API	float   table_cos		( int angle_in_degrees );
...
#endif // #ifndef VOSTOK_MATH_FUNCTIONS_H_INCLUDED
