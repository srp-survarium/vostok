...
ODE_API void	dJointInitContact( dxJointContact *j, const dContact *c );
ODE_API void	removeJointReferencesFromAttachedBodies (dxJoint *j);
/**
 ...
 * @ingroup joints
 */
ODE_API dReal dJointGetAMotorParam ( const dxJoint * , int parameter);
...
ODE_API void dInternalStepIsland (dxWorld *world, dxBody * const *body, int nb,
			  dxJoint * const *joint, int nj, dReal stepsize);

ODE_API void dxQuickStepper (dxWorld *world, dxBody * const *body, int nb,
