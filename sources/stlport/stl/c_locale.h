...
#  define _Locale_CNTRL _BB
#  define _Locale_UPPER _UP
#  define _Locale_LOWER _LO
#  define _Locale_DIGIT _DI
#  define _Locale_XDIGIT _XD
#  define _Locale_PUNCT _PU
#  define _Locale_SPACE _SP
#  define _Locale_PRINT (_DI|_LO|_PU|_SP|_UP|_XA)
#  define _Locale_ALPHA (_LO|_UP|_XA)
#endif
