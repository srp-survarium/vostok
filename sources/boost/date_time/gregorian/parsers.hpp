...
namespace gregorian {
   ...
   * return 'not_special' */
  BOOST_DATE_TIME_DECL special_values special_value_from_string(const vostok::network::std_string& s);

  //! Deprecated: Use from_simple_string
  inline date from_string(vostok::network::std_string s) {
  ...
  inline date from_simple_string(vostok::network::std_string s) {
  ...
  inline date from_us_string(vostok::network::std_string s) {
  ...
  inline date from_uk_string(vostok::network::std_string s) {
  ...
  inline date from_undelimited_string(vostok::network::std_string s) {
    return date_time::parse_undelimited_date<date>(s);
  }

  //! From iso type date string where with order year-month-day eg: 20020125
  inline date date_from_iso_string(const vostok::network::std_string& s) {
    return date_time::parse_undelimited_date<date>(s);
  }
  ...
  inline date_period date_period_from_string(const vostok::network::std_string& s){
