...
namespace gregorian {
  ...
  /*!\ingroup date_format
   */
  inline vostok::network::std_string to_simple_string(const date& d) {
  ...
  /*!\ingroup date_format
   */
  inline vostok::network::std_string to_simple_string(const date_period& d) {
    vostok::network::std_string s("[");
    vostok::network::std_string d1(date_time::date_formatter<date,date_time::simple_format<char> >::date_to_string(d.begin()));
    vostok::network::std_string d2(date_time::date_formatter<date,date_time::simple_format<char> >::date_to_string(d.last()));
  ...
  /*!\ingroup date_format
   */
  inline vostok::network::std_string to_iso_string(const date_period& d) {
    vostok::network::std_string s(date_time::date_formatter<date,date_time::iso_format<char> >::date_to_string(d.begin()));
  ...
  /*!\ingroup date_format
   */
  inline vostok::network::std_string to_iso_extended_string(const date& d) {
  ...
  /*!\ingroup date_format
   */
  inline vostok::network::std_string to_iso_string(const date& d) {
    return date_time::date_formatter<date,date_time::iso_format<char> >::date_to_string(d);
  }
  
  

  inline vostok::network::std_string to_sql_string(const date& d) 
  {
