...
namespace gregorian {
  ...
  {
    bad_month() : std::out_of_range(vostok::network::std_string("Month number is out of range 1..12")) {}
  };
  ...
  public:
    ...
    typedef std::map<vostok::network::std_string, unsigned short> month_map_type;
