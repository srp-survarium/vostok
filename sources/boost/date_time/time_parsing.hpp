...
namespace date_time {
  ...
  inline
  time_duration
  parse_delimited_time_duration(const vostok::network::std_string& s)
  {
  ...
  inline
  bool 
  split(const vostok::network::std_string& s,
        char sep,
        vostok::network::std_string& first,
        vostok::network::std_string& second)
  {
  ...
  inline
  time_type
  parse_delimited_time(const vostok::network::std_string& s, char sep)
  {
    typedef typename time_type::time_duration_type time_duration;
    typedef typename time_type::date_type date_type;

    //split date/time on a unique delimiter char such as ' ' or 'T'
    vostok::network::std_string date_string, tod_string;
  ...
  inline
  time_duration
  parse_undelimited_time_duration(const vostok::network::std_string& s)
  {
    int precision = 0;
    {
      // msvc wouldn't compile 'time_duration::num_fractional_digits()' 
    ...
    vostok::network::std_string remain = s.substr(sign);
    ...
    typedef boost::tokenizer<boost::offset_separator,
                             vostok::network::std_string::const_iterator,
                             vostok::network::std_string > tokenizer;
    typedef boost::tokenizer<boost::offset_separator,
                             vostok::network::std_string::const_iterator,
                             vostok::network::std_string >::iterator tokenizer_iterator;
    ...
    for(tokenizer_iterator ti=tok.begin(); ti!=tok.end();++ti){
      switch(pos) {
        ...
        case 3:
          {
            vostok::network::std_string char_digits(ti->substr(1)); // digits w/no decimal
  ...
  inline
  time_type
  parse_iso_time(const vostok::network::std_string& s, char sep)
  {
    typedef typename time_type::time_duration_type time_duration;
    typedef typename time_type::date_type date_type;
