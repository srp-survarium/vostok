...
namespace date_time {
    ...
    public:
      ...
      virtual vostok::network::std_string start_rule_as_string() const=0;
      virtual date_type end_day(year_type y) const=0;
      virtual vostok::network::std_string end_rule_as_string() const=0;
    ...
    public:
      ...
      virtual vostok::network::std_string start_rule_as_string() const
      {
      ...
      virtual vostok::network::std_string end_rule_as_string() const
      {
