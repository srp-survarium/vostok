...
- 0x20 `mov byte[ebp-1],0; lea eax; call finalize_impl` = LTCG-folded empty out-of-line
  call (documented artifact, assembly_patterns.md line 462) -- source line 38, UNREPRODUCIBLE
...
-> ```
   ...
   {
       // line 38: folded empty call (artifact)
