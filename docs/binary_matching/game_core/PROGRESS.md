...
- weapon_core_show_state (concrete WeaponCore show-state subclass, 5 fns; ONE unit, branch
  match/game_core-weapon_core_show_state off origin/int/game_core):
    ...
    weapon_core_show_state::new_object                      99.98% DONE     (cubic_spline_skeleton_animation_pinned(animations[0]/[1])->length_in_frames(); time_scale=weapon/user; placement-new ctor. Instruction stream byte-identical; 0.02% is reloc/representative artifact, same as pistol/idle new_object siblings.)
