...
- game_core::weapon_core_base_state::{ctor,deserializing} -> STATE[ctor INPROGRESS (bytes 100% but structure mismatch: body-assigns vs member-init list), deserializing 100%|DONE] -> PR #121, structure fix follow-up (regressions: none)
