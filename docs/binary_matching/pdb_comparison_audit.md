...
`1082b21db83b5fcbe221dff0f6c323aa25396550` in an isolated worktree and Wine
prefix with a successful full `python3 -m vostok build -j6`. No reconstructed
C++ was changed for this audit.

| PDB | bytes | SHA-256 |
|---|---:|---|
| candidate `binaries/Win32/survarium-dx11-win32-gold.pdb` | 105,065,472 | `2e03a682c4927a2b55d4aebf3062066df6df1aa24d43f68454c1527104f38c15` |
...
those differing scopes there are 13,833 inversion participants, 0 changed
