...
movzx eax, al
```
Steerable structurally; the inner `operator T` is where the inline-vs-call cut can wall the % (~89%, config-value-operator-cast.md). cite: player_parameters_modifyer_cook::translate_query player_parameters_cook.cpp:196.
