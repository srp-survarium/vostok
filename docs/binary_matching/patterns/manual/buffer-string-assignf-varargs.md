...
```
Steerable: the arg count drives `add esp,N`; a wrong N or a missing/extra push = a mismatched format-arg list in source. cite: survarium::items_cook::translate_query (rva 0x761b20) items_cook.cpp:23; object_wire.cpp:100 `wire_name.assignf("wire_%X", this)`.
