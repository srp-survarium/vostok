...
```
Steerable: source is just `m_cb();`; the offset follows from struct layout. cite: player_logic_sprint_state::initialize / ::finalize player_logic_sprint_state.cpp:96,102.
