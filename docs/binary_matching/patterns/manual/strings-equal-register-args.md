...
je    short $LN..
```
Steerable: the arg ORDER in source picks the EAX-vs-ECX assignment — swap operands if the literal is in the wrong register. cite: survarium::damage_model::on_broken_limb_affect (rva 0x6ff660) damage_model.cpp:317; mirror order at weapon_core::on_animation_ik_interval weapon_core.cpp:898.
