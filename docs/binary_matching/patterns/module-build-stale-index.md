...
symptoms: freshly-anchored symbols missing from binaries/pdb/base/evidence.sqlite
confidence: 5/10
variants: stale-comdat-other-module.md

`vostok.build.ninja <module>` (and `vostok build <module>`) compiles the module's objs
but skips the EXE/PDB link. The base structure/PDB evidence database is generated from the PDB, so
