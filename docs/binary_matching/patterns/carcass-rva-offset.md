# Carcass `// FUNCTION BODY[0xVA]` RVAs are +0x10000 off the PDB evidence database RVA
...
binaries/pdb/target/evidence.sqlite (carcass 0xa72f0 == index 0x972f0, 0x8d690 == 0x7d690).
