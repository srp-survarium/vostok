...
Checkpoint after the state/object-base batch: the registers account for 275
declarations, including existing bodies and explicitly open models/extent
questions. The literal scan is now 521 marked lines: game 294, game_core 158,
Scaleform 57, physics 6, animation 5, render 1. Excluding the 57 inactive SDK
mirror lines leaves 464 active marked lines, **not** a remaining-function
