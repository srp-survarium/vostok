...
Checkpoint after the dead/preview state audit: the registers account for 797
declarations, including existing bodies and explicitly open models/extent
questions. The literal scan is now 406 marked lines: game 285, game_core 52,
Scaleform 57, physics 6, animation 5, render 1. Excluding the 57 inactive SDK
mirror lines leaves 349 active marked lines, **not** a remaining-function
