...
Checkpoint after the game inline audit: the registers account for 921
declarations, including existing bodies and explicitly open models/extent
questions. The literal scan is now 330 marked lines: game 209, game_core 52,
Scaleform 57, physics 6, animation 5, render 1. Excluding the 57 inactive SDK
mirror lines leaves 273 active marked lines, **not** a remaining-function
