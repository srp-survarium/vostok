...
| 13 | remaining compilands | every `temp/structure_queue/sources/` file not consumed by 2-11 + the 9 owner-unknown TU-locals | DONE (this commit) - 9 orphan predicates triaged out (pass 6); header queue empty |
