# ai_navigation data relocation problems

_Generated by `python3 -m vostok data module-relocs ai_navigation`. Every physical
retail and candidate ai_navigation relocation into `.rdata`, `.data`, or the
...
- Retail relocation sites: 17
- Candidate relocation sites: 17
- Paired sites: 17
- Retail-only sites: 0
...
- Extentless allocation dossiers: 7
- Paired functions with raw deduplicated datum-set differences: 0
- Open function datum-use rows: 0

Pairing modes: `function-offset`=17

Paired access shapes: `EXACT`=17

Paired referents: `EXACT`=17

Complete/extent debt results: `EXACT`=6, `EXTENTLESS`=11

Extentless evidence-window results: `EXACT`=7
