# logging data relocation problems

_Generated by `python3 -m vostok data module-relocs logging`. Every physical
retail and candidate logging relocation into `.rdata`, `.data`, or the
...
- Retail relocation sites: 31
- Candidate relocation sites: 31
- Paired sites: 31
- Retail-only sites: 0
- Candidate-only sites: 0
- Problematic audit rows: 0
...
- Extentless allocation dossiers: 14
- Paired functions with raw deduplicated datum-set differences: 0
- Open function datum-use rows: 0

Pairing modes: `access-sequence`=3, `function-offset`=28

Paired access shapes: `EXACT`=31

Paired referents: `EXACT`=31

Complete/extent debt results: `EXACT`=13, `EXTENTLESS`=18

Extentless evidence-window results: `EXACT`=12, `LINKER_VALUE`=1, `VTABLE_CODE_TARGETS`=1
