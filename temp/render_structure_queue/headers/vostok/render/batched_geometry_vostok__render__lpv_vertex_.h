...
class vostok::render::vector<vostok::render::lpv_vertex>;
...
struct batched_geometry< lpv_vertex > : public batched_geometry_interface {
	...
	inline			batched_geometry<vostok::render::lpv_vertex>( ) { /* no source */ }
protected:
	inline			batched_geometry<vostok::render::lpv_vertex>(
