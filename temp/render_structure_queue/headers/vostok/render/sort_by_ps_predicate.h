...
#ifndef RENDER_SORT_BY_PS_PREDICATE_H_INCLUDED
#define RENDER_SORT_BY_PS_PREDICATE_H_INCLUDED
...
struct sort_by_ps_predicate {
	inline			sort_by_ps_predicate( enum_render_stage_type arg_0, const u32 arg_1 ) { /* no source */ }
...
#endif // #ifndef RENDER_SORT_BY_PS_PREDICATE_H_INCLUDED
