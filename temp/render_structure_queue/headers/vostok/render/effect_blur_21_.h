...
class effect_blur< 21 > : public effect_descriptor {
public:
	inline			effect_blur<21>	( ) { /* no source */ }

	virtual	void	compile			( effect_compiler& arg_0, custom_config_value const& arg_1 ) override { /* no source */ }

	virtual			~effect_blur<21>( ) { /* no source */ }
}; // class effect_blur< 21 >

STATIC_SIZE_ASSERT(effect_blur< 21 >, 0x4);
