...
class effect_blur< 25 > : public effect_descriptor {
public:
	inline			effect_blur<25>	( ) { /* no source */ }

	virtual	void	compile			( effect_compiler& arg_0, custom_config_value const& arg_1 ) override { /* no source */ }

	virtual			~effect_blur<25>( ) { /* no source */ }
}; // class effect_blur< 25 >

STATIC_SIZE_ASSERT(effect_blur< 25 >, 0x4);
