...
#ifndef RENDER_EFFECT_POST_PROCESS_DISTORTION_MATERIALS_H_INCLUDED
#define RENDER_EFFECT_POST_PROCESS_DISTORTION_MATERIALS_H_INCLUDED
...
public:
	...
	inline			effect_post_process_distortion_materials( ) { /* no source */ }
	virtual			~effect_post_process_distortion_materials( ) { /* no source */ }
...
#endif // #ifndef RENDER_EFFECT_POST_PROCESS_DISTORTION_MATERIALS_H_INCLUDED
