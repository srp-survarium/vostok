...
class effect_blur< 13 > : public effect_descriptor {
public:
	inline			effect_blur<13>	( ) { /* no source */ }

	virtual	void	compile			( effect_compiler& arg_0, custom_config_value const& arg_1 ) override { /* no source */ }

	virtual			~effect_blur<13>( ) { /* no source */ }
}; // class effect_blur< 13 >

STATIC_SIZE_ASSERT(effect_blur< 13 >, 0x4);
