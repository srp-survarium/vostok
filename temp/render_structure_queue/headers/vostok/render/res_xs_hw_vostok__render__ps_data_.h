...
class res_xs_hw< ps_data > : public resource_intrusive_base {
	inline							res_xs_hw<vostok::render::ps_data>	( ) { /* no source */ }
	inline							~res_xs_hw<vostok::render::ps_data>	( ) { /* no source */ }
...
private:
			HRESULT					create_hw_shader					( ID3D10Blob* shader_code, ID3D11PixelShader** hardware_shader );
public:
	inline	ID3D11PixelShader*		hardware_shader						( ) const { /* no source */ }
