...
class plane_spot_light_effect< 0 > : public effect_descriptor {
	virtual	void	compile						( effect_compiler& compiler, custom_config_value const& config ) override { /* no source */ }

public:
	inline			plane_spot_light_effect<0>	( ) { /* no source */ }
	virtual			~plane_spot_light_effect<0>	( ) { /* no source */ }
}; // class plane_spot_light_effect< 0 >

STATIC_SIZE_ASSERT(plane_spot_light_effect< 0 >, 0x4);
