...
#ifndef RENDER_TEXTURE_POOL_H_INCLUDED
#define RENDER_TEXTURE_POOL_H_INCLUDED

/* INCLUDES */
class vostok::render::vector<vostok::render::texture_pool::slot>;
...
public:
	...
	inline	res_texture*	get				( ) { /* no source */ }

	inline	void			release			( res_texture const* arg_0 ) { /* no source */ }

	inline	u32				memory_usage	( ) { /* no source */ }

	inline	u32				unoccupied_count( ) { /* no source */ }

private:
	/* 0x0000 */	vector< texture_pool::slot >	m_textures;
	/* 0x000c */	u32								m_unoccupied_count;
	/* 0x0010 */	u32								m_width;
	/* 0x0014 */	u32								m_height;
	/* 0x0018 */	DXGI_FORMAT						m_format;
	/* 0x001c */	u32								m_mips;
	/* 0x0020 */	u32								m_memory_usage;
}; // class texture_pool
...
#endif // #ifndef RENDER_TEXTURE_POOL_H_INCLUDED
