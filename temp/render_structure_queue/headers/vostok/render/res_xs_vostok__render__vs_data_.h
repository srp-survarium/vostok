...
class res_xs< vs_data > : public resource_intrusive_base {
			explicit						res_xs<vostok::render::vs_data>	( xs_descriptor< vs_data > const& binder );

	inline	void							destroy_impl					( ) const { /* no source */ }

public:
	inline	bool							equal							( xs_descriptor< vs_data > const& arg_0 ) const { /* no source */ }

			s32								compare							( xs_descriptor< vs_data > const& binder ) const;

	inline	bool							less							( xs_descriptor< vs_data > const& arg_0 ) const { /* no source */ }
	...
	inline	res_xs_hw< vs_data > const*		hardware_shader					( ) { /* no source */ }

	inline									~res_xs<vostok::render::vs_data>( ) { /* no source */ }

	/* 0x0000 */	/* resource_intrusive_base */
private:
	/* 0x0004 */	res_xs_hw< vs_data >_ptr		m_hardware_shader;
