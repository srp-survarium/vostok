...
#ifndef RENDER_DEVICE_CAPS_H_INCLUDED
#define RENDER_DEVICE_CAPS_H_INCLUDED

/* INCLUDES */
struct vostok::render::device_caps::caps_geometry;
struct vostok::render::device_caps::caps_raster;
...
class device_caps {
public:
	inline			device_caps	( ) { /* no source */ }

	inline	void	update		( ) { /* no source */ }

	/* 0x0000 */	bool							force_gpu_ref;
	/* 0x0001 */	bool							force_gpu_sw;
	/* 0x0002 */	bool							force_gpu_non_pure;
	/* 0x0004 */	u32								gpu_num;
	/* 0x0008 */	DXGI_FORMAT						target_fmt;
	/* 0x000c */	DXGI_FORMAT						depth_fmt;
	/* 0x0010 */	u32								refresh_rate;
	/* 0x0014 */	u16								geometry_major;
	/* 0x0016 */	u16								geometry_minor;
	/* 0x0018 */	device_caps::caps_geometry		geometry;
	/* 0x0020 */	u16								raster_major;
	/* 0x0022 */	u16								raster_minor;
	/* 0x0024 */	device_caps::caps_raster		raster;
	/* 0x002c */	u32								id_vendor;
	/* 0x0030 */	u32								id_device;
}; // class device_caps
...
#endif // #ifndef RENDER_DEVICE_CAPS_H_INCLUDED
