...
class boost::function<void __cdecl(vostok::render::decal_properties const &)>;
...
class functor_with_big_buffer_to_copy_command< decal_properties > : public base_command , public boost::noncopyable {
public:
	inline			functor_with_big_buffer_to_copy_command<vostok::render::decal_properties>(
	...
	virtual			~functor_with_big_buffer_to_copy_command<vostok::render::decal_properties>( ) { /* no source */ }

	/* 0x0000 */	/* base_command */
	/* 0x0054 */	/* boost::noncopyable */
private:
	/* 0x0058 */	boost::function< void( decal_properties const& ) >	m_on_execute;
	/* 0x0078 */	boost::function< void( base_command& ) >	m_on_defer_execution;
	/* 0x0098 */	const decal_properties		m_data;
}; // class functor_with_big_buffer_to_copy_command< decal_properties >

STATIC_SIZE_ASSERT(functor_with_big_buffer_to_copy_command< decal_properties >, 0x100);
