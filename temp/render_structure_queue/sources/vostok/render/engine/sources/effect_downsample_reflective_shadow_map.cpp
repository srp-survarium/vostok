...
#include "pch.h"
#include "vostok\render\engine\sources\effect_downsample_reflective_shadow_map.h"
...
{
	// FUNCTION BODY[0x7b5280]: 10
	// <0>
	// <1>
	// <0x7b528b>|0x00b|+0x008:'19'
	// <0x7b5293>|0x013|+0x02d:'20'
	// <0x7b52c0>|0x040|+0x048:'21'
	// <0>
	// <1>
	// <2>
	// <0x7b5308>|0x088|+0x006:'25'
	// <0x7b530e>|0x08e|+0x005:'26'
	// ******
}
