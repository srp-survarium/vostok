...
// STATE[STUB]
inline void effect_manager::create_effect<vostok::render::effect_exponential_volume_fog>( res_effect_ptr* out_effect )
{
	// LOCALS
	...
	// STATICS
	// static effect_exponential_volume_fog descriptor_object = <0x4c26c68>;
	// ******

	// FUNCTION BODY[0x7f550]: 15
	// <0x7f55a>|0x00a|+0x02d:'69'
	// <0>
	// <0x7f587>|0x037|+0x00c:'71'
	// <0x7f593>|0x043|+0x013:'72'
	// <0>
	// <1>
	// <2>
	// <3>
	...
	// <6>
	// <7>
	// <0x7f5a6>|0x056|+0x073:'81'
	// <0x7f619>|0x0c9|+0x002:'82'
	// <0x7f61b>|0x0cb|+0x035:'83'
	// ******
}
