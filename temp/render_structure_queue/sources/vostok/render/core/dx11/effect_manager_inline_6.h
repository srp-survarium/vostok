...
// STATE[STUB]
inline void effect_manager::create_effect<vostok::render::effect_apply_distortion>( res_effect_ptr* out_effect )
{
	// LOCALS
	...
	// STATICS
	// static effect_apply_distortion 	descriptor_object = <0x4c267bc>;
	// ******

	// FUNCTION BODY[0x7f180]: 15
	// <0x7f18a>|0x00a|+0x02d:'69'
	// <0>
	// <0x7f1b7>|0x037|+0x00c:'71'
	// <0x7f1c3>|0x043|+0x013:'72'
	// <0>
	// <1>
	// <2>
	// <3>
	...
	// <6>
	// <7>
	// <0x7f1d6>|0x056|+0x073:'81'
	// <0x7f249>|0x0c9|+0x002:'82'
	// <0x7f24b>|0x0cb|+0x035:'83'
	// ******
}
