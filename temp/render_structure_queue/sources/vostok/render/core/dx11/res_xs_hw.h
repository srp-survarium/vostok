...
#ifndef VOSTOK\RENDER\CORE\DX11\RES_XS_HW_H_INCLUDED
#define VOSTOK\RENDER\CORE\DX11\RES_XS_HW_H_INCLUDED

namespace vostok {
namespace render {

// STATE[STUB]
inline void res_xs_hw<vostok::render::vs_data>::set_name( shared_string const& name )
{
	// FUNCTION BODY[0x126bd0]
	// ******
}
...
#endif // #ifndef VOSTOK\RENDER\CORE\DX11\RES_XS_HW_H_INCLUDED
