...
// STATE[STUB]
inline  res_xs_hw<vostok::render::vs_data>::res_xs_hw<vostok::render::vs_data>( )
{
	// FUNCTION BODY[0x12f980]: 1
	// <0>
	// ******
}
...
{
	// CALL SITE INFO
	// <0x12f9f0> -> unsigned long < unknown >()
	// ******

	// FUNCTION BODY[0x12f9e0]: 1
	// <0x12f9e3>|0x003|+0x016:'27'
	// ******
}

// STATE[STUB]
inline HRESULT res_xs_hw<vostok::render::vs_data>::create_hw_shader( ID3D10Blob* shader_code )
{
	// LOCALS
	...
	// CALL SITE INFO
	// <0x12fa4c> -> void* < unknown >()
	// <0x12fa56> -> unsigned long < unknown >()
	// <0x12fa8b> -> HRESULT < unknown >( _D3D11_SHADER_DESC* )
	// <0x12facd> -> unsigned long < unknown >()
	// ******

	// FUNCTION BODY[0x12fa30]: 47
	// <0>
	// <1>
	// <0x12fa43>|0x013|+0x00b:'55'
	// <0x12fa4e>|0x01e|+0x00a:'56'
	// <0>
	// <0x12fa58>|0x028|+0x00d:'58'
	// <0>
	// <0x12fa65>|0x035|+0x004:'60'
	// <0>
	// <1>
	// <2>
	// <3>
	// <4>
	// <0x12fa69>|0x039|+0x013:'66'
	// <0>
	// <1>
	// <2>
	// <0x12fa7c>|0x04c|+0x011:'70'
	// <0>
	// <1>
	// <2>
	// <0x12fa8d>|0x05d|+0x019:'74'
	// <0x12faa6>|0x076|+0x015:'75'
	// <0>
	// <0x12fabb>|0x08b|+0x021:'77'
	// <0>
	// <1>
	// <2>
	// <3>
	...
	// <16>
	// <17>
	// <0x12fadc>|0x0ac|-0x00d:'96'
	// <0>
	// <1>
	// <0x12facf>|0x09f|+0x002:'99'
	// <0x12fad1>|0x0a1|+0x0d2:'100'
	// ******
}

// STATE[STUB]
inline void res_xs_hw<vostok::render::vs_data>::parse_resources(
	ID3D11ShaderReflection*					shader_reflection,
