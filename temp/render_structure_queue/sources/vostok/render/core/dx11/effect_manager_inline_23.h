...
// STATE[STUB]
inline void effect_manager::create_effect<vostok::render::effect_light_mask>( res_effect_ptr* out_effect )
{
	// LOCALS
	...
	// STATICS
	// static effect_light_mask 		descriptor_object = <0x4c265b0>;
	// ******

	// FUNCTION BODY[0x74470]: 15
	// <0x7447a>|0x00a|+0x02d:'69'
	// <0>
	// <0x744a7>|0x037|+0x00c:'71'
	// <0x744b3>|0x043|+0x013:'72'
	// <0>
	// <1>
	// <2>
	// <3>
	...
	// <6>
	// <7>
	// <0x744c6>|0x056|+0x073:'81'
	// <0x74539>|0x0c9|+0x002:'82'
	// <0x7453b>|0x0cb|+0x035:'83'
	// ******
}
