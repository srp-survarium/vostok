...
// STATE[STUB]
inline void effect_manager::create_effect<vostok::render::effect_translucency>( res_effect_ptr* out_effect )
{
	// LOCALS
	...
	// STATICS
	// static effect_translucency 		descriptor_object = <0x4c267d4>;
	// ******

	// FUNCTION BODY[0x7e3d0]: 15
	// <0x7e3da>|0x00a|+0x02d:'69'
	// <0>
	// <0x7e407>|0x037|+0x00c:'71'
	// <0x7e413>|0x043|+0x013:'72'
	// <0>
	// <1>
	// <2>
	// <3>
	...
	// <6>
	// <7>
	// <0x7e426>|0x056|+0x073:'81'
	// <0x7e499>|0x0c9|+0x002:'82'
	// <0x7e49b>|0x0cb|+0x035:'83'
	// ******
}
