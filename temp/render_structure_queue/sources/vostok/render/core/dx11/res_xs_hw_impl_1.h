...
// STATE[STUB]
inline  res_xs_hw<vostok::render::gs_data>::res_xs_hw<vostok::render::gs_data>( )
{
...
// STATE[STUB]
inline HRESULT res_xs_hw<vostok::render::gs_data>::create_hw_shader( ID3D10Blob* shader_code )
{
	// LOCALS
	// u32 								buffer_size
	...
	// CALL SITE INFO
	// <0x12fe1c> -> void* < unknown >()
	// <0x12fe26> -> unsigned long < unknown >()
	// <0x12fe32> -> void* < unknown >()
	// <0x12fe3c> -> unsigned long < unknown >()
	// <0x12fe58> -> HRESULT < unknown >( pcvoid, unsigned long, ID3D11ClassLinkage*, ID3D11GeometryShader** )
	// <0x12fe88> -> HRESULT < unknown >( _D3D11_SHADER_DESC* )
	// ******

	// FUNCTION BODY[0x12fe00]: 47
	// <0>
	// <1>
	// <0x12fe0b>|0x00b|+0x013:'55'
	// <0x12fe1e>|0x01e|+0x00a:'56'
	// <0>
	// <0x12fe28>|0x028|+0x034:'58'
	// <0>
	// <0x12fe5c>|0x05c|+0x006:'60'
	// <0>
	// <1>
	// <2>
	// <3>
	// <4>
	// <0x12fe62>|0x062|+0x017:'66'
	// <0>
	// <1>
	// <2>
	// <0x12fe79>|0x079|+0x011:'70'
	// <0>
	// <1>
	// <2>
	// <0x12fe8a>|0x08a|+0x019:'74'
	// <0x12fea3>|0x0a3|+0x015:'75'
	// <0>
	// <0x12feb8>|0x0b8|+0x021:'77'
	// <0>
	// <1>
	// <2>
	// <3>
	...
	// <16>
	// <17>
	// <0x12fed9>|0x0d9|-0x00d:'96'
	// <0>
	// <1>
	// <0x12fecc>|0x0cc|+0x002:'99'
	// <0x12fece>|0x0ce|+0x0ca:'100'
	// ******
}

// STATE[STUB]
inline void res_xs_hw<vostok::render::gs_data>::parse_resources(
	ID3D11ShaderReflection*					shader_reflection,
