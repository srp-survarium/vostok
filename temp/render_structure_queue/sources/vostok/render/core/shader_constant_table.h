...
#ifndef VOSTOK\RENDER\CORE\SHADER_CONSTANT_TABLE_H_INCLUDED
#define VOSTOK\RENDER\CORE\SHADER_CONSTANT_TABLE_H_INCLUDED

namespace vostok {
namespace render {

// STATE[STUB]
inline explicit shader_constant_table::shader_constant_table( shader_constant_table const& other )
{
	// FUNCTION BODY[0x124850]: 0
	// ******
}
...
#endif // #ifndef VOSTOK\RENDER\CORE\SHADER_CONSTANT_TABLE_H_INCLUDED
