...
//	vostok::ai::navigation::world& ai_navigation_world( ) const	{ return *m_ai_navigation_world; }
	...
	vostok::render::render_output_window_ptr	render_output_window( )			{ return m_render_output_window; }
	vostok::render::viewport_type const&		viewport			( ) const	{ return m_viewport; }
...
//	float3									m_movement_target;
	...
	vostok::ui::window*						m_debug_window;
