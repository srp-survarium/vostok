...
using vostok::game::tool_solid_visual;
using vostok::game::object_base;

tool_solid_visual::tool_solid_visual(vostok::game::game_world& w)
:super		(w)
{
//	load_library	();
}
...
object_base* tool_solid_visual::load_object(vostok::configs::lua_config_value const& t)
{
