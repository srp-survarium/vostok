...
public:	
	...
	virtual void				set_eyes_direction	( float3 const& direction ) { VOSTOK_UNREFERENCED_PARAMETER( direction ); }
...
private:			
	...
	animation::callback_return_type_enum on_animation_interval_end	(
			...
			void	on_animation_controller_animations_arrived( vostok::resources::queries_result const& result );
...
////////////////////////////////////////////////////////////////////////////
	...
	vostok::ai::navigation::path_type					m_navigation_path;
