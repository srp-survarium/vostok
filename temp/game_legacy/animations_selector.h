...
{
public:
			animations_selector					( vostok::animation::animation_player& player );

	void	set_target							( vostok::ai::animation_item const& animation_emitter );
	void	set_target							( vostok::ai::movement_target const& target_position );
...
private:
	...
	vostok::animation::animation_player&			m_animation_player;
