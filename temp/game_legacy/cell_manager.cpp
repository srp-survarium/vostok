...
static vostok::console_commands::cc_bool		cells_debug_draw( "cells_debug_draw", g_cells_debug_draw, true, vostok::console_commands::command_type_user_specific );

static vostok::console_commands::cc_u32		cells_flood_depth( "cells_flood_depth", g_cells_flood_depth, 3, 1000, true, vostok::console_commands::command_type_engine_internal );
...
{
	VOSTOK_UNREFERENCED_PARAMETERS( &k, clr );
//	vostok::render::debug::renderer& renderer = m_game.renderer().debug();
	float4x4 m;
	m.identity();
