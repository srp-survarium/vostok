...
class game_scene : private vostok::physics::engine,  private boost::noncopyable {
public:
	...
	vostok::render::scene_ptr const&			get_render_scene		( )	const { return m_scene; }
	vostok::render::scene_view_ptr const&		get_render_scene_view	( )	const { return m_scene_view; }
