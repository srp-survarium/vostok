...
bool console::on_text_changed(ui::window* w, int p1, int p2)
{
	...
	if(res==0)
	{
		...
		if(current)
		{
			...
			vostok::sprintf				(m_current_command_info, "%s current is <%s>", info_str, status_str);
			m_tips.clear				();
