...
#ifndef VOSTOK_RENDER_BASE_EDITOR_RENDERER_H_INCLUDED
#define VOSTOK_RENDER_BASE_EDITOR_RENDERER_H_INCLUDED
...
public:
	...
	virtual	void 	terrain_update_cell_buffer	( visual_ptr v, vostok::vectora<buffer_fragment_NEW> & fragments, float4x4 const& transform, command_finished_callback const& finish_callback, u32 finish_callback_argument) = 0;
...
#endif // #ifndef VOSTOK_RENDER_BASE_EDITOR_RENDERER_H_INCLUDED