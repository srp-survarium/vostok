...
#include <vostok/animation/i_skeleton.h>
...
{
	vostok::fixed_string<64>	material_instance_name;
	vostok::fixed_string<64>	shading_group_name;
	u32						num_vertices;
	u32						num_indices;
	u32						primitive_count;
};
...
protected:
	VOSTOK_DECLARE_PURE_VIRTUAL_DESTRUCTOR( render_model_instance_base )
