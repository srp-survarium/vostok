...
struct VOSTOK_NOVTABLE platform {
	...
	virtual	void				update_visual				( u32 id, vostok::math::float4x4 const& transform, bool selected ) = 0;
	virtual	void				remove_visual				( u32 id ) = 0;
	virtual	void				update_visual_vertex_buffer	( vostok::render::visual_ptr v, vectora<buffer_fragment> const& fragments ) = 0;
	virtual	void				update_visual_index_buffer	( vostok::render::visual_ptr v, vectora<buffer_fragment> const& fragments ) = 0;
	virtual	void				change_visual_shader		( vostok::render::visual_ptr v, char const* shader, char const* texture ) = 0;
	...
	virtual	void 				terrain_update_cell_buffer	( visual_ptr v, vostok::vectora<buffer_fragment_NEW> const& fragments, float4x4 const& transform) = 0;
