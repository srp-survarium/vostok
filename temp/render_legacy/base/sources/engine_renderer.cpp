...
using vostok::render::engine::engine_renderer;

engine_renderer::engine_renderer				( vostok::render::base_world& world, vostok::render::platform& platform ) :
	m_world							( world ),
	m_platform						( platform )
{
}
...
void engine_renderer::set_view_matrix	( vostok::math::float4x4 const& matrix )
{
	m_world.commands().push_command	( L_NEW( command_view_matrix ) ( m_platform, matrix ) );
}

void engine_renderer::set_projection_matrix( vostok::math::float4x4 const& matrix )
{
