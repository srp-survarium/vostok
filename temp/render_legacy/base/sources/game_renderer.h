...
class game_renderer :
	public vostok::render::game::renderer,
...
public:
	...
	virtual void	add_light					( u32 id, vostok::render::light_props const& props );
	virtual void	update_light				( u32 id, vostok::render::light_props const& props );
