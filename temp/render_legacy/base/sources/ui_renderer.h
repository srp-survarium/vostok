...
class ui_command :
	public vostok::render::ui::command,
...
public:
						...
						ui_command			( ui::vertex* begin, ui::vertex* end, int prim_type, int point_type, vostok::render::platform& p);
	virtual				~ui_command			();
...
class ui_renderer :
	public vostok::render::ui::renderer,
	private boost::noncopyable
{
public:
