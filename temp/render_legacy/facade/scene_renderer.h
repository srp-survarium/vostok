...
#ifndef VOSTOK_RENDER_FACADE_SCENE_RENDERER_IMPL_H_INCLUDED
#define VOSTOK_RENDER_FACADE_SCENE_RENDERER_IMPL_H_INCLUDED
...
public:
	...
	// speedtree
	void			add_speedtree_instance			( scene_ptr const& scene, render::speedtree_instance_ptr const& v, vostok::math::float4x4 const& transform, bool populate_forest );
	void			remove_speedtree_instance		( scene_ptr const& scene, render::speedtree_instance_ptr const& v, bool populate_forest );
	void			update_speedtree_instance		( scene_ptr const& scene, render::speedtree_instance_ptr const& v, vostok::math::float4x4 const& transform, bool populate_forest );
	...
	// sky
	void			set_sky_material				( scene_ptr const& scene, vostok::resources::unmanaged_resource_ptr const& mtl_ptr);
	
#ifndef MASTER_GOLD
	void			draw_render_statistics			( vostok::ui::world& ui_world, render::scene_view_ptr const& scene );
#endif // #ifndef MASTER_GOLD
...
#endif // #ifndef VOSTOK_RENDER_FACADE_SCENE_RENDERER_IMPL_H_INCLUDED