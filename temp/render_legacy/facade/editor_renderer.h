...
#ifndef VOSTOK_RENDER_FACADE_EDITOR_RENDERER_H_INCLUDED
#define VOSTOK_RENDER_FACADE_EDITOR_RENDERER_H_INCLUDED
...
public:
	...
	void	update_preview_particle_system				( scene_ptr const& scene, particle::particle_system** preview_ps, vostok::configs::lua_config_value const& config_value );
	...
	void	add_preview_particle_system					( scene_ptr const& scene, particle::particle_system** preview_ps, vostok::configs::lua_config_value const& init_values, math::float4x4 const& transform = math::float4x4().identity() );
	...
	void 	terrain_update_cell_buffer					( scene_ptr const& scene, render::render_model_instance_ptr const& v, vostok::vectora<terrain_buffer_fragment> & fragments, float4x4 const& transform, on_command_finished_functor_type const& on_command_finished_functor );
	...
	void	set_selection_parameters					( vostok::math::float4 const& selection_color, float selection_rate );
...
#endif // #ifndef VOSTOK_RENDER_FACADE_EDITOR_RENDERER_H_INCLUDED