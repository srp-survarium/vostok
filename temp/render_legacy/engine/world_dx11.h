...
#ifndef VOSTOK_RENDER_ENGINE_PLATFORM_DX11_H_INCLUDED
#define VOSTOK_RENDER_ENGINE_PLATFORM_DX11_H_INCLUDED
...
class renderer;
//typedef	vostok::resources::resource_ptr < vostok::render::renderer, vostok::resources::unmanaged_intrusive_base > renderer_ptr;
...
public:
	...
	vostok::render::renderer*								m_renderer;
...
//			void			change_model_shader			( render::render_model_instance_ptr const& v, char const* shader, char const* texture );
			...
			void		set_particles_render_mode		( scene_view_ptr view_ptr, vostok::particle::enum_particle_render_mode render_mode );
...
#endif // #ifndef VOSTOK_RENDER_ENGINE_PLATFORM_DX11_H_INCLUDED