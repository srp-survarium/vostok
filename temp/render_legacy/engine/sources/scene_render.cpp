...
#include <vostok/render/engine/vertex_formats.h>
#include <vostok/render/engine/effect_combine.h>
...
#include <vostok/render/engine/stage_gbuffer.h>
#include <vostok/render/engine/stage_texture_mip_clamp_test.h>
#include <vostok/render/engine/stage_pre_lighting.h>
#include <vostok/render/engine/stage_sun.h>
#include <vostok/render/engine/stage_sun_materials.h>
#include <vostok/render/engine/stage_skybox.h>
#include <vostok/render/engine/stage_combine.h>
#include <vostok/render/engine/stage_lights.h>
#include <vostok/render/engine/stage_screen_image.h>
#include <vostok/render/engine/scene_context.h>
...
//m_context.m_smap = resource_manager::ref().create_render_target( r2_rt_smap_depth, smap_size, smap_size, smap_fmt);
	...
	// Initialize textyres
	configs::lua_config_ptr config = vostok::configs::create_lua_config();
	vostok::configs::lua_config_value  & cfg = config->get_root();
...
void scene_render::on_test_visual_loaded	( vostok::resources::queries_result& data)
{
	ASSERT							( !data.empty());
