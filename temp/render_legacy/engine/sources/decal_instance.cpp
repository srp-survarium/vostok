...
void decal_shader_constants_and_geometry::set(vostok::render::renderer_context* context,
...
void decal_instance::render(vostok::render::renderer_context* context, 
...
u32 decal_instance::draw(vostok::render::renderer_context* context,
