...
struct branch_vertex
{
	...
	float  m_afDiffuseTexCoords[2], m_afDetailTexCoords[2];    // texcoord1
...
void speedtree_tree_component_branch::init_index_buffer(SpeedTree::SIndexedTriangles const* lod, render::vector<u16>& out_indices)
{
...
// 		m_material_effects, 
// 		mtl_ptr, speedtree_branch_vertex_input_type,
// 		false
// 	);
}
