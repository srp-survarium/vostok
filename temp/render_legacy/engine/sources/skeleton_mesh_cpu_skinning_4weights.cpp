...
using vostok::render::skeleton_mesh_cpu_skinning_4weights;
...
void skeleton_mesh_cpu_skinning_4weights::load				( vostok::configs::binary_config_value const& properties, vostok::memory::chunk_reader& r )
{
...
void skeleton_mesh_cpu_skinning_4weights::update( vostok::render::vector<float4x4> const& bones )
{
	skinning_sw						( bones );
}

void skeleton_mesh_cpu_skinning_4weights::skinning_sw( vostok::render::vector<float4x4> const& bones )
{
	...
	vostok::render::base_basis	Basis; // quant
