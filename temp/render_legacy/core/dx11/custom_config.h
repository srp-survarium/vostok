...
struct custom_config: public vostok::resources::unmanaged_intrusive_base
{
	custom_config	 ();
	void destroy	 (custom_config* in_this);
	
	bool operator == (vostok::configs::binary_config_value const& value)	{ return m_root == value; }
...
custom_config_ptr	create_custom_config(effect_options_descriptor const& value, vostok::mutable_buffer& buffer, u32& out_data_crc, bool calc_data_crc = false);
custom_config_ptr	create_custom_config(custom_config_value const& value, vostok::mutable_buffer& buffer, u32& out_data_crc, bool calc_data_crc = false);
custom_config_ptr	create_custom_config(configs::binary_config_value const& value, vostok::mutable_buffer& buffer, u32& out_data_crc, bool calc_data_crc = false);
