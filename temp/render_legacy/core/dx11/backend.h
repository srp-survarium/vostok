...
// 	void set_ca( shared_string name, u32 index, float x, float y, float z, float w);
	...
	inline void	render_indexed_instanced( D3D_PRIMITIVE_TOPOLOGY type, u32 index_count, u32 start_index, u32 base_vertex, u32 instance_count, u32 start_instance);
...
// 	/*VOSTOK_ALIGN( 16)*/ shader_constant_buffer_ptr	m_constant_buffer_pixel;
// 	/*VOSTOK_ALIGN( 16)*/ shader_constant_buffer_ptr	m_constant_buffer_vertex;
