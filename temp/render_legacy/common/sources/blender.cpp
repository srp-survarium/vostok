...
{
	VOSTOK_UNREFERENCED_PARAMETER	( mem_reader );
...
{
	VOSTOK_UNREFERENCED_PARAMETERS	( mem_reader, int_prop );
}

void read_bool(memory::reader& mem_reader, bool& bool_prop)
{
	VOSTOK_UNREFERENCED_PARAMETERS	( mem_reader, bool_prop );
}

void read_string(memory::reader& mem_reader, char* str_prop)
{
	VOSTOK_UNREFERENCED_PARAMETERS	( mem_reader, str_prop );
}
...
{
	VOSTOK_UNREFERENCED_PARAMETERS	( compiler, options );
