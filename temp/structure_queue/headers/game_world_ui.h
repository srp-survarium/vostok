...
class survarium::vector<enum survarium::profile_slot_enum>;
...
class survarium::inventory_item_props;
class survarium::match_options;

namespace survarium {

enum survarium::game_mode_type
{
...
public:
	...
	inline	flash_movie_resource_ptr&		get_ui							( ) { /* no source */ }
...
private:
	...
	/* 0x0034 */	vector< enum profile_slot_enum >	m_slots_to_update;
}; // class game_world_ui
