...
class survarium::weapon_sound_events_handler_state_cook<survarium::weapon_sound_events_handler_state<survarium::weapon_core_hide_state> >::config_params;
...
class survarium::weapon_sound_events_handler_state<survarium::weapon_core_hide_state>;
class survarium::weapon_state_creation_params;

namespace survarium {

class weapon_sound_events_handler_state_cook< weapon_sound_events_handler_state< weapon_core_hide_state > > : public resources::unmanaged_cook , public boost::noncopyable {
public:
	inline						weapon_sound_events_handler_state_cook<survarium::weapon_sound_events_handler_state<survarium::weapon_core_hide_state> >( ) { /* no source */ }
	...
	inline	void				on_subresources_ready	(
									...
									weapon_sound_events_handler_state_cook< weapon_sound_events_handler_state< weapon_core_hide_state > >::config_params	arg_3
								) { /* no source */ }

	inline	weapon_sound_events_handler_state< weapon_core_hide_state >*	new_state				(
	...
	virtual						~weapon_sound_events_handler_state_cook<survarium::weapon_sound_events_handler_state<survarium::weapon_core_hide_state> >( ) { /* no source */ }
}; // class weapon_sound_events_handler_state_cook< weapon_sound_events_handler_state< weapon_core_hide_state > >

STATIC_SIZE_ASSERT(weapon_sound_events_handler_state_cook< weapon_sound_events_handler_state< weapon_core_hide_state > >, 0x20);
