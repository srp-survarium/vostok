...
class survarium::booby_trap_set;
class survarium::booby_trap_set_cook_data;
...
public:
	inline	explicit				booby_trap_set_cook			( game_world& arg_0 ) { /* no source */ }

	virtual	void					delete_resource				( resources::resource_base* resource ) override { /* no source */ }
	virtual	booby_trap_set_core*	new_derived_resource		( ) override { /* no source */ }
