...
class weapon_core_state_cook_template< weapon_core_aimed_state > : public resources::unmanaged_cook {
public:
	inline								weapon_core_state_cook_template<survarium::weapon_core_aimed_state>( ) { /* no source */ }
	virtual								~weapon_core_state_cook_template<survarium::weapon_core_aimed_state>( ) { /* no source */ }
	...
	inline	void						on_subresources_ready	(
			...
			weapon_core_aimed_state*	new_object				(
											mutable_buffer							buffer,
											weapon_state_creation_params const*		params,
											resources::managed_resource_ptr const*	animations,
											const u32								animations_count
										);
}; // class weapon_core_state_cook_template< weapon_core_aimed_state >

STATIC_SIZE_ASSERT(weapon_core_state_cook_template< weapon_core_aimed_state >, 0x20);
