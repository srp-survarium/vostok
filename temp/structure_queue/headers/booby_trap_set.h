...
public:
	...
	virtual											~booby_trap_set				( ) { /* no source */ }
			...
			render::static_model_instance_ptr		pick_ghost_model			( bool is_placing_allowed );
			bool									pick_current_ghost_model	( float4x4 const& transform, bool is_placing_allowed );
			void									remove_current_ghost_model	( );

	inline	booby_trap_set*							return_this					( ) { /* no source */ }
...
private:
	...
	/* 0x0174 */	render::static_model_instance_ptr		m_model_ghost_allowed;
	/* 0x0178 */	render::static_model_instance_ptr		m_model_ghost_denied;
	/* 0x017c */	render::static_model_instance_ptr		m_current_rendering_model;
