...
class weapon_sound_events_handler_state< pistol_weapon_core_show_state > : public pistol_weapon_core_show_state {
public:
	inline			weapon_sound_events_handler_state<survarium::pistol_weapon_core_show_state>(
						weapon&			arg_0,
						const float		arg_1,
	...
	virtual			~weapon_sound_events_handler_state<survarium::pistol_weapon_core_show_state>( ) { /* no source */ }

private:
	/* 0x0000 */	/* pistol_weapon_core_show_state */
	/* 0x0180 */	weapon_sound_effect		m_sound_effect;
	/* 0x01a8 */	pcvoid					m_buffer_for_sounds;
}; // class weapon_sound_events_handler_state< pistol_weapon_core_show_state >

STATIC_SIZE_ASSERT(weapon_sound_events_handler_state< pistol_weapon_core_show_state >, 0x1B0);
