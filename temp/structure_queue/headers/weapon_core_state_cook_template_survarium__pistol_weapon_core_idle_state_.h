...
class weapon_core_state_cook_template< pistol_weapon_core_idle_state > : public resources::unmanaged_cook {
public:
	inline										weapon_core_state_cook_template<survarium::pistol_weapon_core_idle_state>( ) { /* no source */ }
	virtual										~weapon_core_state_cook_template<survarium::pistol_weapon_core_idle_state>( ) { /* no source */ }
	...
	inline	void								on_subresources_ready	(
			...
			pistol_weapon_core_idle_state*		new_object				(
													mutable_buffer							buffer,
													weapon_state_creation_params const*		params,
													resources::managed_resource_ptr const*	animations,
													const u32								animations_count
												);
}; // class weapon_core_state_cook_template< pistol_weapon_core_idle_state >

STATIC_SIZE_ASSERT(weapon_core_state_cook_template< pistol_weapon_core_idle_state >, 0x20);
