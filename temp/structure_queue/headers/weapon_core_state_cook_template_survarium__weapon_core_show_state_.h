...
class weapon_core_state_cook_template< weapon_core_show_state > : public resources::unmanaged_cook {
public:
	inline								weapon_core_state_cook_template<survarium::weapon_core_show_state>( ) { /* no source */ }
	virtual								~weapon_core_state_cook_template<survarium::weapon_core_show_state>( ) { /* no source */ }
...
}; // class weapon_core_state_cook_template< weapon_core_show_state >

STATIC_SIZE_ASSERT(weapon_core_state_cook_template< weapon_core_show_state >, 0x20);
