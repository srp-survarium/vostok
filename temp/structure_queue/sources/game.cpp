...
#include "pch.h"
#include "vostok\game\sources\game.h"
...
// STATE[STUB]
void* game::`scalar deleting destructor'( u32 arg_0 )
{
	return NULL;

	// FUNCTION BODY[0x8da10]: 8
	// <0>
	// <1>
	// <0x8d9a6>|0x006|+0x00f:'100'
	// <0x8d9b5>|0x015|+0x01d:'101'
	// <0>
	// <0x8d9d2>|0x032|+0x00f:'103'
	// <0x8d9e1>|0x041|+0x00c:'104'
	// <0x8d9ed>|0x04d|+0x010:'105'
	// ******
}
...
// STATE[STUB]
explicit scaleform_movie_cook::scaleform_movie_cook( flash_factory& factory )
{
