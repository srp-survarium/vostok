...
#ifndef VOSTOK\GAME\SOURCES\BOOBY_TRAP_SET_COOK_H_INCLUDED
#define VOSTOK\GAME\SOURCES\BOOBY_TRAP_SET_COOK_H_INCLUDED

namespace survarium {

// STATE[STUB]
inline void booby_trap_set_cook::delete_resource( resources::resource_base* resource )
{
...
// STATE[STUB]
inline booby_trap_set_core* booby_trap_set_cook::new_derived_resource( )
{
	return NULL;
...
// STATE[STUB]
inline void* game_world::`scalar deleting destructor'( u32 arg_0 )
{
	return NULL;

	// FUNCTION BODY[0x8f7c0]
	// <0x8f7b0>|0x000|      :'27'	{
	// ******
}
	...
	// typedef
	// 	survarium::game_world::bullet_tracer*
	// 	iterator_type;
...
#endif // #ifndef VOSTOK\GAME\SOURCES\BOOBY_TRAP_SET_COOK_H_INCLUDED
