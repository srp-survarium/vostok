...
#include "pch.h"
#include "vostok\game\sources\booby_trap_set.h"

namespace survarium {

// STATE[STUB]
explicit booby_trap_set::booby_trap_set( game_world& game_world )
{
...
// STATE[STUB]
render::static_model_instance_ptr booby_trap_set::pick_ghost_model( bool is_placing_allowed )
{
