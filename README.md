...
**Overall: 3,844 / 12,915 functions exact (29.76%) &middot; 3,844 / 12,915 functions exact-max (29.76%) &middot; 66.32% fuzzy &middot; 66.32% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 312 / 2,647 (11.8%) | 312 / 2,647 (11.8%) | 53.7% |     53.7% |
