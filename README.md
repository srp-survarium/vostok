...
**Overall: 10,435 / 13,014 functions exact (80.18%) &middot; 11,034 / 13,014 functions exact-max (84.79%) &middot; 93.33% fuzzy &middot; 94.94% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | -----: | --------: |
| `render`        |   351 | 2,022 / 2,734 (74.0%) | 2,246 / 2,734 (82.2%) |  91.2% |     93.3% |
| `game`          |   141 |   975 / 1,528 (63.8%) | 1,106 / 1,528 (72.4%) |  85.5% |     88.6% |
| `core`          |   136 | 1,169 / 1,325 (88.2%) | 1,259 / 1,325 (95.0%) |  97.2% |     98.6% |
| `vostok`        |   112 | 1,094 / 1,250 (87.5%) | 1,114 / 1,250 (89.1%) |  97.0% |     97.8% |
| `game_core`     |   189 |   823 / 1,181 (69.7%) |   854 / 1,181 (72.3%) |  93.5% |     95.7% |
...
**Function-reachable retail data: 98.13% (70,200,521 / 71,536,291 unique bytes) &middot; paired for comparison: 4.30% (3,074,550 / 71,536,291) &middot; matched projected copies: 65.98% (17,400,025 / 26,373,081).**

_The projection has 14,387 paired copies across 1,695 units and 31,654 unresolved blockers. Strict relocation comparison exposes 1,487 otherwise-exact functions (587,469 code bytes) with referent debt._

_The linked-image audit is 3.98% exact and covers 98.57% by PDB type extent, with 86.33% paired-only fidelity (10636 / 12160 definitions). Integrity ratchet: armed._
