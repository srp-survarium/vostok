...
**Overall: 10,442 / 13,014 functions exact (80.24%) &middot; 11,090 / 13,014 functions exact-max (85.22%) &middot; 93.42% fuzzy &middot; 95.14% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | -----: | --------: |
| `render`        |   351 | 2,038 / 2,734 (74.5%) | 2,256 / 2,734 (82.5%) |  91.6% |     93.6% |
