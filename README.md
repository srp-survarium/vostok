...
**Overall: 5,849 / 12,915 functions exact (45.29%) &middot; 5,918 / 12,915 functions exact-max (45.82%) &middot; 59.78% fuzzy &middot; 60.36% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 541 / 2,647 (20.4%) | 541 / 2,647 (20.4%) | 34.1% |     34.1% |
