...
**Overall: 10,140 / 13,017 functions exact (77.90%) &middot; 10,780 / 13,017 functions exact-max (82.81%) &middot; 92.26% fuzzy &middot; 94.23% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | ----: | --------: |
| `render`        |   351 | 1,984 / 2,734 (72.6%) | 2,208 / 2,734 (80.8%) | 91.2% |     93.2% |
