...
**Overall: 9,192 / 12,932 functions exact (71.08%) &middot; 9,429 / 12,932 functions exact-max (72.91%) &middot; 88.41% fuzzy &middot; 88.91% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | -----: | --------: |
| `render`        |   351 | 1,703 / 2,653 (64.2%) | 1,703 / 2,653 (64.2%) |  86.4% |     86.4% |
