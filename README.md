...
**Overall: 10,548 / 13,014 functions exact (81.05%) &middot; 11,138 / 13,014 functions exact-max (85.58%) &middot; 93.57% fuzzy &middot; 95.15% fuzzy-max.**
...
| `vostok`        |   112 | 1,125 / 1,250 (90.0%) | 1,142 / 1,250 (91.4%) |  97.5% |     98.2% |
...
| `network`       |    25 |      90 / 159 (56.6%) |      93 / 159 (58.5%) |  90.6% |     91.7% |
| `network_core`  |    22 |      91 / 127 (71.7%) |      96 / 127 (75.6%) |  97.7% |     98.2% |
...
_Updated 2026-09-19 &middot; delinker `d7e9292` (folded-symbol reconciliation)._
<!-- match-score:end -->
...
**Function-reachable retail data: 98.14% (70,204,079 / 71,536,291 unique bytes) &middot; paired for comparison: 4.32% (3,089,443 / 71,536,291) &middot; matched projected copies: 66.09% (17,436,223 / 26,383,211).**

_The projection has 15,047 paired copies across 1,701 units and 31,084 unresolved blockers. Strict relocation comparison exposes 1,479 otherwise-exact functions (572,975 code bytes) with referent debt._

_The linked-image audit is 4.02% exact and covers 98.57% by PDB type extent, with 86.67% paired-only fidelity (11276 / 12793 definitions). Integrity ratchet: armed._
