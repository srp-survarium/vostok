...
**Overall: 3,846 / 12,915 functions exact (29.78%) &middot; 3,846 / 12,915 functions exact-max (29.78%) &middot; 66.23% fuzzy &middot; 66.23% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 312 / 2,647 (11.8%) | 312 / 2,647 (11.8%) | 53.4% |     53.4% |
