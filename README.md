...
**Overall: 10,484 / 13,014 functions exact (80.56%) &middot; 11,077 / 13,014 functions exact-max (85.12%) &middot; 93.52% fuzzy &middot; 95.11% fuzzy-max.**
...
**Function-reachable retail data: 98.14% (70,204,079 / 71,536,291 unique bytes) &middot; paired for comparison: 4.32% (3,090,407 / 71,536,291) &middot; matched projected copies: 66.09% (17,439,803 / 26,386,091).**

_The projection has 15,293 paired copies across 1,701 units and 30,838 unresolved blockers. Strict relocation comparison exposes 1,475 otherwise-exact functions (577,174 code bytes) with referent debt._
