...
**Overall: 3,884 / 12,915 functions exact (30.07%) &middot; 3,884 / 12,915 functions exact-max (30.07%) &middot; 67.59% fuzzy &middot; 67.59% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 345 / 2,647 (13.0%) | 345 / 2,647 (13.0%) | 57.7% |     57.7% |
