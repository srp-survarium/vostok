...
**Overall: 9,195 / 12,932 functions exact (71.10%) &middot; 9,436 / 12,932 functions exact-max (72.97%) &middot; 88.40% fuzzy &middot; 88.92% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | -----: | --------: |
| `render`        |   351 | 1,710 / 2,653 (64.5%) | 1,710 / 2,653 (64.5%) |  86.4% |     86.4% |
