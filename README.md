...
**Overall: 10,472 / 13,014 functions exact (80.47%) &middot; 11,063 / 13,014 functions exact-max (85.01%) &middot; 93.43% fuzzy &middot; 95.01% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | -----: | --------: |
| `render`        |   351 | 2,028 / 2,734 (74.2%) | 2,248 / 2,734 (82.2%) |  91.3% |     93.3% |
