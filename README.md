...
**Overall: 9,288 / 12,932 functions exact (71.82%) &middot; 9,678 / 12,932 functions exact-max (74.84%) &middot; 89.09% fuzzy &middot; 90.72% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | ----: | --------: |
| `render`        |   351 | 1,645 / 2,655 (62.0%) | 1,703 / 2,655 (64.1%) | 85.7% |     87.4% |
