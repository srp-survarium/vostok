...
**Overall: 3,875 / 12,915 functions exact (30.00%) &middot; 3,875 / 12,915 functions exact-max (30.00%) &middot; 67.25% fuzzy &middot; 67.25% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 338 / 2,647 (12.8%) | 338 / 2,647 (12.8%) | 56.6% |     56.6% |
