...
**Overall: 10,450 / 13,014 functions exact (80.30%) &middot; 11,094 / 13,014 functions exact-max (85.25%) &middot; 93.56% fuzzy &middot; 95.27% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | -----: | --------: |
| `render`        |   351 | 2,042 / 2,734 (74.7%) | 2,260 / 2,734 (82.7%) |  92.0% |     94.0% |
