...
**Overall: 10,484 / 13,014 functions exact (80.56%) &middot; 11,074 / 13,014 functions exact-max (85.09%) &middot; 93.53% fuzzy &middot; 95.10% fuzzy-max.**
...
| `game_core`     |   189 |   830 / 1,181 (70.3%) |   859 / 1,181 (72.7%) |  93.9% |     96.0% |
...
**Function-reachable retail data: 98.14% (70,204,079 / 71,536,291 unique bytes) &middot; paired for comparison: 4.32% (3,090,497 / 71,536,291) &middot; matched projected copies: 66.09% (17,435,275 / 26,382,203).**

_The projection has 15,038 paired copies across 1,701 units and 31,093 unresolved blockers. Strict relocation comparison exposes 1,469 otherwise-exact functions (571,438 code bytes) with referent debt._

_The linked-image audit is 4.02% exact and covers 98.57% by PDB type extent, with 86.67% paired-only fidelity (11271 / 12789 definitions). Integrity ratchet: armed._
