...
**Overall: 10,157 / 13,017 functions exact (78.03%) &middot; 10,796 / 13,017 functions exact-max (82.94%) &middot; 92.73% fuzzy &middot; 94.63% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | ----: | --------: |
| `render`        |   351 | 1,992 / 2,734 (72.9%) | 2,215 / 2,734 (81.0%) | 91.2% |     93.3% |
