...
**Overall: 10,449 / 13,014 functions exact (80.29%) &middot; 11,093 / 13,014 functions exact-max (85.24%) &middot; 93.55% fuzzy &middot; 95.27% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | -----: | --------: |
| `render`        |   351 | 2,041 / 2,734 (74.7%) | 2,259 / 2,734 (82.6%) |  92.0% |     94.0% |
| `game`          |   141 |   990 / 1,528 (64.8%) | 1,117 / 1,528 (73.1%) |  85.8% |     88.9% |
| `core`          |   136 | 1,175 / 1,325 (88.7%) | 1,261 / 1,325 (95.2%) |  97.3% |     98.6% |
| `vostok`        |   112 | 1,100 / 1,250 (88.0%) | 1,117 / 1,250 (89.4%) |  96.6% |     97.8% |
...
| `physics`       |    14 |     134 / 198 (67.7%) |     155 / 198 (78.3%) |  88.2% |     93.3% |
...
| `network_core`  |    22 |      67 / 127 (52.8%) |      67 / 127 (52.8%) |  94.9% |     94.9% |
...
**Function-reachable retail data: 98.78% (70,661,103 / 71,536,291 unique bytes) &middot; paired for comparison: 98.77% (70,657,944 / 71,536,291) &middot; matched projected copies: 98.17% (421,636,425 / 429,506,589).**

_The projection has 42,016 paired copies across 2,129 units and 106 unresolved blockers. Strict relocation comparison exposes 1,484 otherwise-exact functions (597,247 code bytes) with referent debt._

_The linked-image audit is 99.44% exact and covers 99.47% by PDB type extent, with 99.99% paired-only fidelity (33884 / 33981 definitions). Integrity ratchet: armed._
