...
**Overall: 51.56% fuzzy &middot; 9,492 / 25,372 functions exact (37.41%).**

| Module | Units | Functions exact | Code matched |
|---|--:|--:|--:|
| `render` | 351 | 381 / 2,805 (13.6%) | 3.4% |
| `shared` | 112 | 830 / 2,255 (36.8%) | 36.3% |
| `game` | 141 | 20 / 1,634 (1.2%) | 0.1% |
| `game_core` | 189 | 518 / 1,429 (36.2%) | 21.1% |
