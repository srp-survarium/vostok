...
**Overall: 10,475 / 13,014 functions exact (80.49%) &middot; 11,068 / 13,014 functions exact-max (85.05%) &middot; 93.44% fuzzy &middot; 95.04% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | -----: | --------: |
| `render`        |   351 | 2,033 / 2,734 (74.4%) | 2,253 / 2,734 (82.4%) |  91.4% |     93.4% |
...
_The projection has 14,403 paired copies across 1,695 units and 31,638 unresolved blockers. Strict relocation comparison exposes 1,473 otherwise-exact functions (587,529 code bytes) with referent debt._
