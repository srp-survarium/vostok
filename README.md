...
**Overall: 10,141 / 13,017 functions exact (77.91%) &middot; 10,781 / 13,017 functions exact-max (82.82%) &middot; 92.26% fuzzy &middot; 94.23% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | ----: | --------: |
| `render`        |   351 | 1,985 / 2,734 (72.6%) | 2,209 / 2,734 (80.8%) | 91.2% |     93.2% |
