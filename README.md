...
**Overall: 3,877 / 12,915 functions exact (30.02%) &middot; 3,877 / 12,915 functions exact-max (30.02%) &middot; 67.48% fuzzy &middot; 67.49% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 341 / 2,647 (12.9%) | 341 / 2,647 (12.9%) | 57.4% |     57.4% |
