...
**Overall: 9,106 / 12,932 functions exact (70.41%) &middot; 9,351 / 12,932 functions exact-max (72.31%) &middot; 88.15% fuzzy &middot; 88.70% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | -----: | --------: |
| `render`        |   351 | 1,666 / 2,653 (62.8%) | 1,667 / 2,653 (62.8%) |  86.3% |     86.3% |
