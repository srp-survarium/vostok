...
**Overall: 10,134 / 13,017 functions exact (77.85%) &middot; 10,777 / 13,017 functions exact-max (82.79%) &middot; 92.24% fuzzy &middot; 94.23% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | ----: | --------: |
| `render`        |   351 | 1,978 / 2,734 (72.3%) | 2,205 / 2,734 (80.7%) | 91.2% |     93.2% |
