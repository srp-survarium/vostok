...
**Overall: 3,886 / 12,915 functions exact (30.09%) &middot; 3,886 / 12,915 functions exact-max (30.09%) &middot; 68.13% fuzzy &middot; 68.13% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 347 / 2,647 (13.1%) | 347 / 2,647 (13.1%) | 59.5% |     59.5% |
