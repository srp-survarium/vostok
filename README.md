...
**Overall: 10,480 / 13,014 functions exact (80.53%) &middot; 11,069 / 13,014 functions exact-max (85.05%) &middot; 93.48% fuzzy &middot; 95.07% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | -----: | --------: |
| `render`        |   351 | 2,034 / 2,734 (74.4%) | 2,254 / 2,734 (82.4%) |  91.5% |     93.5% |
