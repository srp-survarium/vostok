...
**Overall: 5,795 / 12,915 functions exact (44.87%) &middot; 5,863 / 12,915 functions exact-max (45.40%) &middot; 58.73% fuzzy &middot; 59.34% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 485 / 2,647 (18.3%) | 485 / 2,647 (18.3%) | 30.7% |     30.8% |
