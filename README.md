...
**Overall: 9,200 / 12,932 functions exact (71.14%) &middot; 9,441 / 12,932 functions exact-max (73.00%) &middot; 88.40% fuzzy &middot; 88.92% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | -----: | --------: |
| `render`        |   351 | 1,715 / 2,653 (64.6%) | 1,715 / 2,653 (64.6%) |  86.4% |     86.4% |
