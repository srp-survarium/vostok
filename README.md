...
**Overall: 9,288 / 12,932 functions exact (71.82%) &middot; 9,680 / 12,932 functions exact-max (74.85%) &middot; 89.09% fuzzy &middot; 90.72% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | ----: | --------: |
| `render`        |   351 | 1,647 / 2,655 (62.0%) | 1,705 / 2,655 (64.2%) | 85.7% |     87.4% |
