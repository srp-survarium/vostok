...
**Overall: 10,139 / 13,017 functions exact (77.89%) &middot; 10,779 / 13,017 functions exact-max (82.81%) &middot; 92.26% fuzzy &middot; 94.23% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | ----: | --------: |
| `render`        |   351 | 1,983 / 2,734 (72.5%) | 2,207 / 2,734 (80.7%) | 91.2% |     93.2% |
