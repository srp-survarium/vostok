...
**Overall: 3,833 / 12,915 functions exact (29.68%) &middot; 3,833 / 12,915 functions exact-max (29.68%) &middot; 64.91% fuzzy &middot; 64.91% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 304 / 2,647 (11.5%) | 304 / 2,647 (11.5%) | 49.3% |     49.3% |
