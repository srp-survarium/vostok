...
**Overall: 10,440 / 13,014 functions exact (80.22%) &middot; 11,034 / 13,014 functions exact-max (84.79%) &middot; 93.36% fuzzy &middot; 94.94% fuzzy-max.**
...
| `game_core`     |   189 |   824 / 1,181 (69.8%) |   854 / 1,181 (72.3%) |  93.5% |     95.7% |
...
**Function-reachable retail data: 98.13% (70,200,521 / 71,536,291 unique bytes) &middot; paired for comparison: 4.32% (3,087,313 / 71,536,291) &middot; matched projected copies: 66.01% (17,418,705 / 26,387,285).**

_The projection has 14,403 paired copies across 1,695 units and 31,638 unresolved blockers. Strict relocation comparison exposes 1,456 otherwise-exact functions (567,765 code bytes) with referent debt._
