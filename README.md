...
**Overall: 10,481 / 13,014 functions exact (80.54%) &middot; 11,070 / 13,014 functions exact-max (85.06%) &middot; 93.48% fuzzy &middot; 95.07% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | -----: | --------: |
| `render`        |   351 | 2,035 / 2,734 (74.4%) | 2,255 / 2,734 (82.5%) |  91.5% |     93.5% |
