...
**Overall: 10,482 / 13,014 functions exact (80.54%) &middot; 11,071 / 13,014 functions exact-max (85.07%) &middot; 93.48% fuzzy &middot; 95.07% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | -----: | --------: |
| `render`        |   351 | 2,036 / 2,734 (74.5%) | 2,256 / 2,734 (82.5%) |  91.5% |     93.5% |
