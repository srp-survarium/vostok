...
**Overall: 3,847 / 12,915 functions exact (29.79%) &middot; 3,847 / 12,915 functions exact-max (29.79%) &middot; 66.27% fuzzy &middot; 66.27% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 312 / 2,647 (11.8%) | 312 / 2,647 (11.8%) | 53.5% |     53.5% |
