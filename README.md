...
**Overall: 3,875 / 12,915 functions exact (30.00%) &middot; 3,875 / 12,915 functions exact-max (30.00%) &middot; 67.31% fuzzy &middot; 67.31% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 339 / 2,647 (12.8%) | 339 / 2,647 (12.8%) | 56.8% |     56.8% |
