...
**Overall: 9,287 / 12,932 functions exact (71.81%) &middot; 9,679 / 12,932 functions exact-max (74.85%) &middot; 89.09% fuzzy &middot; 90.72% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | ----: | --------: |
| `render`        |   351 | 1,646 / 2,655 (62.0%) | 1,704 / 2,655 (64.2%) | 85.7% |     87.4% |
