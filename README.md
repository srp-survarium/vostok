...
**Overall: 3,815 / 12,915 functions exact (29.54%) &middot; 5,574 / 12,915 functions exact-max (43.16%) &middot; 62.14% fuzzy &middot; 62.39% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 289 / 2,647 (10.9%) | 289 / 2,647 (10.9%) | 40.4% |     40.5% |
