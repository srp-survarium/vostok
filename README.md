...
**Overall: 10,474 / 13,014 functions exact (80.48%) &middot; 11,067 / 13,014 functions exact-max (85.04%) &middot; 93.44% fuzzy &middot; 95.04% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | -----: | --------: |
| `render`        |   351 | 2,032 / 2,734 (74.3%) | 2,252 / 2,734 (82.4%) |  91.4% |     93.4% |
| `game`          |   141 |   980 / 1,528 (64.1%) | 1,111 / 1,528 (72.7%) |  85.6% |     88.7% |
| `core`          |   136 | 1,172 / 1,325 (88.5%) | 1,259 / 1,325 (95.0%) |  97.2% |     98.6% |
| `vostok`        |   112 | 1,091 / 1,250 (87.3%) | 1,114 / 1,250 (89.1%) |  96.5% |     97.8% |
...
**Function-reachable retail data: 98.13% (70,200,521 / 71,536,291 unique bytes) &middot; paired for comparison: 4.31% (3,086,577 / 71,536,291) &middot; matched projected copies: 66.01% (17,418,213 / 26,385,813).**

_The projection has 14,403 paired copies across 1,695 units and 31,638 unresolved blockers. Strict relocation comparison exposes 1,472 otherwise-exact functions (586,444 code bytes) with referent debt._
