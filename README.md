...
**Overall: 3,819 / 12,915 functions exact (29.57%) &middot; 5,578 / 12,915 functions exact-max (43.19%) &middot; 62.38% fuzzy &middot; 62.63% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 290 / 2,647 (11.0%) | 290 / 2,647 (11.0%) | 41.2% |     41.3% |
