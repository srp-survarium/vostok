...
**Overall: 3,842 / 12,915 functions exact (29.75%) &middot; 3,842 / 12,915 functions exact-max (29.75%) &middot; 65.93% fuzzy &middot; 65.93% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 310 / 2,647 (11.7%) | 310 / 2,647 (11.7%) | 52.4% |     52.4% |
