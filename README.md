...
**Overall: 10,441 / 13,014 functions exact (80.23%) &middot; 11,094 / 13,014 functions exact-max (85.25%) &middot; 93.63% fuzzy &middot; 95.34% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | -----: | --------: |
| `render`        |   351 | 2,042 / 2,734 (74.7%) | 2,260 / 2,734 (82.7%) |  92.2% |     94.2% |
| `game`          |   141 |   990 / 1,528 (64.8%) | 1,117 / 1,528 (73.1%) |  85.8% |     88.9% |
| `core`          |   136 | 1,175 / 1,325 (88.7%) | 1,261 / 1,325 (95.2%) |  97.3% |     98.6% |
| `vostok`        |   112 | 1,095 / 1,250 (87.6%) | 1,117 / 1,250 (89.4%) |  96.9% |     97.8% |
...
| `physics`       |    14 |     133 / 198 (67.2%) |     155 / 198 (78.3%) |  88.1% |     93.3% |
...
**Function-reachable retail data: 98.78% (70,661,103 / 71,536,291 unique bytes) &middot; paired for comparison: 98.77% (70,657,928 / 71,536,291) &middot; matched projected copies: 98.17% (421,636,961 / 429,506,593).**

_The projection has 42,014 paired copies across 2,129 units and 108 unresolved blockers. Strict relocation comparison exposes 1,472 otherwise-exact functions (595,041 code bytes) with referent debt._
