...
**Overall: 3,892 / 12,915 functions exact (30.14%) &middot; 3,892 / 12,915 functions exact-max (30.14%) &middot; 68.49% fuzzy &middot; 68.49% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 353 / 2,647 (13.3%) | 353 / 2,647 (13.3%) | 60.6% |     60.6% |
