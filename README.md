...
**Overall: 3,804 / 12,915 functions exact (29.45%) &middot; 5,563 / 12,915 functions exact-max (43.07%) &middot; 60.80% fuzzy &middot; 61.01% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 276 / 2,647 (10.4%) | 276 / 2,647 (10.4%) | 36.1% |     36.1% |
