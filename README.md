...
**Overall: 47.46% fuzzy (+2.91%) &middot; 4,198 / 12,915 functions exact (32.50%, +383 best-ever).**
...
| `game`          |   141 |  145 / 1,498 (9.7%) |            151 (+6) | 13.2% |     +1.3% |
...
| `scaleform`     |    47 |    59 / 453 (13.0%) |             67 (+8) |  6.4% |     +0.3% |
