...
**Overall: 3,658 / 12,915 functions exact (28.32%) &middot; 3,658 / 12,915 functions exact-max (28.32%) &middot; 58.84% fuzzy &middot; 58.84% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 |  190 / 2,647 (7.2%) |  190 / 2,647 (7.2%) | 32.0% |     32.0% |
