...
**Overall: 10,017 / 13,017 functions exact (76.95%) &middot; 10,663 / 13,017 functions exact-max (81.92%) &middot; 91.70% fuzzy &middot; 93.76% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | ----: | --------: |
| `render`        |   351 | 1,874 / 2,734 (68.5%) | 2,098 / 2,734 (76.7%) | 90.3% |     92.6% |
