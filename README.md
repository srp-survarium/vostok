...
**Overall: 3,873 / 12,915 functions exact (29.99%) &middot; 3,873 / 12,915 functions exact-max (29.99%) &middot; 66.99% fuzzy &middot; 66.99% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 336 / 2,647 (12.7%) | 336 / 2,647 (12.7%) | 55.8% |     55.8% |
