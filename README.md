...
**Overall: 5,897 / 12,915 functions exact (45.66%) &middot; 5,897 / 12,915 functions exact-max (45.66%) &middot; 60.43% fuzzy &middot; 60.43% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 560 / 2,647 (21.2%) | 560 / 2,647 (21.2%) | 35.7% |     35.7% |
