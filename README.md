...
**Overall: 10,138 / 13,017 functions exact (77.88%) &middot; 10,778 / 13,017 functions exact-max (82.80%) &middot; 92.26% fuzzy &middot; 94.23% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | ----: | --------: |
| `render`        |   351 | 1,982 / 2,734 (72.5%) | 2,206 / 2,734 (80.7%) | 91.2% |     93.2% |
