...
**Overall: 10,143 / 13,017 functions exact (77.92%) &middot; 10,783 / 13,017 functions exact-max (82.84%) &middot; 92.26% fuzzy &middot; 94.23% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | ----: | --------: |
| `render`        |   351 | 1,987 / 2,734 (72.7%) | 2,211 / 2,734 (80.9%) | 91.2% |     93.2% |
