...
**Overall: 10,410 / 13,014 functions exact (79.99%) &middot; 11,052 / 13,014 functions exact-max (84.92%) &middot; 93.31% fuzzy &middot; 95.01% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | -----: | --------: |
| `render`        |   351 | 2,028 / 2,734 (74.2%) | 2,246 / 2,734 (82.2%) |  91.3% |     93.3% |
| `game`          |   141 |   985 / 1,528 (64.5%) | 1,112 / 1,528 (72.8%) |  85.7% |     88.8% |
| `core`          |   136 | 1,175 / 1,325 (88.7%) | 1,261 / 1,325 (95.2%) |  97.3% |     98.6% |
| `vostok`        |   112 | 1,100 / 1,250 (88.0%) | 1,117 / 1,250 (89.4%) |  97.0% |     97.8% |
| `game_core`     |   189 |   815 / 1,181 (69.0%) |   859 / 1,181 (72.7%) |  92.3% |     95.9% |
| `animation`     |   102 |     578 / 727 (79.5%) |     594 / 727 (81.7%) |  91.9% |     92.4% |
| `ai`            |   124 |     636 / 691 (92.0%) |     658 / 691 (95.2%) |  99.3% |     99.6% |
...
| `particle`      |    25 |     379 / 400 (94.8%) |     396 / 400 (99.0%) |  99.3% |     99.9% |
...
| `network_core`  |    22 |      66 / 127 (52.0%) |      66 / 127 (52.0%) |  94.9% |     94.9% |
...
**Function-reachable retail data: 98.78% (70,661,103 / 71,536,291 unique bytes) &middot; paired for comparison: 98.77% (70,658,158 / 71,536,291) &middot; matched projected copies: 98.17% (421,639,741 / 429,506,761).**

_The projection has 42,029 paired copies across 2,129 units and 93 unresolved blockers. Strict relocation comparison exposes 1,870 otherwise-exact functions (819,323 code bytes) with referent debt._

_The linked-image audit is 99.45% exact and covers 99.47% by PDB type extent, with 100.00% paired-only fidelity (33970 / 33990 definitions). Integrity ratchet: armed._
