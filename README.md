...
**Overall: 3,884 / 12,915 functions exact (30.07%) &middot; 3,884 / 12,915 functions exact-max (30.07%) &middot; 68.23% fuzzy &middot; 68.23% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 347 / 2,647 (13.1%) | 347 / 2,647 (13.1%) | 59.8% |     59.8% |
