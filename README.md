...
**Overall: 3,799 / 12,915 functions exact (29.42%) &middot; 5,835 / 12,915 functions exact-max (45.18%) &middot; 60.60% fuzzy &middot; 60.88% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 271 / 2,647 (10.2%) | 548 / 2,647 (20.7%) | 35.5% |     35.7% |
