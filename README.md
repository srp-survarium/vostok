...
**Overall: 3,805 / 12,915 functions exact (29.46%) &middot; 5,564 / 12,915 functions exact-max (43.08%) &middot; 60.93% fuzzy &middot; 61.14% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 277 / 2,647 (10.5%) | 277 / 2,647 (10.5%) | 36.6% |     36.6% |
