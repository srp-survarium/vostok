...
**Overall: 9,287 / 12,932 functions exact (71.81%) &middot; 9,677 / 12,932 functions exact-max (74.83%) &middot; 89.09% fuzzy &middot; 90.72% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | ----: | --------: |
| `render`        |   351 | 1,644 / 2,655 (61.9%) | 1,702 / 2,655 (64.1%) | 85.7% |     87.4% |
