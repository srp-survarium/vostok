...
**Overall: 3,818 / 12,915 functions exact (29.56%) &middot; 5,577 / 12,915 functions exact-max (43.18%) &middot; 62.49% fuzzy &middot; 62.70% fuzzy-max.**
...
| :-------------- | ----: | ------------------: | ------------------: | ----: | --------: |
| `render`        |   351 | 290 / 2,647 (11.0%) | 290 / 2,647 (11.0%) | 41.5% |     41.5% |
