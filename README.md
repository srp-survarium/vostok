...
**Overall: 9,295 / 12,932 functions exact (71.88%) &middot; 9,685 / 12,932 functions exact-max (74.89%) &middot; 89.10% fuzzy &middot; 90.73% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | ----: | --------: |
| `render`        |   351 | 1,652 / 2,655 (62.2%) | 1,710 / 2,655 (64.4%) | 85.7% |     87.5% |
