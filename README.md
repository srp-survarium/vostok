...
**Overall: 10,451 / 12,999 functions exact (80.40%) &middot; 11,051 / 12,999 functions exact-max (85.01%) &middot; 93.47% fuzzy &middot; 95.08% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | -----: | --------: |
| `render`        |   351 | 1,998 / 2,702 (73.9%) | 2,223 / 2,702 (82.3%) |  91.5% |     93.6% |
| `game`          |   141 |   981 / 1,534 (64.0%) | 1,113 / 1,534 (72.6%) |  85.6% |     88.7% |
| `core`          |   136 | 1,172 / 1,325 (88.5%) | 1,259 / 1,325 (95.0%) |  97.2% |     98.6% |
| `vostok`        |   112 | 1,098 / 1,257 (87.4%) | 1,121 / 1,257 (89.2%) |  96.9% |     97.8% |
...
**Function-reachable retail data: 98.13% (70,200,521 / 71,536,291 unique bytes) &middot; paired for comparison: 4.31% (3,084,977 / 71,536,291) &middot; matched projected copies: 66.01% (17,414,065 / 26,379,525).**

_The projection has 14,394 paired copies across 1,695 units and 31,647 unresolved blockers. Strict relocation comparison exposes 1,454 otherwise-exact functions (573,911 code bytes) with referent debt._
