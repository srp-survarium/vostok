...
**Overall: 10,262 / 13,014 functions exact (78.85%) &middot; 10,886 / 13,014 functions exact-max (83.65%) &middot; 92.97% fuzzy &middot; 94.72% fuzzy-max.**
...
| `vostok`        |   112 | 1,062 / 1,250 (85.0%) | 1,082 / 1,250 (86.6%) |  96.0% |     96.9% |
...
| `particle`      |    25 |     377 / 400 (94.2%) |     394 / 400 (98.5%) |  99.3% |     99.9% |
| `vfs`           |    71 |     278 / 390 (71.3%) |     289 / 390 (74.1%) |  97.2% |     97.4% |
| `ui`            |    27 |     216 / 227 (95.2%) |     218 / 227 (96.0%) |  99.0% |     99.5% |
| `physics`       |    14 |     135 / 198 (68.2%) |     155 / 198 (78.3%) |  88.4% |     93.3% |
| `fs`            |    25 |     126 / 165 (76.4%) |     139 / 165 (84.2%) |  97.0% |     97.9% |
...
**Function-reachable retail data: 98.14% (70,204,079 / 71,536,291 unique bytes) &middot; paired for comparison: 98.13% (70,200,898 / 71,536,291) &middot; matched projected copies: 98.15% (421,095,667 / 429,038,615).**

_The projection has 15,332 paired copies across 1,701 units and 30,799 unresolved blockers. Strict relocation comparison exposes 1,442 otherwise-exact functions (585,381 code bytes) with referent debt._

_The linked-image audit is 98.50% exact and covers 98.57% by PDB type extent, with 99.96% paired-only fidelity (12910 / 13297 definitions). Integrity ratchet: armed._
