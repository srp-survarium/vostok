...
**Overall: 10,443 / 13,014 functions exact (80.24%) &middot; 11,091 / 13,014 functions exact-max (85.22%) &middot; 93.46% fuzzy &middot; 95.18% fuzzy-max.**
...
| :-------------- | ----: | --------------------: | --------------------: | -----: | --------: |
| `render`        |   351 | 2,039 / 2,734 (74.6%) | 2,257 / 2,734 (82.6%) |  91.7% |     93.7% |
