...
**Overall: 10,488 / 13,014 functions exact (80.59%) &middot; 11,078 / 13,014 functions exact-max (85.12%) &middot; 93.53% fuzzy &middot; 95.11% fuzzy-max.**
...
| `game_core`     |   189 |   834 / 1,181 (70.6%) |   863 / 1,181 (73.1%) |  93.9% |     96.0% |
...
**Function-reachable retail data: 98.14% (70,204,079 / 71,536,291 unique bytes) &middot; paired for comparison: 4.32% (3,090,497 / 71,536,291) &middot; matched projected copies: 66.10% (17,439,955 / 26,382,203).**

_The projection has 15,038 paired copies across 1,701 units and 31,093 unresolved blockers. Strict relocation comparison exposes 1,463 otherwise-exact functions (569,506 code bytes) with referent debt._

_The linked-image audit is 4.02% exact and covers 98.57% by PDB type extent, with 86.68% paired-only fidelity (11269 / 12786 definitions). Integrity ratchet: armed._
