...
//////////////////////////////////////////////////////////////////////////
// static mesh, depth-pass layout (static_mesh_vertex_input_shadow.h).
// The normal - and the vertex colour of type 2 - are declared and never
// read: they hold their place in the input signature so the same vertex
// buffer feeds this pass and the g-stage one.
//////////////////////////////////////////////////////////////////////////
...
{
#if CONFIG_WIND_MOTION==1 || CONFIG_WIND_MOTION==2
	...
	// vertex_base.vs doubles this; the shipped depth blob does not.
...
void fill_output_vertex(in vertex_input_struct input, out vertex_output_struct output)
{
	...
	output.homogeneous_position	= mul( m_VP,  float4( position, 1.f));
