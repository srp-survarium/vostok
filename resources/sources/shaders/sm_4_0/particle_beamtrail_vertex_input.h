...
#ifndef SHADERS_SM_4_0_PARTICLE_BEAMTRAIL_VERTEX_INPUT_H_INCLUDED
#define SHADERS_SM_4_0_PARTICLE_BEAMTRAIL_VERTEX_INPUT_H_INCLUDED
...
material_parameters get_material_parameters(inout vertex_output_struct input)
{
	...
	parameters.tangent_to_viewspace 	= float3x3( float3(1.0f, 0.0f, 0.0f), float3(0.0f, 1.0f, 0.0f), float3(0.0f, 0.0f, 1.0f));
	
	return parameters;
}

#endif // #ifndef SHADERS_SM_4_0_PARTICLE_BEAMTRAIL_VERTEX_INPUT_H_INCLUDED